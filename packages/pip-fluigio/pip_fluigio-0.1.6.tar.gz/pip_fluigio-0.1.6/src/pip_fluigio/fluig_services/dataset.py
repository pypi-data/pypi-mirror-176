...
from pip_fluigio.__fluig_services_base.interfaces.dataset import (
    DatasetQuery, DatasetQueryParams, StructConstraint, StructField,
    StructOrder)
...
class Dataset(DatasetProvider):
    ...
    def get_all_available_dataset(
        self, *, company_id: str, user_name: str, password: str
    ) -> Optional[List[dict]]:
    ...
    def disable_dataset(
        self, *, company_id: str, user_name: str, password: str, dataset_name: str
    ) -> None:
