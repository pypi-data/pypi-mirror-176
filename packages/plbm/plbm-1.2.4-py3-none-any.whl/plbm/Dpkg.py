...
@Desc    :   当前文件作用
"""
from plbm import ComMand, ColorLogger
from os import path
...
class DpkgManagement:
	...
	def check_local_pac_version(self, pac=None, pac_v=None):
		"""
		...
		"""
		self.get_status = False
		cmd = """dpkg -l | grep docker.io | awk '{print $1,$2,$3}'"""
	...
	def get_local_pac_version(self, pac):
		"""
		获取本地包版本,通过(local_package_version)获取值
		:param pac: 包名称
		:return: 获取结果(bool)
		"""
		self.check_local_pac_version(pac=pac, pac_v='get_local_pac_version')
