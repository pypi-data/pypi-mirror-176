...
from intersection.consts import MERGE_FILE_WORK_SUB_DIR
...
def merge_sorted_files(file_paths, destination_dir):
    ...
    """
    merged_dir = join(destination_dir, MERGE_FILE_WORK_SUB_DIR)
    makedirs(merged_dir)
...
def _merge_values(first_file, second_file, merged_file):
    value_1, value_2 = next_value(first_file), next_value(second_file)
