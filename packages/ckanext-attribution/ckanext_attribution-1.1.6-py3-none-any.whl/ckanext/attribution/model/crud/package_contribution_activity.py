...
from ckanext.attribution.model.package_contribution_activity import (PackageContributionActivity,
...
class PackageContributionActivityQuery(BaseQuery):
    ...
    def read_package(cls, pkg_id):
        return Session.query(PackageContributionActivity).filter(PackageContributionActivity.package_id == pkg_id).all()