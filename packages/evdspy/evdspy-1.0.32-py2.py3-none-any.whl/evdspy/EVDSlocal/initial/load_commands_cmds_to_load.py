...
def get_input_for_categs_data_groups(list_of_categs: List[tuple]):
    if config.current_mode_is_test:
        return
...
def get_input_for_categs_data_groups_deeper(codes_and_titles: List[tuple]):
...
def get_categories_main():
    ...
    get_input_for_categs_data_groups(list_of_categs)
