...
class Active_Learning_Loop:
    ...
    def generate_initial_space(self):
        s = [list(np.linspace(0, 1, 20)), list(np.linspace(0, 1, 20)), list(np.linspace(0, 1, 20))]
    ...
    def ternary_visualization(self, add_data = None, save_path = None):
        if add_data is None:
