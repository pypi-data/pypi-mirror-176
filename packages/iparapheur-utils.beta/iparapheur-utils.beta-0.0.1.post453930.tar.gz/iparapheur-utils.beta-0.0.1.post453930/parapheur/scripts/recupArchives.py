...
use_id_in_path = True
if config.has_option(__config_section__, "use_id_in_path"):
    use_id_in_path = config.get(__config_section__, "use_id_in_path") == "true"
# use_only_print_pdfs = False
...
def get_full_folder_path(dossier_type, dossier_subtype, dossier_title, dossier_id):
    ...
    if use_id_in_path:
        ...
        full_path = "{0}/{1}/{2}/{3}".format(recup_folder, dossier_type, dossier_subtype, dossier_title)
