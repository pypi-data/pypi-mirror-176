...
BioSAK CheckM -i checkm_op.txt -o bin_qualities.txt
BioSAK CheckM -i checkm_op.txt -o bin_qualities.txt -r

# get the quality of qualified bins 
BioSAK CheckM -i checkm_op.txt -cpl 99 -o bin_qualities_cpl99.txt
BioSAK CheckM -i checkm_op.txt -cpl 99 -ctm 5 -o bin_qualities_cpl99_ctm5.txt

# get the quality of qualified bins and copy them into a separate folder
BioSAK CheckM -i checkm_op.txt -bin bin_folder -x fa -cpl 99 -o bin_qualities_cpl99.txt
BioSAK CheckM -i checkm_op.txt -bin bin_folder -x fa -cpl 99 -ctm 5 -o bin_qualities_cpl99_ctm5.txt
