                            ...
                            if where_condition.field.sourceFormat is not None:
                                ...
                                if formatted_value is not None:
                                    ...
                                    if where_condition.steps is not None and where_condition.interval is not None:
                                        formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + where_condition.interval + " " + direction + " " + where_condition.steps
                                    elif where_condition.steps is not None and where_condition.interval is None:
                                        formatted_cond = (
                                                field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + direction + " " + where_condition.steps
                                        )
                                    elif where_condition.steps is None and where_condition.interval is not None:
                                        formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + where_condition.interval + " " + direction
                                    else:
                                        formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + direction
