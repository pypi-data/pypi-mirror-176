...
from rssbot.obj import Object, Wd, items, keys, register, update, values
from rssbot.obj import edit, kind, load, save
from rssbot.obj import ObjectDecoder, ObjectEncoder
from rssbot.obj import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "rssbot.obj.Object")
