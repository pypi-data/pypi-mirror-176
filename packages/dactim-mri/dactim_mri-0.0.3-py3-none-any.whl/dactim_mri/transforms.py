...
def skull_stripping(input_path, output_suffixe="brain", mask=False):
...
def n4_bias_field_correction(input_path, output_suffixe="corrected", mask=False):
    ...
    """
    print(f"INFO - Starting bis field correction for\n\t{input_path :}")
    output_path = input_path.replace(".nii.gz", "_" + output_suffixe + ".nii.gz")
