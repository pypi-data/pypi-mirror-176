...
class DataOraclepaasDatabaseServiceInstance(
    cdktf.TerraformDataSource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-oraclepaas.dataOraclepaasDatabaseServiceInstance.DataOraclepaasDatabaseServiceInstance",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/oraclepaas/d/database_service_instance#name DataOraclepaasDatabaseServiceInstance#name}.
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/oraclepaas/d/database_service_instance#id DataOraclepaasDatabaseServiceInstance#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        config = DataOraclepaasDatabaseServiceInstanceConfig(
            name=name,
            id=id,
    ...
    @builtins.property
    @jsii.member(jsii_name="apexUrl")
    def apex_url(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "apexUrl"))
    ...
    def bring_your_own_license(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "bringYourOwnLicense"))
    ...
    @builtins.property
    @jsii.member(jsii_name="enterpriseManagerUrl")
    def enterprise_manager_url(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "enterpriseManagerUrl"))

    @builtins.property
    @jsii.member(jsii_name="failoverDatabase")
    def failover_database(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "failoverDatabase"))
    ...
    def high_performance_storage(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "highPerformanceStorage"))

    @builtins.property
    @jsii.member(jsii_name="hybridDisasterRecoveryIp")
    def hybrid_disaster_recovery_ip(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "hybridDisasterRecoveryIp"))
    ...
    def ip_reservations(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "ipReservations"))
    ...
    @builtins.property
    @jsii.member(jsii_name="monitorUrl")
    def monitor_url(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "monitorUrl"))
    ...
    @builtins.property
    @jsii.member(jsii_name="pluggableDatabaseName")
    def pluggable_database_name(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "pluggableDatabaseName"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-oraclepaas.dataOraclepaasDatabaseServiceInstance.DataOraclepaasDatabaseServiceInstanceConfig",
...
class DataOraclepaasDatabaseServiceInstanceConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataOraclepaasDatabaseServiceInstanceConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


__all__ = [
    "DataOraclepaasDatabaseServiceInstance",
