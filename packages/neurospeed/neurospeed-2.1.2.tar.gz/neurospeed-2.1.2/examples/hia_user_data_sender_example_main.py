...
def get_sensors_mockup():
    ...
    sensor_info[user_data_stream_id] =  {
        ...
        "channel_count": 1,
        "channel_map": ["ch_0", "timestamp"], # timestamp doesn't count as channel
...
def run_user_test_flow(config_path):
    ...
    if hia_client.is_connected():
        ...
        hia_client.send_data([5, 7], first_stream_id ) 
...
def run_HIAs():
    ...
    config_path_user1 = os.path.join(str(Path().absolute()) ,"config","hia_config1.json")
