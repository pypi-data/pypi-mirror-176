...
setuptools.setup(
    ...
    url=None, ##
    install_requires=["braceexpand","import_expression","importlib_metadata","psutil","typing-extensions","py-cord"],
    ...
    keywords="jishkucord, py-cord, discord, cog, repl, extension, jishaku",
    python_requires='>=3.9',
)
