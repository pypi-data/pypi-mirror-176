...
def create(config, plandir, cluster, overrides, dnsconfig=None):
    ...
    data = {'domain': 'karmalabs.corp',
            ...
            'baremetal': False,
            'baremetal_apache': True,
            'baremetal_apache_port': 80,
            'sushy': False,
            'coredns': True,
            'mdns': True,
            'sslip': False,
    ...
    baremetal_apache = data.get('baremetal_apache', False)
    baremetal_apache_port = data.get('baremetal_apache_port', 80)
    ...
    if sno:
        ...
        if baremetal_hosts:
            ...
            if baremetal_apache_port != 80:
                host_ip += f":{baremetal_apache_port}"
