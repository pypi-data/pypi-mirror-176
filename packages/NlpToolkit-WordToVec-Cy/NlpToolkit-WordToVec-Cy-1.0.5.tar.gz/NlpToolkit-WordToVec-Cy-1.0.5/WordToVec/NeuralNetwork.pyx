...
cdef class NeuralNetwork:
    ...
    cpdef __trainCbow(self):
        ...
        cdef Vector outputs, output_update
        cdef int word_index, b, cw, a, c, last_word_index, d, l2, target, label
    ...
    cpdef __trainSkipGram(self):
        ...
        cdef Sentence current_sentence
        cdef Vector outputs, output_update
        cdef int word_index, b, cw, a, c, last_word_index, d, l1, l2, target, label
        cdef VocabularyWord current_word
        cdef double f, g
        iteration = Iteration(self.__corpus, self.__parameter)
        self.__corpus.open()
