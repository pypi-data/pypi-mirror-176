...
class PeriodBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Period", package_path="metocean/longTermStatistics", description="Description for stochastic process with sampling at certain period."):
        ...
        self.add_attribute(Attribute("name","string","name of the time period as seen in SIMA.",default=None))
        self.add_attribute(Attribute("period","string","place holder identification for the time period e.g. Year, Jan",default=None))
