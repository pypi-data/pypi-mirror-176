...
class Weibull(Entity):
    ...
    def __init__(self , description="", variable=None, unit=None, **kwargs):
        super().__init__(**kwargs)
        self.description = description
        self.variable = variable
        self.unit = unit
        self.shape = ndarray(1)
        self.scale = ndarray(1)
        self.location = ndarray(1)
