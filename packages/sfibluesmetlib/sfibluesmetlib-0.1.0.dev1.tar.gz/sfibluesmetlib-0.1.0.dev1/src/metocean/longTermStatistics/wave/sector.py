...
from metocean.longTermStatistics.wave.contour import Contour
from metocean.longTermStatistics.wave.jointextremevalues import JointExtremeValues
from metocean.longTermStatistics.wave.spectralpeak import SpectralPeak
from metocean.longTermStatistics.wave.weibull import Weibull
...
class Sector(NamedEntity):
    ...
    def __init__(self , description="", name=None, direction=0.0, sectorSize=0.0, probability=0.0, **kwargs):
