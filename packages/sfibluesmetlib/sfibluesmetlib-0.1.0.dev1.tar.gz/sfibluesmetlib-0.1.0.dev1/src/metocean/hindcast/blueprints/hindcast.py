...
class HindcastBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Hindcast", package_path="metocean/hindcast", description="Description for hindcast metocean data."):
        ...
        self.add_attribute(Attribute("name","string","name for the metocean data.",default=None))
        self.add_attribute(Attribute("date","string","date string.",Dimension("*"),default=None))
        ...
        self.add_attribute(Attribute("latitude","number","Latitude epsg:4326",default=0.0))
        self.add_attribute(Attribute("longitude","number","Longitude epsg:4326",default=0.0))