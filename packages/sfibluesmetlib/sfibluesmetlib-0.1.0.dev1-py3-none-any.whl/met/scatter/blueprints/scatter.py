...
class ScatterBlueprint(NamedEntityBlueprint):
    ...
    def __init__(self, name="Scatter", package_path="met/scatter", description="Description for scatter data based on Hs-Tp."):
        ...
        self.add_attribute(Attribute("name","string","name for the scatter data as appear in SIMA.",default=None))
        ...
        self.add_attribute(BlueprintAttribute("sectors","met/scatter/Sector","sector scatter data.",True,Dimension("*")))
        self.add_attribute(BlueprintAttribute("omni","met/scatter/Sector","omni scatter data.",True))