...
from metocean.hindcast.stochasticcurrent import StochasticCurrent
from metocean.hindcast.stochasticwave import StochasticWave
from metocean.hindcast.stochasticwind import StochasticWind
...
class Hindcast(NamedEntity):
    ...
    current : List[StochasticCurrent]
         current models.
    latitude : float
         Latitude epsg:4326(default 0.0)
    longitude : float
         Longitude epsg:4326(default 0.0)
    """

    def __init__(self , description="", name=None, latitude=0.0, longitude=0.0, **kwargs):
