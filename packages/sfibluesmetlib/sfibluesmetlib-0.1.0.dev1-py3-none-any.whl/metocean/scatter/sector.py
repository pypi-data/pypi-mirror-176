...
from metocean.scatter.wave import Wave
from metocean.scatter.windcurrent import WindCurrent
...
class Sector(NamedEntity):
    ...
    def __init__(self , description="", name=None, direction=0.0, sectorSize=0.0, **kwargs):
