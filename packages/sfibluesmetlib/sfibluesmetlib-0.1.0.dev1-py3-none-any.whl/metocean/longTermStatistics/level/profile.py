...
from metocean.longTermStatistics.hsbinnedsector import HsBinnedSector
from metocean.longTermStatistics.sector import Sector
...
class Profile(NamedEntity):
    ...
    def __init__(self , description="", name=None, level=0.0, **kwargs):
