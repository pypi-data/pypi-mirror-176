...
from metocean.longTermStatistics.level.stat import Stat
from metocean.longTermStatistics.wave.stat import Stat
...
class Period(NamedEntity):
    ...
    def __init__(self , description="", name=None, period=None, **kwargs):
