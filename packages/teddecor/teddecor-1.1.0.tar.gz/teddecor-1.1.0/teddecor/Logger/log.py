    ...
    def custom(
        ...
        *args: Any,
        ...
        if self._compare(LL.CUSTOM, self._level):
            self.__out(*args, label=label, clr=clr, gaps=gaps)
