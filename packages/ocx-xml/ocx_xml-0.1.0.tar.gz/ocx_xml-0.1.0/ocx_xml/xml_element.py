...
class LxmlElement:
    ...
    def cardinality(element) -> tuple:
        ...
        """
        qn = QName(element)
        # assert qn.localname == 'element', f'{__class__} expected an "element" type, got {qn.localname}'
    ...
    @staticmethod
    def find_all_children_with_attribute_value(element: Element, name: str, attrib_name: str, attrib_value: str,
                                               namespace: str = '*') -> List:
    ...
    @staticmethod
    def find_all_children_with_name_and_attribute(element: Element, child_name: str, attrib_name: str,
                                                  namespace: str = '*') -> List:
