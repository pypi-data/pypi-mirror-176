...
Report bugs at [https://github.com/boromir674/pytest-subprocess/issues](https://github.com/boromir674/pytest-subprocess/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/pytest-subprocess/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Pytest Plugin for Testing Subprocesses could always use more documentation, whether as part of the official Pytest Plugin for Testing Subprocesses docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/pytest-subprocess/issues](https://github.com/boromir674/pytest-subprocess/issues).
...
Here's how to set up `pytest-subprocess` for local development.

1. Fork the `pytest-subprocess` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/pytest-subprocess.git
```
...
Pytest Plugin for Testing Subprocesses is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/pytest-subprocess/milestones?direction=desc&sort=due_date&state=open)
