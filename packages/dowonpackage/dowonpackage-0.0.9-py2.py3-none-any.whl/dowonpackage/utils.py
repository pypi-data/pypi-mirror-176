...
def concordance(phrase, text, show=False):
    ...
    .. code-block:: python
        ...
        >>> from dowonpackage.corpus import kolaw
        >>> from dowonpackage import utils
...
if sys.version_info[0] < 3:
    from dowonpackage import csvutils
    ...
    def csvread(f, encoding='utf-8'):
        ...
        .. code-block:: python
            ...
            >>> from dowonpackage.utils import csvread
    ...
    def csvwrite(data, f):
        ...
        .. code-block:: python
            ...
            >>> from dowonpackage.utils import csvwrite
...
if sys.version_info[0] < 3:
    def pprint(obj, **kwargs):
        ...
        .. code-block:: python
            ...
            >>> import pprint, dowonpackage
            >>> pprint.pprint([u"Print", u"유니코드", u"easily"])
            [u'Print', u'\uc720\ub2c8\ucf54\ub4dc', u'easily']
            >>> dowonpackage.utils.pprint([u"Print", u"유니코드", u"easily"])
            ['Print', '유니코드', 'easily']
