...
from rime_sdk.internal.swagger_config_parser import (
        ...
        with RESTErrorHandler():
            ...
            while True:
                ...
                next_interval = RimeTimeRange(
                    start_time_epoch_seconds=next_start_time,
                    end_time_epoch_seconds=next_end_time,
                )
...
def get_reference_set_source(
    ...
    if rolling_window_duration is not None and reference_set_time_bin is not None:
        ...
        reference_set_time_bin_range = RimeTimeRange(
            start_time_epoch_seconds=start_time.timestamp(),
            end_time_epoch_seconds=end_time.timestamp(),
        )
