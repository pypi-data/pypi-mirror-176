...
class FeatureFlagServicer(object):
    ...
    def GetFeatureFlag(self, request, context):
        """GetFeatureFlag returns feature message with customer name
    ...
    def GetLimitStatus(self, request, context):
        """GetLimitStatus returns a license limit status.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def GetEnabledFeature(self, request, context):
        """GetEnabledFeature whether a feature is enabled in license for a customer.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def ListEnabledFeatures(self, request, context):
        """ListEnabledFeatures returns all features enabled in license for a customer.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
