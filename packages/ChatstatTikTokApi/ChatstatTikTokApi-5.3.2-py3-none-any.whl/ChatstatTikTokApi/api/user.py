...
class User:
    ...
    def __str__(self):
        return f"ChatstatTikTokApi.user(username='{self.username}', user_id='{self.user_id}', sec_uid='{self.sec_uid}')"
    ...
    def __getattr__(self, name):
        ...
        raise AttributeError(f"{name} doesn't exist on ChatstatTikTokApi.api.User")
