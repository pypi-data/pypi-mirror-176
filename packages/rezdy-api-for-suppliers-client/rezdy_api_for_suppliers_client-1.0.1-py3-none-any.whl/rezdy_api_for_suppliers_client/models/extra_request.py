...
from ..models.extra_request_extra_price_type import ExtraRequestExtraPriceType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExtraRequest")
...
class ExtraRequest:
    ...
    Attributes:
        ...
        extra_price_type (Union[Unset, ExtraRequestExtraPriceType]): Price type for this extra. Defines what quantities
            are allowed and how their price is calculated
    ...
    extra_price_type: Union[Unset, ExtraRequestExtraPriceType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extra_price_type: Union[Unset, ExtraRequestExtraPriceType]
        if isinstance(_extra_price_type, Unset):
            extra_price_type = UNSET
        else:
            extra_price_type = ExtraRequestExtraPriceType(_extra_price_type)
        ...
        extra_request.additional_properties = d
