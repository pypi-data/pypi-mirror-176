...
class _LinearLabelSimulate(_BaseSimulator[_LinearLabelModel]):
    ...
    def _make_legend_labels(self, compound: str, initial_index: int) -> list[str]:
        return [
            f"Pos {i}"
            for i in range(
    ...
    def plot_label_distribution(
        ...
        legend = self._make_legend_labels(compound, initial_index)
        if title is None:
            title = compound
        return plot(
            plot_args=(x, y),
    ...
    def plot_label_distribution_grid(
        ...
        legend_groups = [
            ...
            self._make_legend_labels(compound, initial_index)
            for compound in compounds
        ]
