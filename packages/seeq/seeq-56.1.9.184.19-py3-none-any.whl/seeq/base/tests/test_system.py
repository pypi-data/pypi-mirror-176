...
def test_calculate_default_optimal_heap_sizes():
    ...
    test_matrix = [
        ...
        [8, 4000, 1000, 250, 2250, 250, 500, 200, 300, 800, 160, 200, 100],
        [8, 8000, 2000, 500, 2250, 500, 1000, 200, 300, 1600, 160, 200, 100],
        [8, 12000, 3390, 750, 2250, 750, 1500, 200, 300, 2400, 160, 200, 100],
        [8, 16000, 4848, 1000, 2992, 1000, 2000, 200, 300, 3200, 160, 200, 100],
        [8, 32000, 10656, 2000, 5984, 2000, 4000, 200, 300, 6400, 160, 200, 100],
        [8, 64000, 26272, 4000, 11968, 4000, 4000, 200, 300, 12800, 160, 200, 100],
        [8, 128000, 57504, 8000, 23936, 8000, 4000, 200, 300, 25600, 160, 200, 100],
        [8, 256000, 119968, 16000, 47872, 16000, 4000, 200, 300, 51200, 160, 200, 100],

        # 64-bit, 64 cpu cores for screenshot purposes
        [64, 4000, 1000, 250, 2250, 250, 500, 400, 300, 800, 1280, 200, 100],
        [64, 8000, 2000, 500, 2250, 500, 1000, 400, 300, 1600, 1280, 200, 100],
        [64, 12000, 3000, 750, 2250, 750, 1500, 400, 300, 2400, 1280, 200, 100],
        [64, 16000, 4000, 1000, 2992, 1000, 2000, 400, 300, 3200, 1280, 200, 100],
        [64, 32000, 9336, 2000, 5984, 2000, 4000, 400, 300, 6400, 1280, 200, 100],
        [64, 64000, 20952, 4000, 11968, 4000, 8000, 400, 300, 12800, 1280, 200, 100],
        [64, 128000, 44184, 8000, 23936, 8000, 16000, 400, 300, 25600, 1280, 200, 100],
        [64, 256000, 90648, 16000, 47872, 16000, 32000, 400, 300, 51200, 1280, 200, 100],
        [64, 512000, 215576, 32000, 95744, 32000, 32000, 400, 300, 102400, 1280, 200, 100],
    ]
