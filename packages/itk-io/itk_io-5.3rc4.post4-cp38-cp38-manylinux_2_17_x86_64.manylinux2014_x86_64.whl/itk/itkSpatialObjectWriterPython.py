...
class itkSpatialObjectWriter2(itk.ITKCommonBasePython.itkObject):
    ...
    BinaryPointsOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter2_BinaryPointsOn)
    BinaryPointsOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter2_BinaryPointsOff)
    ...
    WriteImagesInSeparateFileOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter2_WriteImagesInSeparateFileOn)
    WriteImagesInSeparateFileOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter2_WriteImagesInSeparateFileOff)
...
class itkSpatialObjectWriter3(itk.ITKCommonBasePython.itkObject):
    ...
    BinaryPointsOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter3_BinaryPointsOn)
    BinaryPointsOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter3_BinaryPointsOff)
    ...
    WriteImagesInSeparateFileOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter3_WriteImagesInSeparateFileOn)
    WriteImagesInSeparateFileOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter3_WriteImagesInSeparateFileOff)
...
class itkSpatialObjectWriter4(itk.ITKCommonBasePython.itkObject):
    ...
    BinaryPointsOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter4_BinaryPointsOn)
    BinaryPointsOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter4_BinaryPointsOff)
    ...
    WriteImagesInSeparateFileOn = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter4_WriteImagesInSeparateFileOn)
    WriteImagesInSeparateFileOff = _swig_new_instance_method(_itkSpatialObjectWriterPython.itkSpatialObjectWriter4_WriteImagesInSeparateFileOff)
