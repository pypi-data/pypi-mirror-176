...
class SpiDebuggerObjectModel(ghidra.dbg.DebuggerObjectModel, object):
    ATTRIBUTE_MAP_TYPE: ghidra.async.TypeSpec = ghidra.async.TypeSpec$1@44dd0a99
    ELEMENT_MAP_TYPE: ghidra.async.TypeSpec = ghidra.async.TypeSpec$1@44dd0a99
    ...
    @overload
    def fetchModelObject(self, __a0: List[object], __a1: bool) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def fetchModelValue(self, __a0: List[object], __a1: bool) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def fetchObjectAttributes(self, __a0: List[object], __a1: bool) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def fetchObjectElements(self, __a0: List[object], __a1: bool) -> java.util.concurrent.CompletableFuture: ...

    @staticmethod
    def fetchSuccessorValue(__a0: ghidra.dbg.target.TargetObject, __a1: List[object], __a2: bool, __a3: bool) -> java.util.concurrent.CompletableFuture: ...
