...
class AssemblyNumericSymbols(object):
    ...
    EMPTY: ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNumericSymbols = ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNumericSymbols@60c9e2e4
    equates: java.util.Map
    labels: java.util.Map
    labelsBySpace: java.util.Map
    ...
    @staticmethod
    def forMaps(equates: java.util.Map, labels: java.util.Map) -> ghidra.app.plugin.assembler.sleigh.symbol.AssemblyNumericSymbols:
        """
