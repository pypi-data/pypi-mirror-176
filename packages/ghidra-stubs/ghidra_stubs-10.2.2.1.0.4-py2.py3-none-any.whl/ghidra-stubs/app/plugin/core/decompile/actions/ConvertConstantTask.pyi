...
class ConvertConstantTask(object, utility.function.Callback):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.decompile.DecompilerActionContext, __a1: unicode, __a2: ghidra.program.model.address.Address, __a3: ghidra.program.model.pcode.Varnode, __a4: long, __a5: int): ...
