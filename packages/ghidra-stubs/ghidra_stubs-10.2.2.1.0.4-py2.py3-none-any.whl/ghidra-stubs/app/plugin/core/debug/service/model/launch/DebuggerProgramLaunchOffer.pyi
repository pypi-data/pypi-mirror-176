...
class DebuggerProgramLaunchOffer(object):
    ...
    class LaunchConfigurator(object):
        NOP: ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchConfigurator = ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer$LaunchConfigurator$1@62d10df6
    ...
    @overload
    def launchProgram(self, __a0: ghidra.util.task.TaskMonitor, __a1: bool) -> java.util.concurrent.CompletableFuture: ...

    @overload
    def launchProgram(self, __a0: ghidra.util.task.TaskMonitor, __a1: bool, __a2: ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchConfigurator) -> java.util.concurrent.CompletableFuture: ...
