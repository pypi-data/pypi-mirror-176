...
class ListenerSet(object):
    CALLING_THREAD: java.util.concurrent.Executor = ghidra.util.datastruct.ListenerMap$1@2ffc84d
    ...
    def addChained(self, __a0: ghidra.util.datastruct.ListenerSet) -> None: ...
    ...
    def removeChained(self, __a0: ghidra.util.datastruct.ListenerSet) -> None: ...
