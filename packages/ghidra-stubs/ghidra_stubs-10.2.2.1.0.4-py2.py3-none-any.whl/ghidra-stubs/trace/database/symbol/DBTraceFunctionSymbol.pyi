...
class DBTraceFunctionSymbol(ghidra.trace.database.symbol.DBTraceNamespaceSymbol, ghidra.trace.model.symbol.TraceFunctionSymbol):
    ...
    def insertParameter(self, __a0: int, __a1: ghidra.program.model.listing.Variable, __a2: ghidra.program.model.symbol.SourceType) -> ghidra.trace.database.symbol.DBTraceParameterSymbol: ...
