...
class DBTraceMemorySpace(object, ghidra.trace.model.memory.TraceMemorySpace, ghidra.trace.database.memory.InternalTraceMemoryOperations, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    @overload
    def addRegion(self, __a0: unicode, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.address.AddressRange, __a3: List[ghidra.trace.model.memory.TraceMemoryFlag]) -> ghidra.trace.model.memory.TraceMemoryRegion: ...

    @overload
    def addRegion(self, __a0: unicode, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.address.AddressRange, __a3: java.util.Collection) -> ghidra.trace.model.memory.TraceMemoryRegion: ...
    ...
    @overload
    def getAddressesWithState(self, __a0: com.google.common.collect.Range, __a1: java.util.function.Predicate) -> ghidra.program.model.address.AddressSetView: ...
    ...
    def getCodeSpace(self, __a0: bool) -> ghidra.trace.model.listing.TraceCodeSpace: ...

    def getFirstChange(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange) -> long: ...
    ...
    def getRegionsIntersecting(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange) -> java.util.Collection: ...
