...
class DBTraceDataSettingsOperations(ghidra.trace.model.map.TraceAddressSnapRangePropertyMapOperations, object):
    EMPTY_MAP: ghidra.util.database.spatial.SpatialMap = ghidra.util.database.spatial.SpatialMap$EmptySpatialMap@9369a63
    ...
    @overload
    def clear(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode) -> None: ...

    def deleteValue(self, __a0: object) -> None: ...

    def doExactOrNew(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode) -> ghidra.trace.database.data.DBTraceDataSettingsAdapter.DBTraceSettingsEntry: ...
    ...
    def doGetExactEntry(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode) -> ghidra.trace.database.data.DBTraceDataSettingsAdapter.DBTraceSettingsEntry: ...

    def doMakeWay(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode) -> None: ...
    ...
    @overload
    def getAddressSetView(self, __a0: com.google.common.collect.Range, __a1: java.util.function.Predicate) -> ghidra.program.model.address.AddressSetView: ...
    ...
    def getSettingNames(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address) -> java.util.Collection: ...
    ...
    @overload
    def isEmpty(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address) -> bool: ...

    def keys(self) -> java.util.Collection: ...

    def makeWay(self, __a0: ghidra.trace.database.data.DBTraceDataSettingsAdapter.DBTraceSettingsEntry, __a1: com.google.common.collect.Range) -> None: ...
    ...
    @overload
    def put(self, __a0: ghidra.program.model.address.Address, __a1: com.google.common.collect.Range, __a2: object) -> object: ...

    @overload
    def put(self, __a0: ghidra.program.model.address.AddressRange, __a1: com.google.common.collect.Range, __a2: object) -> object: ...
    ...
    def setLong(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode, __a3: long) -> None: ...

    def setString(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode, __a3: unicode) -> None: ...

    def setValue(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: unicode, __a3: object) -> None: ...
