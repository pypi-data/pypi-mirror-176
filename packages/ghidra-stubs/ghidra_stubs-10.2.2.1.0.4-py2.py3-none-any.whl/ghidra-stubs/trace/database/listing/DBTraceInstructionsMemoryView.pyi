...
class DBTraceInstructionsMemoryView(ghidra.trace.database.listing.AbstractBaseDBTraceCodeUnitsMemoryView, ghidra.trace.model.listing.TraceInstructionsView, ghidra.trace.database.listing.InternalTraceBaseDefinedUnitsView):
    ...
    @overload
    def addInstructionSet(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.lang.InstructionSet, __a2: bool) -> ghidra.program.model.address.AddressSetView: ...

    @overload
    def addInstructionSet(self, __a0: com.google.common.collect.Range, __a1: ghidra.trace.model.guest.TracePlatform, __a2: ghidra.program.model.lang.InstructionSet, __a3: bool) -> ghidra.program.model.address.AddressSetView: ...

    def checkIsInMemory(self, __a0: ghidra.program.model.address.AddressSpace) -> None: ...

    @overload
    def clear(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.lang.Register, __a2: ghidra.util.task.TaskMonitor) -> None: ...

    @overload
    def clear(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange, __a2: bool, __a3: ghidra.util.task.TaskMonitor) -> None: ...

    @overload
    def clear(self, __a0: ghidra.trace.model.guest.TracePlatform, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.lang.Register, __a3: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    @overload
    def coversRange(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange) -> bool: ...

    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.lang.InstructionPrototype, __a3: ghidra.program.model.lang.ProcessorContextView) -> ghidra.trace.model.listing.TraceInstruction: ...

    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: ghidra.trace.model.guest.TracePlatform, __a3: ghidra.program.model.lang.InstructionPrototype, __a4: ghidra.program.model.lang.ProcessorContextView) -> ghidra.trace.model.listing.TraceInstruction: ...
    ...
    @overload
    def intersectsRange(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange) -> bool: ...
