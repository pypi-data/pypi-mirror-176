...
class DBTraceDefinedDataMemoryView(ghidra.trace.database.listing.AbstractBaseDBTraceCodeUnitsMemoryView, ghidra.trace.database.listing.InternalTraceDefinedDataView):
    ...
    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.data.DataType) -> ghidra.trace.database.listing.DBTraceDataAdapter: ...

    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.lang.Register, __a2: ghidra.program.model.data.DataType) -> ghidra.trace.model.listing.TraceData: ...

    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.data.DataType, __a3: int) -> ghidra.trace.database.listing.DBTraceDataAdapter: ...

    @overload
    def create(self, __a0: ghidra.trace.model.guest.TracePlatform, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.lang.Register, __a3: ghidra.program.model.data.DataType) -> ghidra.trace.model.listing.TraceData: ...
