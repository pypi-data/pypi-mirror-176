...
class DBTraceDefinedDataView(ghidra.trace.database.listing.AbstractBaseDBTraceDefinedUnitsView, ghidra.trace.database.listing.InternalTraceDefinedDataView):
    ...
    @overload
    def create(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.data.DataType) -> ghidra.trace.model.listing.TraceData: ...
