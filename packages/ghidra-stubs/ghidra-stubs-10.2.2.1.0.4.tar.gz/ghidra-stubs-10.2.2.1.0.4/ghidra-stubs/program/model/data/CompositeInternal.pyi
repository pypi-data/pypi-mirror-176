...
class CompositeInternal(ghidra.program.model.data.Composite, object):
    ...
    class ComponentComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.ComponentComparator = ghidra.program.model.data.CompositeInternal$ComponentComparator@a686dfa
    ...
    class OffsetComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OffsetComparator = ghidra.program.model.data.CompositeInternal$OffsetComparator@126b64a2
    ...
    class OrdinalComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OrdinalComparator = ghidra.program.model.data.CompositeInternal$OrdinalComparator@4776acb5
