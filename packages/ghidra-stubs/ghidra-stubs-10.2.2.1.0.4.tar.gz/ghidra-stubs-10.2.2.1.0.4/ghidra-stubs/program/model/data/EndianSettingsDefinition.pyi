...
class EndianSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    BIG: int = 2
    DEF: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@7e486426
    DEFAULT: int = 0
    ENDIAN: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@7e486426
    LITTLE: int = 1
