...
class FileByteProvider(object, ghidra.app.util.bin.ByteProvider, ghidra.app.util.bin.MutableByteProvider):
    """
    A ByteProvider that reads its bytes from a file.
    """

    EMPTY_BYTEPROVIDER: ghidra.app.util.bin.ByteProvider = ghidra.app.util.bin.EmptyByteProvider@6f6cabbf
