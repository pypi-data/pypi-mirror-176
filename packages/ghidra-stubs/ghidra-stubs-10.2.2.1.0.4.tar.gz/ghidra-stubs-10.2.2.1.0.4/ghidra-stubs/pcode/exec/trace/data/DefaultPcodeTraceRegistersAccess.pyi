...
class DefaultPcodeTraceRegistersAccess(ghidra.pcode.exec.trace.data.AbstractPcodeTraceDataAccess, ghidra.pcode.exec.trace.data.PcodeTraceRegistersAccess):
    ...
    def getKnownBefore(self) -> ghidra.program.model.address.AddressSetView: ...

    def getKnownNow(self) -> ghidra.program.model.address.AddressSetView: ...
