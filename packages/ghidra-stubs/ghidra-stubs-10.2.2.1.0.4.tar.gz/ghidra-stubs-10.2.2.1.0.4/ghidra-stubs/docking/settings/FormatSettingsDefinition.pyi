...
class FormatSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    CHAR: int = 4
    DECIMAL: int = 1
    DEF: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@34a14393
    DEF_BINARY: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@7b1e67b8
    DEF_CHAR: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@d5f4b55
    DEF_DECIMAL: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@574cee1
    DEF_HEX: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@34a14393
    DEF_OCTAL: ghidra.docking.settings.FormatSettingsDefinition = ghidra.docking.settings.FormatSettingsDefinition@7dea7fba
    HEX: int = 0
    OCTAL: int = 3
