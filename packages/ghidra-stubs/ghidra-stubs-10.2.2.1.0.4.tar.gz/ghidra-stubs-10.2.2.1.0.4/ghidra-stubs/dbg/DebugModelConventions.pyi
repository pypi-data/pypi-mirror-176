...
class DebugModelConventions(java.lang.Enum):
    ...
    class AllRequiredAccess(ghidra.async.AsyncReference):
        ...
        def getAllAccessibility(self) -> bool: ...
        ...
        @property
        def allAccessibility(self) -> bool: ...
    ...
    class SubTreeListenerAdapter(ghidra.dbg.AnnotatedDebuggerAttributeListener):
        ...
        def addListener(self, __a0: ghidra.dbg.target.TargetObject) -> bool: ...

        def addListenerAndConsiderSuccessors(self, __a0: ghidra.dbg.target.TargetObject) -> bool: ...
    ...
    class AncestorTraversal(java.util.concurrent.CompletableFuture):
        ...
        @overload
        def acceptEitherAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.Consumer, __a2: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...
        ...
        @overload
        def applyToEitherAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.Function, __a2: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...
        ...
        @overload
        def thenApplyAsync(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
    ...
    @staticmethod
    def trackAccessibility(__a0: ghidra.dbg.target.TargetObject) -> java.util.concurrent.CompletableFuture: ...
