...
class DBTraceEquateManager(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.symbol.TraceEquateManager, ghidra.trace.database.space.DBTraceDelegatingManager):
    ...
    @overload
    def clearReferences(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange, __a2: ghidra.util.task.TaskMonitor) -> None: ...

    @overload
    def clearReferences(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressSetView, __a2: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    def getReferringAddresses(self, __a0: com.google.common.collect.Range) -> ghidra.program.model.address.AddressSetView: ...
