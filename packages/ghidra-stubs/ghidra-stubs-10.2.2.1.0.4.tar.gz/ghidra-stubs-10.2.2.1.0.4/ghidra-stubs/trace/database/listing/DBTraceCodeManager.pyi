...
class DBTraceCodeManager(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.listing.TraceCodeManager, ghidra.trace.database.space.DBTraceDelegatingManager):
    ...
    def clearPlatform(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange, __a2: ghidra.trace.database.guest.DBTraceGuestPlatform, __a3: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    @overload
    def getCodeRegisterSpace(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: int, __a2: bool) -> ghidra.trace.database.listing.DBTraceCodeSpace: ...
