...
class DBTraceObjectManager(object, ghidra.trace.model.target.TraceObjectManager, ghidra.trace.database.DBTraceManager):
    ...
    def addBreakpoint(self, __a0: unicode, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.address.AddressRange, __a3: java.util.Collection, __a4: java.util.Collection, __a5: bool, __a6: unicode) -> ghidra.trace.model.breakpoint.TraceObjectBreakpointLocation: ...

    def addMemoryRegion(self, __a0: unicode, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.address.AddressRange, __a3: java.util.Collection) -> ghidra.trace.model.memory.TraceObjectMemoryRegion: ...

    def addModule(self, __a0: unicode, __a1: unicode, __a2: com.google.common.collect.Range, __a3: ghidra.program.model.address.AddressRange) -> ghidra.trace.model.modules.TraceObjectModule: ...

    def addSection(self, __a0: unicode, __a1: unicode, __a2: com.google.common.collect.Range, __a3: ghidra.program.model.address.AddressRange) -> ghidra.trace.database.module.TraceObjectSection: ...
    ...
    def addThread(self, __a0: unicode, __a1: unicode, __a2: com.google.common.collect.Range) -> ghidra.trace.model.thread.TraceObjectThread: ...
    ...
    @overload
    def getObjectsByPath(self, __a0: com.google.common.collect.Range, __a1: ghidra.trace.model.target.TraceObjectKeyPath) -> java.util.stream.Stream: ...
    ...
    def getObjectsIntersecting(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange, __a2: unicode, __a3: java.lang.Class) -> java.util.Collection: ...
    ...
    def getValuePaths(self, __a0: com.google.common.collect.Range, __a1: ghidra.dbg.util.PathPredicates) -> java.util.stream.Stream: ...

    def getValuesAt(self, __a0: long, __a1: ghidra.program.model.address.Address) -> java.util.Collection: ...

    def getValuesIntersecting(self, __a0: com.google.common.collect.Range, __a1: ghidra.program.model.address.AddressRange) -> java.util.Collection: ...
    ...
    def queryAllInterface(self, __a0: com.google.common.collect.Range, __a1: java.lang.Class) -> java.util.stream.Stream: ...
