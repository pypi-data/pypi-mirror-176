...
class Measure(Generic[T], JSONEncoder):
    ...
    def print(self, *metrics: Union[MetricName, str], output: Union[TextIO, str] = stdout) -> None:
        ...
        :param output: The file handler or the file path where the result are stored.
           By default, it is printed in the standard output.
        """
        ...
        for i, metric in enumerate(metrics):
            print(f'{metric}: ', self[metric].format(), end='\n' if i % 3 == 0 else '\t', file=file)
