...
REQUIRED_PKGS = [
    ...
    f'spark_nlp=={johnsnowlabs.settings.raw_version_nlp}',
    f'nlu=={johnsnowlabs.settings.raw_version_nlu}',
    f'spark_nlp-display=={johnsnowlabs.settings.raw_version_nlp_display}',
    'numpy',
    'dataclasses',
    'requests',
    'databricks-api',
