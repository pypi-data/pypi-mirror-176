...
raw_version_jsl_lib = '4.2.3rc10'
raw_version_nlp = '4.2.2'
raw_version_medical = '4.2.2'
raw_version_secret_medical = '4.2.2'
raw_version_secret_ocr = '4.2.0'

raw_version_ocr = '4.2.0'
...
workshop_cert_nb_folder = f'{workshop_local_folder}/tutorials/Certification_Trainings_JSL'
