/*
    Copyright 2015-2022 Stéphane De Mita, Mathieu Siol
    ...
    class StructureHolder {
        ...
        public:
            ...
            */
            ...
            unsigned int get_ni_req() const; ///< \brief Get required number of ingroup samples.
            unsigned int get_no_req() const; ///< \brief Get required number of outgroup samples.
            ...
            const char * subset(const StructureHolder& source, char * popstring, bool outgroup); ///< \brief Copy data from source object, only from specified population (in a \n-separated string of labels) return empty string if success, otherwise first unknown population label
