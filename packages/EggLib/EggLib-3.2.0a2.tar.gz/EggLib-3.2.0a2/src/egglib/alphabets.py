"""
    Copyright 2018-2021 Stephane De Mita, Mathieu Siol
...
class Alphabet(object):
    ...
    For ``range`` alphabets, both parameters :fparam:`expl` and :fparam:`miss`
    ...
    def add_exploitable(self, value):
        ...
        alphabets and for the special alphabet. The allele value
...
"""Alphabet corresponding to the Genepop format."""
genepop.lock()
