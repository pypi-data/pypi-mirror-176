import os, egglib, sys, unittest, random, re, gc, time, collections, time
...
class SampleView_test(unittest.TestCase):
    ...
    def test__iter__aln_T(self):
        self.assertIsInstance(self.sAI0, Iterable)
        self.assertIsInstance(self.sAO0, Iterable)

    def test__iter__cnt_T(self):
        self.assertIsInstance(self.sCI0, Iterable)
        self.assertIsInstance(self.sCO0, Iterable)
...
class  SequenceView_test(unittest.TestCase):
    ...
    def test__iter__aln__T(self):
        self.assertIsInstance(self.seqAI0, Iterable)
        self.assertIsInstance(self.seqAO1, Iterable)
        self.assertEqual(list(self.seqCI2), list('AAGAAAGCGAGTG'))

    def test__iter__cnt__T(self):
        self.assertIsInstance(self.seqCI2, Iterable)
        self.assertIsInstance(self.seqCO1, Iterable)
...
class LabelView_test(unittest.TestCase):
    ...
    def test__iter__aln_T(self):
        self.assertIsInstance(self.gAO0, Iterable)
        self.assertIsInstance(self.gAI4, Iterable)

    def test__iter__cnt_T(self):
        self.assertIsInstance(self.gCO0, Iterable)
        self.assertIsInstance(self.gCI5, Iterable)
...
class Database_test(unittest.TestCase):
    ...
    def test_fasta_aln_T(self):
        fname=os.path.join(path_T,'test_aln_to_fasta.fa')
        self.aln.fasta(fname)
    ...
    def test_fasta_aln_E(self):
        ...
        with self.assertRaises(ValueError):
            self.aln.fasta(fname)
        fname=os.path.join(path_T,'test_aln_to_fasta_.fa')
        with self.assertRaises(ValueError):
            self.aln.fasta(fname,linelength=0)

    def test_fasta_cnt_T(self):
        fname=os.path.join(path_T,'test_cnt_to_fasta.fa')
        self.cnt.fasta(fname)
        self.assertTrue(os.path.exists(fname))
        self.assertTrue(os.path.getsize(fname)>0)
    ...
    def test_fasta_cnt_E(self):
        ...
        with self.assertRaises(ValueError):
            self.cnt.fasta(fname)
        fname=os.path.join(path_T,'test_cnt_to_fasta_.fa')
        with self.assertRaises(ValueError):
            self.cnt.fasta(fname,linelength=0)
    ...
    def test__iter__aln_T(self):
        self.assertIsInstance(self.aln, Iterable)

    def test__iValueter__cnt_T(self):
        self.assertIsInstance(self.cnt, Iterable)
    ...
    def test_reserve(self):
        ...
        for i in range(10):
            ...
            aln.reserve(nsam=1000, nsit=1000)
            for i in range(1000):
                aln.add_sample('', 'A'*1000, [])
    ...
    def test_reserve_cnt_T(self):
        ...
        for i in range(10):
            ...
            cnt.reserve(nsam=1000, nsit=1000)
            for i in range(1000):
                cnt.add_sample('', 'A'*1000, [])
            t1 = time.process_time()
            T1 += t1-t0
...
class Align_test(unittest.TestCase):
    ...
    def test_extract_fix_ends_T(self):
        ...
        self.assertRegexpMatches(seq_9,'^\?.*\?$') #"assertRegexpMatches" pour la version 2.* de Python et "assertRegex" pour la version 3.* de python.
        seq_1=self.aln.get_sequence(0).string()
        self.assertNotRegexpMatches(seq_1,'^\?.*\?$')
...
"""
    ...
    def test_phyml_aln_T(self):
        ...
        self.assertRegexpMatches(self.aln.phyml(), '^[0-9]*\s[0-9]*\n([a-z0-9A-Z%]*\s*[-?AGTCUMRINXWS]*\n)*')
        self.assertIsInstance(self.aln.phyml(), str)
        self.assertRegexpMatches(self.aln.phyml(), '^[0-9]*\s[0-9]*\n([a-z0-9A-Z%]*\s*[-?AGTCUMRINXWS]*\n)*')
    ...
    def test_slider_aln_T(self):
        ...
        self.assertIsInstance(self.aln.slider(9, 5), Iterable)
    ...
    def test_random_missing_T(self):
        ...
        self.assertRegexpMatches(self.aln.get_sequence(0).string(), '[ACGT]')
        self.assertRegexpMatches(self.aln.get_sequence(0).string(), '-')
        self.assertNotRegexpMatches(self.aln.get_sequence(0).string(), 'N')
        self.aln.random_missing(1.0, missing='N')
        self.assertNotRegexpMatches(self.aln.get_sequence(0).string(), '[ACGT]')
        self.assertRegexpMatches(self.aln.get_sequence(0).string(), '-')
        self.assertRegexpMatches(self.aln.get_sequence(0).string(), 'N')
...
class  Container_test(unittest.TestCase):
    ...
    def test_equalize_cnt_T(self):
        ...
        self.assertRegexpMatches(self.cnt.get_sequence(3).string(), 'N*$')
