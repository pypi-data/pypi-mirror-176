...
### 1.9.1 (2021-06-10)
  ...
  * Docs: Update documentation regarding adding a new exchange to krypton_cryptofeed
...
### 1.7.0 (2021-02-15)
  ...
  * Feature: Explain when krypton_cryptofeed crashes during pairs retrieval
...
### 1.6.1 (2020-11-12)
  ...
  * Feature: Support for raw file playback. Will be useful for testing features and building out new test suites for krypton_cryptofeed.
...
### 1.3.1 (2020-03-17)
  ...
  * Feature: Added new field, receipt timestamp, to all callbacks. This contains the time the message was received by krypton_cryptofeed.
