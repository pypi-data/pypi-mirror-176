...
from krypton_cryptofeed.defines import BID, ASK, BITMEX, BUY, CANCELLED, FILLED, FUNDING, FUTURES, L2_BOOK, LIMIT, LIQUIDATIONS, MARKET, OPEN, OPEN_INTEREST, ORDER_INFO, PERPETUAL, SELL, TICKER, TRADES, UNFILLED
...
from krypton_cryptofeed.exchanges.mixins.bitmex_rest import BitmexRestMixin
from krypton_cryptofeed.types import OrderBook, Trade, Ticker, Funding, OrderInfo, OpenInterest, Liquidation
...
class Bitmex(Feed, BitmexRestMixin):
    ...
    async def _book(self, msg: dict, timestamp: float):
        ...
        if not msg['data']:
            # see https://github.com/bmoscon/krypton_cryptofeed/issues/688
