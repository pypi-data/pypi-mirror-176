...
'''
import asyncio
from krypton_cryptofeed.connection import Connection
import logging
import signal
...
from krypton_cryptofeed.log import get_logger
from krypton_cryptofeed.nbbo import NBBO
...
class FeedHandler:
    ...
    def run(self, start_loop: bool = True, install_signal_handlers: bool = True, exception_handler=None):
        ...
        install_signal_handlers: bool, default True
            ...
            can only be done from the main thread's loop, so if running krypton_cryptofeed on
