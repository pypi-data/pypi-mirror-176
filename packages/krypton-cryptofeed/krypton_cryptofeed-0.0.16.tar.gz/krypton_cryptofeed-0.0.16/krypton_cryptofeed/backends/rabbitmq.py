...
from krypton_cryptofeed.backends.backend import BackendBookCallback, BackendCallback


class RabbitCallback:
    def __init__(self, host='localhost', none_to=None, numeric_type=float, queue_name='krypton_cryptofeed', exchange_mode=False, exchange_name='amq.topic', exchange_type='topic', routing_key='krypton_cryptofeed', **kwargs):
        """
        Parameters
        ----------
        host: str
