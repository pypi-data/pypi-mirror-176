...
class LayoutCollector:
    ...
    def get_entity(self, node: aspose.words.Node) -> object:
        '''Returns an opaque position of the :class:`LayoutEnumerator` which corresponds to the specified node.
        You can use returned value as an argument to :attr:`LayoutEnumerator.current` given the document being
        enumerated and the document of the node are the same.
        
        This method works for only :class:`aspose.words.Paragraph` nodes, as well as indivisible inline nodes,
        e.g. :class:`aspose.words.BookmarkStart` or :class:`aspose.words.drawing.Shape`. It doesn't work for :class:`aspose.words.Run`, :class:`aspose.words.tables.Cell`:class:`aspose.words.tables.Row` or :class:`aspose.words.tables.Table` nodes, and nodes within header/footer.
        
        Note that the entity returned for a :class:`aspose.words.Paragraph` node is a paragraph break span. Use the appropriate method to ascend to the parent line
        
        If you need to navigate to a :class:`aspose.words.Run` of text then you can insert bookmark right before it
        and then navigate to the bookmark instead.
        
        If you need to navigate to a :class:`aspose.words.tables.Cell` node then you can move to a :class:`aspose.words.Paragraph`
        node in this cell and then ascend to a parent entity. The same approach can be used for :class:`aspose.words.tables.Row`
...
class LayoutEnumerator:
    ...
    Use combination of :meth:`LayoutCollector.get_entity` and :attr:`LayoutEnumerator.current` move to the entity which corresponds to a document node.
    To learn more, visit the `Converting to Fixed-page Format <https://docs.aspose.com/words/net/converting-to-fixed-page-format/>` documentation article.'''
    ...
    def move_next_logical(self) -> bool:
        ...
        Note that all :attr:`LayoutEntityType.SPAN` entities are linked together thus if :attr:`LayoutEnumerator.current`
