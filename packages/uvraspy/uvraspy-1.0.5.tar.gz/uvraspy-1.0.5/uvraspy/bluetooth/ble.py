"""
from https://github.com/PunchThrough/espresso-ble
all credit to PunchThrough, this is a slightly modified copy of their code
the original code missed some imports

it's here because they don't have a library on pypi
...
def find_adapter(bus):
    """
    Returns the first object that the bluez service has
    that has a GattManager1 interface
    """
...
def bytes_to_dbus_array(value):
    print(value)
    return [dbus.Byte(i) for i in value]


def dbus_array_to_bytes(value):
...
class Application(dbus.service.Object):
    ...
    def __init__(self, bus):
        ...
        self.obj = dbus.service.Object.__init__(self, bus, self.path)
...
class Advertisement(dbus.service.Object):
    ...
    def __init__(self, bus, index, advertising_type, base_path):
        self.path = self.PATH_BASE + str(index)
        self.bus = bus
