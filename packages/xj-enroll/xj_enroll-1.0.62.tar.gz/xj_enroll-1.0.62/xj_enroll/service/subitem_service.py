...
class SubitemService:
        ...
        try:
            ...
            if not is_pagination:
                ...
                for item in result_list:
                    ...
                    record_list = SubitemService.check_has_enroll(item.get("id"), user_id)
                    item["is_enroll"] = 1 if record_list and len(record_list) > 0 else 0
    ...
    def check_has_enroll(subitem_id, user_id=None, is_need_list=False):
        ...
        if user_id:
            ...
            return list(obj.filter(user_id=user_id).values())
        return None
