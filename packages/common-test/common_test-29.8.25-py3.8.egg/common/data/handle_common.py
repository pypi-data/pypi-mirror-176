...
if __name__ == '__main__':
    ...
    # print ("test: {'a':'${id_test2}'}")
    print (req_expr("{'a':'${ams.id_test2}'}", _no_content=0))
    print(req_expr("{'a':'000${ams.id_test21}'}", _no_content=0))
    print(req_expr("{'a':'abc${ams.id_test2}'}", _no_content=0))

    # print (re.findall("test1", "test123"))
