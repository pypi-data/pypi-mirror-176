...
if __name__ == '__main__':
    data1 = FilePlugin.load_json('calculateFee.json',_readMode=0).encode("utf-8")
    APIDriver.http_request('http://172.20.29.51:8380/mu/ssv/service/rest-ssv/tripReceive','post','json',data=data1)