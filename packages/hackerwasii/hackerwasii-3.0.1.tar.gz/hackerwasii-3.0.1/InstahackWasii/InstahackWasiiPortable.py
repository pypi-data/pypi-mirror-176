...
#
# @filename    : InstahackWasiiPortable.py
# @description : Provides All Utils to make instahack-py and
#                tor server portable.
...
class InstahackWasiiPortable():
    ...
    @staticmethod
    def isSetInstahackWasiiPortable():
        ret = True
    ...
    def __init__(self):
        if self.isSetInstahackWasiiPortable() is False:
        ...
        # instance for portable instahack.
        self.torrc = '''
## Configuration file for a typical Tor user
## Last updated 10 November 2022 , instahack v3.0.1
...
#PublishServerDescriptor 0
    '''
        ...
        InstahackWasiiConfigurationCreator(path=None, fp=self.instagram_py_config_fp,
                                        tserver_port=str(self.torserver_port),
                                        tcontrol_port=str(
                                            self.torserver_control_port),
                                        tcontrol_password="").create()  # Instahack Config.
    ...
    def getInstahackWasiiConfigPath(self):
        return self.instagram_py_config_fp.name

    def isTorServerRunning(self):
        ret = True
        if self.isSetInstahackWasiiPortable():
