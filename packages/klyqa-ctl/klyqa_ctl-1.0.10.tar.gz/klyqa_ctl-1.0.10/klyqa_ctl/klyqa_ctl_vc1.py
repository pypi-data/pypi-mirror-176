...
def add_command_args(parser):
    ...
    # vc1 getter
    parser.add_argument('--all', help='If this flag is set, the whole state will be requested', action='store_true')
    parser.add_argument('--power', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--cleaning', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--beeping', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--battery', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--sidebrush', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--rollingbrush', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--filter', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--carpetbooster', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--area', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--time', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--calibrationtime', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--workingmode', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--workstatus', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--suction', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--water', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--direction', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--errors', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--cleaningrec', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--equipmentmodel', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--alarmmessages', help='If this flag is set, the state element will be requested', action='store_true')
    # parser.add_argument('--commissioninfo', help='If this flag is set, the state element will be requested', action='store_true')
    parser.add_argument('--mcu', help='Ask if mcu is online', action='store_true')
    
    # vc1 setter
    parser.add_argument('--cleaning', nargs=1, choices=['on', 'off', 'get'], help='turn cleaning on/off')
    parser.add_argument('--power', choices=['on', 'off', 'get'], help='turn power on/off')
    parser.add_argument('--cleaning', choices=['on', 'off', 'get'], help='turn cleaning on/off')
    parser.add_argument('--beeping', choices=['on', 'off', 'get'], help='enable/disable the find-vc function')
    parser.add_argument('--carpetbooster', metavar='strength', type=int, help='set the carpet booster strength (0-255)')
    parser.add_argument('--workingmode', choices=['STANDBY', 'SMART', 'MOP', 'WALL_FOLLOW', 'PARTIAL_BOW', 'SPIRAL', 'CHARGE_GO', 'SROOM', 'get'], help='set the working mode')
    parser.add_argument('--water', choices=['LOW', 'MID', 'HIGH', 'get'], help='set water quantity')
    parser.add_argument('--suction', choices=['LOW', 'MID', 'HIGH', 'get'], help='set suction power')
    parser.add_argument('--direction', choices=['FORWARDS','BACKWARDS', 'TURN_LEFT', 'TURN_RIGHT', 'STOP', 'get'], help='manually control movement')
    parser.add_argument('--commissioninfo', type=str, help='set up to 256 characters of commisioning info')
    parser.add_argument('--calibrationtime', metavar='time', type=int, help='set the calibration time (1-1999999999)')
    parser.set_defaults(func=set_set)
...
class Klyqa_account:
    ...
    * account settings
    ...
    async def bulb_handle_local_tcp(self, bulb: KlyqaBulb):
        """Handle the incoming tcp connection to the bulb."""
        return_state = -1
        response = ""
    ...
    async def search_and_send_to_bulb(self, timeout_ms=DEFAULT_SEND_TIMEOUT_MS) -> bool:
