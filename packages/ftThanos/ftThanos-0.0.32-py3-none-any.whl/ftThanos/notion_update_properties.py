	...
	def update_title(self, elem):
		if elem['update'] == True:
			if elem['content'] == True:
				...
				elem['properties']['title'].append(self.build_text(elem))
		return elem
	...
	def update_rich_text(self, elem):
		if elem['update'] == True:
			if elem['content'] == True:
				...
				elem['properties']['rich_text'].append(self.build_text(elem))
		return elem
	...
	def update_date(self, elem):
		if elem['update'] == True:
			if elem['content'] == True:
				...
				if elem['start'] == None and elem['end'] == None:
