...
from ..configs.get_configs import (
    ...
    linux_paramiko_get_interfaces,
    linux_paramiko_get_configs
)
...
def get_junos_lo_configs(nornir=None, dev_name=None, dev=None, connected_interfaces=None):
    ...
    print("Junos po_int list: ", po_int)
...
def get_linux_lo_configs(nornir=None, dev_name=None):
    """
    Get Junos device configs using Juniper PYEZ library.
    ...
    """
    # Get Physical Object (PO) config statements
    device_configs = linux_paramiko_get_configs(nornir=nornir, dev_name=dev_name, format='json')
    print("Device configs json: ")
    print_json(device_configs)
    device_configs_commands = linux_paramiko_get_configs(nornir=nornir, dev_name=dev_name, format='commands')
    print("Device configs commands: ")
    print(device_configs_commands)

    # Get Physical Object interface names
    #po_int = linux_paramiko_get_interfaces(device_configs)
    #print("Linux po_ints: ", po_int)
