...
class RealTimeMonitoringIPv6NeighboursApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_ipv6_interface_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/device/ndv6',
    ...
    def get_ipv6_interface(
        ...
        **kwargs
        ...
        """get_ipv6_interface  # noqa: E501

        Get IPv6 Neighbors from device (Real Time)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_ipv6_interface(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['device_id'] = \
            device_id
        return self.get_ipv6_interface_endpoint.call_with_http_info(**kwargs)
