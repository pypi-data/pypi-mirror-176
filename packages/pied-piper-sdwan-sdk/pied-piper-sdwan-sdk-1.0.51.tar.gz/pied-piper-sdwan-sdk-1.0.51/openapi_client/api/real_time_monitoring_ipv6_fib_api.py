...
class RealTimeMonitoringIPv6FIBApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ipv6_fib_list_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/device/ip/v6fib',
                'operation_id': 'create_ipv6_fib_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_ipv6_fib_list(
        self,
        device_id,
        **kwargs
    ):
        """create_ipv6_fib_list  # noqa: E501

        Get IPv6 FIB list from device (Real Time)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_ipv6_fib_list(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['device_id'] = \
            device_id
        return self.create_ipv6_fib_list_endpoint.call_with_http_info(**kwargs)
