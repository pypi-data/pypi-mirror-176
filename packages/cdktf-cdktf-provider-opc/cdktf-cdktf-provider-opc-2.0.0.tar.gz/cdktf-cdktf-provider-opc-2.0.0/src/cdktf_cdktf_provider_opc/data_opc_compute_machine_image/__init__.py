...
class DataOpcComputeMachineImage(
    cdktf.TerraformDataSource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-opc.dataOpcComputeMachineImage.DataOpcComputeMachineImage",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param account: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/opc/d/compute_machine_image#account DataOpcComputeMachineImage#account}.
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/opc/d/compute_machine_image#name DataOpcComputeMachineImage#name}.
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/opc/d/compute_machine_image#id DataOpcComputeMachineImage#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        config = DataOpcComputeMachineImageConfig(
            account=account,
            name=name,
            id=id,
    ...
    def hypervisor(self) -> cdktf.StringMap:
        return typing.cast(cdktf.StringMap, jsii.get(self, "hypervisor"))
    ...
    def no_upload(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "noUpload"))
    ...
    def sizes(self) -> cdktf.StringMap:
        return typing.cast(cdktf.StringMap, jsii.get(self, "sizes"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-opc.dataOpcComputeMachineImage.DataOpcComputeMachineImageConfig",
...
class DataOpcComputeMachineImageConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataOpcComputeMachineImageConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


__all__ = [
    "DataOpcComputeMachineImage",
    "DataOpcComputeMachineImageConfig",
]
