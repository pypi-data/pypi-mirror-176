...
class EntityUpstream:
    ...
    def from_dict(obj: Any) -> 'EntityUpstream':
        ...
        return EntityUpstream(created_at, aspect_type, entity_upstream_created_at, entity_id, field_mappings, id, source_entities)
...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, dashboard_id, last_ingested_at, last_modified_at, logical_id, source_info, upstream)
...
class ColumnTagAssignment:
    ...
    def from_dict(obj: Any) -> 'ColumnTagAssignment':
        ...
        return ColumnTagAssignment(column_name, tag_name)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, asset_contacts, asset_followers, asset_governed_tags, dataset_created_at, custom_metadata, deleted_at, description_assignment, display_name, documentation, entity_type, entity_upstream, field_associations, field_statistics, dataset_id, last_ingested_at, last_modified_at, logical_id, ownership_assignment, query_history, schema, soda_data_quality, source_info, statistics, structure, tag_assignment, upstream, usage)
