...
class BodySetFlavorPrice(object):
    ...
    def __init__(self, price=None, _configuration=None):  # noqa: E501
        """BodySetFlavorPrice - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def price(self):
        """Gets the price of this BodySetFlavorPrice.  # noqa: E501


        :return: The price of this BodySetFlavorPrice.  # noqa: E501
        :rtype: str
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this BodySetFlavorPrice.


        :param price: The price of this BodySetFlavorPrice.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BodySetFlavorPrice, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodySetFlavorPrice):
            return False
