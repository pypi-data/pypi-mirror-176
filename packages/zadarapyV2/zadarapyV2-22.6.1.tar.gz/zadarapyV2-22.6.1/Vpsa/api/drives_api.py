...
class DrivesApi(object):
    ...
    def get_drive_performance(self, id, body_get_drive_performance, **kwargs):  # noqa: E501
        """get_drive_performance  # noqa: E501

        Returns the last 60 data points of performance data for the specified interval.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_drive_performance(id, body_get_drive_performance, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyGetDrivePerformance body_get_drive_performance: todo (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_drive_performance_with_http_info(id, body_get_drive_performance, **kwargs)  # noqa: E501
        else:
            (data) = self.get_drive_performance_with_http_info(id, body_get_drive_performance, **kwargs)  # noqa: E501
            return data

    def get_drive_performance_with_http_info(self, id, body_get_drive_performance, **kwargs):  # noqa: E501
        """get_drive_performance  # noqa: E501

        Returns the last 60 data points of performance data for the specified interval.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_drive_performance_with_http_info(id, body_get_drive_performance, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_get_drive_performance']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_get_drive_performance' is set
        if self.api_client.client_side_validation and ('body_get_drive_performance' not in params or
                                                       params['body_get_drive_performance'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_get_drive_performance` when calling `get_drive_performance`")  # noqa: E501
        ...
        body_params = None
        if 'body_get_drive_performance' in params:
            body_params = params['body_get_drive_performance']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
    ...
    def rename_drive(self, id, body_rename_drive, **kwargs):  # noqa: E501
        """rename_drive  # noqa: E501

        Rename a drive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_drive(id, body_rename_drive, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyRenameDrive body_rename_drive: todo (required)
        :return: InlineResponse20026
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rename_drive_with_http_info(id, body_rename_drive, **kwargs)  # noqa: E501
        else:
            (data) = self.rename_drive_with_http_info(id, body_rename_drive, **kwargs)  # noqa: E501
            return data

    def rename_drive_with_http_info(self, id, body_rename_drive, **kwargs):  # noqa: E501
        """rename_drive  # noqa: E501

        Rename a drive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_drive_with_http_info(id, body_rename_drive, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_rename_drive']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_rename_drive' is set
        if self.api_client.client_side_validation and ('body_rename_drive' not in params or
                                                       params['body_rename_drive'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_rename_drive` when calling `rename_drive`")  # noqa: E501
        ...
        body_params = None
        if 'body_rename_drive' in params:
            body_params = params['body_rename_drive']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
    ...
    def replace_drive(self, id, body_replace_drive, **kwargs):  # noqa: E501
        """replace_drive  # noqa: E501

        Replace a drive in a Raid Group with a different free drive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replace_drive(id, body_replace_drive, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyReplaceDrive body_replace_drive: todo (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.replace_drive_with_http_info(id, body_replace_drive, **kwargs)  # noqa: E501
        else:
            (data) = self.replace_drive_with_http_info(id, body_replace_drive, **kwargs)  # noqa: E501
            return data

    def replace_drive_with_http_info(self, id, body_replace_drive, **kwargs):  # noqa: E501
        """replace_drive  # noqa: E501

        Replace a drive in a Raid Group with a different free drive.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replace_drive_with_http_info(id, body_replace_drive, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_replace_drive']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_replace_drive' is set
        if self.api_client.client_side_validation and ('body_replace_drive' not in params or
                                                       params['body_replace_drive'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_replace_drive` when calling `replace_drive`")  # noqa: E501
        ...
        body_params = None
        if 'body_replace_drive' in params:
            body_params = params['body_replace_drive']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
