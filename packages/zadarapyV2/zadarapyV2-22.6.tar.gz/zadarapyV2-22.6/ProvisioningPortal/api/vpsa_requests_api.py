...
class VpsaRequestsApi(object):
    ...
    def approve(self, id, body_approve, **kwargs):  # noqa: E501
        """approve  # noqa: E501

        Approve a vpsa request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.approve(id, body_approve, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyApprove body_approve: todo (required)
        ...
        if kwargs.get('async_req'):
            return self.approve_with_http_info(id, body_approve, **kwargs)  # noqa: E501
        else:
            (data) = self.approve_with_http_info(id, body_approve, **kwargs)  # noqa: E501
            return data

    def approve_with_http_info(self, id, body_approve, **kwargs):  # noqa: E501
        """approve  # noqa: E501

        Approve a vpsa request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.approve_with_http_info(id, body_approve, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_approve']  # noqa: E501
        ...
        # verify the required parameter 'body_approve' is set
        if self.api_client.client_side_validation and ('body_approve' not in params or
                                                       params['body_approve'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_approve` when calling `approve`")  # noqa: E501
        ...
        body_params = None
        if 'body_approve' in params:
            body_params = params['body_approve']
        # HTTP header `Accept`
    ...
    def deny(self, id, body_deny, **kwargs):  # noqa: E501
        """deny  # noqa: E501

        Deny a vpsa request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deny(id, body_deny, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyDeny body_deny: todo (required)
        :return: InlineResponse20022
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deny_with_http_info(id, body_deny, **kwargs)  # noqa: E501
        else:
            (data) = self.deny_with_http_info(id, body_deny, **kwargs)  # noqa: E501
            return data

    def deny_with_http_info(self, id, body_deny, **kwargs):  # noqa: E501
        """deny  # noqa: E501

        Deny a vpsa request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deny_with_http_info(id, body_deny, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_deny']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_deny' is set
        if self.api_client.client_side_validation and ('body_deny' not in params or
                                                       params['body_deny'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_deny` when calling `deny`")  # noqa: E501
        ...
        body_params = None
        if 'body_deny' in params:
            body_params = params['body_deny']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
