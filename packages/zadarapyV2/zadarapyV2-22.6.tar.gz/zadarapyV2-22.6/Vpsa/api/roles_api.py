...
class RolesApi(object):
    ...
    def add_role(self, body_add_role, **kwargs):  # noqa: E501
        """add_role  # noqa: E501

        Add a new role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_role(body_add_role, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BodyAddRole body_add_role: todo (required)
        ...
        if kwargs.get('async_req'):
            return self.add_role_with_http_info(body_add_role, **kwargs)  # noqa: E501
        else:
            (data) = self.add_role_with_http_info(body_add_role, **kwargs)  # noqa: E501
            return data

    def add_role_with_http_info(self, body_add_role, **kwargs):  # noqa: E501
        """add_role  # noqa: E501

        Add a new role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_role_with_http_info(body_add_role, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body_add_role']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body_add_role' is set
        if self.api_client.client_side_validation and ('body_add_role' not in params or
                                                       params['body_add_role'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_add_role` when calling `add_role`")  # noqa: E501
        ...
        body_params = None
        if 'body_add_role' in params:
            body_params = params['body_add_role']
        # HTTP header `Accept`
    ...
    def update_role(self, role_id, body_update_role, **kwargs):  # noqa: E501
        """update_role  # noqa: E501

        Update a role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_role(role_id, body_update_role, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str role_id: TODO (required)
        :param BodyUpdateRole body_update_role: todo (required)
        :return: InlineResponse200102
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_role_with_http_info(role_id, body_update_role, **kwargs)  # noqa: E501
        else:
            (data) = self.update_role_with_http_info(role_id, body_update_role, **kwargs)  # noqa: E501
            return data

    def update_role_with_http_info(self, role_id, body_update_role, **kwargs):  # noqa: E501
        """update_role  # noqa: E501

        Update a role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_role_with_http_info(role_id, body_update_role, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['role_id', 'body_update_role']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_update_role' is set
        if self.api_client.client_side_validation and ('body_update_role' not in params or
                                                       params['body_update_role'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_update_role` when calling `update_role`")  # noqa: E501
        ...
        body_params = None
        if 'body_update_role' in params:
            body_params = params['body_update_role']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
