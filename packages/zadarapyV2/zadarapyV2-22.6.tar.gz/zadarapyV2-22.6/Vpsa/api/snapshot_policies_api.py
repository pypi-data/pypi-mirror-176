...
class SnapshotPoliciesApi(object):
    ...
    def create_snapshot_policy(self, body_create_snapshot_policy, **kwargs):  # noqa: E501
        """create_snapshot_policy  # noqa: E501

        Create a Snapshot Policy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot_policy(body_create_snapshot_policy, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BodyCreateSnapshotPolicy body_create_snapshot_policy: todo (required)
        ...
        if kwargs.get('async_req'):
            return self.create_snapshot_policy_with_http_info(body_create_snapshot_policy, **kwargs)  # noqa: E501
        else:
            (data) = self.create_snapshot_policy_with_http_info(body_create_snapshot_policy, **kwargs)  # noqa: E501
            return data

    def create_snapshot_policy_with_http_info(self, body_create_snapshot_policy, **kwargs):  # noqa: E501
        """create_snapshot_policy  # noqa: E501

        Create a Snapshot Policy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot_policy_with_http_info(body_create_snapshot_policy, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body_create_snapshot_policy']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body_create_snapshot_policy' is set
        if self.api_client.client_side_validation and ('body_create_snapshot_policy' not in params or
                                                       params['body_create_snapshot_policy'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_create_snapshot_policy` when calling `create_snapshot_policy`")  # noqa: E501
        ...
        body_params = None
        if 'body_create_snapshot_policy' in params:
            body_params = params['body_create_snapshot_policy']
        # HTTP header `Accept`
    ...
    def rename_snapshot_policy(self, id, body_rename_snapshot_policy, **kwargs):  # noqa: E501
        """rename_snapshot_policy  # noqa: E501

        Rename a Snapshot Policy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_snapshot_policy(id, body_rename_snapshot_policy, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyRenameSnapshotPolicy body_rename_snapshot_policy: todo (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rename_snapshot_policy_with_http_info(id, body_rename_snapshot_policy, **kwargs)  # noqa: E501
        else:
            (data) = self.rename_snapshot_policy_with_http_info(id, body_rename_snapshot_policy, **kwargs)  # noqa: E501
            return data

    def rename_snapshot_policy_with_http_info(self, id, body_rename_snapshot_policy, **kwargs):  # noqa: E501
        """rename_snapshot_policy  # noqa: E501

        Rename a Snapshot Policy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_snapshot_policy_with_http_info(id, body_rename_snapshot_policy, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_rename_snapshot_policy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_rename_snapshot_policy' is set
        if self.api_client.client_side_validation and ('body_rename_snapshot_policy' not in params or
                                                       params['body_rename_snapshot_policy'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_rename_snapshot_policy` when calling `rename_snapshot_policy`")  # noqa: E501
        ...
        body_params = None
        if 'body_rename_snapshot_policy' in params:
            body_params = params['body_rename_snapshot_policy']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
    ...
    def update_snapshot_policy(self, id, body_update_snapshot_policy, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot_policy(id, body_update_snapshot_policy, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyUpdateSnapshotPolicy body_update_snapshot_policy: todo (required)
        :return: InlineResponse200125
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_snapshot_policy_with_http_info(id, body_update_snapshot_policy, **kwargs)  # noqa: E501
        else:
            (data) = self.update_snapshot_policy_with_http_info(id, body_update_snapshot_policy, **kwargs)  # noqa: E501
            return data

    def update_snapshot_policy_with_http_info(self, id, body_update_snapshot_policy, **kwargs):  # noqa: E501
        """update_snapshot_policy  # noqa: E501

        Update a Snapshot Policy creation and deletion rules. The update will apply to all Volumes to which this policy is applied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot_policy_with_http_info(id, body_update_snapshot_policy, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_update_snapshot_policy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_update_snapshot_policy' is set
        if self.api_client.client_side_validation and ('body_update_snapshot_policy' not in params or
                                                       params['body_update_snapshot_policy'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_update_snapshot_policy` when calling `update_snapshot_policy`")  # noqa: E501
        ...
        body_params = None
        if 'body_update_snapshot_policy' in params:
            body_params = params['body_update_snapshot_policy']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
