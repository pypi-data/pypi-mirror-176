...
class BodyUpdateProvider(object):
    ...
    def __init__(self, name=None, enabled=None, _configuration=None):  # noqa: E501
        """BodyUpdateProvider - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this BodyUpdateProvider.  # noqa: E501


        :return: The name of this BodyUpdateProvider.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BodyUpdateProvider.


        :param name: The name of this BodyUpdateProvider.  # noqa: E501
        :type: str
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this BodyUpdateProvider.  # noqa: E501


        :return: The enabled of this BodyUpdateProvider.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this BodyUpdateProvider.


        :param enabled: The enabled of this BodyUpdateProvider.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BodyUpdateProvider, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodyUpdateProvider):
            return False
