...
class TenantApi(object):
    ...
    def list_tenanats(self, **kwargs):  # noqa: E501
        """list_tenanats  # noqa: E501

        Get the list of tenants  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_tenanats(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_tenanats_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_tenanats_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_tenanats_with_http_info(self, **kwargs):  # noqa: E501
        """list_tenanats  # noqa: E501

        Get the list of tenants  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_tenanats_with_http_info(async_req=True)
        >>> result = thread.get()
