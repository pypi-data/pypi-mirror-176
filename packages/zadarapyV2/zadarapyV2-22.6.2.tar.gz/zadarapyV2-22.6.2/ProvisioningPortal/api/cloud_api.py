...
class CloudApi(object):
    ...
    def create_cloud(self, body_create_cloud, **kwargs):  # noqa: E501
        """create_cloud  # noqa: E501

        Create a cloud  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_cloud(body_create_cloud, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BodyCreateCloud body_create_cloud: todo (required)
        ...
        if kwargs.get('async_req'):
            return self.create_cloud_with_http_info(body_create_cloud, **kwargs)  # noqa: E501
        else:
            (data) = self.create_cloud_with_http_info(body_create_cloud, **kwargs)  # noqa: E501
            return data

    def create_cloud_with_http_info(self, body_create_cloud, **kwargs):  # noqa: E501
        """create_cloud  # noqa: E501

        Create a cloud  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_cloud_with_http_info(body_create_cloud, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body_create_cloud']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body_create_cloud' is set
        if self.api_client.client_side_validation and ('body_create_cloud' not in params or
                                                       params['body_create_cloud'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_create_cloud` when calling `create_cloud`")  # noqa: E501
        ...
        body_params = None
        if 'body_create_cloud' in params:
            body_params = params['body_create_cloud']
        # HTTP header `Accept`
    ...
    def update_cloud(self, id, body_update_cloud, **kwargs):  # noqa: E501
        """update_cloud  # noqa: E501

        Update a cloud  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cloud(id, body_update_cloud, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: TODO (required)
        :param BodyUpdateCloud body_update_cloud: todo (required)
        :return: InlineResponse2002
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_cloud_with_http_info(id, body_update_cloud, **kwargs)  # noqa: E501
        else:
            (data) = self.update_cloud_with_http_info(id, body_update_cloud, **kwargs)  # noqa: E501
            return data

    def update_cloud_with_http_info(self, id, body_update_cloud, **kwargs):  # noqa: E501
        """update_cloud  # noqa: E501

        Update a cloud  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cloud_with_http_info(id, body_update_cloud, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body_update_cloud']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'body_update_cloud' is set
        if self.api_client.client_side_validation and ('body_update_cloud' not in params or
                                                       params['body_update_cloud'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body_update_cloud` when calling `update_cloud`")  # noqa: E501
        ...
        body_params = None
        if 'body_update_cloud' in params:
            body_params = params['body_update_cloud']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
