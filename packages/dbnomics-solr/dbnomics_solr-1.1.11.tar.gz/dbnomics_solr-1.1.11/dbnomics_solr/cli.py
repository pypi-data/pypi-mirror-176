...
def index_providers(
    ...
    dirhash_jobs: int = typer.Option(
        env.int("DIRHASH_JOBS", default=1),
        help="The number of processes to use when computing a dirhash.",
        show_default=True,
    ),
    fail_fast: bool = typer.Option(env.bool("FAIL_FAST", default=False), help="Disable retry mechanism."),
