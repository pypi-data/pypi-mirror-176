...
def _install_filebeat(installer):
    ...
    Docs at https://www.elastic.co/guide/en/beats/filebeat/current/filebeat-installation-configuration.html
    """

    if installer.clone_type == 'deb':
        cmd_list = [
            "wget https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-8.2.2-amd64.deb -O /tmp/filebeat-8.2.2-amd64.deb",
            "dpkg -i /tmp/filebeat-8.2.2-amd64.deb",
        ]
    else:
        cmd_list = [
            "wget https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-8.2.2-x86_64.rpm -O /tmp/filebeat-8.2.2-x86_64.rpm",
            "rpm -vi /tmp/filebeat-8.2.2-x86_64.rpm",
        ]
