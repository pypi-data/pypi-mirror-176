...
class MiScaleBluetoothDeviceData(BluetoothData):
    ...
    def _start_update(self, service_info: BluetoothServiceInfo) -> None:
        ...
        if "0000181b-0000-1000-8000-00805f9b34fb" in list(advertising_data.service_data.keys()):
            ### Xiaomi V2 Scale ###
        ...
        elif "0000181d-0000-1000-8000-00805f9b34fb" in list(advertising_data.service_data.keys()):
            ### Xiaomi V1 Scale ###
