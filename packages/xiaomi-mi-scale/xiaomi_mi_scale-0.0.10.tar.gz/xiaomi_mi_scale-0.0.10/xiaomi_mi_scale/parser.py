...
class MiScaleBluetoothDeviceData(BluetoothData):
    ...
    def _start_update(self, service_info: BluetoothServiceInfo) -> None:
        ...
        if list(service_info.service_data.keys())[0] == "0000181b-0000-1000-8000-00805f9b34fb":
            ### Xiaomi V2 Scale ###
            name = DEVICE_TYPES[Models.MiScaleV2]
        ...
        elif list(service_info.service_data.keys())[0] == "0000181d-0000-1000-8000-00805f9b34fb":
            ### Xiaomi V1 Scale ###
            name = DEVICE_TYPES[Models.MiScaleV2]
            self.set_device_name(name)
            self.set_title(name)
