...
py_tools_ds could always use more documentation, whether as part of the
official py_tools_ds docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.7, 3.8. 3.9, 3.10 and for PyPy. Check
