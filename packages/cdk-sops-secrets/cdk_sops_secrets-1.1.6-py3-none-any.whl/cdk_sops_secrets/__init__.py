...
class SopsSecret(
    ...
    def apply_removal_policy(self, policy: aws_cdk.RemovalPolicy) -> None:
        ...
        '''
        if __debug__:
            def stub(policy: aws_cdk.RemovalPolicy) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def grant_write(
        ...
        '''
        if __debug__:
            def stub(_grantee: aws_cdk.aws_iam.IGrantable) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def secret_value_from_json(self, json_field: builtins.str) -> aws_cdk.SecretValue:
        ...
        '''
        if __debug__:
            def stub(json_field: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class SopsSyncProvider(
    ...
    def add_age_key(self, key: aws_cdk.SecretValue) -> None:
        ...
        '''
        if __debug__:
            def stub(key: aws_cdk.SecretValue) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
