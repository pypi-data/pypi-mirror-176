    ...
    for path_in, _id in prop:     
        ...
        if path_in.endswith('.csv'):
            ...
            try:
                ...
                if os.path.exists(path_out + "clones.jpg"):
                    os.remove(path_out + "clones.jpg")
                fig.savefig(path_out + "clones.jpg")
                plt.close(fig)            
        else:
    ...
    for path_in, _id in prop:
        ...
        if path_in.endswith('.csv'):
            ...
            try:
                ...
                if os.path.exists(path_out + "mutation_wave.jpg"):
                    os.remove(path_out + "mutation_wave.jpg")
                fig.savefig(path_out + "mutation_wave.jpg")
                plt.close(fig)            
        else:
            print("Wrong file: %s" % path_in)
            continue        
    ...
    for path_in, _id in prop:
        ...
        if path_in.endswith('.csv'):
            ...
            try:
                ...
                if os.path.exists(path_out + "fitness_wave.jpg"):
                    os.remove(path_out + "fitness_wave.jpg")
                fig.savefig(path_out + "fitness_wave.jpg")
                plt.close(fig)            
        else:
            print("Wrong file: %s" % path_in)
            continue  
