...
class ExergenicsApi:
    ...
    ********************************
    ...
    def putFile(self, plantCode, urlToFile, category, name, equipCode='', jobId = ''):
        activityUrl = "{}/{}/?urlToFile={}&category={}&name={}&equipCode={}&jobId={}".format(self.ex__putFile, plantCode,
    ...
    def getFiles(self, plantCode, category=None, equipCode="", jobId = ""):
        if category is not None:
            activityUrl = "{}/{}?category={}&equipCode={}&jobId={}".format(self.ex__getFiles, plantCode, category, equipCode, jobId)
        else:
            activityUrl = "{}/{}?equipCode={}&jobId={}".format(self.ex__getFiles, plantCode, equipCode, jobId)
    ...
    def setJobData(self, jobId, fieldName, fieldValue):
        activityUrl = "{}/{}?fieldName={}&fieldValue={}".format(self.ex__setJobData, jobId, fieldName, urllib.parse.quote_plus(fieldValue))
        self.lastStatus, self.lastResponse = self.doRequest(self.getExchangeEndpoint(), activityUrl, {})
        if self.noResponse():
            return False
        return True
    ...
    def portalChart_lineChart(self, plantCode, chartName, portalCategory, dataFrame, title="title",
        ...
        urlToChart = self.plotlyLineChart(dataFrame, title, xAxisTitle, yAxisTitle, outputType, legendTitle,
                                          ...
                                          titleColor)
        self.putFile(plantCode, urlToChart, portalCategory, chartName, equipCode, jobId)
        return urlToChart
    ...
    def portalChart_bowlChart2D(self, plantCode, chartName, portalCategory, data, title="title", equipCode="", jobId=""):
    ...
    def portalChart_bowlChart3D(self, plantCode, chartName, portalCategory, point, x, y, z, title="title", equipCode="", jobId=""):
