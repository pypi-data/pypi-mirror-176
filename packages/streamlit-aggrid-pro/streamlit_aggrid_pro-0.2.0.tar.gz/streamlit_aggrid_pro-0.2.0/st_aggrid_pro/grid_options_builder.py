...
class GridOptionsBuilder:
    ...
    def configure_default_column(self, min_column_width=5, resizable=True, sortable=True, filterable=True, sorteable=True, editable=False, groupable=False,enablePivot=True,enableValue=True, **other_default_column_properties):
        ...
        if enablePivot:
            defaultColDef["enablePivot"] = enablePivot

        if enableValue:
            defaultColDef["enableValue"] = enableValue
