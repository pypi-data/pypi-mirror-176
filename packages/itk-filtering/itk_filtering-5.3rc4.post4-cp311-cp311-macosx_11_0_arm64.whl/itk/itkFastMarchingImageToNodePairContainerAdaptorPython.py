...
class itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID2ID2ID2_GetTrialValue)
...
class itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID3ID3ID3_GetTrialValue)
...
class itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorID4ID4ID4_GetTrialValue)
...
class itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF2IF2IF2_GetTrialValue)
...
class itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF3IF3IF3_GetTrialValue)
...
class itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4(itk.ITKCommonBasePython.itkObject):
    ...
    GetAliveImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetAliveImage)
    ...
    GetTrialImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetTrialImage)
    ...
    GetForbiddenImage = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetForbiddenImage)
    ...
    GetIsForbiddenImageBinaryMask = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetIsForbiddenImageBinaryMask)
    ...
    GetAliveValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetAliveValue)
    ...
    GetTrialValue = _swig_new_instance_method(_itkFastMarchingImageToNodePairContainerAdaptorPython.itkFastMarchingImageToNodePairContainerAdaptorIF4IF4IF4_GetTrialValue)
