...
def retrieve_saml_login(
    conninfo: request.Connection, _credentials: Optional[Credentials], saml_login_id: str
) -> request.RestResponse:
    return conninfo.send_request('POST', '/v1/session/retrieve-saml-login', body=saml_login_id)
...
def posix_uid_to_all_related_identities(
    conninfo: request.Connection, _credentials: Optional[Credentials], posix_uid: object
) -> request.RestResponse:
    method = 'GET'
...
def posix_gid_to_all_related_identities(
    conninfo: request.Connection, _credentials: Optional[Credentials], posix_gid: object
) -> request.RestResponse:
    method = 'GET'
...
def local_username_to_all_related_identities(
    conninfo: request.Connection, _credentials: Optional[Credentials], username: object
) -> request.RestResponse:
    method = 'GET'
...
def find_identity(
    ...
    """
    return conninfo.send_request('POST', '/v1/auth/identity/find', body=attrs)
...
def expand_identity(
    ...
    return conninfo.send_request('POST', '/v1/auth/identity/expand', body=req)
