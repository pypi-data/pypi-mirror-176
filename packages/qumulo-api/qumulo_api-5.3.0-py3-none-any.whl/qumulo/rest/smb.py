...
def smb_list_share_v1(
    conninfo: request.Connection, _credentials: Optional[Credentials], id_: str
) -> request.RestResponse:
    """
...
def smb_list_shares(
    ...
    return conninfo.send_request('GET', '/v2/smb/shares/')
...
def smb_set_share(
    ...
    return conninfo.send_request('PUT', uri, body=share_info, if_match=if_match)
...
def close_smb_file(
    ...
    return conninfo.send_request(method, uri, body=handle_infos)
