...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "domains", "tunnel_satellite", "tunnel_enduser", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "domains", "tunnel_satellite", "tunnel_enduser", ], str]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "address", "domains", "tunnel_satellite", "tunnel_enduser", "created_at", "created_by", "updated_at", "updated_by", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "address", "domains", "tunnel_satellite", "tunnel_enduser", "created_at", "created_by", "updated_at", "updated_by", ], str]):
                    return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_access_tier_id_put_oapg(
        self: api_client.Api,
...
class V2AccessTierIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_access_tier_id_put(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._v2_access_tier_id_put_oapg(
            body=body,
