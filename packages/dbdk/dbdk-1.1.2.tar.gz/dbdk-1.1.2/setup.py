...
PACKAGE_NAME = 'dbdk' #Debe coincidir con el nombre de la carpeta 
...
DESCRIPTION = 'Discord Bot Dev Kit is a set of funtions and classes to simplify the creation of discord bots' #Descripción corta
