...
class ExecutionReport(BaseModel):
    ...
    numberOfTimeValuesSuccessfullyParsed: StrictInt = 0
    numberOfTimeValuesDeletionSuccessfullyParsed: StrictInt = 0
    numberOfBatchValuesSuccessfullyParsed: StrictInt = 0
    numberOfBatchCreatedOrUpdated: StrictInt = 0
    numberOfEventCreatedOrUpdated: StrictInt = 0
    numberOfEventValuesSuccessfullyParsed: StrictInt = 0
    numberOfEventTagsSuccessfullyParsed: StrictInt = 0
    numberOfBatchRelationsSuccessfullyParsed: StrictInt = 0
    numberOfParsingErrors: StrictInt = 0
    numberOfInvalidValues: StrictInt = 0
    numberOfTimeVectorValuesSuccessfullyParsed: StrictInt = 0
    numberOfBatchVectorValuesSuccessfullyParsed: StrictInt = 0

    def update(
        self,
        time_values_parsed: StrictInt = 0,
        time_values_deleted: StrictInt = 0,
        batch_values_parsed: StrictInt = 0,
        batch_created_updated: StrictInt = 0,
        events_created_updated: StrictInt = 0,
        event_values_parsed: StrictInt = 0,
        event_tags_parsed: StrictInt = 0,
        batch_relations_parsed: StrictInt = 0,
        parsing_errors: StrictInt = 0,
        invalid_values: StrictInt = 0,
        time_vector_values_parsed: StrictInt = 0,
        batch_vector_values_parsed: StrictInt = 0,
    ):
        self.numberOfTimeValuesSuccessfullyParsed += time_values_parsed
        self.numberOfTimeValuesDeletionSuccessfullyParsed += time_values_deleted
        self.numberOfBatchValuesSuccessfullyParsed += batch_values_parsed
        self.numberOfBatchCreatedOrUpdated += batch_created_updated
        self.numberOfEventCreatedOrUpdated += events_created_updated
        self.numberOfEventValuesSuccessfullyParsed += event_values_parsed
        self.numberOfEventTagsSuccessfullyParsed += event_tags_parsed
        self.numberOfBatchRelationsSuccessfullyParsed += batch_relations_parsed
        self.numberOfParsingErrors += parsing_errors
        self.numberOfInvalidValues += invalid_values
        self.numberOfTimeVectorValuesSuccessfullyParsed += time_vector_values_parsed
        self.numberOfBatchVectorValuesSuccessfullyParsed += batch_vector_values_parsed
...
Trigger = Union[CronTrigger, FileReceptionTrigger]
...
class StoredTimeVectorDataParameter(BaseModel):
    ...
    @validator("type")
    def validate_type(cls, value):
        if value != "STORED_TIME_VECTOR_DATA":
            raise ValueError("'type' should be 'STORED_TIME_VECTOR_DATA'")
        return value
...
class ModelExecution(BaseModel):
    ...
    def get_data_input_dict(
        ...
        if data_type == "any" and values_type == "any":
            ...
            input_types = ["STORED_TIME_VECTOR_DATA"]
            if strict is False:
    ...
    def get_data_output_dict(
        ...
        if data_type == "any" and values_type == "any":
            ...
            output_types = ["STORED_TIME_VECTOR_DATA"]
            if strict is False:
...
def set_default_execution_report(output_summary: ExecutionReport):
    """
    Put a summary into a global variable, for external use
    Parameters
    ----------
    ...
    DEFAULT_EXECUTION_REPORT = output_summary
