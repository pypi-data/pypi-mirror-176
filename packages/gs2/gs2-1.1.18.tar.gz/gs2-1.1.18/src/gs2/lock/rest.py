...
class Gs2LockRestClient(rest.AbstractGs2RestClient):
    ...
    def _describe_mutexes(
        self,
        request: DescribeMutexesRequest,
        callback: Callable[[AsyncResult[DescribeMutexesResult]], None],
        is_blocking: bool,
    ):
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lock',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/mutex".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
        ...
        _job = rest.NetworkJob(
            url=url,
            method='GET',
            result_type=DescribeMutexesResult,
            callback=callback,
            headers=headers,
            query_strings=query_strings,
        )
    ...
    def describe_mutexes(
        self,
        request: DescribeMutexesRequest,
    ) -> DescribeMutexesResult:
        async_result = []
        with timeout(30):
            self._describe_mutexes(
                request,
                lambda result: async_result.append(result),
                is_blocking=True,
            )
    ...
    async def describe_mutexes_async(
        self,
        request: DescribeMutexesRequest,
    ) -> DescribeMutexesResult:
        async_result = []
    ...
    def _describe_mutexes_by_user_id(
        self,
        request: DescribeMutexesByUserIdRequest,
        callback: Callable[[AsyncResult[DescribeMutexesByUserIdResult]], None],
        is_blocking: bool,
    ):
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lock',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/mutex".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        ...
        _job = rest.NetworkJob(
            url=url,
            method='GET',
            result_type=DescribeMutexesByUserIdResult,
            callback=callback,
            headers=headers,
            query_strings=query_strings,
        )
    ...
    def describe_mutexes_by_user_id(
        self,
        request: DescribeMutexesByUserIdRequest,
    ) -> DescribeMutexesByUserIdResult:
        async_result = []
        with timeout(30):
            self._describe_mutexes_by_user_id(
                request,
                lambda result: async_result.append(result),
                is_blocking=True,
            )
    ...
    async def describe_mutexes_by_user_id_async(
        self,
        request: DescribeMutexesByUserIdRequest,
    ) -> DescribeMutexesByUserIdResult:
        async_result = []
