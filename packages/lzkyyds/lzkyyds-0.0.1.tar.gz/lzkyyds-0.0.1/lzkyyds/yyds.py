...
class ToolClass(Api):
    ...
    def click(self, x: Union[str, int, float], y: Union[str, int, float]):
        """点击"""
    ...
    def get_screen_size(self):
        ...
        return {"device_width": res[0], "device_height": res[1]}
...
class AiHandler(Api):
    ...
    def __find_name(self, name: str, option: dict = None):
    ...
    def click(self, name: str, option: dict = None):
        self.__isClick = False
        res = self.__find_name(name, option)
        if res:
    ...
    def exists(self, name: str, option: dict):
        res = self.__find_name(name, option)
        return bool(res)
