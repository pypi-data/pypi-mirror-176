...
class AdHandler:
    def __init__(self, project_name: str):
        ...
        self.__device_size = self.__tool.get_screen_size()
        self.__device_width = float(self.__device_size["device_width"])
        self.__device_height = float(self.__device_size["device_height"])
