...
class Excel:
    ...
    def append_to_excel(self, filename, data, sheet_name='Sheet1', startrow=None, truncate_sheet=False, header=False, **to_excel_kwargs):
        ...
        df.to_excel(writer, sheet_name, startrow=startrow, header=header, if_sheet_exists='overlay', **to_excel_kwargs)
    ...
    def insert_image(self, filename: str, imagename: str, sheet_name: str) -> None:
        writer = pd.ExcelWriter(filename, engine='openpyxl', mode='a')
