...
class DataOpentelekomcloudIdentityUserV3(
    ...
    def __init__(
        ...
        *,
        ...
        :param region: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/opentelekomcloud/d/identity_user_v3#region DataOpentelekomcloudIdentityUserV3#region}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataOpentelekomcloudIdentityUserV3Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
