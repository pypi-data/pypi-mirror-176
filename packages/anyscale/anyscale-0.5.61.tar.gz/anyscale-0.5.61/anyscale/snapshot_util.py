...
# TODO(ekl) enable this flag by default. This causes workspaces to use the $CWD
# as the runtime env working dir instead of always the workspace root.
RELATIVE_WORKING_DIR = bool(os.environ.get("RELATIVE_WORKING_DIR", False))
