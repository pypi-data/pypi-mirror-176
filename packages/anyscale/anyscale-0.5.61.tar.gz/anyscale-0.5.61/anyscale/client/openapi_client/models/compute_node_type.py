...
class ComputeNodeType(object):
    ...
    def __init__(self, name=None, instance_type=None, resources=None, aws_advanced_configurations=None, gcp_advanced_configurations=None, local_vars_configuration=None):  # noqa: E501
