...
class AWSNodeOptions(object):
    ...
    def __init__(self, block_device_mappings=None, iam_instance_profile=None, security_group_ids=None, subnet_id=None, tag_specifications=None, network_interfaces=None, placement=None, launch_template=None, local_vars_configuration=None):  # noqa: E501
