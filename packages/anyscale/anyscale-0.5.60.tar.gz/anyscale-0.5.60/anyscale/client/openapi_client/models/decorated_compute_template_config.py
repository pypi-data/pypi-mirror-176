...
class DecoratedComputeTemplateConfig(object):
    ...
    def __init__(self, cloud_id=None, max_workers=None, region=None, allowed_azs=None, head_node_type=None, worker_node_types=None, aws=None, gcp=None, azure=None, maximum_uptime_minutes=None, idle_termination_minutes=None, cloud=None, local_vars_configuration=None):  # noqa: E501
