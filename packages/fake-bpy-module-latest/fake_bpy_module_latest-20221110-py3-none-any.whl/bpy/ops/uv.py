...
def align_rotation(override_context: typing.
                   ...
                   undo: bool = None,
                   *,
                   method: typing.Union[str, int] = 'AUTO',
...
def randomize_uv_transform(
    ...
    :type loc: typing.Union[typing.List[float], typing.Tuple[float, float], 'mathutils.Vector']
    ...
    :type scale: typing.Union[typing.List[float], typing.Tuple[float, float], 'mathutils.Vector']
    '''
