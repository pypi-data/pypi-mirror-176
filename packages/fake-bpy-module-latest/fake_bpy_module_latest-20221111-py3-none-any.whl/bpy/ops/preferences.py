...
def addon_refresh(override_context: typing.
                  ...
                  execution_context: typing.Union[str, int] = None,
                  undo: bool = None):
    ''' Scan add-on directories for new modules :file: startup/bl_operators/userpref.py\:568 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$568> _
...
def copy_prev(override_context: typing.Union[typing.
              ...
              execution_context: typing.Union[str, int] = None,
              undo: bool = None):
    ''' Copy settings from previous version :file: startup/bl_operators/userpref.py\:139 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$139> _
...
def keyconfig_remove(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: bool = None):
    ''' Remove key config :file: startup/bl_operators/userpref.py\:412 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$412> _
...
def keyconfig_test(override_context: typing.
                   ...
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None):
    ''' Test key configuration for conflicts :file: startup/bl_operators/userpref.py\:161 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$161> _
...
def keyitem_add(override_context: typing.
                ...
                execution_context: typing.Union[str, int] = None,
                undo: bool = None):
    ''' Add key map item :file: startup/bl_operators/userpref.py\:360 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$360> _
...
def studiolight_show(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: bool = None):
    ''' Show light preferences :file: startup/bl_operators/userpref.py\:1134 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$1134> _
