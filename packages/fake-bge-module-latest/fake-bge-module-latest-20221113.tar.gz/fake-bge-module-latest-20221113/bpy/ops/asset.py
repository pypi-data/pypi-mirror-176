...
def open_containing_blend_file():
    ''' Open the blend file that contains the active asset :file: startup/bl_operators/assets.py\:96 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/assets.py$96> _
...
def tag_remove():
    ''' Remove an existing keyword tag from the active asset :file: startup/bl_operators/assets.py\:60 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/assets.py$60> _
