...
def mask_from_cavity(mix_mode: typing.Union[str, int] = 'MIX',
    ...
    :param use_automask_settings: Automask Settings, Use default settings from Options panel in sculpt mode
...
def symmetrize(merge_tolerance: float = 0.0005):
