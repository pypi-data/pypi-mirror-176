...
class DataDnsMxRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataDnsMxRecordSetConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-dns.dataDnsMxRecordSet.DataDnsMxRecordSetMx",
    jsii_struct_bases=[],
    name_mapping={},
)
class DataDnsMxRecordSetMx:
    ...
    def __repr__(self) -> str:
        return "DataDnsMxRecordSetMx(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataDnsMxRecordSetMxList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-dns.dataDnsMxRecordSet.DataDnsMxRecordSetMxList",
):
    def __init__(
        self,
    ...
    def get(self, index: jsii.Number) -> "DataDnsMxRecordSetMxOutputReference":
        '''
        ...
        return typing.cast("DataDnsMxRecordSetMxOutputReference", jsii.invoke(self, "get", [index]))
...
class DataDnsMxRecordSetMxOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-dns.dataDnsMxRecordSet.DataDnsMxRecordSetMxOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def internal_value(self) -> typing.Optional[DataDnsMxRecordSetMx]:
        return typing.cast(typing.Optional[DataDnsMxRecordSetMx], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(self, value: typing.Optional[DataDnsMxRecordSetMx]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataDnsMxRecordSetMx]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    "DataDnsMxRecordSet",
    "DataDnsMxRecordSetConfig",
    "DataDnsMxRecordSetMx",
    "DataDnsMxRecordSetMxList",
