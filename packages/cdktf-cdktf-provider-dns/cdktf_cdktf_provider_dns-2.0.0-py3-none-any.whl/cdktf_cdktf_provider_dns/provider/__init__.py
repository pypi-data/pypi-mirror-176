...
class DnsProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/dns#alias DnsProvider#alias}
        '''
        if __debug__:
            def stub(
                scope: constructs.Construct,
        ...
        config = DnsProviderConfig(alias=alias)
