...
@jsii.data_type(
    jsii_type="@cdktf/provider-dns.dataDnsSrvRecordSet.DataDnsSrvRecordSetConfig",
...
class DataDnsSrvRecordSetConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataDnsSrvRecordSetConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-dns.dataDnsSrvRecordSet.DataDnsSrvRecordSetSrv",
    jsii_struct_bases=[],
    name_mapping={},
)
class DataDnsSrvRecordSetSrv:
    ...
    def __repr__(self) -> str:
        return "DataDnsSrvRecordSetSrv(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataDnsSrvRecordSetSrvList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-dns.dataDnsSrvRecordSet.DataDnsSrvRecordSetSrvList",
):
    def __init__(
        self,
    ...
    def get(self, index: jsii.Number) -> "DataDnsSrvRecordSetSrvOutputReference":
        '''
        ...
        return typing.cast("DataDnsSrvRecordSetSrvOutputReference", jsii.invoke(self, "get", [index]))
...
class DataDnsSrvRecordSetSrvOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-dns.dataDnsSrvRecordSet.DataDnsSrvRecordSetSrvOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def internal_value(self) -> typing.Optional[DataDnsSrvRecordSetSrv]:
        return typing.cast(typing.Optional[DataDnsSrvRecordSetSrv], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(self, value: typing.Optional[DataDnsSrvRecordSetSrv]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataDnsSrvRecordSetSrv]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    "DataDnsSrvRecordSet",
    "DataDnsSrvRecordSetConfig",
    "DataDnsSrvRecordSetSrv",
    "DataDnsSrvRecordSetSrvList",
