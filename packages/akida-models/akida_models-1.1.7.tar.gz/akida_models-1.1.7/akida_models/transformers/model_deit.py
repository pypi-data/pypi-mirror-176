...
from .model_vit import CONFIG_TI, CONFIG_S, CONFIG_B, _get_quant_config
...
def bc_deit_ti16_imagenet_pretrained():
    ...
    Returns:
        ...
        formatted dict.
    """
    model_name = 'bc_deit_ti16_224_quant_config_8bit.h5'
    file_hash = '70923a62a2d3622e3eaeb3c9ce1804a9bdfcc9fd2f8a6f28d3e8e44970b60fa9'
...
def bc_deit_dist_ti16_imagenet_pretrained():
    ...
    Returns:
        ...
        formatted dict.
    """
    model_name = 'bc_deit_dist_ti16_224_quant_config_8bit.h5'
    file_hash = '857f0250ed6026bc04a993206179cdbe8339f8f5be4c572739dd376ed4bd0cfb'
    model_path = fetch_file(BASE_WEIGHT_PATH + model_name,
                            fname=model_name,
                            file_hash=file_hash,
                            cache_subdir='models')
