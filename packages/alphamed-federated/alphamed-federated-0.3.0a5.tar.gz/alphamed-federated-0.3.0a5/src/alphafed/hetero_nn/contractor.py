...
from ..contractor import (ApplyGRPCSendingDataEvent, ContractEvent,
...
SendFeatureEvent = ApplyGRPCSendingDataEvent
SendFeatureGradEvent = ApplyGRPCSendingDataEvent
SendTestFeatureEvent = ApplyGRPCSendingDataEvent
...
class HeteroNNContractor(RSAContractor):
    ...
    def query_partners(self, is_auto_ml: bool = False) -> List[str]:
        """Query all partners in the task."""
        return self._task_contractor.query_nodes(is_auto_ml=is_auto_ml)
