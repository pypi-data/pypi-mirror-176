...
class FedAvgScheduler(Scheduler, metaclass=ABCMeta):
    ...
    def _setup_context(self, id: str, task_id: str, is_initiator: bool = False):
        ...
        self._save_root = os.path.join('/data/alphamed-federated', self.task_id)
    ...
    def _save_model(self):
        ...
        with open(os.path.join(save_dir, "model_ckt.pt"), 'wb') as f:
    ...
    def _prepare_task_output(self) -> Tuple[str, str]:
        ...
        model_file = os.path.join(save_dir, "scripted_model.pt")
