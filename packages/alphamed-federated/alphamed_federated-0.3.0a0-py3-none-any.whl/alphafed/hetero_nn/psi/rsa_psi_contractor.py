...
class PublicKeyEvent(ContractEvent):
    ...
    def contract_to_event(cls, contract: dict) -> 'PublicKeyEvent':
        ...
        assert n and isinstance(n, int) and n > 0, f'invalid public key: {n=}'
...
SendingBlindIdsEvent = ApplySendingDataEvent
SendingSignedIdsEvent = ApplySendingDataEvent
DistributingIntersectionEvent = ApplySendingDataEvent
