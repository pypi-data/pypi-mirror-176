...
class AutoInception(AutoInceptionBase):
    ...
    def fine_tune(self, id: str, task_id: str, dataset_dir: str, is_initiator: bool = False):
        self.id = id
    ...
    def _save_fine_tuned(self):
        ...
        with open(os.path.join(self._save_path, 'fine_tuned.json'), 'w') as f:
...
class InceptionFedAvgScheduler(SecureFedAvgScheduler):
    ...
    def _prepare_task_output(self) -> Tuple[str, str]:
        ...
        resource_zip_file = f'{resource_dir}.zip'
