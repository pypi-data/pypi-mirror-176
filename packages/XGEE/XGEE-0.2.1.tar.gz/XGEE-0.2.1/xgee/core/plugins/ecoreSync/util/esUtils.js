var builtInClasses=Object.values(window["Ecore"]).filter((val) => { return val.eClass?true:false })
...
class EsUtilities{
    ...
    isLocalEcoreElement(name){
        ...
        var keys=Object.keys(window["Ecore"]);
    ...
    {
        var Ecore=window["Ecore"]        
        let res=builtInClasses.find((clazz) => { return clazz == eClass})?true:false
        return res
    }
