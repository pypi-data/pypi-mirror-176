...
download_url = 'https://gitlab.com/m9s/nereid_catalog.git'
requires = [
    'MarkupSafe<2.1.0',
    ]
...
setup(name=name,
    version=version,
    description='Tryton Nereid Catalog Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/nereid_catalog.git',
        },
    keywords='',
    package_dir={'trytond.modules.nereid_catalog': '.'},
    packages=(
        ['trytond.modules.nereid_catalog']
        + ['trytond.modules.nereid_catalog.%s' % p
