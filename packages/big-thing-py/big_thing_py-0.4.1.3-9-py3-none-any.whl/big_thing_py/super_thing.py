...
class SoPSuperThing(SoPBigThing):
    ...
    def __init__(self, name: str = None, service_list: List[SoPService] = [], alive_cycle: float = 60, is_super: bool = False, is_parallel: bool = True,
                 ip: str = None, port: int = None, ssl_ca_path: str = f'{get_project_root()}/CA', ssl_enable: bool = True, log_name: str = None, log_enable: bool = True, append_mac_address: bool = True,
                 refresh_cycle: float = 10):
        super().__init__(name=name, service_list=service_list, alive_cycle=alive_cycle, is_super=is_super,
                         is_parallel=is_parallel, ip=ip, port=port, ssl_ca_path=ssl_ca_path, ssl_enable=ssl_enable, log_name=log_name, log_enable=log_enable, append_mac_address=append_mac_address)
    ...
    def _handle_MS_SUPER_ACTION(self, super_action_msg: Union[SoPSuperScheduleMessage, SoPSuperExecuteMessage]):
        ...
        # 만약 타켓 함수가 없다면 에러를 출력한다.
            ...
            SOPLOG_DEBUG(
                f'Function {super_action_request._trigger_msg._super_function_name} was not exist', 'red')
            return False
            ...
            for middleware in service_list.service_list():
                ...
                for thing in thing_list:
                    ...
                    for value_info in value_list:
                        ...
                        # TODO: energy, cycle info was omit in service list
