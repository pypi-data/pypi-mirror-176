...
def main():
    ...
    thing = SoPBigThing(name=args.name, service_list=function_list + value_list,
                        ...
                        ssl_ca_path=f'{get_project_root()}/CA/', ssl_enable=None, append_mac_address=False, log_name='%s')
...
def generate_thing(args):
    super_thing = SoPBasicSuperThing(name=args.name, ip=args.host, port=args.port, is_super=True, is_parallel=%s, ssl_ca_path=f'{get_project_root()}/CA/', ssl_enable=None,
...
class SimulationGenerator:
    ...
    def generate_simulation_code(self):
        ...
        self.function_names_pool = self.generate_random_words(
            int(self.simulation_config['service']['service_type_num']))
