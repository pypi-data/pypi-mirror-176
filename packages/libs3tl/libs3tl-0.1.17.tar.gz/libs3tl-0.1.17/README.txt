...
### New Release Note version='0.1.17' ###

Added new function inside Step.py class, trimPropertiesConfig() this function enable us to trim the extra spaces in .properties files and also changes related to handOff() method;