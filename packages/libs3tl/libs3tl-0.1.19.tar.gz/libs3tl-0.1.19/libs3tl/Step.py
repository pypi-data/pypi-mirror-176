...
class Step:
    ...
    # Storing the dataToHandoff in a dataframe and the converting  DF to json and printing it
    # def handOff(self, rC, taskID, nextStep, dataToHandoff):
    def handOff(self, dataToHandoff):
        try:
            self.logInfo("Handoff",self.taskID)
