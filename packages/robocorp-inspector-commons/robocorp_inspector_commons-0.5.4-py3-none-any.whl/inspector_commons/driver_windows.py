...
class WindowsDriver:
    ...
    def _on_click(
        ...
        try:
            ...
            self.logger.debug("Constructed Locator: %s", locator)
        ...
        self.queue.put(locator, block=False, timeout=PICK_TIMEOUT)
    ...
    def listen(self, active_window: str):
        with auto.UIAutomationInitializerInThread(debug=True):
            ...
            try:
                ...
                self.logger.debug("Locator after selection: %s", locator)
            except Empty:
