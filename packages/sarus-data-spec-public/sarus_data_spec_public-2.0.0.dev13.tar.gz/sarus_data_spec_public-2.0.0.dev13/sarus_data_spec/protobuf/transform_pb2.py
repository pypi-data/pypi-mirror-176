...
_TRANSFORM_EXTERNAL = _descriptor.Descriptor(
  ...
  nested_types=[_TRANSFORM_EXTERNAL_OPIDENTIFIER, _TRANSFORM_EXTERNAL_STD, _TRANSFORM_EXTERNAL_PANDAS, _TRANSFORM_EXTERNAL_NUMPY, _TRANSFORM_EXTERNAL_TENSORFLOW, _TRANSFORM_EXTERNAL_SKLEARN, _TRANSFORM_EXTERNAL_PANDASPROFILING, _TRANSFORM_EXTERNAL_XGBOOST, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
