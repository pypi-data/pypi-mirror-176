...
_SCALAR_PRIVACYPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='epsilons', full_name='sarus_data_spec.Scalar.PrivacyParameters.epsilons', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deltas', full_name='sarus_data_spec.Scalar.PrivacyParameters.deltas', index=1,
