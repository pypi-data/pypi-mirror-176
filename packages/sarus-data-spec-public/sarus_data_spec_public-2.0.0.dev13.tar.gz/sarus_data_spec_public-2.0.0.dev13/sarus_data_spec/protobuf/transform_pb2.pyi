...
class Transform(google.protobuf.message.Message):
    ...
    class External(google.protobuf.message.Message):
        ...
        class OpIdentifier(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal[u"numpy",b"numpy",u"op",b"op",u"pandas",b"pandas",u"pandas_profiling",b"pandas_profiling",u"sklearn",b"sklearn",u"std",b"std",u"tensorflow",b"tensorflow",u"xgboost",b"xgboost"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal[u"numpy",b"numpy",u"op",b"op",u"pandas",b"pandas",u"pandas_profiling",b"pandas_profiling",u"sklearn",b"sklearn",u"std",b"std",u"tensorflow",b"tensorflow",u"xgboost",b"xgboost"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal[u"op",b"op"]) -> typing.Optional[typing_extensions.Literal["std","pandas","numpy","tensorflow","sklearn","pandas_profiling","xgboost"]]: ...
