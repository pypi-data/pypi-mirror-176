...
class Scalar(google.protobuf.message.Message):
    ...
    class PrivacyParameters(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        EPSILONS_FIELD_NUMBER: builtins.int
        DELTAS_FIELD_NUMBER: builtins.int
        @property
        def epsilons(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
        @property
        def deltas(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
        def __init__(self,
            *,
            epsilons : typing.Optional[typing.Iterable[builtins.float]] = ...,
            deltas : typing.Optional[typing.Iterable[builtins.float]] = ...,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"deltas",b"deltas",u"epsilons",b"epsilons"]) -> None: ...
