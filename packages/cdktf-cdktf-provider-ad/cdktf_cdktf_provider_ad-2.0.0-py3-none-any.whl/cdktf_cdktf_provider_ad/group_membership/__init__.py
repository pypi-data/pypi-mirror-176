...
class GroupMembership(
    ...
    def group_members_input(self) -> typing.Optional[typing.List[builtins.str]]:
        return typing.cast(typing.Optional[typing.List[builtins.str]], jsii.get(self, "groupMembersInput"))
    ...
    def group_members(self) -> typing.List[builtins.str]:
        return typing.cast(typing.List[builtins.str], jsii.get(self, "groupMembers"))

    @group_members.setter
    def group_members(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
...
@jsii.data_type(
    jsii_type="@cdktf/provider-ad.groupMembership.GroupMembershipConfig",
