...
class Gpo(
    ...
    @builtins.property
    @jsii.member(jsii_name="numericStatus")
    def numeric_status(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "numericStatus"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-ad.gpo.GpoConfig",
...
class GpoConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
