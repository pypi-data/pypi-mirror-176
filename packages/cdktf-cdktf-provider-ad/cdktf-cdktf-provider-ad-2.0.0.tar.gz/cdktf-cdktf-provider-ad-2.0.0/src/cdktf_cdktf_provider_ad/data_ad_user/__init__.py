...
class DataAdUser(
    ...
    def smart_card_logon_required(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "smartCardLogonRequired"))
    ...
    def trusted_for_delegation(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "trustedForDelegation"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-ad.dataAdUser.DataAdUserConfig",
...
class DataAdUserConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataAdUserConfig(%s)" % ", ".join(
