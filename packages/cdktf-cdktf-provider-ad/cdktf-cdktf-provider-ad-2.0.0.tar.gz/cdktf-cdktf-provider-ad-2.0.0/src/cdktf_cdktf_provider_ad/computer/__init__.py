...
class Computer(
    ...
    @jsii.member(jsii_name="resetPre2Kname")
    def reset_pre2_kname(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetPre2Kname", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="pre2KnameInput")
    def pre2_kname_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "pre2KnameInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="pre2Kname")
    def pre2_kname(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "pre2Kname"))

    @pre2_kname.setter
    def pre2_kname(self, value: builtins.str) -> None:
        if __debug__:
            def stub(value: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pre2Kname", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-ad.computer.ComputerConfig",
...
class ComputerConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
