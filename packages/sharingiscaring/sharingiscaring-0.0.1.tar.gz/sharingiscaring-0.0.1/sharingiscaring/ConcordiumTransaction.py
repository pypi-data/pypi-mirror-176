...
class Event:
    ...
    def translate_event_from_graphQL(self):
        ...
        if etype == TransactionTypeQL.AccountCreated.name:
            self.d['contents'] = e['accountAddress']['asString']

        if etype == TransactionTypeQL.AmountAddedByDecryption.name:
            self.d['amount'] = int(e['amount'])
            self.d['account'] = e['accountAddress']['asString']
        
        elif etype == TransactionTypeQL.BakerSetOpenStatus.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['openStatus'] = EventOpenStatusFromQLToNode[e['openStatus']].value

        elif etype == TransactionTypeQL.BakerSetBakingRewardCommission.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['bakingRewardCommission'] = e['bakingRewardCommission']
        
        elif etype == TransactionTypeQL.BakerSetFinalizationRewardCommission.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['finalizationRewardCommission'] = e['finalizationRewardCommission']

        elif etype == TransactionTypeQL.BakerSetTransactionFeeCommission.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['transactionFeeCommission'] = e['transactionFeeCommission']

        elif etype == TransactionTypeQL.BakerSetMetadataURL.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['metadataUrl'] = e['metadataUrl']
        
        elif etype == TransactionTypeQL.DelegationAdded.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
        
        elif etype == TransactionTypeQL.DelegationSetDelegationTarget.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
        ...
        elif etype == TransactionTypeQL.DelegationSetRestakeEarnings.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
            self.d['restakeEarnings'] = e['restakeEarnings']
        
        elif etype == TransactionTypeQL.DelegationRemoved.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
        
        elif etype == TransactionTypeQL.DelegationStakeDecreased.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
            self.d['newStake'] = e['newStakedAmount']
        
        elif etype == TransactionTypeQL.DelegationStakeIncreased.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['delegatorId'] = e['delegatorId']
            self.d['newStake'] = e['newStakedAmount']
            
        elif etype == TransactionTypeQL.BakerAdded.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
        ...
        elif etype == TransactionTypeQL.BakerKeysUpdated.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['aggregationKey'] = e['aggregationKey']
            self.d['electionKey'] = e['electionKey']
        ...
        elif etype == TransactionTypeQL.BakerRemoved.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            
        elif etype == TransactionTypeQL.BakerSetRestakeEarnings.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['restakeEarnings'] = e['restakeEarnings']
        
        elif etype == TransactionTypeQL.BakerStakeDecreased.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['newStake'] = e['newStakedAmount']
        
        elif etype == TransactionTypeQL.BakerStakeIncreased.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['bakerId'] = e['bakerId']
            self.d['newStake'] = e['newStakedAmount']

        elif etype == TransactionTypeQL.ChainUpdateEnqueued.name:
        ...
        elif etype == TransactionTypeQL.ContractInitialized.name:
        ...
        elif etype == TransactionTypeQL.ContractResumed.name:
            self.d['address'] = {'index': e['contractAddress']['index'], 'subindex': e['contractAddress']['subIndex']}
            self.d['success'] = e['success']

        elif etype == TransactionTypeQL.ContractInterrupted.name:
            self.d['address'] = {'index': e['contractAddress']['index'], 'subindex': e['contractAddress']['subIndex']}

        elif etype == TransactionTypeQL.ContractUpdated.name:
            self.d['address'] = {'index': e['contractAddress']['index'], 'subindex': e['contractAddress']['subIndex']}
            self.d['amount'] = e['amount']
            self.d['contractVersion'] = 0  # note: not available in QL
        ...
        elif etype == TransactionTypeQL.ContractModuleDeployed.name:
            self.d['contents'] = e['moduleRef']
            
        elif etype == TransactionTypeQL.CredentialDeployed.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['regId'] = e['regId']
            

        elif etype == TransactionTypeQL.CredentialsUpdated.name:
            self.d['account'] = e['accountAddress']['asString']
            self.d['newCredIds'] = e['newCredIds']
            self.d['newThreshold'] = e['newThreshold']
            self.d['removedCredIds'] = e['removedCredIds']

        elif etype == TransactionTypeQL.DataRegistered.name:
            self.d['data'] = e['dataAsHex']
            
        elif etype == TransactionTypeQL.EncryptedAmountsRemoved.name:
            pass

        elif etype == TransactionTypeQL.NewEncryptedAmount.name:
            pass
        
        elif etype == TransactionTypeQL.TransferMemo.name:
            # note this is actually NOT the same as the node, as the node does NOT decode.
            self.d['memo'] = e['decoded']['text']
            
        elif etype == TransactionTypeQL.Transferred.name:
            self.d['amount'] = int(e['amount'])
            self.d['from'] = self.determineAddress(e['from'])
            self.d['to']   = self.determineAddress(e['to'])
            
        elif etype == TransactionTypeQL.TransferredWithSchedule.name:
...
class ConcordiumTransaction:
    ...
    def __init__(self, concordium_node):
        self.concordium_node = concordium_node
    ...
    def find_memo_and_amount(self):
        ...
        if ((self.contents == 'transferWithMemo') or (self.contents == 'Transferred')):
            for event in self.result['events']:
                if event['tag'] == TransactionTypeQL.TransferMemo.name:
                    self.memo = event['memo']
                if event['tag'] == TransactionTypeQL.Transferred.name:
    ...
    def set_possible_cns_domain(self):
        ...
        for event in self.result['events']:
            if event['tag'] == TransactionTypeQL.ContractUpdated.name:
