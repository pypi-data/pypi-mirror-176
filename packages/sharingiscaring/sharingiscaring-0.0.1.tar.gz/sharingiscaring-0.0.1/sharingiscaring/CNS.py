...
class CNSDomain:
    ...
    def get_cns_domain_name(self, concordium_node, hex):
        ...
        try:
            ...
            # self.cns_domains_by_name[domain_name] = hex
            # self.cns_domains_by_token_id[hex] = domain_name
            # self.save_cns_translations()
        except:
