...
class Runner:
    ...
    def __run_container(self, variables, path_parent: str, target_parent: str, image: str,
                        job_data, script_file: ScriptsFile, entrypoint: Optional[str],
                        network: str, target_workdir: str, last_result: bool,
                        result: bool) -> bool:
    ...
    @staticmethod
    def __run_native(variables, entrypoint: Optional[str], script_file: ScriptsFile,
                     job_data, last_result: bool, result: bool) -> bool:
    ...
    def run(self, job_data, last_result: bool, pipeline_history: PipelineHistory) -> bool:
