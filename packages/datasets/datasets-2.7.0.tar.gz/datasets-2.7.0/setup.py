...
3. Commit these changes, push and create a Pull Request:
   ...
   https://github.com/huggingface/datasets/pull/new/release
   Create Pull Request
...
7. Fill release notes in the tag in GitHub once everything is looking hunky-dory
   ...
   - Create new release: https://github.com/huggingface/datasets/releases/new
...
8. Set the dev version
   ...
   - Commit these changes, push and create a Pull Request:
       ...
       https://github.com/huggingface/datasets/pull/new/dev-version
       Create Pull Request
