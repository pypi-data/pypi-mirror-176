...
- Pre-trained model: `keyword_spotting_pacman_v2.mltk.zip <https://github.com/siliconlabs/mltk/blob/master/mltk/models/siliconlabs/keyword_spotting_pacman_v2.mltk.zip>`_
...
`Keyword Spotting Pac-Man <https://siliconlabs.github.io/mltk/mltk/tutorials/keyword_spotting_pacman_v2.html>`_ tutorial.
