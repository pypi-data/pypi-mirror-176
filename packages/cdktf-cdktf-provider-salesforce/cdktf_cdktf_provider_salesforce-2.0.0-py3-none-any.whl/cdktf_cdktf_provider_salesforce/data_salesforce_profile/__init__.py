...
class DataSalesforceProfile(
    ...
    def __init__(
        ...
        *,
        ...
        config = DataSalesforceProfileConfig(
            name=name,
...
@jsii.data_type(
    jsii_type="@cdktf/provider-salesforce.dataSalesforceProfile.DataSalesforceProfileConfig",
...
class DataSalesforceProfileConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataSalesforceProfileConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


__all__ = [
    "DataSalesforceProfile",
    "DataSalesforceProfileConfig",
]
