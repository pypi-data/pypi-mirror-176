...
class InstallmentPaymentServiceApi:
    ...
    def count_with_http_info(self, space_id, filter, **kwargs):
        ...
        return self.api_client.call_api(
            '/installment-payment/count', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_installment_payment_with_http_info(self, space_id, transaction_id, installment_plan_configuration, **kwargs):
        ...
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `create_installment_payment`")
        # verify the required parameter 'transaction_id' is set
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `create_installment_payment`")
        # verify the required parameter 'installment_plan_configuration' is set
        if ('installment_plan_configuration' not in params or
                params['installment_plan_configuration'] is None):
            raise ValueError("Missing the required parameter `installment_plan_configuration` when calling `create_installment_payment`")
        ...
        if 'installment_plan_configuration' in params:
            query_params.append(('installmentPlanConfiguration', params['installment_plan_configuration']))
        ...
        return self.api_client.call_api(
            '/installment-payment/createInstallmentPayment', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/installment-payment/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
