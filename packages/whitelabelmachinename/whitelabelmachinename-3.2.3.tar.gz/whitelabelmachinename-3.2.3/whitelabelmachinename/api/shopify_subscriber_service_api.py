...
class ShopifySubscriberServiceApi:
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/shopify-subscriber/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_with_http_info(self, space_id, query, **kwargs):
        ...
        if ('query' not in params or
                params['query'] is None):
            raise ValueError("Missing the required parameter `query` when calling `update`")
        ...
        return self.api_client.call_api(
            '/shopify-subscriber/update', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
