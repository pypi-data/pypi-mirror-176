...
class DebtCollectorConfigurationServiceApi:
    ...
    def count_with_http_info(self, space_id, **kwargs):
        ...
        return self.api_client.call_api(
            '/debt-collector-configuration/count', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_with_http_info(self, space_id, id, **kwargs):
        ...
        return self.api_client.call_api(
            '/debt-collector-configuration/read', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/debt-collector-configuration/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
