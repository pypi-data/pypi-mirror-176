...
class Patcher(object):
    url_repo = "https://msedgedriver.azureedge.net"
    zip_name = "edgedriver_%s.zip"
    exe_name = "msedgedriver%s"
    ...
    if platform.endswith("win32"):
        d = "~/appdata/roaming/undetected_edgedriver"
    elif platform.startswith("linux"):
        d = "~/.local/share/undetected_edgedriver"
    elif platform.endswith("darwin"):
        d = "~/Library/Application Support/undetected_edgedriver"
    else:
        d = "~/.undetected_edgedriver"
    ...
    def __init__(self, executable_path=None, force=False, version_main: int = 0):
        ...
        Args:
            executable_path: None = automatic
                             a full file path to the EdgeDriver executable
            force: False
    ...
    def fetch_package(self):
        """
        Downloads EdgeDriver from source
