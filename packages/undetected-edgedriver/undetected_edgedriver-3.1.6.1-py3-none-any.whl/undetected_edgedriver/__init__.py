...
class Edge(selenium.webdriver.edge.webdriver.WebDriver):
    """
    Controls the EdgeDriver and allows you to drive the browser.
    ...
    reconnect()
        ...
        -stops the edgedriver service which runs in the background
        -starts the edgedriver service which runs in the background
        -recreate session
    ...
    def __init__(
        ...
        **kw
        ...
        Parameters
        ----------
        options: EdgeOptions, optional, default: None - automatic useful defaults
            this takes an instance of EdgeOptions, mainly to customize browser behavior.
        ...
        user_data_dir: str , optional, default: None (creates temp profile)
            if user_data_dir is a path to a valid edge profile directory, use it,
        ...
        browser_executable_path: str, optional, default: None - use find_edge_executable
        ...
        patcher_force_close: bool, optional, default: False
            instructs the patcher to do whatever it can to access the edgedriver binary
        ...
        suppress_welcome: bool, optional , default: True
            ...
            edge as your default browser, and if you want to send even more data to google.
        ...
        use_subprocess: bool, optional , default: True,
            False (the default) makes sure Chrome will get it's own process (so no subprocess of edgedriver.exe or python
              ...
              ---end script --
              and will be greeted with an error, since the program exists before edge has a change to launch.
        ...
        no_sandbox: bool, optional, default=True 
             ...
             this option has a default of True since many people seem to run this as root (....) , and edge does not start
        ...
        try:
            if hasattr(options, "_session") and options._session is not None:
                ...
                #  you'll get conflicts starting edge
                raise RuntimeError("you cannot reuse the EdgeOptions object")
        ...
        if not user_data_dir:
            ...
            # check if an old uc.EdgeOptions is used, and extract the user data dir
            ...
            if hasattr(options, "user_data_dir") and getattr(
                ...
                warnings.warn(
                    "using EdgeOptions.user_data_dir might stop working in future versions."
                ...
                logger.debug(
                    ...
                    "session, and added it to edge startup arguments: %s" % arg
                )
        ...
        if not options.binary_location:
            options.binary_location = (
                browser_executable_path or find_edge_executable()
            )
        ...
        if headless or options.headless:
            ...
            # fixes "could not connect to edge" error when running
    ...
    def start_session(self, capabilities=None, browser_profile=None):
        ...
        super(selenium.webdriver.edge.webdriver.WebDriver, self).start_session(
