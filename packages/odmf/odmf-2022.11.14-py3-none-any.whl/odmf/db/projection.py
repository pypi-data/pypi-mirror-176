...
def _UTMLetterDesignator(Lat):
    ...
    Written by Chuck Gantz- chuck.gantz@globalstar.com, Pythonized by Philipp Kraft
    """
    letters = 'XWVUTSRQPNMLKJHGFEDCZ'
    boundaries = range(72, -81, -8)
    if Lat > 84 or Lat < -80:
        return 'Z'
    else:
        for b, z in zip(boundaries, letters):
            if Lat >= b:
                return z
        return 'Z'
...
if __name__ == '__main__':
    (z, e, n) = LLtoUTM(23, 40 + (6 + 18.3591 / 60) /
                        60, -(88 + (13 + 9.52349 / 60) / 60))
    # print z, e, n
