...
def test_many_filetypes():
    filenames = [
        # Windows可执行文件
        'Hello64.exe_', 'Hello64.dll_', 'Hello64.sys_',
        'Hello32.exe_', 'Hello32.dll_', 'Hello32.sys_',
        # 安卓
        'app-debug.apk_',
        # pdf
        'hello.pdf_',
        # 图片
        'hello.png_', 'hello.jpg_', 'hello.bmp_', 'hello.gif_',
        # 音频
        'hello.mp3_',
        # 视频
        'hello.mp4_', 'hello.flv_', 'hello.avi_',
        # office文档
        'office.doc_', 'office.xls_', 'office.ppt_',
        'office.docx_', 'office.xlsx_', 'office.pptx_',
        # WPS创建的office2007+文档
