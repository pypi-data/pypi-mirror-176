...
[boto3 1.26.10](https://boto3.amazonaws.com/v1/documentation/api/1.26.10/index.html)
...
- `boto3-stubs-lite[all]` - Type annotations for all 321 services.
...
- `boto3-stubs-lite[ssm-incidents]` - Type annotations for
  ...
  service.
- `boto3-stubs-lite[ssmsap]` - Type annotations for
  [SsmSap](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ssmsap/)
  service.
