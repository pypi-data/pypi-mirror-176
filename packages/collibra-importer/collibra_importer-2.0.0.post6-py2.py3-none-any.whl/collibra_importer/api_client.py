...
import collibra_importer.models
from collibra_importer import rest
from collibra_importer.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(collibra_importer.models, klass)
