...
class InlineObject6(object):
    ...
    def __init__(self, send_notification=False, batch_size=1000, simulation=False, save_result=False, file_id=None, file=None, file_name='synchronization_file', delete_file=False, continue_on_error=False, separator=';', quote='"', escape='\\', strict_quotes=None, ignore_leading_whitespace=None, header_row=None, template=None, local_vars_configuration=None):  # noqa: E501
    ...
    def send_notification(self):
        """Gets the send_notification of this InlineObject6.  # noqa: E501

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :return: The send_notification of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def send_notification(self, send_notification):
        """Sets the send_notification of this InlineObject6.

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param send_notification: The send_notification of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def batch_size(self):
        """Gets the batch_size of this InlineObject6.  # noqa: E501

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :return: The batch_size of this InlineObject6.  # noqa: E501
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        """Sets the batch_size of this InlineObject6.

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :param batch_size: The batch_size of this InlineObject6.  # noqa: E501
        :type: int
        """
    ...
    @property
    def simulation(self):
        """Gets the simulation of this InlineObject6.  # noqa: E501
        ...
        :return: The simulation of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def simulation(self, simulation):
        """Sets the simulation of this InlineObject6.

        Whether the import should be triggered as a simulation. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.  # noqa: E501

        :param simulation: The simulation of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    def save_result(self):
        """Gets the save_result of this InlineObject6.  # noqa: E501
        ...
        :return: The save_result of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def save_result(self, save_result):
        """Sets the save_result of this InlineObject6.

        Whether the import Result should be persisted or forgotten. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.<p><b>DEPRECATED:</b>This parameter is deprecated and will be removed in the future.</b>.  # noqa: E501

        :param save_result: The save_result of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this InlineObject6.

        The <code>id</code> of uploaded file.<p><b>NOTE:</b> if this field is used, <code>file</code> should not be set.  # noqa: E501

        :param file_id: The file_id of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    @property
    def file(self):
        """Gets the file of this InlineObject6.  # noqa: E501
        ...
        :return: The file of this InlineObject6.  # noqa: E501
        :rtype: file
        """
        return self._file
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this InlineObject6.

        The file to upload. If set, then also <code>fileName</code> should be provided.<p><b>NOTE:</b> if this field is used, <code>fileId</code> should not be set.  # noqa: E501

        :param file: The file of this InlineObject6.  # noqa: E501
        :type: file
        """
    ...
    @property
    def file_name(self):
        """Gets the file_name of this InlineObject6.  # noqa: E501
        ...
        :return: The file_name of this InlineObject6.  # noqa: E501
        :rtype: str
        """
    ...
    def file_name(self, file_name):
        """Sets the file_name of this InlineObject6.

        The name of the file to upload. If set, then also <code>file</code> should be provided.<p><b>NOTE:</b> if this field is used, <code>fileId</code> should not be set.  # noqa: E501

        :param file_name: The file_name of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    def delete_file(self):
        """Gets the delete_file of this InlineObject6.  # noqa: E501
        ...
        :return: The delete_file of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def delete_file(self, delete_file):
        """Sets the delete_file of this InlineObject6.

        Whether the file should be deleted after the synchronization job is finished, regardless of the result. <b>The default value</b> is <code>false</code>.<p><b>NOTE:</b> if the file corresponds to an attachment, the attachment will be deleted.  # noqa: E501

        :param delete_file: The delete_file of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    def continue_on_error(self):
        """Gets the continue_on_error of this InlineObject6.  # noqa: E501
        ...
        :return: The continue_on_error of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def continue_on_error(self, continue_on_error):
        """Sets the continue_on_error of this InlineObject6.

        Whether the import should continue if some of the import commands are invalid or failed to execute. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the valid commands are still committed to the database, which can lead to partial results being stored.  # noqa: E501

        :param continue_on_error: The continue_on_error of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def separator(self):
        """Gets the separator of this InlineObject6.  # noqa: E501

        The delimiter character used to separate entries. <b>The default value</b> is <code>';'</code>.  # noqa: E501

        :return: The separator of this InlineObject6.  # noqa: E501
        :rtype: str
        """
    ...
    def separator(self, separator):
        """Sets the separator of this InlineObject6.

        The delimiter character used to separate entries. <b>The default value</b> is <code>';'</code>.  # noqa: E501

        :param separator: The separator of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quote(self):
        """Gets the quote of this InlineObject6.  # noqa: E501

        The delimiter character used for quoted entries. <b>The default value</b>  is <code>'\"'</code>.  # noqa: E501

        :return: The quote of this InlineObject6.  # noqa: E501
        :rtype: str
        """
        return self._quote
    ...
    def quote(self, quote):
        """Sets the quote of this InlineObject6.

        The delimiter character used for quoted entries. <b>The default value</b>  is <code>'\"'</code>.  # noqa: E501

        :param quote: The quote of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    def escape(self, escape):
        """Sets the escape of this InlineObject6.

        The delimiter character used to escape separator or quote character. <b>The default value</b> is <code>'\\\\'</code>.  # noqa: E501

        :param escape: The escape of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    def strict_quotes(self):
        """Gets the strict_quotes of this InlineObject6.  # noqa: E501

        Whether the characters outside quotes should be ignored. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :return: The strict_quotes of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def strict_quotes(self, strict_quotes):
        """Sets the strict_quotes of this InlineObject6.

        Whether the characters outside quotes should be ignored. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param strict_quotes: The strict_quotes of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    def ignore_leading_whitespace(self):
        """Gets the ignore_leading_whitespace of this InlineObject6.  # noqa: E501

        Whether whitespace characters before quotes should be ignored. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :return: The ignore_leading_whitespace of this InlineObject6.  # noqa: E501
        :rtype: bool
        """
    ...
    def ignore_leading_whitespace(self, ignore_leading_whitespace):
        """Sets the ignore_leading_whitespace of this InlineObject6.

        Whether whitespace characters before quotes should be ignored. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param ignore_leading_whitespace: The ignore_leading_whitespace of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    def header_row(self, header_row):
        """Sets the header_row of this InlineObject6.

        Whether the first row of the synchronized CSV file is the header. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param header_row: The header_row of this InlineObject6.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def template(self):
        """Gets the template of this InlineObject6.  # noqa: E501
        ...
        :return: The template of this InlineObject6.  # noqa: E501
        :rtype: str
        """
    ...
    def template(self, template):
        """Sets the template of this InlineObject6.

        The template that should be used for parsing and synchronizing the contents of the CSV file.  <br/><p>There is one placeholder currently supported:<ul>     <li><b>${x}</b> - refers to the n-th column in the CSV file, e.g. ${1}, ${2}, ...)</li></ul><p>Example of a correct JSON template:</p> <pre> [   {     \"resourceType\": \"Asset\",     \"identifier\": {       \"name\": \"${1}\",       \"domain\": {         \"name\": \"${2}\",         \"community\": {           \"name\": \"Some Community\"         }       }     },     \"attributes\" : {       \"00000000-0000-0000-0000-000000003115\" : [ {         \"value\" : \"${3}\"        } ],       \"00000000-0000-0000-0000-000000000222\" : [ {         \"value\" : \"${4}\"       } ]     }   } ] </pre>  # noqa: E501

        :param template: The template of this InlineObject6.  # noqa: E501
        :type: str
        """
