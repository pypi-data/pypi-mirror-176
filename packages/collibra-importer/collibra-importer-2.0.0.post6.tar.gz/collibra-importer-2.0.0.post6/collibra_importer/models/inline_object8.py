...
class InlineObject8(object):
    ...
    def __init__(self, send_notification=False, batch_size=1000, simulation=False, save_result=False, finalization_strategy='REMOVE_RESOURCES', missing_asset_status_id=None, finalization_parameters=None, local_vars_configuration=None):  # noqa: E501
    ...
    def send_notification(self):
        """Gets the send_notification of this InlineObject8.  # noqa: E501

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :return: The send_notification of this InlineObject8.  # noqa: E501
        :rtype: bool
        """
    ...
    def send_notification(self, send_notification):
        """Sets the send_notification of this InlineObject8.

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param send_notification: The send_notification of this InlineObject8.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def batch_size(self):
        """Gets the batch_size of this InlineObject8.  # noqa: E501

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :return: The batch_size of this InlineObject8.  # noqa: E501
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        """Sets the batch_size of this InlineObject8.

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :param batch_size: The batch_size of this InlineObject8.  # noqa: E501
        :type: int
        """
    ...
    @property
    def simulation(self):
        """Gets the simulation of this InlineObject8.  # noqa: E501
        ...
        :return: The simulation of this InlineObject8.  # noqa: E501
        :rtype: bool
        """
    ...
    def simulation(self, simulation):
        """Sets the simulation of this InlineObject8.

        Whether the import should be triggered as a simulation. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.  # noqa: E501

        :param simulation: The simulation of this InlineObject8.  # noqa: E501
        :type: bool
        """
    ...
    def save_result(self):
        """Gets the save_result of this InlineObject8.  # noqa: E501
        ...
        :return: The save_result of this InlineObject8.  # noqa: E501
        :rtype: bool
        """
    ...
    def save_result(self, save_result):
        """Sets the save_result of this InlineObject8.

        Whether the import Result should be persisted or forgotten. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.<p><b>DEPRECATED:</b>This parameter is deprecated and will be removed in the future.</b>.  # noqa: E501

        :param save_result: The save_result of this InlineObject8.  # noqa: E501
        :type: bool
        """
    ...
    def finalization_strategy(self):
        """Gets the finalization_strategy of this InlineObject8.  # noqa: E501
        ...
        :return: The finalization_strategy of this InlineObject8.  # noqa: E501
        :rtype: str
        """
    ...
    def finalization_strategy(self, finalization_strategy):
        """Sets the finalization_strategy of this InlineObject8.

        The synchronization finalization strategy used in the clean up action. This determines whether to remove, ignore or change the status of assets that no longer exist in the external system.<br />Possible values are `REMOVE_RESOURCES`, `CHANGE_STATUS` and `IGNORE`.<br />When you select `CHANGE_STATUS`, you must also provide a value for `missingAssetStatusId`.  # noqa: E501

        :param finalization_strategy: The finalization_strategy of this InlineObject8.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def missing_asset_status_id(self):
        """Gets the missing_asset_status_id of this InlineObject8.  # noqa: E501
        ...
        :return: The missing_asset_status_id of this InlineObject8.  # noqa: E501
        :rtype: str
        """
    ...
    def missing_asset_status_id(self, missing_asset_status_id):
        """Sets the missing_asset_status_id of this InlineObject8.

        If <b>finalizationStrategy</b> is set to `CHANGE_STATUS` then this parameter determines the new status ID for assets that no longer exist in the external system.  # noqa: E501

        :param missing_asset_status_id: The missing_asset_status_id of this InlineObject8.  # noqa: E501
        :type: str
        """
    ...
    def finalization_parameters(self):
        """Gets the finalization_parameters of this InlineObject8.  # noqa: E501
        ...
        :return: The finalization_parameters of this InlineObject8.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def finalization_parameters(self, finalization_parameters):
        """Sets the finalization_parameters of this InlineObject8.

        If you have set `finalizationStrategy` to `CHANGE_STATUS`, the status ID for the assets that no longer exist in the external system.<p><b>NOTE:</b> This parameter must be declared with an 'application/json' content type.<p><b>DEPRECATED:</b> This parameter is deprecated and will be removed in the future. Please, use </b>missingAssetStatusId</b>.  # noqa: E501

        :param finalization_parameters: The finalization_parameters of this InlineObject8.  # noqa: E501
        :type: dict(str, str)
        """
