...
class InlineObject2(object):
    ...
    def __init__(self, send_notification=False, batch_size=1000, simulation=False, save_result=False, file_id=None, file=None, file_name='import_file', delete_file=False, continue_on_error=False, relations_action=None, local_vars_configuration=None):  # noqa: E501
    ...
    def send_notification(self):
        """Gets the send_notification of this InlineObject2.  # noqa: E501

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :return: The send_notification of this InlineObject2.  # noqa: E501
        :rtype: bool
        """
    ...
    def send_notification(self, send_notification):
        """Sets the send_notification of this InlineObject2.

        Whether job status notification should be sent. <b>The default value</b> is <code>false</code>.  # noqa: E501

        :param send_notification: The send_notification of this InlineObject2.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def batch_size(self):
        """Gets the batch_size of this InlineObject2.  # noqa: E501

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :return: The batch_size of this InlineObject2.  # noqa: E501
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        """Sets the batch_size of this InlineObject2.

        <i>The batchSize parameter is now deprecated and is ignored during command execution.</i>  # noqa: E501

        :param batch_size: The batch_size of this InlineObject2.  # noqa: E501
        :type: int
        """
    ...
    @property
    def simulation(self):
        """Gets the simulation of this InlineObject2.  # noqa: E501
        ...
        :return: The simulation of this InlineObject2.  # noqa: E501
        :rtype: bool
        """
    ...
    def simulation(self, simulation):
        """Sets the simulation of this InlineObject2.

        Whether the import should be triggered as a simulation. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.  # noqa: E501

        :param simulation: The simulation of this InlineObject2.  # noqa: E501
        :type: bool
        """
    ...
    def save_result(self):
        """Gets the save_result of this InlineObject2.  # noqa: E501
        ...
        :return: The save_result of this InlineObject2.  # noqa: E501
        :rtype: bool
        """
    ...
    def save_result(self, save_result):
        """Sets the save_result of this InlineObject2.

        Whether the import Result should be persisted or forgotten. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the result of the import simulation will be available at the end of the job but no change will be applied to the DGC.<p><b>DEPRECATED:</b>This parameter is deprecated and will be removed in the future.</b>.  # noqa: E501

        :param save_result: The save_result of this InlineObject2.  # noqa: E501
        :type: bool
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this InlineObject2.

        The <code>id</code> of uploaded file.<p><b>NOTE:</b> if this field is used, <code>file</code> should not be set.  # noqa: E501

        :param file_id: The file_id of this InlineObject2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def file_name(self):
        """Gets the file_name of this InlineObject2.  # noqa: E501
        ...
        :return: The file_name of this InlineObject2.  # noqa: E501
        :rtype: str
        """
    ...
    def file_name(self, file_name):
        """Sets the file_name of this InlineObject2.

        The name of the file to upload. If set, then also <code>file</code> should be provided.<p><b>NOTE:</b> if this field is used, <code>fileId</code> should not be set.  # noqa: E501

        :param file_name: The file_name of this InlineObject2.  # noqa: E501
        :type: str
        """
    ...
    def delete_file(self):
        """Gets the delete_file of this InlineObject2.  # noqa: E501
        ...
        :return: The delete_file of this InlineObject2.  # noqa: E501
        :rtype: bool
        """
    ...
    def delete_file(self, delete_file):
        """Sets the delete_file of this InlineObject2.

        Delete the file from the Collibra Platform if the import / synchronization job is successful. <b>The default value</b> is <code>false</code><p><b>NOTE:</b> if the file corresponds to an attachment, the attachment will be deleted.  # noqa: E501

        :param delete_file: The delete_file of this InlineObject2.  # noqa: E501
        :type: bool
        """
    ...
    def continue_on_error(self):
        """Gets the continue_on_error of this InlineObject2.  # noqa: E501
        ...
        :return: The continue_on_error of this InlineObject2.  # noqa: E501
        :rtype: bool
        """
    ...
    def continue_on_error(self, continue_on_error):
        """Sets the continue_on_error of this InlineObject2.

        Whether the import should continue if some of the import commands are invalid or failed to execute. <b>The default value</b> is <code>false</code>.<p>If <code>true</code>, the valid commands are still committed to the database, which can lead to partial results being stored.  # noqa: E501

        :param continue_on_error: The continue_on_error of this InlineObject2.  # noqa: E501
        :type: bool
        """
    ...
    def relations_action(self):
        """Gets the relations_action of this InlineObject2.  # noqa: E501

        Should it replace existing relations or add/update if any during refresh  # noqa: E501

        :return: The relations_action of this InlineObject2.  # noqa: E501
        :rtype: str
        """
    ...
    def relations_action(self, relations_action):
        """Sets the relations_action of this InlineObject2.

        Should it replace existing relations or add/update if any during refresh  # noqa: E501

        :param relations_action: The relations_action of this InlineObject2.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
