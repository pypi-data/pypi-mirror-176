...
import pandas as pd
import warnings
from essexpropds.util import sql_conn

def rent_floor(date_min):
    '''
    Usage: Read Data and output weighted Offered and RecentAverageEffective Rent by Floorplan
...
def rent_bed(date_min):
    '''
    Usage: Read Data and output weighted Offered and RecentAverageEffective Rent by Bedroom
    Parameters: - str date_min: YYYY-MM-DD date format
    Return:     - pd.Dataframe df_tmp: the queried data 
    '''
...
def rent_property(date_min):
    '''
    Usage: Read Data and output weighted Offered and RecentAverageEffective Rent by Property
    Parameters: - str date_min: YYYY-MM-DD date format
    Return:     - pd.Dataframe df_tmp: the queried data 
    '''
...
def rent_portfolio(date_min):
    '''
    Usage: Read Data and output weighted Offered and RecentAverageEffective Rent by Date
    Parameters: - str date_min: YYYY-MM-DD date format
    Return:     - pd.Dataframe df_tmp: the queried data 
    '''
