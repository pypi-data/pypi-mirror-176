...
# TODO(TEC-9494): Deprecate this method once QT implementation is complete.
def construct_spine_with_all_join_keys_for_TFV(
    ...
    # When data_skew_reduction = True, effective expiry is used for filtering expired features, and TTL
    # filtering is not handled in this function.
    if not data_skew_reduction:
...
def construct_full_tfv_or_ft_df(
    ...
    :param data_skew_reduction: Whether to account for batch schedule + data delay when returning features for spine.
    """
...
# TODO: Deprecate this method once QT supports wild cards and non-qt code path can be removed
