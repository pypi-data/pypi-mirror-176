...
class EnvironmentEffects(enum.Enum):
    _None = 0
    Snow = 1
    Rain = 2
    Bubbles = 3
...
class AmountOrCapacity(enum.Enum):
    Amount = 0
    Capacity = 1
...
class WorldLightingOptions(enum.Enum):
    Unknown1 = 0
