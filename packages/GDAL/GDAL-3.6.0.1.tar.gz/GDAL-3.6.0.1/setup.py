...
is_standalone_build = not os.path.exists('/home/even/gdal/3.6/build/swig/python')

if is_standalone_build:
    include_dirs = []
    library_dirs = []
else:
    include_dirs = ['/home/even/gdal/3.6/build/port', '/home/even/gdal/3.6/port', '/home/even/gdal/3.6/build/gcore', '/home/even/gdal/3.6/gcore', '/home/even/gdal/3.6/alg', '/home/even/gdal/3.6/ogr/', '/home/even/gdal/3.6/ogr/ogrsf_frmts', '/home/even/gdal/3.6/gnm', '/home/even/gdal/3.6/apps']
    library_dirs = ['/home/even/gdal/3.6/build']
libraries = ['gdal']
