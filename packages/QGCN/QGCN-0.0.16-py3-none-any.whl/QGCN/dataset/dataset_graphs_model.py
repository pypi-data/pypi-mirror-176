...
from graphMeasures.features_algorithms.vertices.bfs_moments import BfsMomentsCalculator

# from graphs-package.features_processor.features_processor import FeaturesProcessor, log_nor
from QGCN.graphs_package.features_processor.features_processor import FeaturesProcessor, log_norm
...
# from graphs_pach .multi_graph import MultiGraph
from QGCN.graphs_package.multi_graph.multi_graph import MultiGraph
...
class GraphsDataset(Dataset):
    def __init__(self, params, external_data: ExternalData = None):
        ...
        # the base dir is the dir where the main module is.
        self._base_dir = os.path.dirname(sys.modules['__main__'].__file__)
    ...
    def _standardize_data(self, data):
        ...
        # z-score data
        print(all_data_continuous_vec.shape)
        if self._params["standardization"] == "zscore":
            all_data_continuous_vec = np.array(all_data_continuous_vec)
...
if __name__ == "__main__":
    ext_train = ExternalData("../params/default_binary_params.json")
    ds = GraphsDataset("../params/default_binary_params.json", external_data=ext_train)
