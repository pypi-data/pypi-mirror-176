...
class DataNomadSchedulerConfig(
    ...
    def memory_oversubscription_enabled(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "memoryOversubscriptionEnabled"))

    @builtins.property
    @jsii.member(jsii_name="preemptionConfig")
    def preemption_config(self) -> cdktf.BooleanMap:
        return typing.cast(cdktf.BooleanMap, jsii.get(self, "preemptionConfig"))
...
class DataNomadSchedulerConfigConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
