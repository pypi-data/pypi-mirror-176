...
class GithubSearchResult():
    ...
    def __str__(self) -> str:
        ...
        return f"GithubSearchResult(url={self.url}, content={content})"
...
class GithubSearchResults():
    def __init__(self, github:Github, pattern:str) -> None:
        ...
        self.pages = [i for i in range(0, self.total)]
    ...
    def Get(self) -> GithubSearchResult | None:
        ...
        self.rl.Take()
        url = self.repos.get_page(page)[0].download_url
...
class Github():
    def __init__(self, token:str, ratelimit:str="30/m"):
        ...
        # 每页搜索结果就1个, 就不需要遍历每页的条目了, 测试不影响结果数量, 都是1000个
        self.g.per_page = 1 
