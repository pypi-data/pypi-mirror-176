...
- y (string; optional):
    ...
    _type = 'FeFuncA'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, amplitude=Component.UNDEFINED, exponent=Component.UNDEFINED, intercept=Component.UNDEFINED, tableValues=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'amplitude', 'aria-*', 'className', 'data-*', 'exponent', 'intercept', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'role', 'style', 'tableValues', 'transform', 'x', 'y']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'amplitude', 'aria-*', 'className', 'data-*', 'exponent', 'intercept', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'role', 'style', 'tableValues', 'transform', 'x', 'y']
