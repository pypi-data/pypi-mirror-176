...
- y (string; optional):
    ...
    _type = 'FeDropShadow'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, colorInterpolationFilters=Component.UNDEFINED, dx=Component.UNDEFINED, dy=Component.UNDEFINED, floodColor=Component.UNDEFINED, floodOpacity=Component.UNDEFINED, height=Component.UNDEFINED, result=Component.UNDEFINED, width=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'aria-*', 'className', 'colorInterpolationFilters', 'data-*', 'dx', 'dy', 'floodColor', 'floodOpacity', 'height', 'in', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'result', 'role', 'style', 'transform', 'width', 'x', 'y']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'aria-*', 'className', 'colorInterpolationFilters', 'data-*', 'dx', 'dy', 'floodColor', 'floodOpacity', 'height', 'in', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'result', 'role', 'style', 'transform', 'width', 'x', 'y']
