...
- baseFrequency (string | number; optional):
    ...
    values are forbidden.BCD tables only load  in the browser with
...
- numOctaves (string | number; optional):
    ...
    Negative values are forbidden.BCD  tables only load in the browser
...
- stitchTiles (string | number; optional):
    ...
    first  octave.BCD tables only load in the browser with JavaScript
    enabled. Enable JavaScript to view data.Last modified:  May 13,
    2022, by MDN contributors.
...
- y (string; optional):
    ...
    _type = 'FeTurbulence'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, baseFrequency=Component.UNDEFINED, colorInterpolationFilters=Component.UNDEFINED, height=Component.UNDEFINED, numOctaves=Component.UNDEFINED, result=Component.UNDEFINED, seed=Component.UNDEFINED, stitchTiles=Component.UNDEFINED, width=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'aria-*', 'baseFrequency', 'className', 'colorInterpolationFilters', 'data-*', 'height', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'numOctaves', 'result', 'role', 'seed', 'stitchTiles', 'style', 'transform', 'width', 'x', 'y']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'aria-*', 'baseFrequency', 'className', 'colorInterpolationFilters', 'data-*', 'height', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'numOctaves', 'result', 'role', 'seed', 'stitchTiles', 'style', 'transform', 'width', 'x', 'y']
