...
- clipRule (string | number; optional):
    ...
    data.Last modified: May 17, 2022, by  MDN contributors.
...
- d (string; optional):
    ...
    is a list of path commands where each command is composed  of a
    command letter and numbers that represent the command  parameters.
    The commands are detailed below. You can  use this attribute with
    the following SVG elements: <path>,  <glyph>, <missing-glyph>.d is
    a presentation attribute,  and hence can also be used as a CSS
    property.For <path>,  d is a string containing a series of path
    commands that  define the path to be drawn.Warning: As of SVG2
    <glyph>  is deprecated and shouldn't be used.For <glyph>, d is  a
    string containing a series of path commands that define  the
    outline shape of the glyph.Note: The point of origin  (the
    coordinate 0,0) is usually the upper left corner  of the context.
    However the <glyph> element has its origin  in the bottom left
    corner of its letterbox.Warning: As  of SVG2 <missing-glyph> is
    deprecated and shouldn't be  used.For <missing-glyph>, d is a
    string containing a series  of path commands that define the
    outline shape of the  glyph.   d is a presentation attribute, and
    hence can  be also be modified using CSS.   The property takes
    either  path() or none.    The example below shows how you might
    apply a new path on hover over an element.   The new path  is the
    same as the old one, but adds a line across the  heart. Path
    commands are instructions that define a path  to be drawn. Each
    command is composed of a command letter  and numbers that
    represent the command parameters.SVG  defines 6 types of path
    commands, for a total of 20 commands:Note:  Commands are
    case-sensitive. An upper-case command specifies  absolute
    coordinates, while a lower-case command specifies  coordinates
    relative to the current position.It is always  possible to specify
    a negative value as an argument to  a command:MoveTo instructions
    can be thought of as picking  up the drawing instrument, and
    setting it down somewhere  else—in other words, moving the current
    point (Po; {xo,  yo}). There is no line drawn between Po and the
    new current  point (Pn; {xn, yn}).           Move the current
    point  to the coordinate           x,y. Any subsequent coordinate
    pair(s) are interpreted as parameter(s)           for  implicit
    absolute LineTo (L) command(s) (see below).          Formula: Pn =
    {x, y}           Move the current  point by shifting the last
    known position of            the path by dx along the x-axis and
    by           dy along  the y-axis. Any subsequent coordinate
    pair(s)  are interpreted as parameter(s) for implicit relative
    LineTo           (l) command(s) (see below).
    ...
    just being placed at the same coordinates.BCD tables only  load in
    the browser with JavaScript enabled. Enable JavaScript  to view
    data.Last modified: May 15, 2022, by MDN contributors.
...
- y (string; optional):
    ...
    _type = 'Path'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, clipPath=Component.UNDEFINED, colorInterpolation=Component.UNDEFINED, d=Component.UNDEFINED, fill=Component.UNDEFINED, fillOpacity=Component.UNDEFINED, fillRule=Component.UNDEFINED, markerEnd=Component.UNDEFINED, markerMid=Component.UNDEFINED, markerStart=Component.UNDEFINED, mask=Component.UNDEFINED, opacity=Component.UNDEFINED, paintOrder=Component.UNDEFINED, pathLength=Component.UNDEFINED, pointerEvents=Component.UNDEFINED, requiredFeatures=Component.UNDEFINED, shapeRendering=Component.UNDEFINED, stroke=Component.UNDEFINED, strokeDasharray=Component.UNDEFINED, strokeDashoffset=Component.UNDEFINED, strokeLinecap=Component.UNDEFINED, strokeLinejoin=Component.UNDEFINED, strokeMiterlimit=Component.UNDEFINED, strokeOpacity=Component.UNDEFINED, strokeWidth=Component.UNDEFINED, systemLanguage=Component.UNDEFINED, vectorEffect=Component.UNDEFINED, visibility=Component.UNDEFINED, clipRule=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
