...
- y (string; optional):
    ...
    _type = 'G'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, clipPath=Component.UNDEFINED, colorInterpolation=Component.UNDEFINED, enableBackground=Component.UNDEFINED, mask=Component.UNDEFINED, opacity=Component.UNDEFINED, pointerEvents=Component.UNDEFINED, requiredFeatures=Component.UNDEFINED, systemLanguage=Component.UNDEFINED, fill=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'aria-*', 'className', 'clipPath', 'colorInterpolation', 'data-*', 'enableBackground', 'fill', 'key', 'loading_state', 'mask', 'n_clicks', 'n_clicks_timestamp', 'opacity', 'pointerEvents', 'requiredFeatures', 'role', 'style', 'systemLanguage', 'transform', 'x', 'y']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'aria-*', 'className', 'clipPath', 'colorInterpolation', 'data-*', 'enableBackground', 'fill', 'key', 'loading_state', 'mask', 'n_clicks', 'n_clicks_timestamp', 'opacity', 'pointerEvents', 'requiredFeatures', 'role', 'style', 'systemLanguage', 'transform', 'x', 'y']
