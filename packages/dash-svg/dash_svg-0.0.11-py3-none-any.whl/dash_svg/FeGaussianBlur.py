...
- stdDeviation (string | number; optional):
    ...
    has a non-zero value.BCD tables only load in the browser  with
...
- y (string; optional):
    ...
    _namespace = 'dash_svg'
    _type = 'FeGaussianBlur'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, role=Component.UNDEFINED, colorInterpolationFilters=Component.UNDEFINED, edgeMode=Component.UNDEFINED, height=Component.UNDEFINED, result=Component.UNDEFINED, stdDeviation=Component.UNDEFINED, width=Component.UNDEFINED, x=Component.UNDEFINED, y=Component.UNDEFINED, className=Component.UNDEFINED, transform=Component.UNDEFINED, style=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'aria-*', 'className', 'colorInterpolationFilters', 'data-*', 'edgeMode', 'height', 'in', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'result', 'role', 'stdDeviation', 'style', 'transform', 'width', 'x', 'y']
        self._valid_wildcard_attributes =            ['data-', 'aria-']
        self.available_properties = ['children', 'id', 'aria-*', 'className', 'colorInterpolationFilters', 'data-*', 'edgeMode', 'height', 'in', 'key', 'loading_state', 'n_clicks', 'n_clicks_timestamp', 'result', 'role', 'stdDeviation', 'style', 'transform', 'width', 'x', 'y']
