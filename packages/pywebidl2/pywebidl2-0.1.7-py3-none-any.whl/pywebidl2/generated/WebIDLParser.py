...
class WebIDLParser ( Parser ):
    ...
    def webIDL(self):
        ...
        try:
            ...
            if ((_la) & ~0x3f) == 0 and ((1 << _la) & 18085871630680192) != 0 or _la==67 or _la==89:
                self.state = 176
                self.definitions()
    ...
    def definitions(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (((_la) & ~0x3f) == 0 and ((1 << _la) & 18085871630680192) != 0 or _la==67 or _la==89):
                    break
    ...
    def interfaceRest(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & -320302456595021664) != 0 or (((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & 34078707) != 0:
                self.state = 215
    ...
    def partialInterfaceRest(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & -320302456729239392) != 0 or (((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & 34078707) != 0:
                self.state = 234
    ...
    def interfaceMember(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [5, 19, 20, 21, 22, 23, 24, 26, 28, 30, 31, 34, 35, 36, 39, 41, 42, 43, 49, 50, 51, 55, 56, 57, 59, 60, 61, 62, 63, 64, 65, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 1)
                self.state = 248
    ...
    def mixinRest(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & 5444293452443943072) != 0 or (((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & 34078707) != 0:
                self.state = 275
                self.mixinMembers()
                self.state = 280
                self._errHandler.sync(self)
    ...
    def mixinMember(self):
        ...
        try:
            ...
            if token in [26]:
                ...
                self.const_()
                pass
            elif token in [5, 19, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 57, 59, 62, 65, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 2)
                self.state = 290
    ...
    def callbackRestOrInterface(self):
        ...
        try:
            ...
            if token in [89]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while ((_la) & ~0x3f) == 0 and ((1 << _la) & 5372235858403917984) != 0 or (((_la - 65)) & ~0x3f) == 0 and ((1 << (_la - 65)) & 17039353) != 0:
                    self.state = 307
    ...
    def defaultValue(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [33, 37, 44, 47, 66, 83, 84]:
                self.enterOuterAlt(localctx, 1)
                self.state = 360
                self.constValue()
                pass
    ...
    def operation(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if ((_la) & ~0x3f) == 0 and ((1 << _la) & 2305843078201606144) != 0:
                self.state = 369
                localctx.special = self._input.LT(1)
                _la = self._input.LA(1)
                if not(((_la) & ~0x3f) == 0 and ((1 << _la) & 2305843078201606144) != 0):
    ...
    def operationRest(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if ((_la) & ~0x3f) == 0 and ((1 << _la) & 5376739457964179616) != 0 or (((_la - 65)) & ~0x3f) == 0 and ((1 << (_la - 65)) & 17039289) != 0:
                self.state = 381
                self.argumentList()
    ...
    def argumentRest(self):
        ...
        try:
            ...
            if token in [52]:
                ...
                pass
            elif token in [5, 19, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 57, 59, 62, 65, 68, 69, 70, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 2)
                self.state = 412
                self.type_()
                self.state = 414
    ...
    def argumentName(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [20, 21, 25, 26, 27, 28, 29, 32, 36, 38, 39, 40, 41, 43, 45, 46, 54, 56, 58, 60, 61, 63, 64, 67, 68]:
                self.enterOuterAlt(localctx, 1)
                self.state = 420
    ...
    def stringifier(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [5, 19, 21, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 56, 57, 59, 62, 65, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.state = 433
    ...
    def namespace(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & 5444293452374737056) != 0 or (((_la - 65)) & ~0x3f) == 0 and ((1 << (_la - 65)) & 17039353) != 0:
                self.state = 516
    ...
    def namespaceMember(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [5, 19, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 57, 59, 62, 65, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 1)
                self.state = 530
                self.regularOperation()
                pass
    ...
    def dictionary(self):
        ...
        try:
            ...
            if token in [29]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while ((_la) & ~0x3f) == 0 and ((1 << _la) & 5660466234488520864) != 0 or (((_la - 65)) & ~0x3f) == 0 and ((1 << (_la - 65)) & 17039289) != 0:
                    self.state = 541
    ...
    def type_(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [19, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 57, 59, 62, 65, 68, 69, 70, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 1)
                self.state = 616
                self.singleType()
                pass
    ...
    def returnType(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [5, 19, 22, 23, 24, 30, 31, 34, 35, 42, 49, 50, 51, 55, 57, 59, 62, 65, 68, 69, 70, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 1)
                self.state = 673
                self.type_()
                pass
    ...
    def singleType(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [22, 23, 24, 30, 31, 34, 42, 49, 51, 57, 62, 65, 68, 69, 70, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 89]:
                self.enterOuterAlt(localctx, 1)
                self.state = 677
    ...
    def genericType(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not(((_la) & ~0x3f) == 0 and ((1 << _la) & 577586686570004480) != 0):
    ...
    def distinguishableType(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [22, 23, 31, 34, 42, 51, 62, 68, 69]:
                self.enterOuterAlt(localctx, 1)
                self.state = 724
                self.primitiveType()
                pass
            elif token in [24, 30, 70]:
                self.enterOuterAlt(localctx, 2)
                self.state = 725
                self.stringType()
                pass
            elif token in [72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82]:
                self.enterOuterAlt(localctx, 3)
                self.state = 726
    ...
    def primitiveType(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [42, 62, 69]:
                self.enterOuterAlt(localctx, 1)
                self.state = 733
                self.unsignedIntegerType()
                pass
            elif token in [31, 34, 68]:
                self.enterOuterAlt(localctx, 2)
                self.state = 734
    ...
    def stringType(self):
        ...
        try:
            ...
            self.state = 775
            _la = self._input.LA(1)
            if not((((_la - 24)) & ~0x3f) == 0 and ((1 << (_la - 24)) & 70368744177729) != 0):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def bufferRelatedType(self):
        ...
        try:
            ...
            self.state = 777
            _la = self._input.LA(1)
            if not((((_la - 72)) & ~0x3f) == 0 and ((1 << (_la - 72)) & 2047) != 0):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def floatLiteral(self):
        ...
        try:
            ...
            self.state = 781
            _la = self._input.LA(1)
            if not((((_la - 37)) & ~0x3f) == 0 and ((1 << (_la - 37)) & 140737488356481) != 0):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def other(self):
        ...
        try:
            ...
            if token in [83]:
                ...
                self.match(WebIDLParser.VOID)
                pass
            elif token in [20, 21, 25, 26, 27, 28, 29, 32, 36, 38, 39, 40, 41, 43, 45, 46, 54, 56, 58, 60, 61, 63, 64, 67, 68]:
    ...
    def argumentNameKeyword(self):
        ...
        try:
            ...
            self.state = 831
            _la = self._input.LA(1)
            if not((((_la - 20)) & ~0x3f) == 0 and ((1 << (_la - 20)) & 452260169323491) != 0):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
