...
from hestia_earth.models.hyde32.landTransformationFromForest100YearAverage import MODEL, run, _should_run

class_path = f"hestia_earth.models.{MODEL}.landTransformationFromForest100YearAverage"
fixtures_folder = f"{fixtures_path}/{MODEL}/landTransformationFromForest100YearAverage"
