...
from hestia_earth.models.hyde32.landTransformationFromPermanentPasture20YearAverage import MODEL, run, _should_run

class_path = f"hestia_earth.models.{MODEL}.landTransformationFromPermanentPasture20YearAverage"
fixtures_folder = f"{fixtures_path}/{MODEL}/landTransformationFromPermanentPasture20YearAverage"
