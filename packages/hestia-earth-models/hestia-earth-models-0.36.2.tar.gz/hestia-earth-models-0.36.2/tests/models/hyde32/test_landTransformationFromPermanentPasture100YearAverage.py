...
from hestia_earth.models.hyde32.landTransformationFromPermanentPasture100YearAverage import MODEL, run, _should_run

class_path = f"hestia_earth.models.{MODEL}.landTransformationFromPermanentPasture100YearAverage"
fixtures_folder = f"{fixtures_path}/{MODEL}/landTransformationFromPermanentPasture100YearAverage"
