                                ...
                                form.serialize(),
                                    function (results) {
                                        ...
                                        if (results === undefined || results === null) {
                                            message = '<i class="fas fa-times inline-icon-left"></i> Unknown error';
                                            self.flash_error('Tweet not posted due to unknown error.');
                                        }
                                        else if (!results.success) {
                                            message = '<i class="fas fa-times inline-icon-left"></i> Not posted: ' + results.reason;
                                            self.flash_error('Tweet not posted! Error message: "' + results.reason + '".<br>Your tweet: "' + results.tweet + '".');
                                        }
                                        else {
                                            message = '<i class="fas fa-check inline-icon-left"></i> Posted: ' + results.tweet;
