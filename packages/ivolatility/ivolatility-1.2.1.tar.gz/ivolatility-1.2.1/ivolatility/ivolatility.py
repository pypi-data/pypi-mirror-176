...
def setMethod(endpoint):
	...
	def requestMarketData(params):
		...
		if req.status_code in [200, 400]:
			...
			exceptionEndpoints = ['/proxy/option-series', '/futures/prices/options', '/futures/market-structure', '/equities/option-series', '/futures/rt/single-fut-opt-rawiv','/futures/fut-opt-market-structure']
