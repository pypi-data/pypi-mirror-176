...
const EmptyPlatformSpecificPipeline = ({ onOpenCatalog, onOpenSettings }) => {
    ...
    const customComponentsHelpTopicURL = 'https://elyra.readthedocs.io/en/v3.13.0rc0/user_guide/pipeline-components.html';
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(ui_components_1.dragDropIcon.react, { className: "drag-drop-icon", tag: "div", elementPosition: "center", height: "120px" }),
        react_1.default.createElement("h3", { className: HEADER_CLASS },
...
const pipeline_services_1 = __webpack_require__(/*! @elyra/pipeline-services */ "webpack/sharing/consume/default/@elyra/pipeline-services/@elyra/pipeline-services?78d7");
...
const PipelineWrapper = ({ context, browserFactory, shell, commands, addFileToPipelineSignal, refreshPaletteSignal, settings, widgetId }) => {
                        ...
                        if (migrationError instanceof pipeline_services_1.ComponentNotFoundError) {
                            apputils_1.showDialog({
                                ...
                                body: (react_1.default.createElement("p", null,
                                    ...
                                    ' ',
                                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v3.13.0rc0/user_guide/pipeline-components.html#example-custom-components", target: "_blank", rel: "noreferrer" }, "Example Custom Components"),
                                    ' ',
                                    "and try again.")),
        ...
        if (!componentId) {
            ...
            return apputils_1.showDialog({
                ...
                body: (react_1.default.createElement("p", null,
                    ...
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v3.13.0rc0/user_guide/best-practices-custom-pipeline-components.html#troubleshooting-missing-pipeline-components", target: "_blank", rel: "noreferrer" }, "Learn more..."))),
                buttons: [apputils_1.Dialog.okButton()]
            });
        }
    ...
    const handleSubmission = react_1.useCallback((actionType) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Runtime info
        pipelineJson.pipelines[0].app_data.runtime_config = (_k = configDetails === null || configDetails === void 0 ? void 0 : configDetails.id) !== null && _k !== void 0 ? _k : null;
        // Export info
...
//# sourceMappingURL=lib_index_js.b39ef68325db17e9b0aa.js.map