...
function c_list(){
  $("#c-table").tabulator({columns:[
    ...
    {title:"简介", field:"col", sorter:"string", sortable:false, width:'50%'},
    {title:"操作", field:"cheese", sortable:true,align:'center',width:'20%'},
    ],
    height:'300px',
    }
    )
  $("#c-table").tabulator("setData",[
    ...
    {id:8, name:"调用百度AI",  col:"调用被百度AI进行图像识别",cheese:ce('8')},
    {id:9, name:"调用百度AI_2",  col:"调用被百度AI进行语音识别",cheese:ce('9')},
    {id:10, name:"调用百度AI_3",  col:"调用被百度AI进行语音合成",cheese:ce('10')},
    {id:11, name:"MediaPipe-1", col:"使用MediaPipe进行人脸检测",cheese:ce('11')},
    {id:12, name:"MediaPipe-2",  col:"使用MediaPipe进行面网",cheese:ce('12')},
    {id:13, name:"MediaPipe-3",  col:"使用MediaPipe进行手部检测",cheese:ce('13')},
    {id:14, name:"MediaPipe-4",  col:"使用MediaPipe进行人体姿态检测",cheese:ce('14')},
    {id:15, name:"目标识别",  col:"进行模型推理、目标识别",cheese:ce('15')},
    {id:16, name:"图像分类",  col:"进行模型推理、图像分类",cheese:ce('16')},
...
function model_list(){
  $("#model-table").tabulator({columns:[
    ...
    {title:"简介", field:"info", sorter:"string", sortable:false, width:'20%'},
    {title:"类型", field:"star", sortable:true,width:'15%'},
    {title:"文件大小(M)", field:"file_size", sortable:true,width:'15%'},
    {title:"上传时间", field:"publish", sortable:true,width:'15%'},
    {title:"发布人", field:"people", sortable:true,width:'10%'},
