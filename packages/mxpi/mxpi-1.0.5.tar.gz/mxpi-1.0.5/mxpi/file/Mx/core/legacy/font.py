...
CP437_FONT,ATARI_FONT,LCD_FONT,SEG7_FONT,SINCLAIR_FONT,,SPECCY_FONT,TINY_FONT,UKR_FONT
+-------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
| Font name         | Notes                                           | Source                                                                                         |
+===================+=================================================+================================================================================================+
| ``ATARI_FONT``    | Designed for a terminal emulator written for    | http://gnu.ethz.ch/linuks.mine.nu/atari/                                                       |
|                   | an Atari 800.                                   |                                                                                                |
+-------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
...
#: Bit patterns for SEG7_FONT,
#: source: https://www.dafont.com/digital-7.font,
#: transposed by Jonathan Pereira.
#:
#: NOTE: Only contains characters 0x41 - 0x5A & 0x30 - 0x39 inclusive.
#: All others will appear as blanks
SEG7_FONT = [
    [0x00, 0x00, 0x00, 0x00],  # 0x00
    [0x00, 0x00, 0x00, 0x00],  # 0x01
    ...
    [0x00, 0x00, 0x00, 0x00],  # '?'
    [0x00, 0x00, 0x00, 0x00],  # '@'
    [0xFE, 0x12, 0xFE, 0x00],  # 'A'
    [0xFE, 0x92, 0xFE, 0x00],  # 'B'
    [0xFE, 0x82, 0x82, 0x00],  # 'C'
    [0xFE, 0x82, 0x7C, 0x00],  # 'D'
    [0xFE, 0x92, 0x92, 0x00],  # 'E'
    [0xFE, 0x12, 0x12, 0x00],  # 'F'
    [0xFE, 0x82, 0xE2, 0x00],  # 'G'
    [0xFE, 0x10, 0xFE, 0x00],  # 'H'
    [0x82, 0xFE, 0x82, 0x00],  # 'I'
    [0x82, 0xFE, 0x02, 0x00],  # 'J'
    [0xFE, 0x10, 0xE8, 0x00],  # 'K'
    [0xFE, 0x80, 0x80, 0x00],  # 'L'
    [0xFE, 0x0E, 0xFE, 0x00],  # 'M'
    [0xFE, 0x02, 0xFE, 0x00],  # 'N'
    [0xFE, 0x82, 0xFE, 0x00],  # 'O'
    [0xFE, 0x12, 0x1E, 0x00],  # 'P'
    [0x7E, 0x42, 0xFE, 0x00],  # 'Q'
    [0xFE, 0x12, 0xEE, 0x00],  # 'R'
    [0x9E, 0x92, 0xF2, 0x00],  # 'S'
    [0x02, 0xFE, 0x02, 0x00],  # 'T'
    [0xFE, 0x80, 0xFE, 0x00],  # 'U'
    [0x7E, 0x80, 0x7E, 0x00],  # 'V'
    [0xFE, 0xE0, 0xFE, 0x00],  # 'W'
    [0xEE, 0x10, 0xEE, 0x00],  # 'X'
    [0x0E, 0xF0, 0x0E, 0x00],  # 'Y'
    [0xE2, 0x92, 0x8E, 0x00],  # 'Z'
    [0x00, 0x00, 0x00, 0x00],  # '['
    [0x00, 0x00, 0x00, 0x00],  # '\'
    [0x00, 0x00, 0x00, 0x00],  # ']'
    [0x00, 0x00, 0x00, 0x00],  # '^'
...
SPECCY_FONT = [
    ...
    [0x00, 0x00, 0x3C, 0x24, 0x7E, 0x24, 0x24, 0x00],  # ¢
    [0x00, 0x48, 0x7C, 0x4A, 0x4A, 0x42, 0x44, 0x00],  # £
    [0x00, 0x00, 0x44, 0x38, 0x28, 0x38, 0x44, 0x00],  # ¤
    [0x02, 0x14, 0x18, 0x70, 0x18, 0x14, 0x02, 0x00],  # ¥
    [0x00, 0x00, 0x00, 0x00, 0x66, 0x00, 0x00, 0x00],  # ¦
    [0x00, 0x00, 0x14, 0xAA, 0xAA, 0x50, 0x00, 0x00],  # §
    [0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00],  # ¨
    [0x3C, 0x42, 0x99, 0xA5, 0xA5, 0x81, 0x42, 0x3C],  # ©
    [0x00, 0x00, 0x24, 0x2B, 0x2B, 0x2E, 0x00, 0x00],  # ª
    [0x00, 0x10, 0x28, 0x44, 0x10, 0x28, 0x44, 0x00],  # «
    [0x00, 0x00, 0x08, 0x08, 0x08, 0x08, 0x38, 0x00],  # ¬
    [0x00, 0x00, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00],  # ­
    [0x3C, 0x42, 0xBD, 0x95, 0x95, 0xA9, 0x42, 0x3C],  # ®
    [0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01],  # ¯
    [0x00, 0x00, 0x04, 0x0A, 0x0A, 0x04, 0x00, 0x00],  # °
    [0x00, 0x00, 0x48, 0x48, 0x7E, 0x48, 0x48, 0x00],  # ±
    [0x00, 0x00, 0x00, 0x09, 0x0D, 0x0A, 0x00, 0x00],  # ²
    [0x00, 0x00, 0x00, 0x09, 0x0B, 0x06, 0x00, 0x00],  # ³
    [0x00, 0x00, 0x00, 0x04, 0x02, 0x00, 0x00, 0x00],  # ´
    [0x00, 0xFC, 0x40, 0x40, 0x40, 0x3C, 0x40, 0x00],  # µ
    [0x00, 0x0C, 0x12, 0x12, 0x7E, 0x12, 0x7E, 0x00],  # ¶
    [0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00],  # ·
    [0x00, 0x00, 0x00, 0x80, 0x60, 0x00, 0x00, 0x00],  # ¸
    [0x00, 0x00, 0x00, 0x0A, 0x0F, 0x08, 0x00, 0x00],  # ¹
    [0x00, 0x00, 0x26, 0x29, 0x29, 0x26, 0x00, 0x00],  # º
    [0x00, 0x44, 0x28, 0x10, 0x44, 0x28, 0x10, 0x00],  # »
    [0x00, 0x4E, 0x20, 0x10, 0x08, 0x34, 0x62, 0x00],  # ¼
    [0x00, 0x4E, 0x20, 0x10, 0x08, 0x54, 0x52, 0x00],  # ½
    [0x00, 0x4A, 0x2E, 0x10, 0x08, 0x34, 0x62, 0x00],  # ¾
    [0x00, 0x30, 0x48, 0x45, 0x40, 0x40, 0x20, 0x00],  # ¿
    [0x00, 0x78, 0x14, 0x15, 0x16, 0x14, 0x78, 0x00],  # À
    [0x00, 0x78, 0x14, 0x16, 0x15, 0x14, 0x78, 0x00],  # Á
    [0x00, 0x78, 0x16, 0x15, 0x15, 0x16, 0x78, 0x00],  # Â
    [0x00, 0x78, 0x15, 0x15, 0x15, 0x15, 0x78, 0x00],  # Ã
    [0x00, 0x78, 0x15, 0x14, 0x14, 0x15, 0x78, 0x00],  # Ä
    [0x00, 0x78, 0x16, 0x15, 0x15, 0x16, 0x78, 0x00],  # Å
    [0x7C, 0x12, 0x12, 0x7E, 0x4A, 0x4A, 0x42, 0x00],  # Æ
    [0x00, 0x3C, 0x42, 0xC2, 0x62, 0x42, 0x24, 0x00],  # Ç
    [0x00, 0x7C, 0x54, 0x55, 0x56, 0x54, 0x44, 0x00],  # È
    [0x00, 0x7C, 0x54, 0x56, 0x55, 0x54, 0x44, 0x00],  # É
    [0x00, 0x7C, 0x56, 0x55, 0x55, 0x56, 0x44, 0x00],  # Ê
    [0x00, 0x7C, 0x55, 0x54, 0x54, 0x55, 0x44, 0x00],  # Ë
    [0x00, 0x00, 0x44, 0x45, 0x7E, 0x44, 0x44, 0x00],  # Ì
    [0x00, 0x00, 0x44, 0x44, 0x7E, 0x45, 0x44, 0x00],  # Í
    [0x00, 0x00, 0x44, 0x46, 0x7D, 0x46, 0x44, 0x00],  # Î
    [0x00, 0x00, 0x44, 0x45, 0x7C, 0x45, 0x44, 0x00],  # Ï
    [0x00, 0x08, 0x7E, 0x4A, 0x42, 0x24, 0x18, 0x00],  # Ð
    [0x00, 0x7C, 0x05, 0x09, 0x11, 0x21, 0x7C, 0x00],  # Ñ
    [0x00, 0x38, 0x44, 0x45, 0x46, 0x44, 0x38, 0x00],  # Ò
    [0x00, 0x38, 0x44, 0x46, 0x45, 0x44, 0x38, 0x00],  # Ó
    [0x00, 0x38, 0x46, 0x45, 0x45, 0x46, 0x38, 0x00],  # Ô
    [0x00, 0x38, 0x45, 0x45, 0x45, 0x45, 0x38, 0x00],  # Õ
    [0x00, 0x38, 0x45, 0x44, 0x44, 0x45, 0x38, 0x00],  # Ö
    [0x00, 0x00, 0x44, 0x28, 0x10, 0x28, 0x44, 0x00],  # ×
    [0x00, 0x7C, 0x62, 0x52, 0x4A, 0x46, 0x3E, 0x00],  # Ø
    [0x00, 0x3C, 0x41, 0x42, 0x40, 0x3C, 0x00, 0x00],  # Ù
    [0x00, 0x3C, 0x40, 0x42, 0x41, 0x3C, 0x00, 0x00],  # Ú
    [0x00, 0x3C, 0x42, 0x41, 0x42, 0x3C, 0x00, 0x00],  # Û
    [0x00, 0x3D, 0x40, 0x40, 0x40, 0x3D, 0x00, 0x00],  # Ü
    [0x00, 0x04, 0x08, 0x72, 0x09, 0x04, 0x00, 0x00],  # Ý
    [0x00, 0x7E, 0x24, 0x24, 0x24, 0x24, 0x18, 0x00],  # Þ
    [0x00, 0x00, 0x7C, 0x02, 0x4A, 0x4A, 0x34, 0x00],  # ß
    [0x00, 0x20, 0x55, 0x56, 0x54, 0x78, 0x00, 0x00],  # à
    [0x00, 0x20, 0x54, 0x56, 0x55, 0x78, 0x00, 0x00],  # á
    [0x00, 0x20, 0x56, 0x55, 0x56, 0x78, 0x00, 0x00],  # â
    [0x00, 0x20, 0x55, 0x55, 0x55, 0x78, 0x00, 0x00],  # ã
    [0x00, 0x20, 0x55, 0x54, 0x55, 0x78, 0x00, 0x00],  # ä
    [0x00, 0x20, 0x56, 0x55, 0x56, 0x78, 0x00, 0x00],  # å
    [0x20, 0x54, 0x54, 0x78, 0x54, 0x54, 0x48, 0x00],  # æ
    [0x00, 0x38, 0x44, 0xC4, 0x64, 0x44, 0x00, 0x00],  # ç
    [0x00, 0x38, 0x55, 0x56, 0x54, 0x48, 0x00, 0x00],  # è
    [0x00, 0x38, 0x54, 0x56, 0x55, 0x48, 0x00, 0x00],  # é
    [0x00, 0x38, 0x56, 0x55, 0x56, 0x48, 0x00, 0x00],  # ê
    [0x00, 0x38, 0x55, 0x54, 0x55, 0x48, 0x00, 0x00],  # ë
    [0x00, 0x00, 0x49, 0x7A, 0x40, 0x00, 0x00, 0x00],  # ì
    [0x00, 0x00, 0x48, 0x7A, 0x41, 0x00, 0x00, 0x00],  # í
    [0x00, 0x00, 0x4A, 0x79, 0x42, 0x00, 0x00, 0x00],  # î
    [0x00, 0x00, 0x4A, 0x78, 0x42, 0x00, 0x00, 0x00],  # ï
    [0x00, 0x30, 0x4A, 0x4A, 0x4E, 0x3C, 0x02, 0x00],  # ð
    [0x00, 0x7C, 0x09, 0x05, 0x05, 0x78, 0x00, 0x00],  # ñ
    [0x00, 0x30, 0x49, 0x4A, 0x48, 0x30, 0x00, 0x00],  # ò
    [0x00, 0x30, 0x48, 0x4A, 0x49, 0x30, 0x00, 0x00],  # ó
    [0x00, 0x30, 0x4A, 0x49, 0x4A, 0x30, 0x00, 0x00],  # ô
    [0x00, 0x38, 0x45, 0x45, 0x45, 0x38, 0x00, 0x00],  # õ
    [0x00, 0x39, 0x44, 0x44, 0x44, 0x39, 0x00, 0x00],  # ö
    [0x00, 0x00, 0x10, 0x10, 0x54, 0x10, 0x10, 0x00],  # ÷
    [0x00, 0x78, 0x64, 0x54, 0x4C, 0x3C, 0x00, 0x00],  # ø
    [0x00, 0x38, 0x41, 0x42, 0x40, 0x38, 0x00, 0x00],  # ù
    [0x00, 0x38, 0x40, 0x42, 0x41, 0x38, 0x00, 0x00],  # ú
    [0x00, 0x38, 0x42, 0x41, 0x42, 0x38, 0x00, 0x00],  # û
    [0x00, 0x3A, 0x40, 0x40, 0x40, 0x3A, 0x00, 0x00],  # ü
    [0x00, 0x18, 0xA0, 0xA2, 0xA1, 0x78, 0x00, 0x00],  # ý
    [0x00, 0xFE, 0x28, 0x28, 0x28, 0x10, 0x00, 0x00],   # þ
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
]

#: Bit patterns for ATARI_FONT
#: Designed for a terminal emulator written for an Atari 800.
#: It has only a one pixel descent to maximize pixels available to the main body of each character.
#: Source: http://gnu.ethz.ch/linuks.mine.nu/atari/,
#: transposed by Tiago F. Pimentel (antropoiese).
#:
ATARI_FONT = [
    [0x00, 0x00, 0x00, 0x00, 0x00],  #
    [0x08, 0x1C, 0x3E, 0x1C, 0x00],  #
    [0x00, 0x54, 0xAA, 0x54, 0x00],  #
    [0x00, 0x1F, 0x24, 0xFF, 0x00],  #
    [0x1F, 0x05, 0xF9, 0x28, 0x00],  #
    [0x02, 0x05, 0xF5, 0x50, 0x00],  #
    [0x0F, 0x08, 0xF8, 0x50, 0x00],  #
    [0x00, 0x1E, 0x1E, 0x1E, 0x00],  #
    [0x00, 0x24, 0x2E, 0x24, 0x00],  #
    [0x0F, 0x02, 0xF4, 0x8F, 0x00],
    [0x07, 0x08, 0x17, 0xF0, 0x00],  #
    [0x00, 0x08, 0x08, 0x0F, 0x00],  #
    [0x00, 0x00, 0x00, 0x00, 0x00],  #
    [0x00, 0xF8, 0x08, 0x00, 0x00],  #
    [0x00, 0x0F, 0x08, 0x00, 0x00],  #
    [0x08, 0x08, 0xFF, 0x08, 0x00],  #
    ...
    [0x00, 0x08, 0x08, 0xFF, 0x00],  #
    [0x10, 0x10, 0x1F, 0x10, 0x00],  #
    [0x10, 0x10, 0xF0, 0x10, 0x00],  #
    [0x00, 0x00, 0xFF, 0x00, 0x00],  #
    [0x00, 0x48, 0x54, 0x62, 0x00],  #
    [0x00, 0x62, 0x54, 0x48, 0x00],  #
    [0x02, 0x3E, 0x02, 0x3E, 0x00],  #
    [0x14, 0x34, 0x1C, 0x16, 0x00],  #
    [0x24, 0x7E, 0x15, 0x31, 0x00],  #
    [0x00, 0x00, 0x08, 0x00, 0x00],  #
    [0x00, 0x00, 0x00, 0x00, 0x00],
    [0x00, 0x00, 0x5E, 0x00, 0x00],  # !
    [0x00, 0x06, 0x00, 0x06, 0x00],  # "
    [0x00, 0x7E, 0x24, 0x7E, 0x00],  # #
    [0x00, 0x24, 0xCB, 0x34, 0x00],  # $
    [0x00, 0x62, 0x18, 0x46, 0x00],  # %
    [0x00, 0x3A, 0x65, 0x5A, 0x00],  # &
    ...
    [0x00, 0x3C, 0x4A, 0x3C, 0x00],  # 0
    [0x00, 0x44, 0x7E, 0x40, 0x00],  # 1
    [0x00, 0x64, 0x52, 0x4C, 0x00],  # 2
    [0x00, 0x22, 0x4A, 0x36, 0x00],  # 3
    [0x00, 0x18, 0x14, 0x7E, 0x00],  # 4
    [0x00, 0x2E, 0x4A, 0x32, 0x00],  # 5
    [0x00, 0x3C, 0x4A, 0x32, 0x00],  # 6
    [0x00, 0x02, 0x72, 0x0E, 0x00],  # 7
    [0x00, 0x34, 0x4A, 0x34, 0x00],  # 8
    [0x00, 0x4C, 0x52, 0x3C, 0x00],  # 9
    ...
    [0x00, 0x3C, 0x42, 0x4C, 0x00],  # @
    [0x00, 0x7C, 0x12, 0x7C, 0x00],  # A
    [0x00, 0x7E, 0x4A, 0x34, 0x00],  # B
    [0x00, 0x3C, 0x42, 0x24, 0x00],  # C
    [0x00, 0x7E, 0x42, 0x3C, 0x00],  # D
    [0x00, 0x7E, 0x4A, 0x4A, 0x00],  # E
    [0x00, 0x7E, 0x0A, 0x0A, 0x00],  # F
    [0x00, 0x3C, 0x42, 0x34, 0x00],  # G
    [0x00, 0x7E, 0x08, 0x7E, 0x00],  # H
    [0x00, 0x42, 0x7E, 0x42, 0x00],  # I
    [0x00, 0x20, 0x40, 0x3E, 0x00],  # J
    [0x00, 0x7E, 0x08, 0x76, 0x00],  # K
    [0x00, 0x7E, 0x40, 0x40, 0x00],  # L
    [0x00, 0x7E, 0x04, 0x7E, 0x00],  # M
    [0x00, 0x7C, 0x18, 0x3E, 0x00],  # N
    [0x00, 0x3C, 0x42, 0x3C, 0x00],  # O
    [0x00, 0x7E, 0x12, 0x0C, 0x00],  # P
    [0x00, 0x3C, 0x62, 0x5C, 0x00],  # Q
    [0x00, 0x7E, 0x12, 0x6C, 0x00],  # R
    [0x00, 0x24, 0x4A, 0x34, 0x00],  # S
    [0x00, 0x02, 0x7E, 0x02, 0x00],  # T
    [0x00, 0x7E, 0x40, 0x7E, 0x00],  # U
    [0x00, 0x3E, 0x40, 0x3E, 0x00],  # V
    [0x00, 0x7E, 0x20, 0x7E, 0x00],  # W
    [0x00, 0x76, 0x08, 0x76, 0x00],  # X
    [0x00, 0x06, 0x78, 0x06, 0x00],  # Y
    [0x00, 0x62, 0x5A, 0x46, 0x00],  # Z
    ...
    [0x00, 0x24, 0x54, 0x78, 0x00],  # a
    [0x00, 0x7E, 0x48, 0x30, 0x00],  # b
    [0x00, 0x38, 0x44, 0x44, 0x00],  # c
    [0x00, 0x30, 0x48, 0x7E, 0x00],  # d
    [0x00, 0x38, 0x54, 0x58, 0x00],  # e
    [0x00, 0x08, 0x7C, 0x0A, 0x00],  # f
    [0x00, 0x98, 0xA4, 0x7C, 0x00],  # g
    [0x00, 0x7E, 0x08, 0x70, 0x00],  # h
    [0x00, 0x48, 0x7A, 0x40, 0x00],  # i
    [0x00, 0x80, 0x88, 0x7A, 0x00],  # j
    [0x00, 0x7E, 0x10, 0x68, 0x00],  # k
    [0x00, 0x00, 0x7E, 0x00, 0x00],  # l
    [0x00, 0x7C, 0x08, 0x7C, 0x00],  # m
    [0x00, 0x7C, 0x04, 0x78, 0x00],  # n
    [0x00, 0x38, 0x44, 0x38, 0x00],  # o
    [0x00, 0xFC, 0x24, 0x18, 0x00],  # p
    [0x00, 0x18, 0x24, 0xFC, 0x00],  # q
    [0x00, 0x78, 0x04, 0x04, 0x00],  # r
    [0x00, 0x48, 0x54, 0x24, 0x00],  # s
    [0x00, 0x08, 0x7E, 0x08, 0x00],  # t
    [0x00, 0x7C, 0x40, 0x7C, 0x00],  # u
    [0x00, 0x3C, 0x40, 0x3C, 0x00],  # v
    [0x00, 0x7C, 0x20, 0x7C, 0x00],  # w
    [0x00, 0x6C, 0x10, 0x6C, 0x00],  # x
    [0x00, 0x9C, 0xA0, 0x7C, 0x00],  # y
    ...
    [0x00, 0x38, 0xC6, 0x44, 0x00],  # ¢
    [0x50, 0x7C, 0x4A, 0x22, 0x00],  # £
    [0x00, 0x1C, 0x14, 0x1C, 0x00],  # ¤
    [0x00, 0x2A, 0x7C, 0x2A, 0x00],  # ¥
    [0x00, 0x00, 0x77, 0x00, 0x00],  # ¦
    [0x00, 0x4A, 0x55, 0x29, 0x00],  # §
    [0x00, 0x01, 0x00, 0x01, 0x00],  # ¨
    [0x3E, 0x49, 0x55, 0x3E, 0x00],  # ©
    [0x00, 0x15, 0x13, 0x16, 0x00],  # ª
    [0x10, 0x28, 0x10, 0x28, 0x00],  # «
    [0x00, 0x04, 0x04, 0x0C, 0x00],  # ¬
    [0x00, 0x08, 0x08, 0x08, 0x00],  # ­
    [0x3E, 0x59, 0x45, 0x3E, 0x00],  # ®
    [0x00, 0x01, 0x01, 0x01, 0x00],  # ¯
    [0x00, 0x02, 0x05, 0x02, 0x00],  # °
    [0x00, 0x24, 0x2E, 0x24, 0x00],  # ±
    [0x00, 0x12, 0x1A, 0x14, 0x00],  # ²
    [0x00, 0x12, 0x16, 0x0E, 0x00],  # ³
    [0x00, 0x04, 0x02, 0x00, 0x00],  # ´
    [0x00, 0x7C, 0x20, 0x1C, 0x20],  # µ
    [0x4C, 0x72, 0x7E, 0x42, 0x00],  # ¶
    [0x00, 0x00, 0x10, 0x00, 0x00],  # ·
    [0x00, 0x00, 0xC0, 0x00, 0x00],  # ¸
    [0x00, 0x14, 0x1E, 0x10, 0x00],  # ¹
    [0x00, 0x12, 0x15, 0x12, 0x00],  # º
    [0x28, 0x10, 0x38, 0x10, 0x00],  # »
    [0x00, 0x0B, 0x14, 0x3A, 0x00],  # ¼
    [0x00, 0x0B, 0x3C, 0x3A, 0x00],  # ½
    [0x00, 0x0F, 0x17, 0x3A, 0x00],  # ¾
    [0x00, 0x30, 0x4A, 0x20, 0x00],  # ¿
    [0x00, 0x7D, 0x12, 0x7C, 0x00],  # À
    [0x00, 0x7C, 0x12, 0x7D, 0x00],  # Á
    [0x00, 0x7A, 0x15, 0x7A, 0x00],  # Â
    [0x00, 0x7E, 0x13, 0x7D, 0x00],  # Ã
    [0x00, 0x7D, 0x12, 0x7D, 0x00],  # Ä
    [0x00, 0x7A, 0x15, 0x7A, 0x00],  # Å
    [0x7C, 0x12, 0x7E, 0x4A, 0x00],  # Æ
    [0x00, 0x3C, 0xC2, 0x34, 0x00],  # Ç
    [0x00, 0x7D, 0x56, 0x54, 0x00],  # È
    [0x00, 0x7C, 0x56, 0x55, 0x00],  # É
    [0x00, 0x7E, 0x55, 0x56, 0x00],  # Ê
    [0x00, 0x7D, 0x54, 0x55, 0x00],  # Ë
    [0x00, 0x45, 0x7E, 0x44, 0x00],  # Ì
    [0x00, 0x44, 0x7E, 0x45, 0x00],  # Í
    [0x00, 0x46, 0x7D, 0x46, 0x00],  # Î
    [0x00, 0x45, 0x7C, 0x45, 0x00],  # Ï
    [0x10, 0x7E, 0x4A, 0x3C, 0x00],  # Ð
    [0x00, 0x7D, 0x1B, 0x3E, 0x00],  # Ñ
    [0x00, 0x39, 0x46, 0x38, 0x00],  # Ò
    [0x00, 0x38, 0x46, 0x39, 0x00],  # Ó
    [0x00, 0x3A, 0x45, 0x3A, 0x00],  # Ô
    [0x00, 0x39, 0x47, 0x3A, 0x00],  # Õ
    [0x00, 0x39, 0x44, 0x39, 0x00],  # Ö
    [0x00, 0x28, 0x10, 0x28, 0x00],  # ×
    [0x00, 0xBC, 0x5A, 0x3D, 0x00],  # Ø
    [0x00, 0x7D, 0x42, 0x7C, 0x00],  # Ù
    [0x00, 0x7C, 0x42, 0x7D, 0x00],  # Ú
    [0x00, 0x7A, 0x41, 0x7A, 0x00],  # Û
    [0x00, 0x7D, 0x40, 0x7D, 0x00],  # Ü
    [0x00, 0x0C, 0x72, 0x0D, 0x00],  # Ý
    [0x44, 0x7C, 0x28, 0x10, 0x00],  # Þ
    [0x40, 0x7E, 0x4A, 0x74, 0x00],  # ß
    [0x00, 0x25, 0x56, 0x78, 0x00],  # à
    [0x00, 0x24, 0x56, 0x79, 0x00],  # á
    [0x00, 0x26, 0x55, 0x7A, 0x00],  # â
    [0x00, 0x25, 0x57, 0x7A, 0x00],  # ã
    [0x00, 0x25, 0x54, 0x79, 0x00],  # ä
    [0x00, 0x26, 0x55, 0x7A, 0x00],  # å
    [0x20, 0x54, 0x68, 0x58, 0x00],  # æ
    [0x00, 0x38, 0xC4, 0x44, 0x00],  # ç
    [0x00, 0x38, 0x55, 0x5A, 0x00],  # è
    [0x00, 0x3A, 0x55, 0x58, 0x00],  # é
    [0x00, 0x3A, 0x55, 0x5A, 0x00],  # ê
    [0x00, 0x39, 0x54, 0x59, 0x00],  # ë
    [0x00, 0x49, 0x7A, 0x40, 0x00],  # ì
    [0x00, 0x48, 0x7A, 0x41, 0x00],  # í
    [0x00, 0x4A, 0x79, 0x42, 0x00],  # î
    [0x00, 0x4A, 0x78, 0x42, 0x00],  # ï
    [0x00, 0x3A, 0x47, 0x3D, 0x00],  # ð
    [0x00, 0x7D, 0x07, 0x7A, 0x00],  # ñ
    [0x00, 0x39, 0x46, 0x38, 0x00],  # ò
    [0x00, 0x38, 0x46, 0x39, 0x00],  # ó
    [0x00, 0x3A, 0x45, 0x3A, 0x00],  # ô
    [0x00, 0x39, 0x47, 0x3A, 0x00],  # õ
    ...
    [0x00, 0xB8, 0x54, 0x3A, 0x00],  # ø
    [0x00, 0x7A, 0x44, 0x78, 0x00],  # ù
    [0x00, 0x78, 0x44, 0x7A, 0x00],  # ú
    [0x00, 0x7A, 0x41, 0x7A, 0x00],  # û
    [0x00, 0x7A, 0x40, 0x7A, 0x00],  # ü
    [0x00, 0x9C, 0xA2, 0x7D, 0x00],  # ý
    [0x42, 0x7E, 0x24, 0x18, 0x00],  # þ
    [0x00, 0x00, 0x00, 0x00, 0x00]
]
