...
# Example usage:
#
#   from core.interface.serial import i2c, spi
...
from Mx.core.device import device, parallel_device
from Mx.core.virtual import character
from Mx.oled.device.color import color_device
from Mx.oled.device.greyscale import greyscale_device
import Mx.core.error
from Mx.core.framebuffer import full_frame
from Mx.core.bitmap_font import embedded_fonts
import Mx.oled.const
from Mx.oled.device.framebuffer_mixin import __framebuffer_mixin
...
class sh1106(device):
    ...
    def __init__(self, serial_interface=None, width=128, height=64, rotate=0, **kwargs):
        super(sh1106, self).__init__(Mx.oled.const.sh1106, serial_interface)
        ...
        if settings is None:
            raise Mx.core.error.DeviceDisplayModeError(
...
class ssd1306(device):
    ...
    :param serial_interface: The serial interface (usually a
        :py:class:`core.interface.serial.i2c` instance) to delegate sending
    ...
    def __init__(self, serial_interface=None, width=128, height=64, rotate=0, **kwargs):
        super(ssd1306, self).__init__(Mx.oled.const.ssd1306, serial_interface)
        self.capabilities(width, height, rotate)
...
class ssd1309(ssd1306):
    ...
    :param serial_interface: The serial interface (usually a
        :py:class:`core.interface.serial.spi` instance) to delegate sending
        data and commands through.
    :param width: The number of horizontal pixels (optional, defaults to 128).
    :type width: int
    :param height: The number of vertical pixels (optional, defaults to 64).
...
class ssd1331(color_device):
    ...
    :param serial_interface: The serial interface (usually a
        :py:class:`core.interface.serial.spi` instance) to delegate
...
class ssd1322(greyscale_device):
    ...
    def __init__(self, serial_interface=None, width=256, height=64, rotate=0,
        ...
        super(ssd1322, self).__init__(Mx.oled.const.ssd1322, serial_interface,
...
class ssd1362(greyscale_device):
    ...
    def __init__(self, serial_interface=None, width=256, height=64, rotate=0,
                 mode="RGB", framebuffer=None, **kwargs):
        super(ssd1362, self).__init__(Mx.oled.const.ssd1362, serial_interface,
                                      width, height, rotate, mode, framebuffer,
...
class ssd1322_nhd(greyscale_device):
    ...
    def __init__(self, serial_interface=None, width=128, height=64, rotate=0,
        ...
        super(ssd1322_nhd, self).__init__(Mx.oled.const.ssd1322, serial_interface,
...
class ssd1325(greyscale_device):
    ...
    def __init__(self, serial_interface=None, width=128, height=64, rotate=0,
                 mode="RGB", framebuffer=None, **kwargs):
        super(ssd1325, self).__init__(Mx.core.const.common, serial_interface,
                                      width, height, rotate, mode, framebuffer,
                                      nibble_order=1, **kwargs)
...
class ssd1327(greyscale_device):
    ...
    def __init__(self, serial_interface=None, width=128, height=128, rotate=0,
                 mode="RGB", framebuffer=None, **kwargs):
        super(ssd1327, self).__init__(Mx.core.const.common, serial_interface,
                                      width, height, rotate, mode, framebuffer,
                                      nibble_order=1, **kwargs)
...
class ws0010(parallel_device, character, __framebuffer_mixin):
    ...
    :param serial_interface: The serial interface (usually a
        :py:class:`core.interface.serial.parallel` instance) to delegate sending
        data and commands through.
    ...
    def __init__(self, serial_interface=None, width=100, height=16, undefined='_', font=None,
                 ...
                 const=Mx.oled.const.ws0010, **kwargs):
...
class winstar_weh(ws0010):
    ...
    def __init__(self, serial_interface=None, width=16, height=2, **kwargs):
        super(winstar_weh, self).__init__(const=Mx.oled.const.winstar_weh, serial_interface=serial_interface, width=width * 5, height=height * 8, xwidth=5, **kwargs)
