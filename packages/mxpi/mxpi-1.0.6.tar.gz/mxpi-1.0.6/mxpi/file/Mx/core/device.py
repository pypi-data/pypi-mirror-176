...
from Mx.core import mixin
from Mx.core.util import bytes_to_nibbles
from Mx.core.framebuffer import diff_to_previous
import Mx.core.const
from Mx.core.interface.serial import i2c, noop
...
class device(mixin.capabilities):
    ...
    .. note::
        ...
        :class:`core.render.canvas` context manager.
    """

    def __init__(self, const=None, serial_interface=None):
        self._const = const or core.const.common
...
class linux_framebuffer(device):
    ...
    def __get_display_id(self, device):
        ...
        raise core.error.DeviceNotFoundError(
