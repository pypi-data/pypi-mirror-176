...
function c_list(){
  ...
  $("#c-table").tabulator("setData",[
    ...
    {id:9, name:"调用百度AI",  col:"调用被百度AI进行图像识别",cheese:ce('8')},
    {id:10, name:"调用百度AI_2",  col:"调用被百度AI进行语音识别",cheese:ce('9')},
    {id:11, name:"调用百度AI_3",  col:"调用被百度AI进行语音合成",cheese:ce('10')},
    {id:12, name:"MediaPipe-1", col:"使用MediaPipe进行人脸检测",cheese:ce('11')},
    {id:13, name:"MediaPipe-2",  col:"使用MediaPipe进行面网",cheese:ce('12')},
    {id:14, name:"MediaPipe-3",  col:"使用MediaPipe进行手部检测",cheese:ce('13')},
    {id:15, name:"MediaPipe-3-1",  col:"使用MediaPipe进行手部检测,并连线（由顺德区龙江实验学校张楚彬老师贡献）",cheese:ce('17')},
    {id:16, name:"MediaPipe-4",  col:"使用MediaPipe进行人体姿态检测",cheese:ce('14')},
    {id:17, name:"目标识别",  col:"进行模型推理、目标识别",cheese:ce('15')},
    {id:18, name:"图像分类",  col:"进行模型推理、图像分类",cheese:ce('16')},
  ]);
}
var model_lists
function model_list(){
