...
import cbor2
from Mx.core.util import from_16_to_8, from_8_to_16
...
class bitmap_font():
    ...
    * Font can be initialized from a basic sprite table (with conditions)
    ...
    def load(self, filename):
        ...
        :rtype: :py:class:`core.bitmap_font`
        """
        with open(filename, 'rb') as fp:
            s = fp.readline()
            if s != b'LUMA.CORE.BITMAP_FONT\n':
                raise SyntaxError('Not a core.bitmap_font file')
    ...
    def loads(self, fontdata):
        """
        Load :py:class:`core.bitmap_font` from a string of serialized data produced
        by the ``dumps`` method

        :param fontdata: The serialized font data that will be used to initialize
            the font.  This data is produced by the :py:func:`core.bitmap_font.dumps`
            method.
        :type fontdata: bytes
        :return: a font object
        :rtype: :py:class:`core.bitmap_font`
    ...
    def load_pillow_font(self, file, mappings=None):
        """
        Create :py:class:`core.bitmap_font` from a PIL ImageFont style font.
    ...
    def save(self, filename):
        """
        Write :py:class:`core.bitmap_font` data to a file
        """
    ...
    def _generate_fontdata(self):
        ...
        of a :py:class:`core.bitmap_font`
        """
    ...
    def combine(self, source_font, characters=None, force=False):
        """
        Combine two :py:class:`core.bitmap_font` instances.

        :param source_font: a :py:class:`core.bitmap_font` to copy from
        :type source_font: :py:class:`core.bitmap_font`
...
def load(filename):
    """
    Load a :py:class:`core.bitmap_font` file.  This function creates a
    :py:class:`core.bitmap_font` object from the given :py:class:`core.bitmap_font`
    file, and returns the corresponding font object.

    :param filename: Filename of font file.
    :type filename: str
    :return: A :py:class:`core.bitmap_font` object.
...
def loads(data):
    """
    Load a :py:class:`core.bitmap_font` from a string of serialized data.  This function
    creates a :py:class:`core.bitmap_font` object from serialized data produced from the
    ``dumps`` method and returns the corresponding font object.

    :param data: Serialized :py:class:`core.bitmap_font` data.
    :type data: str
    :return: A :py:class:`core.bitmap_font` object.
    :exception ValueError: If the data does not a valid core.bitmap_font
    """
    f = bitmap_font()
    f.loads(data)
    return f
...
def load_pillow_font(filename, mappings=None):
    """
    Load a PIL font file.  This function creates a core.bitmap_font object
...
def load_sprite_table(sprite_table, index, xwidth, glyph_size, cell_size=None, mappings=None):
    """
    Create a :py:class:`core.bitmap_font` from a sprite table.
...
class embedded_fonts(ImageFont.ImageFont):
    ...
    def combine(self, font, characters=None, force=False):
        ...
        :type font: :py:class:`core.bitmap_font`
