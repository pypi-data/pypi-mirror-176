...
async def present(
    ...
    r"""Creates or modifies the PublicAccessBlock configuration for an Amazon S3 bucket.
...
async def absent(
    ...
    r"""Removes the PublicAccessBlock configuration for an Amazon S3 bucket.
