...
async def present(
    ...
    Args:
        ...
        rollback_configuration(dict, Optional):
            ...
            CloudFormation rolls back the entire stack operation. The key for the Rollback Trigger, Arn (string), is the
            Amazon Resource Name (ARN) of the rollback trigger. If a specified trigger is missing, the entire stack
            operation fails and is rolled back. The value of the Rollback Trigger, Type (string), is resource type of the
