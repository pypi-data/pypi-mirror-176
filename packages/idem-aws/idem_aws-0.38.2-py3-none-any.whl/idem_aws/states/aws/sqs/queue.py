...
async def present(
    ...
    r"""Creates a new standard or FIFO queue.
...
async def absent(hub, ctx, name: str, resource_id: str = None) -> Dict[str, Any]:
    r"""Deletes the queue specified by the QueueUrl, regardless of the queue's contents.
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    r"""Returns a list of your queues in the current region.
