...
def convert_raw_bucket_encryption_to_present(
    ...
    r"""Converts an AWS S3 bucket encryption resource to a common idem present state.
    ...
    Args:
        ...
        idem_resource_name(string, optional):
...
def is_bucket_encryption_configuration_identical(
    ...
    r"""Compares the new and old bucket encryption configurations.
...
def are_bucket_server_side_encryption_rules_identical(
    ...
    r"""Compares the new and old bucket server side encryption rules.
...
async def wait_for_updates(
    ...
    r"""Waits for an AWS S3 bucket encryption configuration to be updated.
...
async def wait_for_delete(
    ...
    r"""Waits for an AWS S3 bucket encryption configuration to be deleted.
