...
def convert_raw_bucket_lifecycle_to_present(
    ...
    r"""Convert an AWS S3 bucket lifecycle resource to a common idem present state.
...
def is_bucket_lifecycle_configuration_identical(
    ...
    r"""Compares the new and old bucket lifecycle configurations.
...
def are_bucket_lifecycle_rules_identical(
    ...
    r"""Compares the new and old bucket lifecycle rules.
...
async def wait_for_updates(
    ...
    r"""Waits for an AWS S3 bucket lifecycle configuration to be updated.
...
async def wait_for_delete(
    ...
    r"""Waits for an AWS S3 bucket lifecycle configuration to be deleted.
