...
async def search(hub, ctx, name, resource_id: str = None):
    """
    Provides details about a specific instance profile as a data-source. This function has been deprecated.
    Please use exec.run with aws.iam.instance_profile.get instead.
    ...
    hub.log.warning(
        f"aws.iam.instance_profile.search '{name}' state has been deprecated. Please use exec.run with aws.iam.instance_profile.get instead."
    )
    result = dict(comment=(), old_state=None, new_state=None, name=name, result=True)
