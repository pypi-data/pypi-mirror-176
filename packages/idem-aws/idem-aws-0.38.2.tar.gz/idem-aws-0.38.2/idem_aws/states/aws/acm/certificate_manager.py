...
async def present(
    ...
    r"""Manage SSL/TLS certificates for your AWS-based websites and applications.
...
async def absent(hub, ctx, name: str, resource_id: str = None) -> Dict[str, Any]:
    r"""Deletes a certificate and its associated private key.
...
def is_pending(hub, ret):
    r"""Reconciliation is_pending plugin for ACM certificates."""
