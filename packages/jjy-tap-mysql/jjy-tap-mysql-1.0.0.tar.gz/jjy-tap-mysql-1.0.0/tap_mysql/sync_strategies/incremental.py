...
def sync_table(mysql_conn, catalog_entry, state, columns, config=None):
    ...
    # singer.write_message(activate_version_message, config=config)
    jjy_custom_singer_write_message(activate_version_message, config=config)
