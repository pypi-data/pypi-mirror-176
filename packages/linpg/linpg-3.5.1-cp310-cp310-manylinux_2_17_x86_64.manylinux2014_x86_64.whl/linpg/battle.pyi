...
class DecorationObject(GameObject2d):
    ...
    def blit(self, _surface: ImageSurface, pos: tuple[int, int], is_dark: bool, alpha: int) -> None: ...
...
class TileMap(Rectangle, SurfaceWithLocalPos):
    ...
    def display_map(self, _surface: ImageSurface, screen_to_move_x: int = ..., screen_to_move_y: int = ...) -> tuple: ...
...
class Entity(Position):
    ...
    def near(self, otherEntity: Union[Position, GameObject2d]) -> bool: ...
    def get_effective_range_coordinates(self, MAP_P: TileMap, ifHalfMode: bool = ...) -> list[list[tuple[int, int]]]: ...
    ...
    def draw(self, _surface: ImageSurface, MAP_P: TileMap, update_id_only: bool = ...) -> None: ...
    def draw_custom(self, action: str, pos: tuple[int, int], _surface: ImageSurface, MAP_P: TileMap, alpha: int = ...) -> None: ...
