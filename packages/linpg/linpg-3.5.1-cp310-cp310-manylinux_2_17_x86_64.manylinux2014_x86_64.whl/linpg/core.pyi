...
class AbstractGameSystem(SystemWithBackgroundMusic, metaclass=ABCMeta):
    folder_for_save_file: Incomplete
    name_for_save_file: Incomplete
    def __init__(self) -> None: ...
    @property
...
class MovableStaticImage(StaticImage):
    def __init__(self, img: PoI, x: int_f, y: int_f, target_x: int_f, target_y: int_f, move_speed_x: int_f, move_speed_y: int_f, width: int_f = ..., height: int_f = ..., tag: str = ...) -> None: ...
...
class VideoSurface(AbstractVideo):
    ...
    @staticmethod
    def get_preview(path: str, size: Optional[tuple[int, int]] = ...) -> ImageSurface: ...
...
class SpriteImage:
    ...
    @classmethod
    def generate(cls, img_folder_path: str, minimize_pixels: bool = ..., resultFileType: str = ...) -> None: ...
