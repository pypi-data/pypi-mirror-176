...
class Draw:
    @staticmethod
    def rect(_surface: ImageSurface, color: tuple[int, int, int, int], rect: PG_TUPLE, thickness: int = ...) -> None: ...
    @staticmethod
...
class Filters:
    @staticmethod
    def glassmorphism_effect(_surface: ImageSurface, _rect: Optional[PG_TUPLE] = ..., whiteness: int = ...) -> ImageSurface: ...
    @staticmethod
...
PG_Sound: Incomplete
PG_Channel: Incomplete
LINPG_RESERVED_BACKGROUND_MUSIC_CHANNEL: Optional[PG_Channel]
LINPG_RESERVED_SOUND_EFFECTS_CHANNEL: Optional[PG_Channel]
LINPG_RESERVED_ENVIRONMENTAL_SOUND_CHANNEL: Optional[PG_Channel]
...
class Sound:
    @staticmethod
    def load(path: str, volume: Optional[float] = ...) -> PG_Sound: ...
    @classmethod
    def load_from_video(cls, path: str, volume: Optional[float] = ..., cache_key: Optional[str] = ...) -> PG_Sound: ...
    @classmethod
    ...
    @staticmethod
    def find_channel(force: bool = ...) -> PG_Channel: ...
    @staticmethod
...
class FontGenerator:
    ...
    def render(self, txt: strint, color: color_liked, background_color: Optional[color_liked] = ...) -> ImageSurface: ...
...
class Font:
    ...
    @classmethod
    def render_global_font(cls, key: str, txt: str, color: color_liked, background_color: color_liked = ...) -> ImageSurface: ...
    @classmethod
    def remove_global_font(cls, key: str) -> None: ...
    @staticmethod
    def create(size: int_f, ifBold: bool = ..., ifItalic: bool = ...) -> FontGenerator: ...
    @classmethod
    def render(cls, txt: strint, color: color_liked, size: int_f, ifBold: bool = ..., ifItalic: bool = ..., background_color: color_liked = ...) -> ImageSurface: ...

class ArtisticFont:
    @staticmethod
    def render_description_box(txt: strint, color: color_liked, size: int, padding: int, background_color: color_liked, ifBold: bool = ..., ifItalic: bool = ..., outline_color: color_liked = ..., thickness: int = ...) -> ImageSurface: ...
    @staticmethod
    def render_with_outline(_text: strint, color: color_liked, size: int, outline_thickness: int = ..., outline_color: color_liked = ..., ifBold: bool = ..., ifItalic: bool = ...) -> ImageSurface: ...
