...
class Violation :    
    def __init__(self, debug=False) :
        ...
        self.url = "https://taas.koroad.or.kr/data/rest/koroadkatech/frequentzone/lgrViolt?authKey="
        # self.key = False
        # self.servicekey = "h6IaD8pH9K8xozwLs3i7OMn%2BGSl99Lw2etPnhUgGIq6teKGwQZ18%2FaowSD4uHR1K"
    ...
    def yearCodes_centerline(self) :
        yearStrs = ["17년도", "18년도", "19년도", "20년도 ~"]
        searchYearCodes = ["2018040", "2019048", "2020081", "2021053"]
    ...
    def yearCodes_signal(self) :
        yearStrs = ["17년도", "18년도", "19년도", "20년도 ~"]
        searchYearCodes = ["2018042", "2019049", "2020083", "2021054"]
