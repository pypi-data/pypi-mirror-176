...
class MaskingServiceConfig(UserObject):
    ...
    *(extends* :py:class:`v1_11_14.web.vo.UserObject` *)* Configuration for the
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "max_job_fetch_count" == "type" or (self.max_job_fetch_count is not self.__undef__ and (not (dirty and not self._max_job_fetch_count[1]) or isinstance(self.max_job_fetch_count, list) or belongs_to_parent)):
