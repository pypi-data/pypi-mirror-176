...
class FluentdAttribute(TypedObject):
    ...
    *(extends* :py:class:`v1_11_14.web.vo.TypedObject` *)* Fluentd attribute.
    ...
    def __init__(self, undef_enabled=True):
        super(FluentdAttribute, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(FluentdAttribute, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(FluentdAttribute, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FluentdAttribute):
            return False
        return super(FluentdAttribute, self).__eq__(other) and \
