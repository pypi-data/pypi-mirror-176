...
class OracleBaseExternalLinkData(OracleBaseLinkData):
    ...
    *(extends* :py:class:`v1_11_12.web.vo.OracleBaseLinkData` *)* Represents
    ...
    def __init__(self, undef_enabled=True):
        super(OracleBaseExternalLinkData, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleBaseExternalLinkData, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleBaseExternalLinkData, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleBaseExternalLinkData):
            return False
        return super(OracleBaseExternalLinkData, self).__eq__(other) and \
