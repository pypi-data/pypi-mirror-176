...
class OracleSourceLessSyncStrategy(OracleSyncStrategy):
    ...
    *(extends* :py:class:`v1_11_16.web.vo.OracleSyncStrategy` *)* Base type for
    ...
    def __init__(self, undef_enabled=True):
        super(OracleSourceLessSyncStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleSourceLessSyncStrategy, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleSourceLessSyncStrategy, self).to_dict(dirty, belongs_to_parent)
        ...
        if "validate_by_opening_db_in_read_only_mode" == "type" or (self.validate_by_opening_db_in_read_only_mode is not self.__undef__ and (not (dirty and not self._validate_by_opening_db_in_read_only_mode[1]) or isinstance(self.validate_by_opening_db_in_read_only_mode, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleSourceLessSyncStrategy):
            return False
        return super(OracleSourceLessSyncStrategy, self).__eq__(other) and \
