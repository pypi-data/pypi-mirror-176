    ...
    *(extends* :py:class:`v1_11_16.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._target_vcdb_tde_keystore_path[0] is not None and obj._target_vcdb_tde_keystore_path[0] is not obj.__undef__:
            assert isinstance(obj._target_vcdb_tde_keystore_path[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._target_vcdb_tde_keystore_path[0], type(obj._target_vcdb_tde_keystore_path[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "target_vcdb_tde_keystore_path" == "type" or (self.target_vcdb_tde_keystore_path is not self.__undef__ and (not (dirty and not self._target_vcdb_tde_keystore_path[1]) or isinstance(self.target_vcdb_tde_keystore_path, list) or belongs_to_parent)):
