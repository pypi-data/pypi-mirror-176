...
class PasswordResetValidationParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_11_16.web.vo.TypedObject` *)* Self-service
    ...
    def __init__(self, undef_enabled=True):
        super(PasswordResetValidationParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PasswordResetValidationParameters, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._token_uuid[0] is not None and obj._token_uuid[0] is not obj.__undef__:
            assert isinstance(obj._token_uuid[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._token_uuid[0], type(obj._token_uuid[0])))
        ...
        if obj._new_password[0] is not None and obj._new_password[0] is not obj.__undef__:
            assert isinstance(obj._new_password[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._new_password[0], type(obj._new_password[0])))
            common.validate_format(obj._new_password[0], "password", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PasswordResetValidationParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "token_uuid" == "type" or (self.token_uuid is not self.__undef__ and (not (dirty and not self._token_uuid[1]) or isinstance(self.token_uuid, list) or belongs_to_parent)):
            dct["tokenUUID"] = dictify(self.token_uuid)
        if "new_password" == "type" or (self.new_password is not self.__undef__ and (not (dirty and not self._new_password[1]) or isinstance(self.new_password, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PasswordResetValidationParameters):
            return False
        return super(PasswordResetValidationParameters, self).__eq__(other) and \
