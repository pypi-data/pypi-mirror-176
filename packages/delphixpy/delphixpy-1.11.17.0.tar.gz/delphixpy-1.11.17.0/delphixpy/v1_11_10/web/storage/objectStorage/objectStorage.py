...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_10.web.vo.S3ObjectStore`
    """
...
def set(engine, s3_object_store=None):
    ...
    :type s3_object_store: :py:class:`v1_11_10.web.vo.S3ObjectStore`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/storage/objectStorage"
...
def test_connection(engine, s3_object_store_test):
    ...
    :type s3_object_store_test: :py:class:`v1_11_10.web.vo.S3ObjectStoreTest`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
