    ...
    *(extends* :py:class:`v1_11_15.web.vo.UserObject` *)* State of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._last_known_target_version[0] is not None and obj._last_known_target_version[0] is not obj.__undef__:
            assert isinstance(obj._last_known_target_version[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._last_known_target_version[0], type(obj._last_known_target_version[0])))
