...
class OraclePDBLinkFromStaging(OracleBaseStagingLinkData):
    ...
    *(extends* :py:class:`v1_11_15.web.vo.OracleBaseStagingLinkData` *)*
    ...
    def __init__(self, undef_enabled=True):
        super(OraclePDBLinkFromStaging, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OraclePDBLinkFromStaging, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OraclePDBLinkFromStaging, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OraclePDBLinkFromStaging):
            return False
        return super(OraclePDBLinkFromStaging, self).__eq__(other) and \
