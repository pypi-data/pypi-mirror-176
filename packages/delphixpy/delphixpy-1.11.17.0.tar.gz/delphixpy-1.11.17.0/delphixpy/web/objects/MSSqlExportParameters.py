    ...
    *(extends* :py:class:`delphixpy.web.vo.DbExportParameters` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "enable_cdc" == "type" or (self.enable_cdc is not self.__undef__ and (not (dirty and not self._enable_cdc[1]) or isinstance(self.enable_cdc, list) or belongs_to_parent)):
            ...
            dct["enableCdc"] = False
        if "prod_sync_config_param" == "type" or (self.prod_sync_config_param is not self.__undef__ and (not (dirty and not self._prod_sync_config_param[1]) or isinstance(self.prod_sync_config_param, list) or belongs_to_parent)):
    ...
    def prod_sync_config_param(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlProdSyncExportConfigParam`
        """
