...
class HostNfsChecksParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Mechanism to verify
    ...
    def __init__(self, undef_enabled=True):
        super(HostNfsChecksParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(HostNfsChecksParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(HostNfsChecksParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HostNfsChecksParameters):
            return False
        return super(HostNfsChecksParameters, self).__eq__(other) and \
