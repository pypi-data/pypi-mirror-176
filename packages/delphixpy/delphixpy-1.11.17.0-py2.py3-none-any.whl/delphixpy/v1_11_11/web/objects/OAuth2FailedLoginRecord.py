...
class OAuth2FailedLoginRecord(FailedLoginRecord):
    ...
    *(extends* :py:class:`v1_11_11.web.vo.FailedLoginRecord` *)* Represents an
    ...
    def __init__(self, undef_enabled=True):
        super(OAuth2FailedLoginRecord, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OAuth2FailedLoginRecord, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OAuth2FailedLoginRecord, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OAuth2FailedLoginRecord):
            return False
        return super(OAuth2FailedLoginRecord, self).__eq__(other) and \
