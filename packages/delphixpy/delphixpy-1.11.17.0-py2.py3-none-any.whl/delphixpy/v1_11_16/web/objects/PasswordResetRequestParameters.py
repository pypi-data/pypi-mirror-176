...
class PasswordResetRequestParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_11_16.web.vo.TypedObject` *)* Parameters in a
    ...
    def __init__(self, undef_enabled=True):
        super(PasswordResetRequestParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PasswordResetRequestParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PasswordResetRequestParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "user_name" == "type" or (self.user_name is not self.__undef__ and (not (dirty and not self._user_name[1]) or isinstance(self.user_name, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PasswordResetRequestParameters):
            return False
        return super(PasswordResetRequestParameters, self).__eq__(other) and \
