...
class OracleExportDBInPlaceTransferStrategy(OracleExportDBTransferStrategy):
    ...
    *(extends* :py:class:`delphixpy.web.vo.OracleExportDBTransferStrategy` *)*
    ...
    def __init__(self, undef_enabled=True):
        super(OracleExportDBInPlaceTransferStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleExportDBInPlaceTransferStrategy, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._db_unique_name[0] is not None and obj._db_unique_name[0] is not obj.__undef__:
            assert isinstance(obj._db_unique_name[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._db_unique_name[0], type(obj._db_unique_name[0])))
        ...
        if obj._virtual_source[0] is not None and obj._virtual_source[0] is not obj.__undef__:
            assert isinstance(obj._virtual_source[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._virtual_source[0], type(obj._virtual_source[0])))
            common.validate_format(obj._virtual_source[0], "objectReference", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleExportDBInPlaceTransferStrategy, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleExportDBInPlaceTransferStrategy):
            return False
        return super(OracleExportDBInPlaceTransferStrategy, self).__eq__(other) and \
