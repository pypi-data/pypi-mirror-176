...
class NettyVersionInfo(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* View netty version
    and switch between legacy and latest netty version.
    """
    def __init__(self, undef_enabled=True):
        super(NettyVersionInfo, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(NettyVersionInfo, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NettyVersionInfo, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NettyVersionInfo):
            return False
        return super(NettyVersionInfo, self).__eq__(other) and \
