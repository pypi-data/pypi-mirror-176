...
class OracleExportTransferStrategy(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The transfer
    ...
    def __init__(self, undef_enabled=True):
        super(OracleExportTransferStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleExportTransferStrategy, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleExportTransferStrategy, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleExportTransferStrategy):
            return False
        return super(OracleExportTransferStrategy, self).__eq__(other) and \
