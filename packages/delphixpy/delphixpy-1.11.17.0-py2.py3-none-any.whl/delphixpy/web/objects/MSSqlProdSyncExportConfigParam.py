...
from delphixpy.web.objects.ProdSyncExportConfigParam import ProdSyncExportConfigParam
...
class MSSqlProdSyncExportConfigParam(ProdSyncExportConfigParam):
    """
    *(extends* :py:class:`delphixpy.web.vo.ProdSyncExportConfigParam` *)* The
    config parameters to use as input to export MSSQL databases for prod sync.
    """
    def __init__(self, undef_enabled=True):
        super(MSSqlProdSyncExportConfigParam, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MSSqlProdSyncExportConfigParam, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlProdSyncExportConfigParam, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "enable_self_recovery" == "type" or (self.enable_self_recovery is not self.__undef__ and (not (dirty and not self._enable_self_recovery[1]) or isinstance(self.enable_self_recovery, list) or belongs_to_parent)):
        ...
        if "enable_worker" == "type" or (self.enable_worker is not self.__undef__ and (not (dirty and not self._enable_worker[1]) or isinstance(self.enable_worker, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MSSqlProdSyncExportConfigParam):
            return False
        return super(MSSqlProdSyncExportConfigParam, self).__eq__(other) and \
