...
class ObjectStoreCacheHitsReport(TypedObject):
    """
    *(extends* :py:class:`v1_11_15.web.vo.TypedObject` *)* A cache hits report
    for an object store.
    """
    def __init__(self, undef_enabled=True):
        super(ObjectStoreCacheHitsReport, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(ObjectStoreCacheHitsReport, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ObjectStoreCacheHitsReport, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreCacheHitsReport):
            return False
        return super(ObjectStoreCacheHitsReport, self).__eq__(other) and \
