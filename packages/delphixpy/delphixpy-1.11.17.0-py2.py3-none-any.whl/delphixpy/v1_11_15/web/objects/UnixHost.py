...
class UnixHost(Host):
    ...
    *(extends* :py:class:`v1_11_15.web.vo.Host` *)* The representation of a
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "oracle_host_parameters" == "type" or (self.oracle_host_parameters is not self.__undef__ and (not (dirty and not self._oracle_host_parameters[1]) or isinstance(self.oracle_host_parameters, list) or belongs_to_parent)):
    ...
    def oracle_host_parameters(self):
        ...
        :rtype: :py:class:`v1_11_15.web.vo.OracleHostParameters`
        """
