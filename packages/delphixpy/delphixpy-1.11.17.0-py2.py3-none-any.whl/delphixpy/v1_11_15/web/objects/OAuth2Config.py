...
class OAuth2Config(TypedObject):
    ...
    *(extends* :py:class:`v1_11_15.web.vo.TypedObject` *)* OAuth2
    ...
    def __init__(self, undef_enabled=True):
        super(OAuth2Config, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OAuth2Config, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._issuer_uri[0] is not None and obj._issuer_uri[0] is not obj.__undef__:
            assert isinstance(obj._issuer_uri[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._issuer_uri[0], type(obj._issuer_uri[0])))
        ...
        if obj._jwk_set_uri[0] is not None and obj._jwk_set_uri[0] is not obj.__undef__:
            assert isinstance(obj._jwk_set_uri[0], TEXT_TYPE), ("Expected one of ['string', 'null'], but got %s of type %s" % (obj._jwk_set_uri[0], type(obj._jwk_set_uri[0])))
        ...
        if obj._audience[0] is not None and obj._audience[0] is not obj.__undef__:
            assert isinstance(obj._audience[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._audience[0], type(obj._audience[0])))
        ...
        if obj._user_id_claim[0] is not None and obj._user_id_claim[0] is not obj.__undef__:
            assert isinstance(obj._user_id_claim[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._user_id_claim[0], type(obj._user_id_claim[0])))
        ...
        if obj._user_matching_field_type[0] is not None and obj._user_matching_field_type[0] is not obj.__undef__:
            assert isinstance(obj._user_matching_field_type[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._user_matching_field_type[0], type(obj._user_matching_field_type[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OAuth2Config, self).to_dict(dirty, belongs_to_parent)
        ...
        if "issuer_uri" == "type" or (self.issuer_uri is not self.__undef__ and (not (dirty and not self._issuer_uri[1]) or isinstance(self.issuer_uri, list) or belongs_to_parent)):
            dct["issuerURI"] = dictify(self.issuer_uri)
        if "jwk_set_uri" == "type" or (self.jwk_set_uri is not self.__undef__ and (not (dirty and not self._jwk_set_uri[1]) or isinstance(self.jwk_set_uri, list) or belongs_to_parent)):
            dct["jwkSetURI"] = dictify(self.jwk_set_uri)
        if "audience" == "type" or (self.audience is not self.__undef__ and (not (dirty and not self._audience[1]) or isinstance(self.audience, list) or belongs_to_parent)):
            dct["audience"] = dictify(self.audience)
        if "user_id_claim" == "type" or (self.user_id_claim is not self.__undef__ and (not (dirty and not self._user_id_claim[1]) or isinstance(self.user_id_claim, list) or belongs_to_parent)):
            dct["userIdClaim"] = dictify(self.user_id_claim)
        if "user_matching_field_type" == "type" or (self.user_matching_field_type is not self.__undef__ and (not (dirty and not self._user_matching_field_type[1]) or isinstance(self.user_matching_field_type, list) or belongs_to_parent)):
            dct["userMatchingFieldType"] = dictify(self.user_matching_field_type)
        if "token_skew_time" == "type" or (self.token_skew_time is not self.__undef__ and (not (dirty and not self._token_skew_time[1]) or isinstance(self.token_skew_time, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OAuth2Config):
            return False
        return super(OAuth2Config, self).__eq__(other) and \
