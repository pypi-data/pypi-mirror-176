...
class BlobObjectStoreTest(ObjectStoreTest):
    ...
    *(extends* :py:class:`v1_11_15.web.vo.ObjectStoreTest` *)* An Azure blob
    ...
    def __init__(self, undef_enabled=True):
        super(BlobObjectStoreTest, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(BlobObjectStoreTest, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(BlobObjectStoreTest, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlobObjectStoreTest):
            return False
        return super(BlobObjectStoreTest, self).__eq__(other) and \
