...
class ObjectStoreTestResult(TypedObject):
    ...
    *(extends* :py:class:`v1_11_15.web.vo.TypedObject` *)* An object store
    ...
    def __init__(self, undef_enabled=True):
        super(ObjectStoreTestResult, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(ObjectStoreTestResult, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ObjectStoreTestResult, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreTestResult):
            return False
        return super(ObjectStoreTestResult, self).__eq__(other) and \
