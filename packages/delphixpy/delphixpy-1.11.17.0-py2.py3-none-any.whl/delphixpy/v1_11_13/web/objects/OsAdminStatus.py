...
class OsAdminStatus(TypedObject):
    ...
    *(extends* :py:class:`v1_11_13.web.vo.TypedObject` *)* Information for the
    ...
    def __init__(self, undef_enabled=True):
        super(OsAdminStatus, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OsAdminStatus, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._storage_pool_state[0] is not None and obj._storage_pool_state[0] is not obj.__undef__:
            assert isinstance(obj._storage_pool_state[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._storage_pool_state[0], type(obj._storage_pool_state[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OsAdminStatus, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OsAdminStatus):
            return False
        return super(OsAdminStatus, self).__eq__(other) and \
