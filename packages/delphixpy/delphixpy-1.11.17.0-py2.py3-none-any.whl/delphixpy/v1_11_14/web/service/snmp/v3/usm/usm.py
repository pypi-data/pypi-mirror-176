...
def create(engine, snmpv3_usm_user_config=None):
    ...
    :type snmpv3_usm_user_config:
        :py:class:`v1_11_14.web.vo.SNMPV3USMUserConfig`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_14.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_11_14.web.objects.SNMPV3
        USMUserConfig.SNMPV3USMUserConfig` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_14.web.vo.SNMPV3USMUserConfig`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_14.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_14.web.vo.SNMPV3USMUserConfig`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/service/snmp/v3/usm"
    response = engine.get(url)
