...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_14.web.vo.StorageDeviceRemovalStatus`
    """
...
def start(engine, storage_device_remove_parameters=None):
    ...
    :type storage_device_remove_parameters:
        :py:class:`v1_11_14.web.vo.StorageDeviceRemoveParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def verify(engine, storage_device_remove_parameters=None):
    ...
    :type storage_device_remove_parameters:
        :py:class:`v1_11_14.web.vo.StorageDeviceRemoveParameters`
    :rtype: :py:class:`v1_11_14.web.vo.StorageDeviceRemovalVerifyResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
