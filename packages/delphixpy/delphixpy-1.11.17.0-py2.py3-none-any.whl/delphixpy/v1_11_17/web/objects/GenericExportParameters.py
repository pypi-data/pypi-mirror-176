...
class GenericExportParameters(ExportParameters):
    ...
    *(extends* :py:class:`v1_11_17.web.vo.ExportParameters` *)* The parameters
    ...
    def __init__(self, undef_enabled=True):
        super(GenericExportParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(GenericExportParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(GenericExportParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericExportParameters):
            return False
        return super(GenericExportParameters, self).__eq__(other) and \
