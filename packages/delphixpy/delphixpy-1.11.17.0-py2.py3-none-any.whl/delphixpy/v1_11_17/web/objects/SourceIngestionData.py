    ...
    *(extends* :py:class:`v1_11_17.web.vo.TypedObject` *)* Objects that map
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._container_type_label[0] is not None and obj._container_type_label[0] is not obj.__undef__:
            assert isinstance(obj._container_type_label[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._container_type_label[0], type(obj._container_type_label[0])))
