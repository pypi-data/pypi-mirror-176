...
class EventsConfig(TypedObject):
    ...
    *(extends* :py:class:`v1_11_17.web.vo.TypedObject` *)* Event Message
    ...
    def __init__(self, undef_enabled=True):
        super(EventsConfig, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(EventsConfig, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(EventsConfig, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "max_message_length" == "type" or (self.max_message_length is not self.__undef__ and (not (dirty and not self._max_message_length[1]) or isinstance(self.max_message_length, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventsConfig):
            return False
        return super(EventsConfig, self).__eq__(other) and \
