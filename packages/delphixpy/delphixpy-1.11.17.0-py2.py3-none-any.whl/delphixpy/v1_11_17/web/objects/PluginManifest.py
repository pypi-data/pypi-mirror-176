...
class PluginManifest(TypedObject):
    """
    *(extends* :py:class:`v1_11_17.web.vo.TypedObject` *)* A manifest
    describing a plugin.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "has_linked_source_size" == "type" or (self.has_linked_source_size is not self.__undef__ and (not (dirty and not self._has_linked_source_size[1]) or isinstance(self.has_linked_source_size, list) or belongs_to_parent)):
        ...
        if "has_virtual_source_size" == "type" or (self.has_virtual_source_size is not self.__undef__ and (not (dirty and not self._has_virtual_source_size[1]) or isinstance(self.has_virtual_source_size, list) or belongs_to_parent)):
        ...
        if "has_virtual_cleanup" == "type" or (self.has_virtual_cleanup is not self.__undef__ and (not (dirty and not self._has_virtual_cleanup[1]) or isinstance(self.has_virtual_cleanup, list) or belongs_to_parent)):
