...
class OracleSourceBasedSyncStrategy(OracleSyncStrategy):
    ...
    *(extends* :py:class:`v1_11_12.web.vo.OracleSyncStrategy` *)* Base type for
    ...
    def __init__(self, undef_enabled=True):
        super(OracleSourceBasedSyncStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleSourceBasedSyncStrategy, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleSourceBasedSyncStrategy, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleSourceBasedSyncStrategy):
            return False
        return super(OracleSourceBasedSyncStrategy, self).__eq__(other) and \
