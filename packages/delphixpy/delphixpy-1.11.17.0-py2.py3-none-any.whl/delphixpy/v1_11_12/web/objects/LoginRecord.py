...
class LoginRecord(TypedObject):
    ...
    *(extends* :py:class:`v1_11_12.web.vo.TypedObject` *)* Represents a failed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(LoginRecord, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(LoginRecord, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoginRecord):
            return False
        return super(LoginRecord, self).__eq__(other) and \
