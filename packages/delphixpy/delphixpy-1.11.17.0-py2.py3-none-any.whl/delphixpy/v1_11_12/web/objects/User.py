    ...
    *(extends* :py:class:`v1_11_12.web.vo.NamedUserObject` *)* Delphix users.
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "locale" == "type" or (self.locale is not self.__undef__ and (not (dirty and not self._locale[1]) or isinstance(self.locale, list) or belongs_to_parent)):
            ...
            dct["locale"] = "en-US"
        if "allow_password_authentication" == "type" or (self.allow_password_authentication is not self.__undef__ and (not (dirty and not self._allow_password_authentication[1]) or isinstance(self.allow_password_authentication, list) or belongs_to_parent)):
