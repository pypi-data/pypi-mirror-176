...
# Load data
data = rg.loadmat('nir_tabletshootout_2002.mat')
...
# Autoscale
X1, _, _ =rg.autoscale(X1)
X2, _, _ =rg.autoscale(X2)
...
print('R2 test: ', np.round(R2_v[0],2))
print('RMSE test: ', np.round(RMSEV,1))
...
#         beta, all_scores, y_pred_final = fct_PPLS(Xcv,Ycv,nbPC) 
...
n1, k1  = X1.shape
model, ypred1 = LMIR_create(X1, Y1)
