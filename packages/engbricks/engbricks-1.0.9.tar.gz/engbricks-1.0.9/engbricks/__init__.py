...
# 
mods = {
    "Arithmetic":                  "engbricks.engbricks.src.maths.arithmetic",
    "Area":                        "engbricks.engbricks.src.maths.areas",
    "Probability":                 "engbricks.engbricks.src.maths.probability",
    "Trigonometry":                "engbricks.engbricks.src.maths.trigonometry",
    "Aircraft":                    "engbricks.engbricks.src.aircraft_performance.performance_aircraft",
    "Wing":                        "engbricks.engbricks.src.aircraft_performance.performance_wing",
    "Propulsion":                  "engbricks.engbricks.src.aircraft_performance.performance_propulsion",
    "Take-Off":                    "engbricks.engbricks.src.aircraft_performance.performance_takeoff",
    "Climb":                       "engbricks.engbricks.src.aircraft_performance.performance_climb",
    "Cruise":                      "engbricks.engbricks.src.aircraft_performance.performance_cruise",
    "Cruise Jet":                  "engbricks.engbricks.src.aircraft_performance.performance_jet_cruise",
    "Cruise Propeller":            "engbricks.engbricks.src.aircraft_performance.performance_propeller_cruise",
    "Landing":                     "engbricks.engbricks.src.aircraft_performance.performance_landing",
    "Glide":                       "engbricks.engbricks.src.aircraft_performance.performance_glide",
    "Turn":                        "engbricks.engbricks.src.aircraft_performance.performance_turn",
    "Looping":                     "engbricks.engbricks.src.aircraft_performance.performance_looping",
    "Structures Vibration":        "engbricks.engbricks.src.structures.vibration",
    "Second Moment of Area":       "engbricks.engbricks.src.structures.second_moment_of_area",
    "Composites":                  "engbricks.engbricks.src.structures.composites",
    "Astrodynamics":               "engbricks.engbricks.src.astrodynamics",
    "Jet Propulsion":              "engbricks.engbricks.src.jet_propulsion",
    "Atmosphere":                  "engbricks.engbricks.src.atmosphere",
    "User":                        "engbricks.engbricks.src.user_equations"
}
# 
# 
# 
