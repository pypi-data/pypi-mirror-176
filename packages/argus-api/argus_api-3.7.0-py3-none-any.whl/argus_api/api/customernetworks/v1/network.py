...
def add_customer_network(
    ...
    :param str location: DEPRECATED. Location ID or short name of the location where the network is located \(default 0\)
...
def lenient_bulk_add_customer_networks(
    ...
    """Bulk add/update customer networks with the option of ignoring failures (DEV)
