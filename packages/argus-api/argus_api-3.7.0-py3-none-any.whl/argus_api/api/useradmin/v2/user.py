...
def add_user(
    ...
    # Only send externallyManaged if the argument was provided, dont send null values
    ...
    # Only send phone if the argument was provided, dont send null values
    ...
    # Only send skipDefaultAuthenticationMethods if the argument was provided, dont send null values
