...
def ingest_bulk_data(
    ...
    """Submit JSON data in bulk that will be forwarded to a Kafka topic based on its category (DEV)
...
def ingest_data(
    ...
    """Submit JSON data that will be forwarded to a Kafka topic based on its category (DEV)
