...
def create_instance(
    ...
    # Only send pinnedTemplateRevision if the argument was provided, dont send null values
...
def search_instances(
    ...
    # Only send monitoringDisabled if the argument was provided, dont send null values
