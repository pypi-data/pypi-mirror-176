...
def add_asset_definition(
    ...
    """Creates a new AssetDefinition (TEST)
...
def calculate_asset_statistics(
    ...
    """Generate the requested statistics for Assets matching the provided search criteria.If groupBys are not explicitly requested Customer will be used by default. (DEV)
    
    :param dict searchRequest: 
    ...
    body = body or {}
    # Only send searchRequest if the argument was provided, dont send null values
    if searchRequest is not None:
        body.update({"searchRequest": searchRequest})
    # Only send fieldAggregation if the argument was provided, dont send null values
    if fieldAggregation is not None:
        body.update({"fieldAggregation": fieldAggregation})
    # Only send rangeMetric if the argument was provided, dont send null values
    if rangeMetric is not None:
        body.update({"rangeMetric": rangeMetric})
    # Only send statisticsMetric if the argument was provided, dont send null values
...
def delete_asset_definition(
    ...
    """Marks a AssetDefinition as deleted (TEST)
...
def recalculate_asset(
    ...
    """Force a recalculation of an Asset's vulnerabilityCount and totalCVSS fields.NB: any changes are propagated up the Asset Group hierarchy if recalculateGroups is set and the Asset belongs to any group(s). (TEST)
    ...
    # Only send recalculateGroups if the argument was provided, dont send null values
...
def reindex_asset(
    ...
    """Re-indexes specified Assets (TEST)
...
def search_assets(
    ...
    # Only send hasGroups if the argument was provided, dont send null values
    if hasGroups is not None:
        body.update({"hasGroups": hasGroups})
    # Only send includeGroupInfo if the argument was provided, dont send null values
    if includeGroupInfo is not None:
        body.update({"includeGroupInfo": includeGroupInfo})
    # Only send assetByVulnerability if the argument was provided, dont send null values
...
def update_asset(
    ...
    """Updates an existing Asset (TEST)
...
def update_asset_definition(
    ...
    """Updates an existing AssetDefinition (TEST)
