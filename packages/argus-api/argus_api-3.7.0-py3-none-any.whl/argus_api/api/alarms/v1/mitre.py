...
def add_mitre_category_relationship(
    ...
    # Only send targetCategoryModel if the argument was provided, dont send null values
    ...
    query_parameters = {}
    # Only send sourceCategoryModel if the argument was provided, dont send null values
...
def add_or_update_mitre_model_version(
    ...
    body = body or {}
    # Only send markAsDefault if the argument was provided, dont send null values
