...
def add_analysis_filter(
    ...
    body = body or {}
    # Only send preStatementCode1 if the argument was provided, dont send null values
    if preStatementCode1 is not None:
        body.update({"preStatementCode1": preStatementCode1})
    # Only send preStatementCode2 if the argument was provided, dont send null values
    if preStatementCode2 is not None:
        body.update({"preStatementCode2": preStatementCode2})
    # Only send statementCode if the argument was provided, dont send null values
    if statementCode is not None:
        body.update({"statementCode": statementCode})
    # Only send triggerCode if the argument was provided, dont send null values
    if triggerCode is not None:
        body.update({"triggerCode": triggerCode})
    # Only send actionName if the argument was provided, dont send null values
    if actionName is not None:
        body.update({"actionName": actionName})
    # Only send defaultAggregate if the argument was provided, dont send null values
    if defaultAggregate is not None:
        body.update({"defaultAggregate": defaultAggregate})
    # Only send skipNewEvent if the argument was provided, dont send null values
...
def get_analysis_filter_status(
    ...
    """Gets the status of a analysis filter (DEV)
...
def list_analysis_filter(
    ...
    route = "/eventfilters/v2/analysis".format(keywordMatch=keywordMatch,
