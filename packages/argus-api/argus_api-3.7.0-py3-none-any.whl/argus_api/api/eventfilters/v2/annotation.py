...
def add_annotation_filter(
    ...
    body = body or {}
    # Only send stage if the argument was provided, dont send null values
...
def get_annotation_filter_status(
    ...
    """Gets the status of a annotation filter (DEV)
...
def list_annotation_filter(
    ...
    route = "/eventfilters/v2/annotation".format(keywordMatch=keywordMatch,
