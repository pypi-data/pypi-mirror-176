...
def add_country(
    ...
    :param int lastModified: The timestamp when this country was last modified
    ...
    if id is not None:
        body.update({"id": id})
    # Only send countryName if the argument was provided, dont send null values
...
def list_countries(
    ...
    # Only send fromID if the argument was provided, dont send null values
...
def search_countries(
    ...
    """Find GeoIP countries (DEV)
    
    :param list sortBy: 
    :param int limit: Max number of results.
    :param int offset: Skip the first \(offset\) objects. By default\, return result from first object.
    :param int fromID: Only return countries where the numeric id is larger than this value. By default\, this is disabled.
