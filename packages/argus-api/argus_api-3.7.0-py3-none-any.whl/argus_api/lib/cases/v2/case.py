...
def add_attachment(
    ...
    :param str encryptedZipPassword: If encryptedZip is enabled\, use this property to document the password set on the zipfile. \(default argus\)
    ...
    :param bool encryptedZip: If set\, mark this attachment as an encrypted zip \(document the password using property encryptedZipPassword\). NOTE\: the service does not encrypt or zip the attachment\, this should be done by the client. \(default false\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    # Only send encryptedZipPassword if the argument was provided, dont send null values
...
def add_comment(
    ...
    # Only send textFormat if the argument was provided, dont send null values
...
def advanced_case_search(
    ...
    # Only send productionCustomers if the argument was provided, dont send null values
...
def create_case(
    ...
    # Only send descriptionTextFormat if the argument was provided, dont send null values
...
def grant_access(
    ...
    # Only send addWatcher if the argument was provided, dont send null values
...
def list_case_seen_status(
    ...
    """List 'last seen' status for a case (DEV)
...
def register_case_seen_status(
    ...
    """Register 'last seen' status for a case (DEV)
...
def upload_streaming_attachment(
    ...
    route = "/cases/v2/case/{caseID}/attachments/upload/{filename}".format(encryptedZipPassword=encryptedZipPassword,
        caseID=caseID,
        filename=filename,
