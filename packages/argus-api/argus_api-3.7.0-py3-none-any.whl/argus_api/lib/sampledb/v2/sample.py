...
def add_analysis(
    ...
    :param str analyzerName: Name of the analyzer that produced this result \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    ...
    if acl is not None:
        body.update({"acl": acl})
    # Only send jobID if the argument was provided, dont send null values
    if jobID is not None:
        body.update({"jobID": jobID})
    # Only send triggeredDetections if the argument was provided, dont send null values
    if triggeredDetections is not None:
        body.update({"triggeredDetections": triggeredDetections})
    # Only send possibleDetections if the argument was provided, dont send null values
    ...
    # Only send verdictStatusOverride if the argument was provided, dont send null values
...
def add_submission(
    ...
    :param str retention: Only retain the submission until the specified time. The submission will be deleted after this time\, unless the sample is malicious. Allows unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time specifies. See https\:\/\/docs.mnemonic.no\/x\/AQDXAQ
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    # Only send retention if the argument was provided, dont send null values
...
def add_verdict(
    ...
    :param str status: The status of the verdict
    ...
    body = body or {}
    # Only send analysisID if the argument was provided, dont send null values
...
def advanced_search(
    ...
    # Only send sha1 if the argument was provided, dont send null values
    if sha1 is not None:
        body.update({"sha1": sha1})
    # Only send md5 if the argument was provided, dont send null values
    if md5 is not None:
        body.update({"md5": md5})
    ...
    # Only send verdict if the argument was provided, dont send null values
...
def list_verdicts(
    ...
    :param list status: List verdicts with the specified statuses only
