...
def add_asset_group(
    ...
    # Only send canContainAssets if the argument was provided, dont send null values
...
def attach_assets(
    ...
    """Attach asset to the asset group. Asset group will recalculate de-normalized fields and flags base on children groups and assets, such as totalCVSS, vulnerabilitiesCount and flags to indicate whether there is high or critical severity vulnerability. (TEST)
...
def attach_children_groups(
    ...
    """Attach asset groups to parent asset group as children. Associating groups should not cause circular relationships. Parent group will recalculate de-normalized fields and flags base on children groups and assets, such as totalCVSS, vulnerabilitiesCount and flags to indicate whether there is high or critical severity vulnerability. (TEST)
...
def detach_assets(
    ...
    """Detach multiple assets from parent asset group. Parent group will recalculate de-normalized fields and flags base on remaining children groups and assets, such as totalCVSS, vulnerabilitiesCount and flags to indicate whether there is high or critical severity vulnerability. Response with parent group after change. (TEST)
...
def get_children_asset_groups(
    ...
    """Get children asset groups associated with specified asset group (PUBLIC)
...
def get_children_assets(
    ...
    """Get assets that associated with specified asset group (PUBLIC)
...
def reindex_asset_group(
    ...
    """Re-indexes specified Asset Groups (TEST)
...
def search_asset_groups(
    ...
    # Only send hasAsset if the argument was provided, dont send null values
    ...
    # Only send hasChild if the argument was provided, dont send null values
...
def update_asset_group(
    ...
    """Updates an existing AssetGroup (TEST)
