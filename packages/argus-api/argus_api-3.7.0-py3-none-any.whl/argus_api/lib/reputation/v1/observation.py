...
def fetch_observations_for_domain(
    ...
    query_parameters = {}
    # Only send countMaxWait if the argument was provided, dont send null values
...
def find_address_observations(
    ...
    :param int countMaxWait: How long to wait for count calculation to complete. \-1\: Skip counting altogether to return search results immediately. 0\: Unlimited count time for when the count matters and response time does not.
...
def find_domain_observations(
    ...
    :param list domains: Search for observations by domain name. \=\> Sanitize by regex \(\?\:\[a\-z0\-9\-\_\]\{1\,63\}\\.\)\+\(\?\:xn\-\-\[a\-z0\-9\-\]\{1\,59\}\|\[a\-z\]\{1\,63\}\)
    :param list sortBy: List of properties to sort by \(prefix with \"\-\" to sort descending\).
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    ...
    # Only send domains if the argument was provided, dont send null values
