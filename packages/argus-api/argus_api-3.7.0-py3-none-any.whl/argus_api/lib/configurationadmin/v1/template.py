...
def create_template(
    ...
    # Only send configurationResource if the argument was provided, dont send null values
...
def promote_all_template_instances(
    ...
    body = body or {}
    # Only send templateRevision if the argument was provided, dont send null values
