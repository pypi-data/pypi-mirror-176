...
def submit_csp_log_event(
    ...
    body = body or {}
    # Only send blockedUri if the argument was provided, dont send null values
    if blockedUri is not None:
        body.update({"blockedUri": blockedUri})
    # Only send disposition if the argument was provided, dont send null values
    if disposition is not None:
        body.update({"disposition": disposition})
    # Only send documentUri if the argument was provided, dont send null values
    if documentUri is not None:
        body.update({"documentUri": documentUri})
    # Only send effectiveDirective if the argument was provided, dont send null values
    if effectiveDirective is not None:
        body.update({"effectiveDirective": effectiveDirective})
    # Only send originalPolicy if the argument was provided, dont send null values
    if originalPolicy is not None:
        body.update({"originalPolicy": originalPolicy})
    # Only send referrer if the argument was provided, dont send null values
    if referrer is not None:
        body.update({"referrer": referrer})
    # Only send scriptSample if the argument was provided, dont send null values
    if scriptSample is not None:
        body.update({"scriptSample": scriptSample})
    # Only send statusCode if the argument was provided, dont send null values
    if statusCode is not None:
        body.update({"statusCode": statusCode})
    # Only send violatedDirective if the argument was provided, dont send null values
