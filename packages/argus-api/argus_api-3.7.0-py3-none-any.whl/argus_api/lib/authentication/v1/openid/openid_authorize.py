...
def add_openid_group_mapping(
    ...
    body = body or {}
    # Only send argusGroup if the argument was provided, dont send null values
    if argusGroup is not None:
        body.update({"argusGroup": argusGroup})
    # Only send externalGroupName if the argument was provided, dont send null values
...
def add_openid_provider(
    ...
    # Only send jwksURI if the argument was provided, dont send null values
    if jwksURI is not None:
        body.update({"jwksURI": jwksURI})
    # Only send configurationURI if the argument was provided, dont send null values
    ...
    # Only send tokenURI if the argument was provided, dont send null values
    if tokenURI is not None:
        body.update({"tokenURI": tokenURI})
    # Only send secret if the argument was provided, dont send null values
    ...
    # Only send newUserMapping if the argument was provided, dont send null values
    if newUserMapping is not None:
        body.update({"newUserMapping": newUserMapping})
    # Only send updateGroupMapping if the argument was provided, dont send null values
...
def list_openid_providers(
    ...
    # Only send targetCustomer if the argument was provided, dont send null values
...
def openid_authentication(
    ...
    # Only send authorizationCode if the argument was provided, dont send null values
    if authorizationCode is not None:
        body.update({"authorizationCode": authorizationCode})
    # Only send flow if the argument was provided, dont send null values
    if flow is not None:
