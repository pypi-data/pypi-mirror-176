...
def set_user_openid_configuration(
    ...
    body = body or {}
    # Only send mappedUserName if the argument was provided, dont send null values
    if mappedUserName is not None:
        body.update({"mappedUserName": mappedUserName})
    # Only send provider if the argument was provided, dont send null values
...
get_user_open_id_configuration = deprecated_alias("get_user_open_id_configuration")(get_user_openid_configuration)
...
set_user_open_id_configuration = deprecated_alias("set_user_open_id_configuration")(set_user_openid_configuration)
...
retrieve_s_m_s_token = deprecated_alias("retrieve_s_m_s_token")(retrieve_sms_token)
...
setup_user_l_d_a_p = deprecated_alias("setup_user_l_d_a_p")(setup_user_ldap)