...
class RowToRipe():
    ...
    def fourier(self,x,y,axis=-1,detrend=True,zeroPadding=0,cycleExtension=1,window='boxcar',printinfo=True):
        '''
        ...
        window = np.expand_dims(window,axis=axis).repeat(shape[axis-1],axis=axis) if len(shape)!=1 else window
