...
class Trigger():
    ...
    @typing.overload
    def __init__(self, loop: wpilib.event._event.EventLoop, isActive: typing.Callable[[], bool]) -> None: ...
    ...
    def falling(self) -> Trigger: 
        ...
        """
    def getEvent(self) -> wpilib.event._event.BooleanEvent: 
        """
