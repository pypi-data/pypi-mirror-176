    ...
    ui: { // Static UI elements
        title: {
            ...
            appLocation: {
                ...
                ru: 'Таргет Локатье',
                de: 'Ziel Lokatier',
                pt_br: 'Localização Alvo',
                sp: 'Ubicación de Destino',
                tr: 'Hedef Konum',
                th: 'สถานที่เป้าหมาย',
            ...
            specificOptions: {
                en: 'auto-py-to-app Specific Options',
                zh: 'auto-py-to-app 特定的选项',
                zh_tw: 'auto-py-to-app 特定的選項',
                ru: 'Особые параметры auto-py-to-app',
                de: 'auto-py-to-app spezifische Optionen',
                pt_br: 'Opções Específicas auto-py-to-app',
                sp: 'Opciones Específicas auto-py-to-app',
                tr: 'auto-py-to-app ye Özel Seçenekler',
                th: 'auto-py-to-app ตัวเลือกเฉพาะ',
                fr: 'Options spécifiques',
                it: 'Opzioni specifiche auto-py-to-app',
                id: 'Pilihan Spesifik auto-py-to-app',
                cz: 'Přesné nastavení auto-py-to-app',
                gr: 'auto-py-to-app Συγκεκριμένες Επιλογές',
            },
            outputDirectory: {
                en: 'Output Directory',
                zh: '输出路径',
