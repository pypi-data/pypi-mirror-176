...
def main():
    ...
    parser.add_argument(
        "--run-group", metavar="NAME", help="run only the named run group", default=None
    )
    parser.add_argument(
        "--docker-tag",
        metavar="NAME",
    ...
    parser.add_argument("--host", metavar="NAME", help="host name or IP", default=None)
    parser.add_argument(
        "--port",
        type=positive_int,
    ...
    parser.add_argument(
        "--auth", "-a", metavar="PASSWORD", help="password for connection", default=None
    )
    parser.add_argument(
        "--user", metavar="NAME", help="user name for connection", default=None
    )
    parser.add_argument(
        "--total-clients",
        metavar="NUM",
