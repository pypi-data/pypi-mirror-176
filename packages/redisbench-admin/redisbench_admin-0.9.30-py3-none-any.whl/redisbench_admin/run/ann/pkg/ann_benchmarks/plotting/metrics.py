...
all_metrics = {
    ...
    "p50": {
        ...
        "function": lambda true_distances, run_distances, metrics, times, run_attrs: percentile_50(
            times
        ),  # noqa
        "worst": float("inf"),
    },
    "p95": {
        ...
        "function": lambda true_distances, run_distances, metrics, times, run_attrs: percentile_95(
            times
        ),  # noqa
        "worst": float("inf"),
    },
    "p99": {
        ...
        "function": lambda true_distances, run_distances, metrics, times, run_attrs: percentile_99(
            times
        ),  # noqa
        "worst": float("inf"),
    },
    "p999": {
        ...
        "function": lambda true_distances, run_distances, metrics, times, run_attrs: percentile_999(
            times
        ),  # noqa
        "worst": float("inf"),
    },
