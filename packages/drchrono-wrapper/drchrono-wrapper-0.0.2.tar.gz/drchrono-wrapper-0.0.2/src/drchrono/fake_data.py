from fake_create.fake_admin_users import userlist_fake
from fake_create.fake_admin_doctors import doctorlist_fake
from fake_create.fake_clinical_patients import patientlist_fake
from fake_create.fake_clinical_appointments import appointment_list_fake
