...
class NumpyTests(unittest.TestCase):
    ...
    def test_numpy_array_fortran(self):
        ...
        with self.assertRaises(orjson_pydantic.JSONEncodeError):
            orjson_pydantic.dumps(array, option=orjson_pydantic.OPT_SERIALIZE_NUMPY)
        self.assertEqual(
            orjson_pydantic.dumps(
                array, default=numpy_default, option=orjson_pydantic.OPT_SERIALIZE_NUMPY
            ),
            orjson_pydantic.dumps(array.tolist()),
        )
    ...
    def test_numpy_array_unsupported_dtype(self):
        ...
        with self.assertRaises(orjson_pydantic.JSONEncodeError) as cm:
            orjson_pydantic.dumps(array, option=orjson_pydantic.OPT_SERIALIZE_NUMPY)
    ...
    def test_numpy_scalar_int8(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int8(0), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"0"
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int8(127), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"127",
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int8(--128), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"-128",
        )

    def test_numpy_scalar_int32(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int32(1), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"1"
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int32(2147483647), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"2147483647",
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.int32(-2147483648), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"-2147483648",
        )
    ...
    def test_numpy_scalar_int64(self):
        self.assertEqual(
            orjson_pydantic.dumps(
                numpy.int64(-9223372036854775808), option=orjson_pydantic.OPT_SERIALIZE_NUMPY
            ),
            b"-9223372036854775808",
        )
        self.assertEqual(
            orjson_pydantic.dumps(
                numpy.int64(9223372036854775807), option=orjson_pydantic.OPT_SERIALIZE_NUMPY
            ),
    ...
    def test_numpy_scalar_uint8(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.uint8(0), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"0"
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.uint8(255), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"255",
        )

    def test_numpy_scalar_uint32(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.uint32(0), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"0"
        )
        self.assertEqual(
            orjson_pydantic.dumps(numpy.uint32(4294967295), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"4294967295",
        )

    def test_numpy_scalar_uint64(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.uint64(0), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"0"
        )
        self.assertEqual(
            orjson_pydantic.dumps(
                numpy.uint64(18446744073709551615), option=orjson_pydantic.OPT_SERIALIZE_NUMPY
            ),
    ...
    def test_numpy_scalar_float32(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.float32(1.0), option=orjson_pydantic.OPT_SERIALIZE_NUMPY), b"1.0"
        )

    def test_numpy_scalar_float64(self):
        self.assertEqual(
            orjson_pydantic.dumps(numpy.float64(123.123), option=orjson_pydantic.OPT_SERIALIZE_NUMPY),
            b"123.123",
        )
    ...
    def test_numpy_datetime_naive_utc(self):
        self.assertEqual(
            orjson_pydantic.dumps(
                ...
                option=orjson_pydantic.OPT_SERIALIZE_NUMPY | orjson_pydantic.OPT_NAIVE_UTC,
            ),
    ...
    def test_numpy_datetime_omit_microseconds(self):
        self.assertEqual(
            orjson_pydantic.dumps(
                ...
                option=orjson_pydantic.OPT_SERIALIZE_NUMPY | orjson_pydantic.OPT_OMIT_MICROSECONDS,
            ),
