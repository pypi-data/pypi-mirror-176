...
class ExternalPart(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i144 in range(_size140):
                        ...
                        self.keyMapping[_key145] = _val146
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.keyMapping is not None:
            oprot.writeFieldBegin('keyMapping', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.keyMapping))
            for kiter147, viter148 in self.keyMapping.items():
...
class Join(object):
    ...
    def __init__(self, metaData=None, left=None, joinParts=None, skewKeys=None, onlineExternalParts=None,):
        self.metaData = metaData
        self.left = left
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i153 in range(_size149):
                        _elem154 = JoinPart()
                        _elem154.read(iprot)
                        self.joinParts.append(_elem154)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i172 in range(_size168):
                        _elem173 = ExternalPart()
                        _elem173.read(iprot)
                        self.onlineExternalParts.append(_elem173)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.skewKeys is not None:
            ...
            for kiter175, viter176 in self.skewKeys.items():
                oprot.writeString(kiter175.encode('utf-8') if sys.version_info[0] == 2 else kiter175)
                oprot.writeListBegin(TType.STRING, len(viter176))
                for iter177 in viter176:
        ...
        if self.onlineExternalParts is not None:
            ...
            for iter178 in self.onlineExternalParts:
                iter178.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
