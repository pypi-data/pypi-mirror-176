...
class Etsy():
    ...
    def get_search_goods(self, page):
        '''
        :param page: 页码
    ...
    def get_shop_goods(self,shop_id, page,limit=36, section_id=None):
        '''
        :param shop_id: 店铺id
        :param page: 页码
        :param limit: 一页多少数据
...
if __name__ == '__main__':
    ...
    #
    data = etsy_obj.get_search_goods(1)
    ...
    #
    # #获取店铺产品
    # data = etsy_obj.get_shop_goods('12308374',limit=500,page=2)
