    ...
    def get_search_products(self, page):
        ...
        try:
            ...
            if self.proxies == None:
                resp = request_handler(url, method='post', headers=headers, data=payload, retry=10,timeout=10)
            else:
                resp = request_handler(url, method='post', headers=headers, data=payload, retry=10, timeout=10,proxies=self.proxies)
