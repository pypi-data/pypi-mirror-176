...
from PyQt5.QtCore import QModelIndex, QMutex, QSize
from PyQt5.QtGui import QIcon, QPixmap
from PyQt5.QtWidgets import QApplication, QComboBox, QLabel, QMainWindow, QWidget
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def on_add_account_event(self, event: AccountEvent) -> None:
        ...
        :return:
        """
        # only open tab when adding a derived account in database
        if event.account.root is not None:
