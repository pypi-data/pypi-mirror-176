...
class PartialAllSiteSettings:
    ...
    #: The ID of the initial base image for the code execution virtual machines
    #: which is shared between all users.
    ...
    #: If enabled teachers can view rubrics on the submissions page, i.e. the
    #: submissions list. Here they have the student view version of the rubric
    #: as apposed to the editor view in the manage assignment page.
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.str,
                doc=(
                    "The ID of the initial base image for the code execution"
                    " virtual machines which is shared between all users."
                ),
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                doc=(
                    ...
                    " page, i.e. the submissions list. Here they have the"
                    " student view version of the rubric as apposed to the"
