...
if t.TYPE_CHECKING or os.getenv("CG_EAGERIMPORT", False):
    ...
    from ..models.bulk_course_registration_link import (
    ...
    from ..models.create_bulk_enroll_result import CreateBulkEnrollResult
    ...
    from ..models.patch_bulk_enroll_link_course_data import (
    ...
    from ..models.post_bulk_enroll_link_course_data import (
    ...
    from ..models.register_user_with_bulk_link_course_data import (
        RegisterUserWithBulkLinkCourseData,
    )
    from ..models.register_user_with_link_course_data import (
        RegisterUserWithLinkCourseData,
    )
    from ..models.result_data_get_course_get_personalized_registration_link import (
...
class CourseService(t.Generic[_ClientT]):
    ...
    def post_bulk_enroll_link(
        self: "CourseService[codegrade.client.AuthenticatedClient]",
        json_body: t.Union[dict, list, "PostBulkEnrollLinkCourseData"],
        *,
        course_id: "int",
        extra_parameters: t.Mapping[
            str, t.Union[str, bool, int, float]
        ...
        """Create a bulk enroll link.

        :param json_body: The body of the request. See
            :class:`.PostBulkEnrollLinkCourseData` for information about the
            possible fields. You can provide this data as a
            :class:`.PostBulkEnrollLinkCourseData` or as a dictionary.
        :param course_id: The id of the course in which this link should enroll
            users.
        :param extra_parameters: The extra query parameters you might want to
            add. By default no extra query parameters are added.

        :returns: A dictionary containing the job sending out the mails and a
                  list of user information for user incompatible with SSO
                  courses.
        """

        url = "/api/v1/courses/{courseId}/bulk_registration_links/".format(
            courseId=course_id
        )
        params = extra_parameters or {}
        ...
        if utils.response_code_matches(resp.status_code, 200):
            # fmt: off
            from ..models.create_bulk_enroll_result import (
                CreateBulkEnrollResult,
            )

            # fmt: on
            return parsers.JsonResponseParser(
                parsers.ParserFor.make(CreateBulkEnrollResult)
            ).try_parse(resp)
    ...
    ) -> "t.Sequence[t.Union[CourseRegistrationLink, BulkCourseRegistrationLink]]":
            ...
            return parsers.JsonResponseParser(
                rqa.List(
                    parsers.make_union(
                        ...
                        parsers.ParserFor.make(BulkCourseRegistrationLink),
                    )
                )
            ).try_parse(resp)
    ...
    def delete_bulk_enroll_link(
        ...
        *,
        ...
        """Delete the given bulk registration link.

        :param course_id: The id of the course to which the bulk registration
            link is connected.
        :param link_id: The id of the bulk registration link.
        :param extra_parameters: The extra query parameters you might want to
            add. By default no extra query parameters are added.
        ...
        url = (
            "/api/v1/courses/{courseId}/bulk_registration_links/{linkId}"
    ...
    def patch_bulk_enroll_link(
        self: "CourseService[codegrade.client.AuthenticatedClient]",
        json_body: t.Union[dict, list, "PatchBulkEnrollLinkCourseData"],
        *,
        course_id: "int",
        link_id: "str",
        extra_parameters: t.Mapping[
        ...
        """Update a bulk enroll link.

        This will *not* resend any emails.

        :param json_body: The body of the request. See
            :class:`.PatchBulkEnrollLinkCourseData` for information about the
            possible fields. You can provide this data as a
            :class:`.PatchBulkEnrollLinkCourseData` or as a dictionary.
        :param course_id: The id of the course in which this link should enroll
            users.
        :param link_id: The id of the bulk registration link.
        :param extra_parameters: The extra query parameters you might want to
    ...
    def get_personalized_registration_link(
        self,
        *,
        course_id: "int",
        link_id: "str",
        ...
        """Get a registration link with precompiled user information for
        sign-up.
        ...
        :param course_id: The id of the course to which the registration link
            is connected.
        :param link_id: The id of the registration link.
        :param user_info_id: The id of the user information.
        :param extra_parameters: The extra query parameters you might want to
            add. By default no extra query parameters are added.

        :returns: The extended serialization of a registration link and the
                  extended serialization of the precompiled user information.
        """

        url = "/api/v1/courses/{courseId}/registration_links/{linkId}/user_info/{userInfoId}".format(
            courseId=course_id, linkId=link_id, userInfoId=user_info_id
        )
        params = extra_parameters or {}
    ...
    def register_user_with_bulk_link(
        self,
        json_body: t.Union[dict, list, "RegisterUserWithBulkLinkCourseData"],
        *,
        course_id: "int",
        link_id: "str",
        extra_parameters: t.Mapping[
        ...
        :param json_body: The body of the request. See
            :class:`.RegisterUserWithBulkLinkCourseData` for information about
            the possible fields. You can provide this data as a
            :class:`.RegisterUserWithBulkLinkCourseData` or as a dictionary.
        :param course_id: The id of the course to which the bulk registration
            link is connected.
        :param link_id: The id of the bulk registration link.
        :param extra_parameters: The extra query parameters you might want to
        ...
        url = (
            "/api/v1/courses/{courseId}/bulk_registration_links/{linkId}/user"
            .format(courseId=course_id, linkId=link_id)
        )
        params = extra_parameters or {}
