...
def dispatchRangeToThreads(beg, end, nb_threads):
...
def currentRandomGeneratorValue():
...
class DiscreteVariable(Variable):
    ...
    def toNumericalDiscreteVar(self):
...
class Instantiation(object):
    ...
    def todict(self, withLabels=True):
        r"""
...
class GraphicalModel(object):
    ...
    @staticmethod
    def spaceCplxToStream(s, dSize, dim, usedMem):
        return _pyAgrum.GraphicalModel_spaceCplxToStream(s, dSize, dim, usedMem)
...
class BayesNet(IBayesNet):
    ...
    def saveBIF(self, name, allowModificationWhenSaving=False):
        r"""
    ...
    def saveDSL(self, name, allowModificationWhenSaving=False):
        r"""
    ...
    def saveNET(self, name, allowModificationWhenSaving=False):
        r"""
    ...
    def saveO3PRM(self, name, allowModificationWhenSaving=False):
        r"""
    ...
    def saveBIFXML(self, name, allowModificationWhenSaving=False):
        r"""
    ...
    def saveUAI(self, name, allowModificationWhenSaving=False):
        r"""
...
class ShaferShenoyMNInference(object):
    ...
    def setNumberOfThreads(self, nb):
        r"""
    ...
    def isGumNumberOfThreadsOverriden(self):
        r"""
    ...
    def setMaxMemory(self, gigabytes):
        r"""
...
class BNLearner(object):
    ...
    def useDirichletPrior(self, *args):
        r"""
    ...
    def mutualInformation(self, *args):
        return _pyAgrum.BNLearner_mutualInformation(self, *args)

    def correctedMutualInformation(self, *args):
