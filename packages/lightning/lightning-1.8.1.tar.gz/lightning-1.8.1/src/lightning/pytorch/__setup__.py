...
_PACKAGE_ROOT = os.path.join(_SOURCE_ROOT, "lightning.pytorch")
...
def _adjust_manifest(**__: Any) -> None:
    ...
    lines += [
        ...
        "recursive-include src/lightning.lite *.md" + os.linesep,
        "recursive-include src/lightning.pytorch *.md" + os.linesep,
        "recursive-include requirements/pytorch *.txt" + os.linesep,
        "include src/lightning.pytorch/py.typed" + os.linesep,  # marker file for PEP 561
    ]
