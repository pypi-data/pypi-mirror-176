...
from lightning.lite.accelerators import ACCELERATOR_REGISTRY
from lightning.lite.accelerators.accelerator import Accelerator
from lightning.lite.accelerators.cuda import CUDAAccelerator
from lightning.lite.accelerators.mps import MPSAccelerator
from lightning.lite.accelerators.tpu import TPUAccelerator
from lightning.lite.plugins import (
    CheckpointIO,
    DeepSpeedPrecision,
...
from lightning.lite.plugins.environments import (
    ClusterEnvironment,
    KubeflowEnvironment,
...
from lightning.lite.plugins.precision.double import DoublePrecision
from lightning.lite.strategies import (
    DDPShardedStrategy,
...
from lightning.lite.strategies.ddp_spawn import _DDP_FORK_ALIASES
from lightning.lite.utilities import _StrategyType, rank_zero_info, rank_zero_warn
from lightning.lite.utilities.device_parser import _determine_root_gpu_device
from lightning.lite.utilities.imports import _IS_INTERACTIVE
