...
class Share(
    ...
    def __init__(
        ...
        *,
        ...
        object: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["ShareObject", typing.Dict[str, typing.Any]]]]] = None,
    ...
    def put_object(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["ShareObject", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def object_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["ShareObject"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["ShareObject"]]], jsii.get(self, "objectInput"))
...
class ShareConfig(cdktf.TerraformMetaArguments):
    ...
    def object(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["ShareObject"]]], result)
...
class ShareObjectList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[ShareObject]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[ShareObject]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[ShareObject]]],
...
class ShareObjectOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[ShareObject, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[ShareObject, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[ShareObject, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[ShareObject, cdktf.IResolvable]],
