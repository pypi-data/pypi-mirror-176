...
class ItemsApi(object):
    ...
    def get_collection_items(
        ...
        **kwargs
        ...
        Returns all collection items as an array of metadata objects.  Please note that ONLY items that have had at least 1 quantity minted will be returned. If you've created an item that has not been minted yet, it will not be returned in the array response.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def grant_collection_role(
        ...
        **kwargs
        ...
        >>> thread = api.grant_collection_role(collection_id, x_authorization, x_password, grant_collection_role_request, async_req=True)
        >>> result = thread.get()
    ...
    def revoke_collection_role(
        ...
        **kwargs
        ...
        >>> thread = api.revoke_collection_role(collection_id, x_authorization, x_password, revoke_collection_role_request, async_req=True)
        >>> result = thread.get()
