...
class CurrenciesApi(object):
    ...
    def grant_currency_role(
        ...
        **kwargs
        ...
        >>> thread = api.grant_currency_role(currency_id, x_authorization, x_password, grant_currency_role_request, async_req=True)
        >>> result = thread.get()
    ...
    def revoke_currency_role(
        ...
        **kwargs
        ...
        >>> thread = api.revoke_currency_role(currency_id, x_authorization, x_password, revoke_collection_role_request, async_req=True)
        >>> result = thread.get()
