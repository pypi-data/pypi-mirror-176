...
def disk_to_logmar(disk_string_input):
    disk_logmar_equivalent = {"disk-condition-1-1": 1.0, "disk-condition-1-2": 1.0, "disk-condition-2-1": 0.9,
                              ...
                              "disk-condition-13-1": -0.2, "disk-condition-13-2": -0.2, "no-disk-condition": 0.0}
...
def main():
    ...
    with open(config_location) as f:
        ...
        if plot_config_info is not None and dir_exist:
            if type_input == "trial":
                csv_name = f"updated_{get_file_name(directory_input)}.csv"
                ...
                plot_data_array, auto_adjust_info = get_plot_info(directory_input, x_data_column_name, y_data_column_name,
