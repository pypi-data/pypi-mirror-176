...
struct bind_frc__SwerveDrivePoseEstimator {
    ...
    static constexpr auto States = SwerveDrivePoseEstimator<NumModules>::States;
static constexpr auto Inputs = SwerveDrivePoseEstimator<NumModules>::Inputs;
static constexpr auto Outputs = SwerveDrivePoseEstimator<NumModules>::Outputs;
...
"heading.\n";
  ...
  cls_SwerveDrivePoseEstimator
      .def(py::init<const Rotation2d&, const Pose2d&, const wpi::array<SwerveModulePosition, NumModules >, SwerveDriveKinematics<NumModules>&, const wpi::array<double, States>&, const wpi::array<double, Outputs>&, const wpi::array<double, 3>&, units::second_t>(),
      py::arg("gyroAngle"), py::arg("initialPose"), py::arg("modulePositions"), py::arg("kinematics"), py::arg("stateStdDevs"), py::arg("localMeasurementStdDevs"), py::arg("visionMeasurementStdDevs"), py::arg("nominalDt")=(units::second_t)0.02_s, release_gil()    , py::keep_alive<1, 2>()    , py::keep_alive<1, 3>()    , py::keep_alive<1, 5>()    , py::keep_alive<1, 6>()    , py::keep_alive<1, 7>()    , py::keep_alive<1, 8>(), py::doc(
...
"                                 loop.")
      ...
      py::arg("pose"), py::arg("gyroAngle"), py::arg("modulePositions"), release_gil(), py::doc(
...
"                                 radians.")
      ...
      py::arg("gyroAngle"), py::arg("moduleStates"), py::arg("modulePositions"), release_gil(), py::doc(
...
":returns: The estimated pose of the robot in meters.")
      ...
      py::arg("currentTime"), py::arg("gyroAngle"), py::arg("moduleStates"), py::arg("modulePositions"), release_gil(), py::doc(
    "Updates the the Unscented Kalman Filter using only wheel encoder\n"
"information. This should be called every loop, and the correct loop period\n"
"must be passed into the constructor of this class.\n"
"\n"
...
":returns: The estimated pose of the robot in meters.")
    ...
    .def_readonly_static("States", &frc::SwerveDrivePoseEstimator<NumModules>::States)
    .def_readonly_static("Inputs", &frc::SwerveDrivePoseEstimator<NumModules>::Inputs)
    .def_readonly_static("Outputs", &frc::SwerveDrivePoseEstimator<NumModules>::Outputs)
;
