...
"when using computer-vision systems.";
  ...
  cls_SwerveDriveOdometry
      ...
      py::arg("kinematics"), py::arg("gyroAngle"), py::arg("modulePositions"), py::arg("initialPose")=Pose2d{}, release_gil()    , py::keep_alive<1, 3>()    , py::keep_alive<1, 5>(), py::doc(
...
":param initialPose:     The starting position of the robot on the field.")
  ...
  if constexpr (NumModules == 2) {
    ...
    return [](SwerveDriveOdometry<NumModules> * self,
      ...
      return self->ResetPosition(pose, gyroAngle, s1, s2, s3, s4);
    };
    ...
    return [](SwerveDriveOdometry<NumModules> * self,
      ...
      return self->ResetPosition(pose, gyroAngle, s1, s2, s3, s4, s5, s6);
    };
  }
}()
, py::doc(
