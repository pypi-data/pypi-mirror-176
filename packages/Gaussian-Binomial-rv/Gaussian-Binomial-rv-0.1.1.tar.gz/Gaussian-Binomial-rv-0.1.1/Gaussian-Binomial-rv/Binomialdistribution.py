...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        x1 = math.factorial(self.n)/(math.factorial(self.n-k)*math.factorial(k))
        x2 = self.p**k * (1-self.p)**(self.n-k)
        return x1 *x2
    ...
    def authorBinomial(self):
        print(f"Binomial = {len(self.FirstName)}")
