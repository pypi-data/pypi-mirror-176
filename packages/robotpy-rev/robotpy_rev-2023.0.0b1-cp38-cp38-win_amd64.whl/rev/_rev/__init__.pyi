...
class CANSparkMaxLowLevel(wpilib.interfaces._interfaces.MotorController):
    ...
    class PeriodicFrame():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        __members__: dict # value = {'kStatus0': <PeriodicFrame.kStatus0: 0>, 'kStatus1': <PeriodicFrame.kStatus1: 1>, 'kStatus2': <PeriodicFrame.kStatus2: 2>, 'kStatus3': <PeriodicFrame.kStatus3: 3>}
