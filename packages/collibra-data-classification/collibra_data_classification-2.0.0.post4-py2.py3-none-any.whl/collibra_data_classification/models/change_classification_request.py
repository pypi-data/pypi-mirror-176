...
class ChangeClassificationRequest(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """ChangeClassificationRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ChangeClassificationRequest.  # noqa: E501

        New name  # noqa: E501

        :return: The name of this ChangeClassificationRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ChangeClassificationRequest.

        New name  # noqa: E501

        :param name: The name of this ChangeClassificationRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeClassificationRequest):
            return False
