...
from collibra_data_classification.models.classify_request import ClassifyRequest  # noqa: E501
...
class TestClassifyRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test ClassifyRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_data_classification.models.classify_request.ClassifyRequest()  # noqa: E501
        if include_optional :
