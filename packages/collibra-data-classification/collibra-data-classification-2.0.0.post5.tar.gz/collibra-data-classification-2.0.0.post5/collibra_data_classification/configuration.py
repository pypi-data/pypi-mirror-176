...
conf = collibra_data_classification.Configuration(
    username='the-user',
    ...
    def __init__(self, host="http://localhost/rest/catalog/1.0",
                 api_key=None, api_key_prefix=None,
                 username=None, password=None,
                 access_token=None, # ROR TODO Added to support JWT
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("collibra_data_classification")
