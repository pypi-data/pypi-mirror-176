...
class generator_lambda_framework:
    ...
    def get_voxel_origin_axis(self, index, axis):
        return (0,0,0)

    def get_field_origin(self, index, dimension):
        return (0,0,0)

    def get_field_origin_x(self, index, dimension):
        return 0

    def get_field_origin_y(self, index, dimension):
        return 0

    def get_field_origin_z(self, index, dimension):
        return 0
...
class generator_lambda_host:
    ...
    def get_field_origin(self, index):
        return self.lambda_framework.get_field_origin(index, 45)
    ...
    def test(self):
        arr = self.lambda_framework.PyMyArray(10)
        arr.set(3, 3333)    
