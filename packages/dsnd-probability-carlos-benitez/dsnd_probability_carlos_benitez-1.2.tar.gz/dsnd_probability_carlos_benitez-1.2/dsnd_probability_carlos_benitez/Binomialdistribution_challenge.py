...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.p = 1.0 * sum(self.mean) / len(self.data)
    ...
    def plot_bar(self):
        ...
        plt.title('Bar char of the data')
        plt.xlabel('outcome')
        plt.ylabel('count')
    ...
    def __repr__(self):
        ...
        return "mean {}, standard deviation{}, p{} y n{}".format(self.mean, self.stdev, self.p, self.n)
        pass
