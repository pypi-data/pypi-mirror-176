...
/* harmony import */ var _widgets_TransformerLeftPanel__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./widgets/TransformerLeftPanel */ "./lib/widgets/TransformerLeftPanel.js");
...
/* harmony import */ var _lib_RPCUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/RPCUtils */ "./lib/lib/RPCUtils.js");
/* harmony import */ var _lib_NotebookUtils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/NotebookUtils */ "./lib/lib/NotebookUtils.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    activate: async (app, labShell, settingRegistry, restorer, toolbarRegistry, translator) => {
        ...
        async function loadPanel() {
            ...
            try {
                const kernel = await _lib_NotebookUtils__WEBPACK_IMPORTED_MODULE_7__["default"].createNewKernel();
                const result = await (0,_lib_RPCUtils__WEBPACK_IMPORTED_MODULE_8__.executeRpc)(kernel, 'proxy.probe', {});
                console.log(result);
            }
            catch (error) {
                console.log(error);
        ...
        app.started.then(() => {
            console.log('started');
            widget = _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget.create(react__WEBPACK_IMPORTED_MODULE_3__.createElement(_widgets_TransformerLeftPanel__WEBPACK_IMPORTED_MODULE_9__.TransformerLeftPanel, { transformerSettings: transformerSettings }));
...
//# sourceMappingURL=lib_index_js.e4f11a6b0e5a146479f0.js.map