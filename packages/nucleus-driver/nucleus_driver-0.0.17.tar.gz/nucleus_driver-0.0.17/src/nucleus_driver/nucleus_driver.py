...
class NucleusDriver:
    ...
    def set_assert_path(self, path: str):
        ...
        self.asserts.set_file_path(path=path)

    def read_assert(self) -> bytes:

        return self.asserts.read_assert()
    ...
    def set_syslog_path(self, path: str):
        ...
        self.syslog.set_file_path(path=path)

    def list_syslog(self):

        self.syslog.list_syslog()

    def read_syslog(self):

        return self.syslog.read_syslog()
