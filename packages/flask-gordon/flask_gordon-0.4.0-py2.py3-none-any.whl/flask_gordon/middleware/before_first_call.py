...
.. autoclass:: BeforeFirstCallMiddleware
...
class BeforeFirstCallMiddleware:
    """
    ...
    def __init__(self, app: "WSGIApplication", fn: t.Callable = None) -> None:
        self.app = app
    ...
    def before_first_call(self, fn: t.Callable) -> t.Callable:
        """
