...
R8Z2_INSTANCES = LocalClusterInstances(gpu_configurations=[a100_config, cpu_config])


class R8Z2Cluster(GenericK8sCluster):
    """ R8Z2 Cluster Overrides """

    allowed_instances: ClusterInstances = R8Z2_INSTANCES
