FIXED forinrange() command and added more description to execute()
----------------------------------------------------------------------------------------
Commands:
...
but can be used more easily and has more permissions. This command will be updated!
...
command - COMMAND = "p" for print, "exit" = exit the program. This command will have more
updates! In the VALUE value on "exit" command type 1, because this command has a few bugs on the "exit" command.
