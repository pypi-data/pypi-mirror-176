...
"""
    ...
    def testDerCodec(self):
        ...
        self.assertEqual(
            rfc3279.sha1WithRSAEncryption, asn1Object["signatureAlgorithm"]["algorithm"]
        )
...
"""
    ...
    def testDerCodec(self):
        ...
        spki_a_p, rest = der_decoder(spki_a["parameters"], asn1Spec=rfc3279.Dss_Parms())
        self.assertFalse(rest)
        self.assertTrue(spki_a_p.prettyPrint())
        self.assertEqual(spki_a["parameters"], der_encoder(spki_a_p))
...
"""
    ...
    def testDerCodec(self):
        ...
        spki_a_p, rest = der_decoder(
            spki_a["parameters"], asn1Spec=rfc3279.KEA_Parms_Id()
        )
        self.assertFalse(rest)
        self.assertTrue(spki_a_p.prettyPrint())
