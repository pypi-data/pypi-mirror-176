...
class ArgoTunnel(
    ...
    jsii_type="@cdktf/provider-cloudflare.argoTunnel.ArgoTunnel",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/argo_tunnel#account_id ArgoTunnel#account_id}
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.argoTunnel.ArgoTunnelConfig",
