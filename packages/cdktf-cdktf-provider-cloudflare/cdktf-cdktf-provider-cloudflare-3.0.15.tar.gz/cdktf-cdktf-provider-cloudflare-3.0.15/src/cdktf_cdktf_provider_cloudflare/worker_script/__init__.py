...
class WorkerScript(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name for the script. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/worker_script#name WorkerScript#name}
