...
class IpList(
    ...
    def __init__(
        ...
        *,
        ...
        item: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["IpListItem", typing.Dict[str, typing.Any]]]]] = None,
    ...
    def put_item(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["IpListItem", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
...
class IpListItemOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[IpListItem, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[IpListItem, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[IpListItem, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[IpListItem, cdktf.IResolvable]],
