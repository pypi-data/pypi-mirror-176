...
class LoadBalancer(
    ...
    def __init__(
        ...
        *,
        ...
        :param zone_id: The zone ID to add the load balancer to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/load_balancer#zone_id LoadBalancer#zone_id}
