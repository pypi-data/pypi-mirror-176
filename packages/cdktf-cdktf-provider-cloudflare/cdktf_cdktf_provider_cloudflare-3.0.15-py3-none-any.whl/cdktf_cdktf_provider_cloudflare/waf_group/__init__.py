...
class WafGroup(
    ...
    jsii_type="@cdktf/provider-cloudflare.wafGroup.WafGroup",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/waf_group#zone_id WafGroup#zone_id}
        ...
        :param mode: Defaults to ``on``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/waf_group#mode WafGroup#mode}
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.wafGroup.WafGroupConfig",
