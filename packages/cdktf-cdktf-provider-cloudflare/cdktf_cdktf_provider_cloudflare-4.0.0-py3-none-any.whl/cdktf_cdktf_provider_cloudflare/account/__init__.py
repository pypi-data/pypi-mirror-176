...
class Account(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        enforce_twofactor: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        :param name: The name of the account that is displayed in the Cloudflare dashboard. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/account#name Account#name}
        :param enforce_twofactor: Whether 2FA is enforced on the account. Defaults to ``false``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/account#enforce_twofactor Account#enforce_twofactor}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/account#id Account#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param type: Account type. Available values: ``enterprise``, ``standard``. Defaults to ``standard``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/account#type Account#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def enforce_twofactor_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "enforceTwofactorInput"))
    ...
    def enforce_twofactor(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "enforceTwofactor"))
