...
class AuthenticatedOriginPullsCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["AuthenticatedOriginPullsCertificateTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/authenticated_origin_pulls_certificate#zone_id AuthenticatedOriginPullsCertificate#zone_id}
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["AuthenticatedOriginPullsCertificateTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["AuthenticatedOriginPullsCertificateTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class AuthenticatedOriginPullsCertificateTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[AuthenticatedOriginPullsCertificateTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[AuthenticatedOriginPullsCertificateTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[AuthenticatedOriginPullsCertificateTimeouts, cdktf.IResolvable]],
