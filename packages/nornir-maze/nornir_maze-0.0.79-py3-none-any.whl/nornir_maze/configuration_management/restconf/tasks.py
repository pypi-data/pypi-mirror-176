...
def rc_verify_current_software_version_fallback_cli(nr_obj: Nornir, verbose=False) -> list:
    """
    TBD
    """
...
def rc_software_install_one_shot_fallback_cli(nr_obj: Nornir, verbose: bool = False) -> bool:
    """
    TBD
    """
...
def rc_install_remove_inactive_fallback_cli(nr_obj: Nornir, verbose: bool = False) -> bool:
    """
    TBD
    """
