...
class InfraEnv(object):
    ...
    swagger_types = {
        ...
        'discovery_kernel_arguments': 'str'
    }
    ...
    attribute_map = {
        ...
        'discovery_kernel_arguments': 'discovery_kernel_arguments'
    }

    def __init__(self, kind=None, id=None, href=None, openshift_version=None, name=None, user_name=None, org_id=None, email_domain=None, proxy=None, additional_ntp_sources=None, ssh_authorized_key=None, pull_secret_set=None, static_network_config=None, type=None, ignition_config_override=None, cluster_id=None, size_bytes=None, download_url=None, generator_version=None, updated_at=None, created_at=None, expires_at=None, cpu_architecture='x86_64', discovery_kernel_arguments=None):  # noqa: E501
        ...
        self._discovery_kernel_arguments = None
        ...
        if discovery_kernel_arguments is not None:
            self.discovery_kernel_arguments = discovery_kernel_arguments
    ...
    @property
    def discovery_kernel_arguments(self):
        """Gets the discovery_kernel_arguments of this InfraEnv.  # noqa: E501

        JSON formatted string array representing the discovery image kernel arguments.  # noqa: E501

        :return: The discovery_kernel_arguments of this InfraEnv.  # noqa: E501
        :rtype: str
        """
        return self._discovery_kernel_arguments

    @discovery_kernel_arguments.setter
    def discovery_kernel_arguments(self, discovery_kernel_arguments):
        """Sets the discovery_kernel_arguments of this InfraEnv.

        JSON formatted string array representing the discovery image kernel arguments.  # noqa: E501

        :param discovery_kernel_arguments: The discovery_kernel_arguments of this InfraEnv.  # noqa: E501
        :type: str
        """

        self._discovery_kernel_arguments = discovery_kernel_arguments
