...
def get_avail_installed_versions(package_name: str) -> Tuple[Iterable[str], str]:
    """
    ...
    avail_versions = strategy(package_name)
...
def parse_args(module_name: str, args: Optional[Sequence[str]] = None) -> ParsedArgs:
