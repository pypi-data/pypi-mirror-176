...
class Vehicle(AddressableObject):  # pylint: disable=too-many-instance-attributes
    ...
    def updateStatus(self, updateCapabilities: bool = True, force: bool = False,  # noqa: C901 # pylint: disable=too-many-branches
        ...
        mileage_dict = self.fetcher.fetchData(f'https://ola.prod.code.seat.cloud.vwgroup.com/v1/vehicles/{self.vin.value}/mileage')
        try:
            ...
            LOG.warn('Cannot get parking position. Car is likely in motion')
            parking_position_dict = None
        ...
        jobs = {
            ...
            Domain.PARKING: {
                'parkingPosition': (ParkingPosition, parking_position_dict)
            },
            Domain.MEASUREMENTS: {
                'odometerStatus': (OdometerMeasurement, mileage_dict)
            }
        }
