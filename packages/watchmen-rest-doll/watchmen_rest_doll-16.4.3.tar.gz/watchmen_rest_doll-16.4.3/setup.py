...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.4.3',
 'watchmen-indicator-surface==16.4.3',
 'watchmen-inquiry-surface==16.4.3',
 'watchmen-pipeline-surface==16.4.3']

extras_require = \
{'boto3': ['boto3>=1.24.20,<2.0.0'],
 'collector': ['watchmen-collector-kernel==16.4.3'],
 ...
 'mysql': ['watchmen-storage-mysql==16.4.3', 'cryptography>=36.0.2,<37.0.0'],
 ...
 'trino': ['watchmen-inquiry-trino==16.4.3']}
