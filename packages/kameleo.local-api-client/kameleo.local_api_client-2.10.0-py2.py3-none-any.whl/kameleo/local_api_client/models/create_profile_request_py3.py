...
class CreateProfileRequest(Model):
    ...
    def __init__(self, *, base_profile_id: str, canvas, webgl, audio, timezone, geolocation, proxy, web_rtc, fonts, plugins, screen, password_manager, name: str=None, tags=None, start_page: str=None, extensions=None, notes: str=None, launcher: str=None, **kwargs) -> None:
