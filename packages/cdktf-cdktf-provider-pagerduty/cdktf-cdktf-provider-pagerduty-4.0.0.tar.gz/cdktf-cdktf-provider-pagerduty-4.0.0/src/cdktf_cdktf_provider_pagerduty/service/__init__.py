...
Refer to the Terraform Registory for docs: [`pagerduty_service`](https://www.terraform.io/docs/providers/pagerduty/r/service).
'''
import abc
import builtins
import datetime
...
class ServiceAlertGroupingParametersOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[ServiceAlertGroupingParameters]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class ServiceIncidentUrgencyRuleOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[ServiceIncidentUrgencyRule]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class ServiceScheduledActionsAtOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[ServiceScheduledActionsAt, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[ServiceScheduledActionsAt, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[ServiceScheduledActionsAt, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[ServiceScheduledActionsAt, cdktf.IResolvable]],
...
class ServiceScheduledActionsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[ServiceScheduledActions, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[ServiceScheduledActions, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[ServiceScheduledActions, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[ServiceScheduledActions, cdktf.IResolvable]],
...
class ServiceSupportHoursOutputReference(
    ...
    def internal_value(self, value: typing.Optional[ServiceSupportHours]) -> None:
        if __debug__:
            def stub(value: typing.Optional[ServiceSupportHours]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
