from pyspv1.spv1dll import Spv1Dll
...
if __name__ == "__main__":
    ...
    spv1dll = Spv1Dll()
    spv1dll.initialize(path="spv1mifare_v102_win.dll",vertical_log=True,log_filter=EnumLogFilter.ALL)
    ...
    if mifare_serial_comm.open_port('COM6', 19200) != True:
