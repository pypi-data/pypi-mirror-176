...
class DataGroup(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'Group': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'Group': ...
