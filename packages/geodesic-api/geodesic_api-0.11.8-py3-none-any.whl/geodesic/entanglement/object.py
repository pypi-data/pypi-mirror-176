...
from geodesic.descriptors import _DatetimeDescr, _DictDescr, _GeometryDescr, _RegexDescr, _StringDescr, _TypeConstrainedDescr
...
class Object(_APIObject, metaclass=ObjectResolver):
    ...
    object_class = _RegexDescr(
        ...
        dict_name="class")
    domain = _RegexDescr(regex=qualifier_re, empty_allowed=True, default="*", doc="the domain of this object")
    category = _RegexDescr(regex=qualifier_re, empty_allowed=True, default="*", doc="the category of this object")
    type = _RegexDescr(regex=qualifier_re, empty_allowed=True, default="*", doc="the type of this object")
    description = _StringDescr(doc="a text description of this object")
    geometry = _GeometryDescr(doc="a geometry for this object. Can be anything, but only points/polygons are indexed")
    item = _DictDescr(doc="an arbitrary dictionary of info about this object. Must be JSON serializable")
    ...
    def connect_with(self, predicate: Union['Predicate', str], object: 'Object', overwrite=False) -> 'Connection':
        """
...
class Event(Object):
    ...
    start_datetime = _DatetimeDescr(doc="a start time or beginning or some time interval for this event")
...
class Link(Object):
    ...
    media_type = _StringDescr(doc="media type of the link", dict_name="media-type")
...
class Predicate(_APIObject):
    edge_attributes = _DictDescr(doc="a dictionary of edge attributes. Must be simple types like strings, ints, floats")
    name = _RegexDescr(regex=name_re, doc="the name of this predicate, describes the relationship very briefly")
...
class Connection(_APIObject):
    ...
    predicate = _TypeConstrainedDescr((Predicate, dict, str), doc="the predicate of this connection")
