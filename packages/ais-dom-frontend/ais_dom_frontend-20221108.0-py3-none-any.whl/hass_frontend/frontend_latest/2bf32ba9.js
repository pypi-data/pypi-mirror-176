/*! For license information please see 2bf32ba9.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[32240],{25782:(e,t,i)=>{i(10994),i(65660),i(70019),i(97968);var r=i(9672),n=i(50856),o=i(33760);(0,r.k)({_template:n.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[o.U]})},89194:(e,t,i)=>{i(10994),i(65660),i(70019);var r=i(9672),n=i(50856);(0,r.k)({_template:n.d`
    <style>
      :host {
    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){y(v(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const f=(0,m.jL)(u,this.hass),y=this._integrations(u,this.entries),v=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(v),b=this._batteryEntity(v),w=this._batteryChargingEntity(v),k=b?this.hass.states[b.entity_id]:void 0,_=k&&"binary_sensor"===(0,l.N)(k),x=w?this.hass.states[w.entity_id]:void 0,$=this._computeArea(this.areas,u),C=[],z=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&z.push(...this._diagnosticDownloadLinks),this._deleteButtons&&z.push(...this._deleteButtons),z.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const A=z.shift();u.disabled_by&&C.push(t.dy`
          ...
          ${"user"===u.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(u,y,C);const P=(0,s.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
        ...
        `:"",D=(0,s.p)(this.hass,"scene")&&v.length?t.dy`
            <ha-card outlined>
              <h1 class="card-header">
                ...
                ${A||z.length?t.dy`
                        <div class="card-actions" slot="actions">
                          <div>
                            <a
                              href=${(0,n.o)(A.href)}
                              rel=${(0,n.o)(A.target?"noreferrer":void 0)}
                              target=${(0,n.o)(A.target)}
                            >
                              <mwc-button
                                class=${(0,n.o)(A.classes)}
                                .action=${A.action}
