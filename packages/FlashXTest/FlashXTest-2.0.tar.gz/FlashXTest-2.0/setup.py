...
setup(
    ...
    package_data={
        "": [
            "FlashXTest/backend/FlashTest/ERROR",
            "FlashXTest/backend/FlashTest/error.sh",
            "FlashXTest/backend/FlashTest/exeScript",
            "FlashXTest/backend/FlashTest/configBase",
            "FlashXTest/backend/FlashTest/configTemplate",
            "FlashXTest/backend/FlashTest/scripts/changeInfoFiles",
            "FlashXTest/backend/FlashTest/scripts/restarttest/restarttest.sh",
        ]
    },
