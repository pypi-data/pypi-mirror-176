...
class GetAppByVersionResponse200:
    ...
    Attributes:
        ...
        policy (Union[Unset, GetAppByVersionResponse200Policy]):
        execution_mode (Union[Unset, GetAppByVersionResponse200ExecutionMode]):
        extra_perms (Union[Unset, GetAppByVersionResponse200ExtraPerms]):
    """
    ...
    policy: Union[Unset, GetAppByVersionResponse200Policy] = UNSET
    execution_mode: Union[Unset, GetAppByVersionResponse200ExecutionMode] = UNSET
    extra_perms: Union[Unset, GetAppByVersionResponse200ExtraPerms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_policy, Unset):
            ...
            policy = GetAppByVersionResponse200Policy.from_dict(_policy)
        ...
        if isinstance(_execution_mode, Unset):
            ...
            execution_mode = GetAppByVersionResponse200ExecutionMode(_execution_mode)
        ...
        if isinstance(_extra_perms, Unset):
            ...
            extra_perms = GetAppByVersionResponse200ExtraPerms.from_dict(_extra_perms)
