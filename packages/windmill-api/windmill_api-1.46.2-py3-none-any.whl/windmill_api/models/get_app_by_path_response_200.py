...
class GetAppByPathResponse200:
    ...
    Attributes:
        ...
        policy (Union[Unset, GetAppByPathResponse200Policy]):
        execution_mode (Union[Unset, GetAppByPathResponse200ExecutionMode]):
        extra_perms (Union[Unset, GetAppByPathResponse200ExtraPerms]):
    """
    ...
    policy: Union[Unset, GetAppByPathResponse200Policy] = UNSET
    execution_mode: Union[Unset, GetAppByPathResponse200ExecutionMode] = UNSET
    extra_perms: Union[Unset, GetAppByPathResponse200ExtraPerms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_policy, Unset):
            ...
            policy = GetAppByPathResponse200Policy.from_dict(_policy)
        ...
        if isinstance(_execution_mode, Unset):
            ...
            execution_mode = GetAppByPathResponse200ExecutionMode(_execution_mode)
        ...
        if isinstance(_extra_perms, Unset):
            ...
            extra_perms = GetAppByPathResponse200ExtraPerms.from_dict(_extra_perms)
