...
/// to the HLO module.
/// * module_: A serialized computation, a text representation of mlir.Module.
...
class XlaCallModule {
 public:
  XlaCallModule(const ::tensorflow::Scope& scope, ::tensorflow::InputList args,
              StringPiece module_, const gtl::ArraySlice<PartialTensorShape>&
              Sout, const DataTypeSlice& Tout, const
              gtl::ArraySlice<::tensorflow::tstring>& dim_args_spec);
