...
class GetConnectorAsync:
    def __init__(self, salureconnect_connection: SalureConnect, token_reference: str = None, test_environment: bool = False, debug: bool = False):
        self.profit = GetConnector(salureconnect_connection, token_reference=token_reference, test_environment=test_environment)
        self.profit_async = ProfitExtractAsync(salureconnect_connection, token_reference=token_reference, test_environment=test_environment, debug=debug)
...
class GetConnector:
    def __init__(self, salureconnect_connection: SalureConnect, token_reference: str, test_environment: bool = False, debug: bool = False):
        self.salureconnect_connection = salureconnect_connection
        if test_environment:
            self.base_url = 'resttest.afas.online'
        else:
            self.base_url = 'rest.afas.online'
        credentials = self.salureconnect_connection.get_system_credential(system='profit', reference=token_reference, test_environment=test_environment)
