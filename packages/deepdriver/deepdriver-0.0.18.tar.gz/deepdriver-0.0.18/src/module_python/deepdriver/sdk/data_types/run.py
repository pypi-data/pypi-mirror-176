...
class Run:
    ...
    def log(self, data: Dict) -> bool:
        ...
        # TODO value값이 Image, Table, Chart 인경우 value값에 각 객체를 json으로 변환한 값을 추가한다.( 각 객체의 to_json호출)
        ...
        succeeded = interface.upload_log(self.run_id, self.log_step, data)
    ...
    def log_artifact(self, artifact: Artifact) -> bool:
        ...
        return artifact.upload(self)

    def use_artifact(self, name: str, type: str, tag: str="", team_name: str="", exp_name: str="") -> Tuple(int, ArtifactRecord):
