...
class dsu_montant_total(Variable):
    ...
    def formula_2020_01(commune, period, parameters):
        ...
        pourcentage_accroissement_dsu_annee_courante = commune.etat('dsu_accroissement_metropole', period)
    ...
    def formula_2013_01(commune, period, parameters):
        # formule pour les tests seulement ?
        ...
        return montants_an_prochain - accroissement * pourcentage_accroissement_dsu_2020  # % à adapter à 2013
