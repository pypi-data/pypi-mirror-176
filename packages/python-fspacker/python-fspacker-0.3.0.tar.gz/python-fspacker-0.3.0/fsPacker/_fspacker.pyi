...
def loads(data:bytes, maxDictSize:int=..., maxOPSize:int=..., maxIndexSize:int=...,
recursiveLimit:int=...) -> Tuple[int, Any]: ...
def load(file:IO[bytes], maxDictSize:int=..., maxOPSize:int=..., maxIndexSize:int=...,
recursiveLimit:int=...) -> Tuple[int, Any]: ...
