    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.45.0.a0",
        "aws_prototyping_sdk.pdk_nag>=0.12.2, <0.13.0",
        "cdk-nag>=2.18.33, <3.0.0",
        "constructs>=10.1.127, <11.0.0",
        "jsii>=1.69.0, <2.0.0",
        "projen>=0.63.11, <0.64.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
