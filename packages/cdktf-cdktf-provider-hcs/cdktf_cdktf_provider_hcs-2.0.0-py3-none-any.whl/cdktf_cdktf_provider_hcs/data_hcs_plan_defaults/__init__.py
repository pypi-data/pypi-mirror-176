...
class DataHcsPlanDefaults(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["DataHcsPlanDefaultsTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        config = DataHcsPlanDefaultsConfig(
            id=id,
            timeouts=timeouts,
    ...
    @builtins.property
    @jsii.member(jsii_name="planVersion")
    def plan_version(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "planVersion"))
    ...
    def timeouts(self) -> "DataHcsPlanDefaultsTimeoutsOutputReference":
        return typing.cast("DataHcsPlanDefaultsTimeoutsOutputReference", jsii.get(self, "timeouts"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataHcsPlanDefaultsTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataHcsPlanDefaultsTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-hcs.dataHcsPlanDefaults.DataHcsPlanDefaultsConfig",
...
class DataHcsPlanDefaultsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataHcsPlanDefaultsConfig(%s)" % ", ".join(
...
class DataHcsPlanDefaultsTimeouts:
    ...
    def __repr__(self) -> str:
        return "DataHcsPlanDefaultsTimeouts(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataHcsPlanDefaultsTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcs.dataHcsPlanDefaults.DataHcsPlanDefaultsTimeoutsOutputReference",
):
    def __init__(
        self,
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataHcsPlanDefaultsTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataHcsPlanDefaultsTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataHcsPlanDefaultsTimeouts, cdktf.IResolvable]],
...
__all__ = [
    "DataHcsPlanDefaults",
    "DataHcsPlanDefaultsConfig",
    "DataHcsPlanDefaultsTimeouts",
