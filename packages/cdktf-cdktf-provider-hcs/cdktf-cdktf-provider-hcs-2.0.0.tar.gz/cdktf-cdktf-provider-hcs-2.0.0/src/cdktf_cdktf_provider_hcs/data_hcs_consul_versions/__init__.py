...
class DataHcsConsulVersions(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["DataHcsConsulVersionsTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        config = DataHcsConsulVersionsConfig(
            id=id,
            timeouts=timeouts,
    ...
    def timeouts(self) -> "DataHcsConsulVersionsTimeoutsOutputReference":
        return typing.cast("DataHcsConsulVersionsTimeoutsOutputReference", jsii.get(self, "timeouts"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataHcsConsulVersionsTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataHcsConsulVersionsTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-hcs.dataHcsConsulVersions.DataHcsConsulVersionsConfig",
...
class DataHcsConsulVersionsConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def __repr__(self) -> str:
        return "DataHcsConsulVersionsConfig(%s)" % ", ".join(
...
class DataHcsConsulVersionsTimeouts:
    ...
    def __repr__(self) -> str:
        return "DataHcsConsulVersionsTimeouts(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataHcsConsulVersionsTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcs.dataHcsConsulVersions.DataHcsConsulVersionsTimeoutsOutputReference",
):
    def __init__(
        self,
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataHcsConsulVersionsTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataHcsConsulVersionsTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataHcsConsulVersionsTimeouts, cdktf.IResolvable]],
...
__all__ = [
    "DataHcsConsulVersions",
    "DataHcsConsulVersionsConfig",
    "DataHcsConsulVersionsTimeouts",
    "DataHcsConsulVersionsTimeoutsOutputReference",
]
