...
class itkCumulativeGaussianOptimizer(itkMultipleValuedNonLinearOptimizer):
    ...
    VerboseOn = _swig_new_instance_method(_ITKOptimizersBasePython.itkCumulativeGaussianOptimizer_VerboseOn)
    VerboseOff = _swig_new_instance_method(_ITKOptimizersBasePython.itkCumulativeGaussianOptimizer_VerboseOff)
...
class itkFRPROptimizer(itkPowellOptimizer):
    ...
    UseUnitLengthGradientOn = _swig_new_instance_method(_ITKOptimizersBasePython.itkFRPROptimizer_UseUnitLengthGradientOn)
    UseUnitLengthGradientOff = _swig_new_instance_method(_ITKOptimizersBasePython.itkFRPROptimizer_UseUnitLengthGradientOff)
