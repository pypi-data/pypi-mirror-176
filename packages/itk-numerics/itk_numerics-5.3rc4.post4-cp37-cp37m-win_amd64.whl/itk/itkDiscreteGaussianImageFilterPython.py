...
def discrete_gaussian_image_filter(*args: itkt.ImageLike,  variance: Union[float, Sequence[float]]=..., maximum_error: Union[float, Sequence[float]]=..., maximum_kernel_width: int=..., filter_dimensionality: int=..., input_boundary_condition: itkt.ImageBoundaryCondition=..., real_boundary_condition: itkt.ImageBoundaryCondition=..., sigma: Union[Sequence[float], float]=..., sigma_array: Sequence[float]=..., use_image_spacing: bool=...,**kwargs)-> itkt.ImageSourceReturn:
