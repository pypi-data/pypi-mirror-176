...
class ArtifactsClient:
    ...
    def download(self, artifact_id: str) -> Awaitable[Response]:
        ...
        return self._client._invoke(Response, "GET", url, "application/octet-stream", None, None)
...
class CatalogsClient:
    ...
    def search_catalog_items(self, resource_paths: list[str]) -> Awaitable[dict[str, CatalogItem]]:
        ...
        url = "/api/v1/catalogs/search-items"

        return self._client._invoke(dict[str, CatalogItem], "POST", url, "application/json", "application/json", json.dumps(JsonEncoder.encode(resource_paths, _json_encoder_options)))
    ...
    def get_availability(self, catalog_id: str, begin: datetime, end: datetime, step: timedelta) -> Awaitable[CatalogAvailability]:
        ...
        queryValues["begin"] = quote(_to_string(begin), safe="")

        queryValues["end"] = quote(_to_string(end), safe="")

        queryValues["step"] = quote(_to_string(step), safe="")
    ...
    def get_license(self, catalog_id: str) -> Awaitable[Optional[str]]:
        ...
        url = "/api/v1/catalogs/{catalogId}/license"
        url = url.replace("{catalogId}", quote(str(catalog_id), safe=""))

        return self._client._invoke(Optional[str], "GET", url, "application/json", None, None)
    ...
    def upload_attachment(self, catalog_id: str, attachment_id: str, content: Union[bytes, Iterable[bytes], AsyncIterable[bytes]]) -> Awaitable[Response]:
        ...
        return self._client._invoke(Response, "PUT", url, "application/octet-stream", "application/octet-stream", content)
    ...
    def delete_attachment(self, catalog_id: str, attachment_id: str) -> Awaitable[Response]:
        ...
        return self._client._invoke(Response, "DELETE", url, "application/octet-stream", None, None)
    ...
    def set_metadata(self, catalog_id: str, metadata: CatalogMetadata) -> Awaitable[None]:
        ...
        return self._client._invoke(type(None), "PUT", url, None, "application/json", json.dumps(JsonEncoder.encode(metadata, _json_encoder_options)))
...
class DataClient:
    ...
    def get_stream(self, resource_path: str, begin: datetime, end: datetime) -> Awaitable[Response]:
        ...
        queryValues["resourcePath"] = quote(_to_string(resource_path), safe="")
...
class JobsClient:
    ...
    def clear_cache(self, catalog_id: str, begin: datetime, end: datetime) -> Awaitable[Job]:
        ...
        queryValues["catalogId"] = quote(_to_string(catalog_id), safe="")
...
class PackageReferencesClient:
    ...
    def get(self) -> Awaitable[dict[str, PackageReference]]:
        ...
        return self._client._invoke(dict[str, PackageReference], "GET", url, "application/json", None, None)
    ...
    def create(self, package_reference: PackageReference) -> Awaitable[UUID]:
        ...
        return self._client._invoke(UUID, "POST", url, "application/json", "application/json", json.dumps(JsonEncoder.encode(package_reference, _json_encoder_options)))
    ...
    def delete(self, package_reference_id: UUID) -> Awaitable[None]:
        ...
        return self._client._invoke(type(None), "DELETE", url, None, None, None)
...
class SourcesClient:
    ...
    def get_registrations(self, user_id: Optional[str] = None) -> Awaitable[dict[str, DataSourceRegistration]]:
        ...
        if user_id is not None:
            queryValues["userId"] = quote(_to_string(user_id), safe="")

        query: str = "?" + "&".join(f"{key}={value}" for (key, value) in queryValues.items())
        url += query

        return self._client._invoke(dict[str, DataSourceRegistration], "GET", url, "application/json", None, None)
    ...
    def create_registration(self, registration: DataSourceRegistration, user_id: Optional[str] = None) -> Awaitable[UUID]:
        ...
        return self._client._invoke(UUID, "POST", url, "application/json", "application/json", json.dumps(JsonEncoder.encode(registration, _json_encoder_options)))
...
class SystemClient:
    ...
    def get_configuration(self) -> Awaitable[Optional[dict[str, object]]]:
        ...
        return self._client._invoke(Optional[dict[str, object]], "GET", url, "application/json", None, None)

    def set_configuration(self, configuration: dict[str, object]) -> Awaitable[None]:
        """
        ...
        return self._client._invoke(type(None), "PUT", url, None, "application/json", json.dumps(JsonEncoder.encode(configuration, _json_encoder_options)))
...
class UsersClient:
    ...
    def authenticate(self, scheme: str, return_url: str) -> Awaitable[Response]:
        ...
        queryValues["scheme"] = quote(_to_string(scheme), safe="")

        queryValues["returnUrl"] = quote(_to_string(return_url), safe="")

        query: str = "?" + "&".join(f"{key}={value}" for (key, value) in queryValues.items())
        url += query

        return self._client._invoke(Response, "POST", url, "application/octet-stream", None, None)

    def sign_out(self, return_url: str) -> Awaitable[Response]:
        """
        Logs out the user.
    ...
    def refresh_token(self, request: RefreshTokenRequest) -> Awaitable[TokenPair]:
        ...
        url = "/api/v1/users/tokens/refresh"
    ...
    def revoke_token(self, request: RevokeTokenRequest) -> Awaitable[Response]:
        ...
        url = "/api/v1/users/tokens/revoke"

        return self._client._invoke(Response, "POST", url, "application/octet-stream", "application/json", json.dumps(JsonEncoder.encode(request, _json_encoder_options)))
    ...
    def get_me(self) -> Awaitable[MeResponse]:
        ...
        return self._client._invoke(MeResponse, "GET", url, "application/json", None, None)
    ...
    def generate_refresh_token(self, description: str, user_id: Optional[str] = None) -> Awaitable[str]:
        ...
        url = "/api/v1/users/tokens/generate"

        queryValues: dict[str, str] = {}

        queryValues["description"] = quote(_to_string(description), safe="")
    ...
    def get_users(self) -> Awaitable[dict[str, NexusUser]]:
        ...
        return self._client._invoke(dict[str, NexusUser], "GET", url, "application/json", None, None)
    ...
    def create_user(self, user: NexusUser) -> Awaitable[str]:
        ...
        return self._client._invoke(str, "POST", url, "application/json", "application/json", json.dumps(JsonEncoder.encode(user, _json_encoder_options)))
    ...
    def get_claims(self, user_id: str) -> Awaitable[dict[str, NexusClaim]]:
        ...
        url = "/api/v1/users/{userId}/claims"
        url = url.replace("{userId}", quote(str(user_id), safe=""))

        return self._client._invoke(dict[str, NexusClaim], "GET", url, "application/json", None, None)
    ...
    def create_claim(self, user_id: str, claim: NexusClaim) -> Awaitable[UUID]:
        ...
        return self._client._invoke(UUID, "POST", url, "application/json", "application/json", json.dumps(JsonEncoder.encode(claim, _json_encoder_options)))
    ...
    def delete_claim(self, claim_id: UUID) -> Awaitable[Response]:
        ...
        url = "/api/v1/users/claims/{claimId}"
    ...
    def get_refresh_tokens(self, user_id: str) -> Awaitable[dict[str, RefreshToken]]:
        ...
        url = "/api/v1/users/{userId}/tokens"
        url = url.replace("{userId}", quote(str(user_id), safe=""))

        return self._client._invoke(dict[str, RefreshToken], "GET", url, "application/json", None, None)
    ...
    def delete_refresh_token(self, token_id: UUID) -> Awaitable[Response]:
        ...
        url = "/api/v1/users/tokens/{tokenId}"
        url = url.replace("{tokenId}", quote(str(token_id), safe=""))
        ...
        while True:
            ...
            if (job_status.status == TaskStatus.CANCELED):
                ...
                if (job_status.result is not None and \
                    ...
                    artifact_id = cast(str, job_status.result)
