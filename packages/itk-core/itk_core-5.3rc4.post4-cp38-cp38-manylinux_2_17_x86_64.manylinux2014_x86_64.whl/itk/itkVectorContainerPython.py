...
class itkVectorContainerULAD(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULAD___New_orig__)
    Clone = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_GetElement)
    SetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_SetElement)
    InsertElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_InsertElement)
    IndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_DeleteIndex)
    Size = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_Size)
    Reserve = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_Reserve)
    Squeeze = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_Squeeze)
    Initialize = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAD_Initialize)
    __swig_destroy__ = _itkVectorContainerPython.delete_itkVectorContainerULAD
    cast = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULAD_cast)
...
itkVectorContainerULAD___New_orig__ = _itkVectorContainerPython.itkVectorContainerULAD___New_orig__
itkVectorContainerULAD_cast = _itkVectorContainerPython.itkVectorContainerULAD_cast
...
class itkVectorContainerULAF(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULAF___New_orig__)
    Clone = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_GetElement)
    SetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_SetElement)
    InsertElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_InsertElement)
    IndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_DeleteIndex)
    Size = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_Size)
    Reserve = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_Reserve)
    Squeeze = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_Squeeze)
    Initialize = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULAF_Initialize)
    __swig_destroy__ = _itkVectorContainerPython.delete_itkVectorContainerULAF
    cast = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULAF_cast)
...
itkVectorContainerULAF___New_orig__ = _itkVectorContainerPython.itkVectorContainerULAF___New_orig__
itkVectorContainerULAF_cast = _itkVectorContainerPython.itkVectorContainerULAF_cast
