...
class itkJPEGImageIO(itk.ITKIOImageBaseBasePython.itkImageIOBase):
    ...
    ProgressiveOn = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_ProgressiveOn)
    ProgressiveOff = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_ProgressiveOff)
    SetCMYKtoRGB = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_SetCMYKtoRGB)
    GetCMYKtoRGB = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_GetCMYKtoRGB)
    CMYKtoRGBOn = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_CMYKtoRGBOn)
    CMYKtoRGBOff = _swig_new_instance_method(_itkJPEGImageIOPython.itkJPEGImageIO_CMYKtoRGBOff)
