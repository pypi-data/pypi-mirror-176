...
class itkVectorContainerULLAD(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULLAD___New_orig__)
    Clone = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_GetElement)
    SetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_SetElement)
    InsertElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_InsertElement)
    IndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_DeleteIndex)
    Size = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_Size)
    Reserve = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_Reserve)
    Squeeze = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_Squeeze)
    Initialize = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAD_Initialize)
    __swig_destroy__ = _itkVectorContainerPython.delete_itkVectorContainerULLAD
    cast = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULLAD_cast)
...
itkVectorContainerULLAD___New_orig__ = _itkVectorContainerPython.itkVectorContainerULLAD___New_orig__
itkVectorContainerULLAD_cast = _itkVectorContainerPython.itkVectorContainerULLAD_cast
...
class itkVectorContainerULLAF(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULLAF___New_orig__)
    Clone = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_GetElement)
    SetElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_SetElement)
    InsertElement = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_InsertElement)
    IndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_DeleteIndex)
    Size = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_Size)
    Reserve = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_Reserve)
    Squeeze = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_Squeeze)
    Initialize = _swig_new_instance_method(_itkVectorContainerPython.itkVectorContainerULLAF_Initialize)
    __swig_destroy__ = _itkVectorContainerPython.delete_itkVectorContainerULLAF
    cast = _swig_new_static_method(_itkVectorContainerPython.itkVectorContainerULLAF_cast)
...
itkVectorContainerULLAF___New_orig__ = _itkVectorContainerPython.itkVectorContainerULLAF___New_orig__
itkVectorContainerULLAF_cast = _itkVectorContainerPython.itkVectorContainerULLAF_cast
