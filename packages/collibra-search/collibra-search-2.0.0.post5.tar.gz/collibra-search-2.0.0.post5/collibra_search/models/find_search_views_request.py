...
class FindSearchViewsRequest(object):
    ...
    def __init__(self, offset=None, limit=None, count_limit=None, name=None, name_match_mode=None, sort_field=None, sort_order=None, local_vars_configuration=None):  # noqa: E501
        """FindSearchViewsRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def name_match_mode(self, name_match_mode):
        ...
        if self.local_vars_configuration.client_side_validation and name_match_mode not in allowed_values:  # noqa: E501
            raise ValueError(
