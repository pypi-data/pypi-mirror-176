...
class Client:
    ...
    def _get_page(self, execution_id, page, page_size, sort_by, filter_str, **kwargs):
        ...
        Args:
            ...
            **kwargs (Any): keyword arguments to pass down to pandas read_csv. See https://pandas.pydata.org/docs/reference/api/pandas.read_csv.html
        ...
        buffer_result = io.StringIO(res)
        return pd.read_csv(buffer_result, encoding='utf-8', **kwargs)

    def get_result(self, execution_id: str, page_size: Optional[int] = 100000, sort_by: Optional[str] = None, filter_str: Optional[str] = None, verbose: bool = False, **kwargs):
        ...
        for page in range(n_pages):
            ...
            chunk = self._get_page(execution_id, page, page_size, sort_by, filter_str, **kwargs)
            if verbose:
                print('done!')
    ...
    def run(self, sql: str, page_size: Optional[int] = 100000, timeout: Optional[int] = 3600, keep_for: Optional[int] = 7200, quiet: Optional[bool] = False, return_job: Optional[bool] = False, _print_fn: Optional[Callable] = None):
