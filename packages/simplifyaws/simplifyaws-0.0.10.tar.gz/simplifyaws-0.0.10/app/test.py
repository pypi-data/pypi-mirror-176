...
def start_testing():
    ...
    saws=SimplifyAWS(services=[Services.SQS],region="ap-southeast-1",aws_access_key="AKIA4PYCDAZLUHJILK7F",aws_secret_key="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",secrets_name='stage/subscription_ms')
