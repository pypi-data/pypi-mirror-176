...
class CloudWanTGW(
    ...
    def __init__(
        ...
        *,
        ...
        attachment_tag: typing.Sequence[typing.Mapping[typing.Any, typing.Any]],
    ...
    def adds2s_vpn(
        ...
        *,
        ...
        return typing.cast(builtins.str, jsii.invoke(self, "adds2sVPN", [name, vpnprops]))
...
class TGWOnCloudWanProps:
    ...
    @builtins.property
    def attachment_tag(self) -> typing.List[typing.Mapping[typing.Any, typing.Any]]:
        '''
        :stability: experimental
        '''
...
class VpnSpecProps:
    def __init__(
        ...
        *,
        ...
        ike_versions: typing.Optional[typing.Sequence[typing.Mapping[typing.Any, typing.Any]]] = None,
