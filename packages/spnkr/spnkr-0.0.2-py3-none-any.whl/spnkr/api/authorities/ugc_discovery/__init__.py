...
class UgcDiscoveryAuthority(BaseAuthority):
    ...
    def get_manifest(self,
                     asset_id: str,
                     version_id: str,
                     clearance_id: str | None = None) -> models.Manifest:
        url = self.URL + f'/hi/manifests/{asset_id}/versions/{version_id}'
        params = dict(clearanceId=clearance_id) if clearance_id is not None else None
        resp = self._session.get(url, params=params)
        resp.raise_for_status()
        return models.Manifest.parse_json(resp.text)
    ...
    def get_engine_gamevariant(self, asset_id: str, version_id: str) -> models.EngineGameVariant:
        url = self.URL + f'/hi/engineGameVariants/{asset_id}/versions/{version_id}'
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.EngineGameVariant.parse_json(resp.text)

    def get_engine_game_variant_without_version(self, asset_id: str) -> models.EngineGameVariant:
        url = self.URL + f'/hi/engineGameVariants/{asset_id}'
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.EngineGameVariant.parse_json(resp.text)

    def get_ugc_game_variant(self, asset_id: str, version_id: str) -> models.UgcGameVariant:
        url = self.URL + f'/hi/ugcGameVariants/{asset_id}/versions/{version_id}'
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.UgcGameVariant.parse_json(resp.text)

    def get_ugc_game_variant_without_version(self, asset_id: str) -> models.UgcGameVariant:
        url = self.URL + f'/hi/ugcGameVariants/{asset_id}'
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.UgcGameVariant.parse_json(resp.text)

    def get_map_mode_pair(self,
                          asset_id: str,
                          version_id: str,
                          clearance_id: str | None = None) -> models.MapModePair:
        url = self.URL + f'/hi/mapModePairs/{asset_id}/versions/{version_id}'
        params = dict(clearanceId=clearance_id) if clearance_id is not None else None
        resp = self._session.get(url, params=params)
        resp.raise_for_status()
        return models.MapModePair.parse_json(resp.text)

    def get_map_mode_pair_without_version(self, asset_id: str) -> models.MapModePair:
    ...
    def get_map(self, asset_id: str, version_id: str) -> models.Map:
        ...
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.Map.parse_json(resp.text)
    ...
    def get_playlist(self,
                     asset_id: str,
                     version_id: str,
                     clearance_id: str | None = None) -> models.Playlist:
        url = self.URL + f'/hi/playlists/{asset_id}/versions/{version_id}'
        params = dict(clearanceId=clearance_id) if clearance_id is not None else None
        resp = self._session.get(url, params=params)
        resp.raise_for_status()
        return models.Playlist.parse_json(resp.text)
    ...
    def get_prefab(self, asset_id: str, version_id: str) -> models.Prefab:
        ...
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.Prefab.parse_json(resp.text)
    ...
    def get_project(self, asset_id: str, version_id: str) -> models.Project:
        ...
        resp = self._session.get(url)
        resp.raise_for_status()
        return models.Project.parse_json(resp.text)
    ...
    def get_tags_info(self) -> models.TagsInfo:
        ...
        resp.raise_for_status()
        return models.TagsInfo.parse_json(resp.text)
    ...
    def search(self,
               ...
               asset_kind: AssetKind | None = None) -> models.Search:
