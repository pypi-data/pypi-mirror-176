...
class OrderLineDisplayNativeSerializer(serializers.Serializer):
    ...
    '''
    geo_targeting = serializers.ListField(child=serializers.CharField(max_length=10, required=True), allow_empty=True,
                                          required=True)
    ...
    '''
    interests = serializers.MultipleChoiceField(choices=DISPLAY_NATIVE_INTERESTS_TYPES, required=False,
                                                allow_empty=True)
