    ...
    for plaText in plaTextList:
        for password in passwordList:
            for checkSize in checkSizeList:
                ...
                Encrypt256(password=password).encryptFile(fpath=plaFile, outpath=cipFile, checkSize=checkSize)
                Encrypt256(password=password).decryptFile(fpath=cipFile, outpath=NewPlaFile)
