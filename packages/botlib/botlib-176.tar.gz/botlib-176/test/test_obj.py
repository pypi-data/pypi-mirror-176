...
from bot.obj import Object, Wd, items, keys, register, update, values
from bot.obj import edit, kind, load, save
from bot.obj import ObjectDecoder, ObjectEncoder
from bot.obj import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "bot.obj.Object")
