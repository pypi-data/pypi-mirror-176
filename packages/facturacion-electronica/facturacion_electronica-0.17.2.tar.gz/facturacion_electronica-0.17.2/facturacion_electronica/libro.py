...
class Libro(object):
    ...
    def _procesar_otros_imp(self, resumen, resumenP):
        ...
        if not 'itemsOtrosImp' in resumenP :
            tots = []
            for o in resumen['itemsOtrosImp']:
                tot = {}
                if 'MntSinCred' not in o:
                    ...
                    no_rec += o['MntSinCred']
            if tots:
                resumenP['itemsOtrosImp'] = tots
            if no_rec > 0:
                resumenP['TotImpSinCredito'] = no_rec
            return resumenP
        seted = False
        itemOtrosImp = []
        for r in resumen['itemsOtrosImp']:
            cod = r['OtrosImp']['CodImp'].replace('_no_rec','')
            for o in resumenP['itemsOtrosImp']:
        ...
        resumenP['itemsOtrosImp'] = itemOtrosImp
    ...
    def _setResumenPeriodoGuias(self, resumen, resumenP):
        ...
        if resumen['TpoOper'] in [1, 2]:
            ...
            TotTraslado = []
            if 'itemsTraslado' not in resumenP:
                ...
                resumenP['itemsTraslado'] = TotTraslado
            else:
                new = []
                seted = False
                for tpo in resumenP['itemsTraslado']:
    ...
    def validar(self):
        ...
        lista = ['TpoDoc', 'TpoImp', 'TotDoc', 'TotAnulado', 'TotMntExe',
                 ...
                 'TotCredIVAUsoComun', 'itemsOtrosImp', 'TotImpSinCredito',
                 ...
                 'TotMntModificado', 'itemsTraslado']
        ResumenPeriodo = []
