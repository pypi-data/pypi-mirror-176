...
setup(
    name='yhmgit',  # How you named your package folder (MyLib)
    packages=['yhmgit'],  # Chose the same as "name"
    ...
    keywords=['yhciutil', 'yhci', 'ciutil'],  # Keywords that define your package best
