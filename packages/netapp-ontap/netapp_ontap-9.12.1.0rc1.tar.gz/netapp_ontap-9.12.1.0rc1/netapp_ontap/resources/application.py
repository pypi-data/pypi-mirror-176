...
* restoring"""
    ...
    """links,mongo_db_on_san,nas,nvme,oracle_on_nfs,oracle_on_san,oracle_rac_on_nfs,oracle_rac_on_san,rpo,s3_bucket,san,sql_on_san,sql_on_smb,statistics,template,vdi_on_nas,vdi_on_san,vsi_on_nas,vsi_on_san,"""
    ...
    """links,delete_data,mongo_db_on_san,name,nas,nvme,oracle_on_nfs,oracle_on_san,oracle_rac_on_nfs,oracle_rac_on_san,rpo,s3_bucket,san,smart_container,sql_on_san,sql_on_smb,statistics,svm,template,vdi_on_nas,vdi_on_san,vsi_on_nas,vsi_on_san,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="application show")
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="application create")
        async def application_create(
            ...
            try:
                ...
                raise ReclineCommandError("Unable to create Application: %s" % err)
            return [resource]
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="application modify")
        async def application_modify(
            ...
            try:
                ...
                raise ReclineCommandError("Unable to modify Application: %s" % err)
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="application delete")
        async def application_delete(
            ...
            try:
                ...
                raise ReclineCommandError("Unable to delete Application: %s" % err)
