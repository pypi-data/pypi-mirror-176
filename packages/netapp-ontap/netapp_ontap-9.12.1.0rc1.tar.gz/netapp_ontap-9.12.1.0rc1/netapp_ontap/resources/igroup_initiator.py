...
class IgroupInitiatorSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    connectivity_tracking = fields.Nested("netapp_ontap.models.igroup_initiator_connectivity_tracking.IgroupInitiatorConnectivityTrackingSchema", data_key="connectivity_tracking", unknown=EXCLUDE)
    r""" The connectivity_tracking field of the igroup_initiator."""

    igroup = fields.Nested("netapp_ontap.resources.igroup.IgroupSchema", data_key="igroup", unknown=EXCLUDE)
...
Example: iqn.1998-01.com.corp.iscsi:name1"""
    ...
    """comment,connectivity_tracking,igroup.name,igroup.uuid,records,"""
    ...
    """comment,connectivity_tracking,igroup.name,igroup.uuid,name,records,"""
