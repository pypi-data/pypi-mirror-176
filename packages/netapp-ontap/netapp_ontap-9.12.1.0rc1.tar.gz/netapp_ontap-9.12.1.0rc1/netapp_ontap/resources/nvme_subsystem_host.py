...
class NvmeSubsystemHostSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    dh_hmac_chap = fields.Nested("netapp_ontap.models.nvme_dh_hmac_chap_authentication.NvmeDhHmacChapAuthenticationSchema", data_key="dh_hmac_chap", unknown=EXCLUDE)
...
Example: nqn.1992-01.example.com:string"""
    ...
    subsystem = fields.Nested("netapp_ontap.models.nvme_subsystem_host_records_subsystem.NvmeSubsystemHostRecordsSubsystemSchema", data_key="subsystem", unknown=EXCLUDE)
    ...
    """dh_hmac_chap,io_queue,nqn,records,subsystem,"""
