...
* required """
    ...
    object_stores = fields.List(fields.Nested("netapp_ontap.models.consistency_group_consistency_groups_tiering_object_stores.ConsistencyGroupConsistencyGroupsTieringObjectStoresSchema", unknown=EXCLUDE), data_key="object_stores")
