...
class StorageSwitchConnectionsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    peer_port = fields.Nested("netapp_ontap.models.storage_switch_connections_peer_port.StorageSwitchConnectionsPeerPortSchema", unknown=EXCLUDE, data_key="peer_port")
    r""" The peer_port field of the storage_switch_connections. """

    source_port = fields.Nested("netapp_ontap.models.storage_switch_connections_source_port.StorageSwitchConnectionsSourcePortSchema", unknown=EXCLUDE, data_key="source_port")
