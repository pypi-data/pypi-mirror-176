...
Example: 1 """
    ...
    message = fields.Nested("netapp_ontap.models.cluster_nodes_controller_failed_power_supply_message.ClusterNodesControllerFailedPowerSupplyMessageSchema", unknown=EXCLUDE, data_key="message")
