...
* auto """
    ...
    r""" Automatic Dedupe Schedule volume state.<br>auto &dash; Volume with auto_state set to auto will have post-process dedupe automatically.<br>deprioritized &dash; Volume with auto_state set to deprioritized will not have have post-process dedupe automatically.
...
* snapvault """
    ...
    """application_io_size,auto_state,compaction,compression,compression_type,cross_volume_dedupe,dedupe,has_savings,last_op_begin,last_op_end,last_op_err,last_op_size,last_op_state,logging_enabled,op_state,path,policy,progress,scanner,schedule,space_savings,state,storage_efficiency_mode,type,"""
    ...
    """application_io_size,compaction,compression,compression_type,cross_volume_dedupe,dedupe,policy,scanner,space_savings,state,storage_efficiency_mode,"""
