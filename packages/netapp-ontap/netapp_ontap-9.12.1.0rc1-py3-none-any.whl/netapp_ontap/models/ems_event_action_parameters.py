...
class EmsEventActionParametersSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The description field of the ems_event_action_parameters. """
...
Example: date-time """
    ...
    r""" The help field of the ems_event_action_parameters. """
...
* query """
    ...
    r""" The title field of the ems_event_action_parameters. """
...
* array """
    ...
    r""" The validation_error_message field of the ems_event_action_parameters. """
