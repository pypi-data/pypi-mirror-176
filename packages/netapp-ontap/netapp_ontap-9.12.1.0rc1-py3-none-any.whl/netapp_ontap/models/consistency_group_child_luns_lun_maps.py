...
__pdoc__ = {
    "ConsistencyGroupChildLunsLunMapsSchema.resource": False,
    "ConsistencyGroupChildLunsLunMapsSchema.opts": False,
...
class ConsistencyGroupChildLunsLunMapsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The igroup field of the consistency_group_child_luns_lun_maps. """
    ...
    @property
    def resource(self):
        return ConsistencyGroupChildLunsLunMaps
...
class ConsistencyGroupChildLunsLunMaps(Resource):

    _schema = ConsistencyGroupChildLunsLunMapsSchema
