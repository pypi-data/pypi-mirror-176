...
__pdoc__ = {
    ...
    "OracleRacOnSanNewIgroupsSchema.opts": False,
    "OracleRacOnSanNewIgroups": False,
}


class OracleRacOnSanNewIgroupsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The igroups field of the oracle_rac_on_san_new_igroups. """
    ...
    r""" The initiator_objects field of the oracle_rac_on_san_new_igroups. """
