...
__pdoc__ = {
    "GivebackStatusSchema.resource": False,
    "GivebackStatusSchema.opts": False,
...
class GivebackStatusSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The error field of the giveback_status. """
...
class GivebackStatus(Resource):

    _schema = GivebackStatusSchema
