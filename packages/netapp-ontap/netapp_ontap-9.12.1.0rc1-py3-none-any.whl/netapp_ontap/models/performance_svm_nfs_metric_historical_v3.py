...
__pdoc__ = {
    ...
    "PerformanceSvmNfsMetricHistoricalV3Schema.opts": False,
    "PerformanceSvmNfsMetricHistoricalV3": False,
}


class PerformanceSvmNfsMetricHistoricalV3Schema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
class PerformanceSvmNfsMetricHistoricalV3(Resource):
