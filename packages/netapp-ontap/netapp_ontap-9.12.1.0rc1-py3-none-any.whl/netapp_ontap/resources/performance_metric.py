...
[
    PerformanceMetric(
        {
            "iops": {"read": 1, "total": 6, "write": 5, "other": 0},
            "duration": "PT15S",
            "status": "ok",
            "timestamp": "2019-01-01T23:33:00+00:00",
            "throughput": {"read": 6826, "total": 212718, "write": 205892, "other": 0},
            "latency": {"read": 148, "total": 199, "write": 216, "other": 0},
        }
    )
]
...
[
    PerformanceMetric(
        {
            "iops": {"read": 18, "total": 45, "write": 26, "other": 0},
            "duration": "PT30M",
            "status": "ok",
            ...
            "latency": {"read": 156, "total": 318, "write": 430, "other": 0},
        }
    ),
    PerformanceMetric(
        {
            "iops": {"read": 48, "total": 76, "write": 28, "other": 0},
            "duration": "PT30M",
            "status": "ok",
            ...
            "latency": {"read": 154, "total": 262, "write": 448, "other": 0},
        }
    ),
    PerformanceMetric(
        {
            "iops": {"read": 94, "total": 548, "write": 16, "other": 437},
            "duration": "PT30M",
            "status": "ok",
            ...
            "latency": {"read": 159, "total": 193, "write": 394, "other": 192},
        }
    ),
    PerformanceMetric(
        {
            "iops": {"read": 0, "total": 13, "write": 13, "other": 0},
            "duration": "PT30M",
            "status": "ok",
            ...
            "latency": {"read": 189, "total": 523, "write": 540, "other": 0},
        }
    ),
]
