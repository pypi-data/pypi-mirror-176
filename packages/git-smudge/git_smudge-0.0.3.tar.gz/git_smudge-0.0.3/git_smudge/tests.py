...
class TestCase(unittest.TestCase):
    ...
    def test_args_2(self):
        ...
        self.assertEqual(filters[1].block, True)
        ...
        self.assertIsInstance(filters[3], git_smudge.CommentOutFilter)
        self.assertEqual(filters[3].match.pattern, 'match_text_3')
        self.assertEqual(filters[3].count, None)

    def test_args_3(self):
        filters = self.get_filters_for_args([
            '--insert', 'match_text_1', 'insert 1', '--block',
            '--insert', 'match_text_2', 'insert 1', 'insert 2', '--line',
            '--comment', 'match_text_3', '--count', '42'
        ...
        self.assertEqual(filters[2].count, 42)
