...
class MlFoundryRun:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # NOTE: soft-disabling system metrics collection for now.
        # after sometime, we will delete the code.
        if "log_system_metrics" in kwargs:
            logger.warning("`log_system_metrics` argument is not supported anymore")
        if False:
    ...
    def use_model(self, fqn: str) -> ModelVersion:
        ...
        Examples:
            ...
            client = mlfoundry.get_client()
            run = client.use_model(project_name="my-new-project")
