...
key_fn = lambda *args, **kwargs: f"{args}_{kwargs}"
...
@decorator
def pickle_cache(func, location='cachedir', ttl_cache=TTLCache(maxsize=128, ttl=8), *args,
                 **kwargs):  # todo 参照 streamlit.cache
