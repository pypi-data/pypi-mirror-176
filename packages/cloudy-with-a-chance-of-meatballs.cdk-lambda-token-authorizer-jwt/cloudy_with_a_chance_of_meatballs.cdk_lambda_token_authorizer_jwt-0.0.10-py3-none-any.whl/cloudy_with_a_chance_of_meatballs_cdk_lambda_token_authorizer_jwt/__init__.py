...
@jsii.data_type(
    jsii_type="cdk-lambda-token-authorizer-jwt.TokenAuthorizerJwtFunctionProps",
    ...
    name_mapping={
        ...
        "tracing_option": "tracingOption",
    },
)
class TokenAuthorizerJwtFunctionProps(aws_cdk.aws_lambda.FunctionOptions):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[aws_cdk.Duration] = None,
        ...
        vpc: typing.Optional[aws_cdk.aws_ec2.IVpc] = None,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
        tracing_option: typing.Optional[aws_cdk.aws_lambda.Tracing] = None,
    ) -> None:
        '''
        :param max_event_age: The maximum age of a request that Lambda sends to a function for processing. Minimum: 60 seconds Maximum: 6 hours Default: Duration.hours(6)
        :param on_failure: The destination for failed invocations. Default: - no destination
        ...
        if __debug__:
            ...
            check_type(argname="argument tracing_option", value=tracing_option, expected_type=type_hints["tracing_option"])
        ...
        if tracing_option is not None:
            self._values["tracing_option"] = tracing_option
    ...
    @builtins.property
    def tracing_option(self) -> typing.Optional[aws_cdk.aws_lambda.Tracing]:
        '''
        :stability: experimental
        '''
        result = self._values.get("tracing_option")
        return typing.cast(typing.Optional[aws_cdk.aws_lambda.Tracing], result)
    ...
    def __repr__(self) -> str:
        return "TokenAuthorizerJwtFunctionProps(%s)" % ", ".join(
...
__all__ = [
    ...
    "TokenAuthorizerJwtFunctionProps",
]
