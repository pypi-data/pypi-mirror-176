...
@jsii.interface(jsii_type="cdk-lambda-token-authorizer-jwt.IAuthorizerOptions")
...
class _IAuthorizerOptionsProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk-lambda-token-authorizer-jwt.IAuthorizerOptions"
...
@jsii.interface(jsii_type="cdk-lambda-token-authorizer-jwt.IAuthorizerOptionsJwks")
...
class _IAuthorizerOptionsJwksProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk-lambda-token-authorizer-jwt.IAuthorizerOptionsJwks"
...
@jsii.data_type(
    jsii_type="cdk-lambda-token-authorizer-jwt.TokenAuthorizerJwtFunctionOptions",
