...
@jsii.interface(
    jsii_type="@cloudy-with-a-chance-of-meatballs/cdk-lambda-token-authorizer-jwt.IAuthorizerOptions"
)
class IAuthorizerOptions(typing_extensions.Protocol):
    '''
    ...
    def jwks(self) -> typing.Optional["IAuthorizerOptionsJwks"]:
        '''
        :stability: experimental
        '''
        ...
    ...
    @builtins.property
    @jsii.member(jsii_name="tokenPayloadJsonSchema")
    def token_payload_json_schema(self) -> typing.Optional[builtins.str]:
        '''
        :stability: experimental
        '''
        ...
...
class _IAuthorizerOptionsProxy:
    '''
    :stability: experimental
    '''

    __jsii_type__: typing.ClassVar[str] = "@cloudy-with-a-chance-of-meatballs/cdk-lambda-token-authorizer-jwt.IAuthorizerOptions"
    ...
    def jwks(self) -> typing.Optional["IAuthorizerOptionsJwks"]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional["IAuthorizerOptionsJwks"], jsii.get(self, "jwks"))
    ...
    def token_payload_json_schema(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "tokenPayloadJsonSchema"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAuthorizerOptions).__jsii_proxy_class__ = lambda : _IAuthorizerOptionsProxy


@jsii.interface(
    jsii_type="@cloudy-with-a-chance-of-meatballs/cdk-lambda-token-authorizer-jwt.IAuthorizerOptionsJwks"
)
class IAuthorizerOptionsJwks(typing_extensions.Protocol):
    '''
    :stability: experimental
    '''
...
class _IAuthorizerOptionsJwksProxy:
    '''
    :stability: experimental
    '''

    __jsii_type__: typing.ClassVar[str] = "@cloudy-with-a-chance-of-meatballs/cdk-lambda-token-authorizer-jwt.IAuthorizerOptionsJwks"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAuthorizerOptionsJwks).__jsii_proxy_class__ = lambda : _IAuthorizerOptionsJwksProxy
...
class TokenAuthorizerJwtFunction(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        authorizer_options: IAuthorizerOptions,
        ...
        props = TokenAuthorizerJwtFunctionOptions(
...
@jsii.data_type(
    jsii_type="@cloudy-with-a-chance-of-meatballs/cdk-lambda-token-authorizer-jwt.TokenAuthorizerJwtFunctionOptions",
...
class TokenAuthorizerJwtFunctionOptions(aws_cdk.aws_lambda.FunctionOptions):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[aws_cdk.Duration] = None,
        ...
        if __debug__:
            ...
            check_type(argname="argument authorizer_options", value=authorizer_options, expected_type=type_hints["authorizer_options"])
    ...
    @builtins.property
    def authorizer_options(self) -> IAuthorizerOptions:
        '''
        :stability: experimental
        '''
        result = self._values.get("authorizer_options")
        assert result is not None, "Required property 'authorizer_options' is missing"
        return typing.cast(IAuthorizerOptions, result)
    ...
    def __repr__(self) -> str:
        return "TokenAuthorizerJwtFunctionOptions(%s)" % ", ".join(
...
__all__ = [
    "IAuthorizerOptions",
    "IAuthorizerOptionsJwks",
    "TokenAuthorizerJwtFunction",
    "TokenAuthorizerJwtFunctionOptions",
]
