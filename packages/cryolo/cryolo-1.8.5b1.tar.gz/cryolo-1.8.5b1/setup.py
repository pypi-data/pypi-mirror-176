...
class PostInstallCommand(install):
    ...
    def binaries_directory(self):
        import os, sys, site
        import cryolo.config_tools as _
    ...
    def run(self):
        ...
        if bin_dir is not None:
            ...
            print("and in the cryolo train config set to the 'backend_weights' option to this file.")
            print("############################################")
        install.run(self)
...
setup(
    ...
    extras_require={
        ...
        'c11':  ['nvidia-tensorflow[horovod] < 1.16, >= 1.15.5+nv22.1','janni >= 0.3.0b5'],
    },
    install_requires=[
        "mrcfile >= 1.3.0",
        "Cython",
