...
from gcid import Object, Wd, items, keys, register, update, values
from gcid import edit, kind, load, save
from gcid import ObjectDecoder, ObjectEncoder
from gcid import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertTrue(Object().__module__, "gcid")

    def test_kind(self):
        self.assertEqual(kind(Object()), "gcid.obj.Object")
