...
class ConfigWindow(QDialog):
    """
    Класс, определяющий и создающий окно изменения настроек сервера
    """
    ...
    def open_file_dialog(self):
        """
        Метод, окрывающий окно определения пути до файла базы данных сервера
        """
    ...
    def save_server_config(self):
        """
        Метод, проверяющий введённые данные на корректность и сохраняющий настройки в файле, если они корректны
        """
