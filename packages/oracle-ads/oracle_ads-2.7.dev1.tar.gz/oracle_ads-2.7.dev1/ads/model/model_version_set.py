...
class ModelVersionSet(Builder):
    ...
    def _models(self, **kwargs) -> List[oci.data_science.models.ModelSummary]:
        ...
        Returns
        -------
        List[oci.data_science.models.ModelSummary]
        ...
        return self.dsc_model_version_set.client.list_models(
            compartment_id=self.compartment_id,
            model_version_set_name=self.name,
            **kwargs,
        ).data

    def models(self, **kwargs) -> "ads.catalog.model.ModelSummaryList":
        """Gets list of models associated with a model version set.
        ...
        kwargs:
            ...
            include_deleted: bool
                Whether to include deleted models in the returned list. Defaults to False.
        ...
        return ModelCatalog(
            compartment_id=self.compartment_id,
            ds_client=self.dsc_model_version_set.client,
            identity_client=kwargs.pop("identity_client", None),
        ).list_models(
...
def model_version_set(
    name: str, create_if_not_exists: Optional[bool] = True, **kwargs: Dict
):
