...
{models}"""
    ...
    def __init__(self, metadata, noindexes=False, noconstraints=False, nojoined=False,
        ...
        for model in classes.values():
            if model.parent_name != 'Base,CUdr':
        ...
        self.collector.add_literal_import('models.ex_import', '*')
    ...
    def render_metadata_declarations(self):
        ...
        import time
        return '# design by seven  ' + str(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()))
