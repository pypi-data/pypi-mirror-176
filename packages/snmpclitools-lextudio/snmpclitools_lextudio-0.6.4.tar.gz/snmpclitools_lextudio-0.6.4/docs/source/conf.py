...
latex_documents = [
    (master_doc, 'PySNMPApplications.tex', 'PySNMP Applications Documentation',
     'Ilya Etingof', 'manual'),
]
...
man_pages = [
    (master_doc, 'pysnmpapplications', 'PySNMP Applications Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PySNMPApplications', 'PySNMP Applications Documentation',
     author, 'PySNMPApplications', 'One line description of project.',
     'Miscellaneous'),
]
