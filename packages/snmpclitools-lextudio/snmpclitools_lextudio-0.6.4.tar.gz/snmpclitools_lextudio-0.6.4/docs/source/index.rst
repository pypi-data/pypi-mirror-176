...
`public instance <https://www.pysnmp.com/snmpsim/public-snmp-agent-simulator.html>`_
of `SNMP agent simulator <https://www.pysnmp.com/snmpsim/>`_ at *demo.pysnmp.com*.
...
some of the well-known MIBs (such as `SNMPv2-MIB <https://mibs.pysnmp.com/asn1/SNMPv2-MIB>`_)
