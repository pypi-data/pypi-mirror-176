...
def resolve_sub(hub, ref: str, gcp_api):
    ...
    def gen_sub(ref: str, gcp_api):
        ...
        callpath[-2] = hub.tool.gcp.case.camel(callpath[-2])
...
def process_response(hub, response: Dict, resource_type: str) -> Dict:
    ...
    if isinstance(response.get("items"), list):
        ...
        ret_items = []
        for service_resource in response["items"]:
            ret_items.append(
                hub.tool.gcp.resolver.filter_raw_properties_to_present(
        ...
        return hub.tool.gcp.resolver.filter_raw_properties_to_present(
