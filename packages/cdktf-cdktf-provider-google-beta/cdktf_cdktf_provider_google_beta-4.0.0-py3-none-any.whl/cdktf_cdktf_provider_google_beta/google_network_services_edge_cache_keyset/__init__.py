...
class GoogleNetworkServicesEdgeCacheKeyset(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        public_key: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["GoogleNetworkServicesEdgeCacheKeysetPublicKey", typing.Dict[str, typing.Any]]]],
...
class GoogleNetworkServicesEdgeCacheKeysetConfig(cdktf.TerraformMetaArguments):
    ...
    def public_key(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["GoogleNetworkServicesEdgeCacheKeysetPublicKey"]]:
        '''public_key block.
        ...
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["GoogleNetworkServicesEdgeCacheKeysetPublicKey"]], result)
...
class GoogleNetworkServicesEdgeCacheKeysetPublicKey:
    def __init__(self, *, id: builtins.str, value: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, id: builtins.str, value: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
