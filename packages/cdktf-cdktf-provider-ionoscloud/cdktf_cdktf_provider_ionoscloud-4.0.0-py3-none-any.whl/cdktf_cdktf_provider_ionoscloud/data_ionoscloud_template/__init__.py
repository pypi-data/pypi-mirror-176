...
Refer to the Terraform Registory for docs: [`data_ionoscloud_template`](https://www.terraform.io/docs/providers/ionoscloud/d/template).
'''
import abc
import builtins
import datetime
...
class DataIonoscloudTemplate(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataIonoscloudTemplateTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataIonoscloudTemplateTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class DataIonoscloudTemplateTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataIonoscloudTemplateTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataIonoscloudTemplateTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataIonoscloudTemplateTimeouts, cdktf.IResolvable]],
