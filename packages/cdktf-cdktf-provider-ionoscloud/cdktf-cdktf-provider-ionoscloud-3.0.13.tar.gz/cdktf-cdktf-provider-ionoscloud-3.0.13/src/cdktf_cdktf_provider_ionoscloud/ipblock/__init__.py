...
class Ipblock(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["IpblockTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["IpblockTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class IpblockIpConsumersOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[IpblockIpConsumers, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[IpblockIpConsumers, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[IpblockIpConsumers, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[IpblockIpConsumers, cdktf.IResolvable]],
...
class IpblockTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[IpblockTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[IpblockTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[IpblockTimeouts, cdktf.IResolvable]],
