...
class DataIonoscloudVolume(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataIonoscloudVolumeTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataIonoscloudVolumeTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class DataIonoscloudVolumeTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataIonoscloudVolumeTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataIonoscloudVolumeTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataIonoscloudVolumeTimeouts, cdktf.IResolvable]],
