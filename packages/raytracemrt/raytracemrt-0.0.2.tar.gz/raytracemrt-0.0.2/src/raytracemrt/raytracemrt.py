...
def main():
    ...
    if pts_path != None:
        ...
        for cnt,p in enumerate(split_paths):
            ...
            project.project(p, pts_path, sensor_pos, intersection_path, voxel_path, voxel_size, True)
        ...
        for cnt,p in enumerate(split_paths):
            print('Projecting ... ...', cnt+1, '/', nsplits)
            intersection_path = os.path.join(intersect_dir, 'projected_intersections' + str(cnt) + '.ply')
            project2box.proj2box(p, intersection_path, sensor_pos, rm_dim, True)
        print('========================')
        print('Done Projecting ... ...')
        print('========================')
        #--------------------------------------------------------
        ...
        utils.vox_bx(intersect_dir, voxel_path, voxel_size, True)
        voxel_paths.append(voxel_path)
        print('========================')
    ...
    if nvp == len(voxel_paths):
        if nvp == 1:
            ...
            merge_vox.processed_merge_vx(voxel_dir, False)
        ...
        print('Gridding ... ...')
        print('========================')
        grid_paths = gen_grids.gen_grids(vpath2process, grid_dir, grid_dim, 10000, True)
        ...
        for cnt,p in enumerate(grid_paths):
            ...
            calc_mrt.calc_mrt(vpath2process, p, mrt_path, True)
        ...
        print('========================')
        utils.merge_viz(mrt_dir, grid_dir, vpath2process, True)
