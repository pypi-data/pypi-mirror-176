...
class DataAzurestackLbRule(
    cdktf.TerraformDataSource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRule",
):
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["DataAzurestackLbRuleTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        :param loadbalancer_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#loadbalancer_id DataAzurestackLbRule#loadbalancer_id}.
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#name DataAzurestackLbRule#name}.
        :param resource_group_name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#resource_group_name DataAzurestackLbRule#resource_group_name}.
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#id DataAzurestackLbRule#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#timeouts DataAzurestackLbRule#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        config = DataAzurestackLbRuleConfig(
    ...
    def put_timeouts(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurestack/d/lb_rule#read DataAzurestackLbRule#read}.
        '''
        value = DataAzurestackLbRuleTimeouts(read=read)
    ...
    def timeouts(self) -> "DataAzurestackLbRuleTimeoutsOutputReference":
        return typing.cast("DataAzurestackLbRuleTimeoutsOutputReference", jsii.get(self, "timeouts"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataAzurestackLbRuleTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataAzurestackLbRuleTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleConfig",
...
class DataAzurestackLbRuleConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
        ...
        if isinstance(timeouts, dict):
            timeouts = DataAzurestackLbRuleTimeouts(**timeouts)
        if __debug__:
            def stub(
                *,
                connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    @builtins.property
    def timeouts(self) -> typing.Optional["DataAzurestackLbRuleTimeouts"]:
        '''timeouts block.
        ...
        return typing.cast(typing.Optional["DataAzurestackLbRuleTimeouts"], result)
    ...
    def __repr__(self) -> str:
        return "DataAzurestackLbRuleConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleTimeouts",
    jsii_struct_bases=[],
    name_mapping={"read": "read"},
)
class DataAzurestackLbRuleTimeouts:
    ...
    def __repr__(self) -> str:
        return "DataAzurestackLbRuleTimeouts(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataAzurestackLbRuleTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-azurestack.dataAzurestackLbRule.DataAzurestackLbRuleTimeoutsOutputReference",
):
    def __init__(
        self,
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataAzurestackLbRuleTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataAzurestackLbRuleTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataAzurestackLbRuleTimeouts, cdktf.IResolvable]],
...
__all__ = [
    ...
    "DataAzurestackLbRuleConfig",
    "DataAzurestackLbRuleTimeouts",
    "DataAzurestackLbRuleTimeoutsOutputReference",
]
