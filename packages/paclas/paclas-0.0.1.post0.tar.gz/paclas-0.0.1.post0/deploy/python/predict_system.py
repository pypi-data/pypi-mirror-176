...
from paclas.deploy.utils.draw_bbox import draw_bbox_results
from paclas.deploy.python.predict_rec import RecPredictor
from paclas.deploy.python.predict_det import DetPredictor
