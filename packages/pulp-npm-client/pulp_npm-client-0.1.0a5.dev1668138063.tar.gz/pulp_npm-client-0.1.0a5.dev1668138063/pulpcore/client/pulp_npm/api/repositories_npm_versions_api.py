...
class RepositoriesNpmVersionsApi(object):
    ...
    def repair(self, npm_npm_repository_version_href, repair, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair(npm_npm_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repair_with_http_info(npm_npm_repository_version_href, repair, **kwargs)  # noqa: E501

    def repair_with_http_info(self, npm_npm_repository_version_href, repair, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_with_http_info(npm_npm_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
