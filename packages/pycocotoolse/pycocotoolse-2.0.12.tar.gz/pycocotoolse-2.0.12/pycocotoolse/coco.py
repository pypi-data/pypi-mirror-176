...
# segmentation, and caption generation. pycocotoolse is a Python API that
# assists in loading, parsing and visualizing the annotations in COCO.
# Please visit http://mscoco.org/ for more information on COCO, including
# for the data, paper, and tutorials. The exact format of the annotations
# is also described on the COCO website. For example usage of the pycocotoolse
# please see pycocotoolse_demo.ipynb. In addition to this API, please download both
...
class COCO:
    ...
    def createIndex(self):
        ...
        anns, cats, imgs = {}, {}, {}
        imgNameToId, imgToAnns, catToImgs, imgNameToId = [defaultdict(list) for _ in range(4)]
    ...
    def updateAnnotation(self, id, imgId, segmentation):
        ...
        for rec in self.dataset["annotations"]:
            if rec["id"] == id:
                # @todo TODO move into debug codes or controlskk
                print(
                    "record point : ",
