...
def main():
    ...
    parser.add_argument('-c', '--credential-json', help='JSON file contains database credentials.',
                        required=True, type=cmder.filename)
    parser.add_argument('-e', '--experiment-json', help='JSON file describes all experiments.',
                        required=True, type=cmder.filename)
    parser.add_argument('-l', '--library-json', help='JSON file describes all libraries.',
                        required=True, type=cmder.filename)
    parser.add_argument('-x', '--link-json', help='JSON file describes all sequence file links.',
                        required=True, type=cmder.filename)
