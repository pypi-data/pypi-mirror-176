...
from acceldata_sdk.models.ruleExecutionResult import RuleExecutionSummary
...
class BackingAsset:
    ...
    def __init__(self, id=None, ruleId=None, tableAssetId=None, customQuery=None, customTableAssetIds=None,
                 tableAlias=None, marker=None, **kwargs):
        self.id = id
        self.ruleId = ruleId
...
class RuleThresholdLevel:
    ...
    def __init__(self, success, warning, **kwargs):
...
class RuleTag:
    ...
    def __init__(self, id, tagId, ruleId, name, **kwargs):
        self.id = id
        self.tagId = tagId
        self.ruleId = ruleId
        self.name = name
...
class PolicyGroup:
    ...
    def __init__(self, id, name, description, createdAt, updatedAt, tenantId,**kwargs):
        self.id = id
        self.name = name
        self.description = description
        self.createdAt = createdAt
...
class RuleResource:
    def __init__(self, rule, details, client=None, **kwargs):
        self.rule = rule
