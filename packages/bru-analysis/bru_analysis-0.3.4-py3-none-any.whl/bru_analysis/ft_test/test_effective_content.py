...
from engagement_rate import EngagementRateFB, EngagementRateIG, EngagementRateTW
groups = {}
words = ['hamburguesa', 'pedido', 'corral', 'mcdonald']
# words = ['hdhjsgdfhg']
account_ids_fb = [160665307320292, 335653391129]

df_pages_fb = pd.read_csv("../facebook_lib_facebook_pages.csv")
df_posts_fb = pd.read_csv("../facebook_lib_facebook_posts.csv")
...
most_eff_hashtags_fb, compare_hashtags_fb, most_eff_mentions_fb, compare_mentions_fb = mec_fb.hashtags_mentions(compare_group="no_group", account_ids=account_ids_fb)
most_eff_words_fb, most_eff_nouns_fb, most_eff_verbs_fb, most_eff_adjs_fb = mec_fb.words()


df_pages_tw = pd.read_csv("../twitter_lib_tweetreply.csv")
df_posts_tw = pd.read_csv("../twitter_lib_tweet.csv")
account_ids_tw = [743597244, 132971039]
...
most_eff_hashtags_tw, compare_hashtags_tw, most_eff_mentions_tw, compare_mentions_tw = mec_tw.hashtags_mentions(compare_group="no_group", account_ids=account_ids_tw, search_word=words)
...
df_pages_ig = pd.read_csv("../instagram_lib_profile.csv")
df_posts_ig = pd.read_csv("../instagram_lib_posts.csv")
