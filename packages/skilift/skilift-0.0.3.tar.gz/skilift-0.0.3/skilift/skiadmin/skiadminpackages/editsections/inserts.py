...
def insert_in_section(skicall):
    ...
    part_tuple = utils.part_info(editedprojname, None, section_name, location)
...
def insert_text(skicall):
    ...
    call_data['schange'], new_location = utils.insert_item_in_section(editedprojname, section_name, call_data['schange'], location, new_text)
