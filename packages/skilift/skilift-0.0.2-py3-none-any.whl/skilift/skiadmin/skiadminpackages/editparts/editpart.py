...
def retrieve_editpart(skicall):
    ...
    # a utils.part_tuple is (project, pagenumber, page_part, section_name, name, location, part_type, brief)
...
def downloadpart(skicall):
    ...
    part_info = utils.part_info(project, pagenumber, section_name, call_data['location'])
    ...
    versions = utils.versions(project)
