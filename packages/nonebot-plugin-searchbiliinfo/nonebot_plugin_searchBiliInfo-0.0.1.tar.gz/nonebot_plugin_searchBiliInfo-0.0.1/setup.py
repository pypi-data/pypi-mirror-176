...
setup(
    ...
    long_description="A plugin for nonebot2. Query Bilibili user information（一个Nonebot2的插件，查询b站用户粉丝、舰团信息查询插件）",
    ...
    platforms="any",
    install_requires=["nonebot2", "nonebot-adapter-onebot", "requests"]  # 这个项目依赖的第三方库
)
