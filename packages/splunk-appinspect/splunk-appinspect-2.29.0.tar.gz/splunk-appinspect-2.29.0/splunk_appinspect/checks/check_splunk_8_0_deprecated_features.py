...
@splunk_appinspect.tags(
    "splunk_appinspect", "removed_feature", "splunk_8_0", "cloud", "private_app", "private_victoria", "private_classic"
)
...
@splunk_appinspect.tags(
    "splunk_appinspect", "splunk_8_0", "cloud", "private_app", "private_victoria", "private_classic"
)
