...
class AugmentQueries(object):
    ...
    def __create_rows_per_table(self, keys: Iterable, table: str):
        ...
        Queries.simple_edit(
            ...
            """,
            connection=self._connection, unique_checks=False, foreign_key_checks=False
        )
    ...
    def __set_feature(self, table: str, features: pd.DataFrame, columns: list):
        ...
        Queries.simple_edit(
            ...
            unique_checks=False, foreign_key_checks=False
        )
...
class PredictionQueries(AugmentQueries):
    PER_CYCLE_TABLE = 'prediction_per_cycle'
    ...
    def __init__(self, connection: RelationalConnection):
        ...
        self.per_cycle_table = PredictionQueries.PER_CYCLE_TABLE
        ...
        self.required_columns_for_table = {
            self.per_cycle_table: ['prediction_per_test', 'ip', 'dev_uid', 'unit_id', 'chl_id', 'test_id', 'cycle', 'predictor'],
        ...
        self.nullable_columns = ['create_date', 'blob_type']
