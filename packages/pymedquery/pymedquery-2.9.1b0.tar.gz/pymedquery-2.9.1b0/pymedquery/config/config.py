...
data_path_aff: str = pkg_resources.path('pymedquery.sql.default', 'image_affine_default_query.sql')
...
BLOB_UIDS: List[str] = ['series_uid', 'mask_uid', 'affine_uid', 'model_id']
...
USELESS_SERIES: str = 'series_b7274b843bb9e6b0364447073c2640a3c4d79706d819b95df09cacaecbdfcd38c14ee133249a5cfed773a584ff2bb'
TEST_SQL_FILE: os.PathLike = os.path.join(ROOT, 'pymedquery/data/sql/create.sql')
TEST_SQL_FILEPATH_FULL: os.PathLike = os.path.join(ROOT, 'pymedquery/sql/default/image_default_query.sql')
TEST_SQL_FILE_MODELW: os.PathLike = os.path.join(ROOT, 'tests/data/sql/model_w_extract.sql')
...
TEST_BATCH_FILEPATH: os.PathLike = os.path.join(ROOT, 'tests/data/sql/batch_extract.sql')
