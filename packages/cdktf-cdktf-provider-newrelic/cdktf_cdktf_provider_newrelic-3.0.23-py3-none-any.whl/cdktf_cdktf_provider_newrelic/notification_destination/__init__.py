...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.notificationDestination.NotificationDestinationProperties",
    jsii_struct_bases=[],
    name_mapping={
        "key": "key",
        "value": "value",
...
class NotificationDestinationPropertiesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-newrelic.notificationDestination.NotificationDestinationPropertiesList",
):
    def __init__(
        self,
...
class NotificationDestinationPropertiesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-newrelic.notificationDestination.NotificationDestinationPropertiesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[NotificationDestinationProperties, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[NotificationDestinationProperties, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[NotificationDestinationProperties, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[NotificationDestinationProperties, cdktf.IResolvable]],
