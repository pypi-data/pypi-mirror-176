...
class DataNewrelicSyntheticsMonitorLocation(
    ...
    jsii_type="@cdktf/provider-newrelic.dataNewrelicSyntheticsMonitorLocation.DataNewrelicSyntheticsMonitorLocation",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.dataNewrelicSyntheticsMonitorLocation.DataNewrelicSyntheticsMonitorLocationConfig",
