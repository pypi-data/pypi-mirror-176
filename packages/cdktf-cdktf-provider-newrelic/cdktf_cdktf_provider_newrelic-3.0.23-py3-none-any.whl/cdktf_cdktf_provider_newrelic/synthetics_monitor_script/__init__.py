...
class SyntheticsMonitorScript(
    ...
    jsii_type="@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScript",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScriptConfig",
...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScriptLocation",
    jsii_struct_bases=[],
...
class SyntheticsMonitorScriptLocationList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScriptLocationList",
):
    def __init__(
        self,
...
class SyntheticsMonitorScriptLocationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-newrelic.syntheticsMonitorScript.SyntheticsMonitorScriptLocationOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[SyntheticsMonitorScriptLocation, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[SyntheticsMonitorScriptLocation, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SyntheticsMonitorScriptLocation, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[SyntheticsMonitorScriptLocation, cdktf.IResolvable]],
