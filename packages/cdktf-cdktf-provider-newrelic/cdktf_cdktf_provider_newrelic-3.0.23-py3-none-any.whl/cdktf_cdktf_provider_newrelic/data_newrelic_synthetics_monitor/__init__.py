...
class DataNewrelicSyntheticsMonitor(
    ...
    jsii_type="@cdktf/provider-newrelic.dataNewrelicSyntheticsMonitor.DataNewrelicSyntheticsMonitor",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.dataNewrelicSyntheticsMonitor.DataNewrelicSyntheticsMonitorConfig",
