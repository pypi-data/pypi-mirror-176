...
class DataNewrelicPluginComponent(
    ...
    jsii_type="@cdktf/provider-newrelic.dataNewrelicPluginComponent.DataNewrelicPluginComponent",
):
...
@jsii.data_type(
    jsii_type="@cdktf/provider-newrelic.dataNewrelicPluginComponent.DataNewrelicPluginComponentConfig",
