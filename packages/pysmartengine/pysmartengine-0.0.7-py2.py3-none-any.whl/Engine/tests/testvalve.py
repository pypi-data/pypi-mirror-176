import Framework,Pipe,Orifice,Environment,GasProperty,Valve,Cylinder,Volume
...
inits3=GasProperty.initstate("init3").init(Mix,3.5e5,300)

# GasProperty.species({"Air":0.7,"N2":0.30})
...
S=Framework.Sensor().connect(Vol2.getport("T"))
