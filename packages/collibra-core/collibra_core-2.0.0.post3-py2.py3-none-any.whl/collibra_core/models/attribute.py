...
class Attribute(object):
    ...
    def __init__(self, asset=None, value=None, type=None, created_on=None, last_modified_on=None, resource_type=None, created_by=None, last_modified_by=None, system=None, id=None, local_vars_configuration=None):  # noqa: E501
