...
class RelationTraceImpl(object):
    ...
    def __init__(self, id=None, created_by=None, created_on=None, last_modified_by=None, last_modified_on=None, system=None, resource_type=None, relation_trace_entries=None, local_vars_configuration=None):  # noqa: E501
        """RelationTraceImpl - a model defined in OpenAPI"""  # noqa: E501
