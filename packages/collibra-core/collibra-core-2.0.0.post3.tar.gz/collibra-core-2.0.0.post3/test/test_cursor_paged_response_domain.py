...
from collibra_core.models.cursor_paged_response_domain import CursorPagedResponseDomain  # noqa: E501
from collibra_core.rest import ApiException

class TestCursorPagedResponseDomain(unittest.TestCase):
    """CursorPagedResponseDomain unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CursorPagedResponseDomain
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.cursor_paged_response_domain.CursorPagedResponseDomain()  # noqa: E501
        if include_optional :
            return CursorPagedResponseDomain(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
                    collibra_core.models.domain_impl.DomainImpl(
                        id = '0', 
    ...
    def testCursorPagedResponseDomain(self):
        """Test CursorPagedResponseDomain"""
