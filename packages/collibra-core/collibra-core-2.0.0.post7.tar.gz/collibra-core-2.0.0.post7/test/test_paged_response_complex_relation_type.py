...
from collibra_core.models.paged_response_complex_relation_type import PagedResponseComplexRelationType  # noqa: E501
from collibra_core.rest import ApiException

class TestPagedResponseComplexRelationType(unittest.TestCase):
    """PagedResponseComplexRelationType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PagedResponseComplexRelationType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.paged_response_complex_relation_type.PagedResponseComplexRelationType()  # noqa: E501
        if include_optional :
            return PagedResponseComplexRelationType(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
                    collibra_core.models.complex_relation_type_impl.ComplexRelationTypeImpl(
                        id = '0', 
    ...
    def testPagedResponseComplexRelationType(self):
        """Test PagedResponseComplexRelationType"""
