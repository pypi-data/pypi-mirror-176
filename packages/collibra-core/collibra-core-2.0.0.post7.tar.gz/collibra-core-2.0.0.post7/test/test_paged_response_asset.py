...
from collibra_core.models.paged_response_asset import PagedResponseAsset  # noqa: E501
...
class TestPagedResponseAsset(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_core.models.paged_response_asset.PagedResponseAsset()  # noqa: E501
        if include_optional :
            return PagedResponseAsset(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
