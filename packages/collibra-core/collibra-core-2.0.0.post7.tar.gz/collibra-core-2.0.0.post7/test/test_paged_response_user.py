...
from collibra_core.models.paged_response_user import PagedResponseUser  # noqa: E501
from collibra_core.rest import ApiException

class TestPagedResponseUser(unittest.TestCase):
    """PagedResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PagedResponseUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.paged_response_user.PagedResponseUser()  # noqa: E501
        if include_optional :
            return PagedResponseUser(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
    ...
    def testPagedResponseUser(self):
        """Test PagedResponseUser"""
