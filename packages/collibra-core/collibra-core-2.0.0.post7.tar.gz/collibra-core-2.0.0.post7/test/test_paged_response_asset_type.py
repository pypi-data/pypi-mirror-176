...
from collibra_core.models.paged_response_asset_type import PagedResponseAssetType  # noqa: E501
...
class TestPagedResponseAssetType(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_core.models.paged_response_asset_type.PagedResponseAssetType()  # noqa: E501
        if include_optional :
            return PagedResponseAssetType(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
