...
from collibra_core.models.cursor_paged_response_asset import CursorPagedResponseAsset  # noqa: E501
from collibra_core.rest import ApiException

class TestCursorPagedResponseAsset(unittest.TestCase):
    """CursorPagedResponseAsset unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CursorPagedResponseAsset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.cursor_paged_response_asset.CursorPagedResponseAsset()  # noqa: E501
        if include_optional :
            return CursorPagedResponseAsset(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
    ...
    def testCursorPagedResponseAsset(self):
        """Test CursorPagedResponseAsset"""
