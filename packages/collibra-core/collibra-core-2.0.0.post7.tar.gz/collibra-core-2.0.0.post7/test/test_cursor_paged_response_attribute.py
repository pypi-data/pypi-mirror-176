...
from collibra_core.models.cursor_paged_response_attribute import CursorPagedResponseAttribute  # noqa: E501
...
class TestCursorPagedResponseAttribute(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test CursorPagedResponseAttribute
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.cursor_paged_response_attribute.CursorPagedResponseAttribute()  # noqa: E501
        if include_optional :
            return CursorPagedResponseAttribute(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
    ...
    def testCursorPagedResponseAttribute(self):
        """Test CursorPagedResponseAttribute"""
