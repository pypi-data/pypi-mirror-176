...
class ChangeComplexRelationTypeRequest(object):
    ...
    def __init__(self, name=None, description=None, color=None, symbol_type=None, icon_code=None, acronym_code=None, attribute_types=None, leg_types=None, local_vars_configuration=None):  # noqa: E501
        """ChangeComplexRelationTypeRequest - a model defined in OpenAPI"""  # noqa: E501
