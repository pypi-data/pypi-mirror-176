...
from collibra_core.models.articulation_rule_impl import ArticulationRuleImpl  # noqa: E501
from collibra_core.rest import ApiException

class TestArticulationRuleImpl(unittest.TestCase):
    """ArticulationRuleImpl unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArticulationRuleImpl
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = collibra_core.models.articulation_rule_impl.ArticulationRuleImpl()  # noqa: E501
        if include_optional :
    ...
    def testArticulationRuleImpl(self):
        """Test ArticulationRuleImpl"""
