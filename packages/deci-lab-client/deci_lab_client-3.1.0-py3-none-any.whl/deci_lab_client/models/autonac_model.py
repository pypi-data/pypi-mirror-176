...
class AutonacModel(object):
    ...
    def __init__(self, update_time=None, creation_time=None, id=None, deleted=False, model_id=None, baseline_model_id=None, workspace_id=None, name=None, owner=None, model_size=None, quantization_level=None, dl_task=None, input_dimensions=None, primary_hardware=None, accuracy_metrics=None, source=None, hyper_parameters=None, raw_format=False, description=None, kpis=None, architecture=None, optimization_state=None, local_vars_configuration=None):  # noqa: E501
