...
class WorkspaceBase(object):
    ...
    def __init__(self, update_time=None, creation_time=None, id=None, deleted=False, name=None, license=None, optimized_models_allowed_limit=2, autonac_optimizations_quota=0, local_vars_configuration=None):  # noqa: E501
