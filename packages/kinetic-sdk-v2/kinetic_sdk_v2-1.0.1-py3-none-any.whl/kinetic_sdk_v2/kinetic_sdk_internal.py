from kinetic_sdk_v2.helpers.generate_make_transfer_batch_transaction import generate_make_transfer_batch_transaction
from kinetic_sdk_v2.generated.client.api.account_api import AccountApi
from kinetic_sdk_v2.generated.client.api.airdrop_api import AirdropApi
from kinetic_sdk_v2.generated.client.api.app_api import AppApi
from kinetic_sdk_v2.generated.client.api.transaction_api import TransactionApi
...
from kinetic_sdk_v2.generated.client import ApiClient
from kinetic_sdk_v2.generated.client import Configuration

from kinetic_sdk_v2.helpers.generate_create_account_transaction import generate_create_account_transaction, generate_create_account_transaction_batch
from kinetic_sdk_v2.helpers.generate_make_transfer_transaction import generate_make_transfer_transaction
from kinetic_sdk_v2.helpers.get_public_key import get_public_key
...
class KineticSdkInternal(object):
    ...
    def create_account_batch(self, owners: list, mint: str, commitment, reference_id: str, reference_type: str):
        blockhash = self._prepare_transaction(self.environment, self.index)
        mint = self._get_app_mint(self.app_config, mint)

        tx = generate_create_account_transaction_batch(
            add_memo=False,
            app_index=self.index,
            recent_blockhash=blockhash['blockhash'],
            mint_fee_payer=self.app_config['mint']['fee_payer'],
