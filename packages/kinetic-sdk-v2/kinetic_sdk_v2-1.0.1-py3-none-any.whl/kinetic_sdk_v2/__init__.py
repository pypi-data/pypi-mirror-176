...
from kinetic_sdk_v2.kinetic_sdk_internal import KineticSdkInternal
...
class KineticSdk(object):
    ...
    def create_account_batch(self, owners: list, mint: PublicKeyString = None, commitment=Commitment("Confirmed"), reference_id: str = None, reference_type: str = None):
        return self.internal.create_account_batch(owners, mint, commitment, reference_id, reference_type)
