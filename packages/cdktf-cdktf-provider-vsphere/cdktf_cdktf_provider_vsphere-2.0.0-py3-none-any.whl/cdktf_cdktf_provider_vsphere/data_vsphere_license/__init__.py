...
class DataVsphereLicense(
    ...
    def __init__(
        ...
        *,
        ...
        :param license_key: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/d/license#license_key DataVsphereLicense#license_key}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataVsphereLicenseConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
