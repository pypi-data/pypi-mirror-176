...
class VirtualMachine(
    ...
    def __init__(
        ...
        *,
        ...
        cdrom: typing.Optional[typing.Union["VirtualMachineCdrom", typing.Dict[str, typing.Any]]] = None,
        clone: typing.Optional[typing.Union["VirtualMachineClone", typing.Dict[str, typing.Any]]] = None,
        ...
        disk: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["VirtualMachineDisk", typing.Dict[str, typing.Any]]]]] = None,
        ...
        force_power_off: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        network_interface: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["VirtualMachineNetworkInterface", typing.Dict[str, typing.Any]]]]] = None,
        num_cores_per_socket: typing.Optional[jsii.Number] = None,
        num_cpus: typing.Optional[jsii.Number] = None,
        ovf_deploy: typing.Optional[typing.Union["VirtualMachineOvfDeploy", typing.Dict[str, typing.Any]]] = None,
        ...
        vapp: typing.Optional[typing.Union["VirtualMachineVapp", typing.Dict[str, typing.Any]]] = None,
        ...
        wait_for_guest_net_routable: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        :param name: The name of this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#name VirtualMachine#name}
        :param resource_pool_id: The ID of a resource pool to put the virtual machine in. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#resource_pool_id VirtualMachine#resource_pool_id}
        :param alternate_guest_name: The guest name for the operating system when guest_id is otherGuest or otherGuest64. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#alternate_guest_name VirtualMachine#alternate_guest_name}
        :param annotation: User-provided description of the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#annotation VirtualMachine#annotation}
        :param boot_delay: The number of milliseconds to wait before starting the boot sequence. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_delay VirtualMachine#boot_delay}
        :param boot_retry_delay: The number of milliseconds to wait before retrying the boot sequence. This only valid if boot_retry_enabled is true. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_retry_delay VirtualMachine#boot_retry_delay}
        :param boot_retry_enabled: If set to true, a virtual machine that fails to boot will try again after the delay defined in boot_retry_delay. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_retry_enabled VirtualMachine#boot_retry_enabled}
        :param cdrom: cdrom block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cdrom VirtualMachine#cdrom}
        :param clone: clone block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#clone VirtualMachine#clone}
        :param cpu_hot_add_enabled: Allow CPUs to be added to this virtual machine while it is running. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_hot_add_enabled VirtualMachine#cpu_hot_add_enabled}
        :param cpu_hot_remove_enabled: Allow CPUs to be added to this virtual machine while it is running. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_hot_remove_enabled VirtualMachine#cpu_hot_remove_enabled}
        :param cpu_limit: The maximum amount of memory (in MB) or CPU (in MHz) that this virtual machine can consume, regardless of available resources. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_limit VirtualMachine#cpu_limit}
        :param cpu_performance_counters_enabled: Enable CPU performance counters on this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_performance_counters_enabled VirtualMachine#cpu_performance_counters_enabled}
        :param cpu_reservation: The amount of memory (in MB) or CPU (in MHz) that this virtual machine is guaranteed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_reservation VirtualMachine#cpu_reservation}
        :param cpu_share_count: The amount of shares to allocate to cpu for a custom share level. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_share_count VirtualMachine#cpu_share_count}
        :param cpu_share_level: The allocation level for cpu resources. Can be one of high, low, normal, or custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_share_level VirtualMachine#cpu_share_level}
        :param custom_attributes: A list of custom attributes to set on this resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#custom_attributes VirtualMachine#custom_attributes}
        :param datacenter_id: The ID of the datacenter where the VM is to be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datacenter_id VirtualMachine#datacenter_id}
        :param datastore_cluster_id: The ID of a datastore cluster to put the virtual machine in. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_cluster_id VirtualMachine#datastore_cluster_id}
        :param datastore_id: The ID of the virtual machine's datastore. The virtual machine configuration is placed here, along with any virtual disks that are created without datastores. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_id VirtualMachine#datastore_id}
        :param disk: disk block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk VirtualMachine#disk}
        :param efi_secure_boot_enabled: When the boot type set in firmware is efi, this enables EFI secure boot. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#efi_secure_boot_enabled VirtualMachine#efi_secure_boot_enabled}
        :param enable_disk_uuid: Expose the UUIDs of attached virtual disks to the virtual machine, allowing access to them in the guest. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_disk_uuid VirtualMachine#enable_disk_uuid}
        :param enable_logging: Enable logging on this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_logging VirtualMachine#enable_logging}
        :param ept_rvi_mode: The EPT/RVI (hardware memory virtualization) setting for this virtual machine. Can be one of automatic, on, or off. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ept_rvi_mode VirtualMachine#ept_rvi_mode}
        :param extra_config: Extra configuration data for this virtual machine. Can be used to supply advanced parameters not normally in configuration, such as instance metadata, or configuration data for OVF images. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#extra_config VirtualMachine#extra_config}
        :param firmware: The firmware interface to use on the virtual machine. Can be one of bios or efi. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#firmware VirtualMachine#firmware}
        :param folder: The name of the folder to locate the virtual machine in. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#folder VirtualMachine#folder}
        :param force_power_off: Set to true to force power-off a virtual machine if a graceful guest shutdown failed for a necessary operation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#force_power_off VirtualMachine#force_power_off}
        :param guest_id: The guest ID for the operating system. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#guest_id VirtualMachine#guest_id}
        :param hardware_version: The hardware version for the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hardware_version VirtualMachine#hardware_version}
        :param host_system_id: The ID of an optional host system to pin the virtual machine to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#host_system_id VirtualMachine#host_system_id}
        :param hv_mode: The (non-nested) hardware virtualization setting for this virtual machine. Can be one of hvAuto, hvOn, or hvOff. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hv_mode VirtualMachine#hv_mode}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#id VirtualMachine#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param ide_controller_count: The number of IDE controllers that Terraform manages on this virtual machine. This directly affects the amount of disks you can add to the virtual machine and the maximum disk unit number. Note that lowering this value does not remove controllers. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ide_controller_count VirtualMachine#ide_controller_count}
        :param ignored_guest_ips: List of IP addresses and CIDR networks to ignore while waiting for an IP. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ignored_guest_ips VirtualMachine#ignored_guest_ips}
        :param latency_sensitivity: Controls the scheduling delay of the virtual machine. Use a higher sensitivity for applications that require lower latency, such as VOIP, media player applications, or applications that require frequent access to mouse or keyboard devices. Can be one of low, normal, medium, or high. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#latency_sensitivity VirtualMachine#latency_sensitivity}
        :param memory: The size of the virtual machine's memory, in MB. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory VirtualMachine#memory}
        :param memory_hot_add_enabled: Allow memory to be added to this virtual machine while it is running. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_hot_add_enabled VirtualMachine#memory_hot_add_enabled}
        :param memory_limit: The maximum amount of memory (in MB) or CPU (in MHz) that this virtual machine can consume, regardless of available resources. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_limit VirtualMachine#memory_limit}
        :param memory_reservation: The amount of memory (in MB) or CPU (in MHz) that this virtual machine is guaranteed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_reservation VirtualMachine#memory_reservation}
        :param memory_share_count: The amount of shares to allocate to memory for a custom share level. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_share_count VirtualMachine#memory_share_count}
        :param memory_share_level: The allocation level for memory resources. Can be one of high, low, normal, or custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_share_level VirtualMachine#memory_share_level}
        :param migrate_wait_timeout: The amount of time, in minutes, to wait for a vMotion operation to complete before failing. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#migrate_wait_timeout VirtualMachine#migrate_wait_timeout}
        :param nested_hv_enabled: Enable nested hardware virtualization on this virtual machine, facilitating nested virtualization in the guest. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#nested_hv_enabled VirtualMachine#nested_hv_enabled}
        :param network_interface: network_interface block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#network_interface VirtualMachine#network_interface}
        :param num_cores_per_socket: The number of cores to distribute amongst the CPUs in this virtual machine. If specified, the value supplied to num_cpus must be evenly divisible by this value. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#num_cores_per_socket VirtualMachine#num_cores_per_socket}
        :param num_cpus: The number of virtual processors to assign to this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#num_cpus VirtualMachine#num_cpus}
        :param ovf_deploy: ovf_deploy block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_deploy VirtualMachine#ovf_deploy}
        :param pci_device_id: A list of PCI passthrough devices. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#pci_device_id VirtualMachine#pci_device_id}
        :param poweron_timeout: The amount of time, in seconds, that we will be trying to power on a VM. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#poweron_timeout VirtualMachine#poweron_timeout}
        :param replace_trigger: Triggers replacement of resource whenever it changes. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#replace_trigger VirtualMachine#replace_trigger}
        :param run_tools_scripts_after_power_on: Enable the run of scripts after virtual machine power-on when VMware Tools is installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_after_power_on VirtualMachine#run_tools_scripts_after_power_on}
        :param run_tools_scripts_after_resume: Enable the run of scripts after virtual machine resume when when VMware Tools is installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_after_resume VirtualMachine#run_tools_scripts_after_resume}
        :param run_tools_scripts_before_guest_reboot: Enable the run of scripts before guest operating system reboot when VMware Tools is installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_reboot VirtualMachine#run_tools_scripts_before_guest_reboot}
        :param run_tools_scripts_before_guest_shutdown: Enable the run of scripts before guest operating system shutdown when VMware Tools is installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_shutdown VirtualMachine#run_tools_scripts_before_guest_shutdown}
        :param run_tools_scripts_before_guest_standby: Enable the run of scripts before guest operating system standby when VMware Tools is installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_standby VirtualMachine#run_tools_scripts_before_guest_standby}
        :param sata_controller_count: The number of SATA controllers that Terraform manages on this virtual machine. This directly affects the amount of disks you can add to the virtual machine and the maximum disk unit number. Note that lowering this value does not remove controllers. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sata_controller_count VirtualMachine#sata_controller_count}
        :param scsi_bus_sharing: Mode for sharing the SCSI bus. The modes are physicalSharing, virtualSharing, and noSharing. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_bus_sharing VirtualMachine#scsi_bus_sharing}
        :param scsi_controller_count: The number of SCSI controllers that Terraform manages on this virtual machine. This directly affects the amount of disks you can add to the virtual machine and the maximum disk unit number. Note that lowering this value does not remove controllers. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_controller_count VirtualMachine#scsi_controller_count}
        :param scsi_type: The type of SCSI bus this virtual machine will have. Can be one of lsilogic, lsilogic-sas or pvscsi. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_type VirtualMachine#scsi_type}
        :param shutdown_wait_timeout: The amount of time, in minutes, to wait for shutdown when making necessary updates to the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#shutdown_wait_timeout VirtualMachine#shutdown_wait_timeout}
        :param storage_policy_id: The ID of the storage policy to assign to the virtual machine home directory. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#storage_policy_id VirtualMachine#storage_policy_id}
        :param swap_placement_policy: The swap file placement policy for this virtual machine. Can be one of inherit, hostLocal, or vmDirectory. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#swap_placement_policy VirtualMachine#swap_placement_policy}
        :param sync_time_with_host: Enable guest clock synchronization with the host. On vSphere 7.0 U1 and above, with only this setting the clock is synchronized on startup and resume. Requires VMware Tools to be installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sync_time_with_host VirtualMachine#sync_time_with_host}
        :param sync_time_with_host_periodically: Enable periodic clock synchronization with the host. Supported only on vSphere 7.0 U1 and above. On prior versions setting ``sync_time_with_host`` is enough for periodic synchronization. Requires VMware Tools to be installed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sync_time_with_host_periodically VirtualMachine#sync_time_with_host_periodically}
        :param tags: A list of tag IDs to apply to this object. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#tags VirtualMachine#tags}
        :param tools_upgrade_policy: Set the upgrade policy for VMware Tools. Can be one of ``manual`` or ``upgradeAtPowerCycle``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#tools_upgrade_policy VirtualMachine#tools_upgrade_policy}
        :param vapp: vapp block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vapp VirtualMachine#vapp}
        :param vbs_enabled: Flag to specify if Virtualization-based security is enabled for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vbs_enabled VirtualMachine#vbs_enabled}
        :param vvtd_enabled: Flag to specify if I/O MMU virtualization, also called Intel Virtualization Technology for Directed I/O (VT-d) and AMD I/O Virtualization (AMD-Vi or IOMMU), is enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vvtd_enabled VirtualMachine#vvtd_enabled}
        :param wait_for_guest_ip_timeout: The amount of time, in minutes, to wait for an available IP address on this virtual machine. A value less than 1 disables the waiter. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_ip_timeout VirtualMachine#wait_for_guest_ip_timeout}
        :param wait_for_guest_net_routable: Controls whether or not the guest network waiter waits for a routable address. When false, the waiter does not wait for a default gateway, nor are IP addresses checked against any discovered default gateways as part of its success criteria. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_net_routable VirtualMachine#wait_for_guest_net_routable}
        :param wait_for_guest_net_timeout: The amount of time, in minutes, to wait for an available IP address on this virtual machine. A value less than 1 disables the waiter. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_net_timeout VirtualMachine#wait_for_guest_net_timeout}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_cdrom(
        self,
        *,
        client_device: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        datastore_id: typing.Optional[builtins.str] = None,
        path: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        :param client_device: Indicates whether the device should be mapped to a remote client device. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#client_device VirtualMachine#client_device}
        :param datastore_id: The datastore ID the ISO is located on. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_id VirtualMachine#datastore_id}
        :param path: The path to the ISO file on the datastore. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#path VirtualMachine#path}
        '''
        value = VirtualMachineCdrom(
            client_device=client_device, datastore_id=datastore_id, path=path
        )
    ...
    def put_clone(
        ...
        *,
        ...
        customize: typing.Optional[typing.Union["VirtualMachineCloneCustomize", typing.Dict[str, typing.Any]]] = None,
        linked_clone: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        '''
        :param template_uuid: The UUID of the source virtual machine or template. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#template_uuid VirtualMachine#template_uuid}
        :param customize: customize block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#customize VirtualMachine#customize}
        :param linked_clone: Whether or not to create a linked clone when cloning. When this option is used, the source VM must have a single snapshot associated with it. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#linked_clone VirtualMachine#linked_clone}
        :param ovf_network_map: Mapping of ovf networks to the networks to use in vSphere. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_network_map VirtualMachine#ovf_network_map}
        :param ovf_storage_map: Mapping of ovf storage to the datastores to use in vSphere. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_storage_map VirtualMachine#ovf_storage_map}
        :param timeout: The timeout, in minutes, to wait for the virtual machine clone to complete. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#timeout VirtualMachine#timeout}
        '''
    ...
    def put_disk(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["VirtualMachineDisk", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_network_interface(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["VirtualMachineNetworkInterface", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_ovf_deploy(
        self,
        *,
        allow_unverified_ssl_cert: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        deployment_option: typing.Optional[builtins.str] = None,
        disk_provisioning: typing.Optional[builtins.str] = None,
        enable_hidden_properties: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        '''
        :param allow_unverified_ssl_cert: Allow unverified ssl certificates while deploying ovf/ova from url. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#allow_unverified_ssl_cert VirtualMachine#allow_unverified_ssl_cert}
        :param deployment_option: The Deployment option to be chosen. If empty, the default option is used. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#deployment_option VirtualMachine#deployment_option}
        :param disk_provisioning: An optional disk provisioning. If set, all the disks in the deployed ovf will have the same specified disk type (e.g., thin provisioned). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_provisioning VirtualMachine#disk_provisioning}
        :param enable_hidden_properties: Allow properties with ovf:userConfigurable=false to be set. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_hidden_properties VirtualMachine#enable_hidden_properties}
        :param ip_allocation_policy: The IP allocation policy. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ip_allocation_policy VirtualMachine#ip_allocation_policy}
        :param ip_protocol: The IP protocol. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ip_protocol VirtualMachine#ip_protocol}
        :param local_ovf_path: The absolute path to the ovf/ova file in the local system. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#local_ovf_path VirtualMachine#local_ovf_path}
        :param ovf_network_map: The mapping of name of network identifiers from the ovf descriptor to network UUID in the VI infrastructure. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_network_map VirtualMachine#ovf_network_map}
        :param remote_ovf_url: URL to the remote ovf/ova file to be deployed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#remote_ovf_url VirtualMachine#remote_ovf_url}
        '''
    ...
    def put_vapp(
        ...
        *,
        ...
        '''
        :param properties: A map of customizable vApp properties and their values. Allows customization of VMs cloned from OVF templates which have customizable vApp properties. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#properties VirtualMachine#properties}
        '''
    ...
    def cdrom(self) -> "VirtualMachineCdromOutputReference":
        return typing.cast("VirtualMachineCdromOutputReference", jsii.get(self, "cdrom"))
    ...
    def imported(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "imported"))
    ...
    def reboot_required(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "rebootRequired"))
    ...
    def cdrom_input(self) -> typing.Optional["VirtualMachineCdrom"]:
        return typing.cast(typing.Optional["VirtualMachineCdrom"], jsii.get(self, "cdromInput"))
    ...
    def disk_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineDisk"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineDisk"]]], jsii.get(self, "diskInput"))
    ...
    def force_power_off_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "forcePowerOffInput"))
    ...
    def network_interface_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineNetworkInterface"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineNetworkInterface"]]], jsii.get(self, "networkInterfaceInput"))
    ...
    def wait_for_guest_net_routable_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "waitForGuestNetRoutableInput"))
    ...
    def force_power_off(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "forcePowerOff"))
    ...
    def force_power_off(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "forcePowerOff", value)
    ...
    def ide_controller_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ideControllerCount", value)
    ...
    def ignored_guest_ips(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ignoredGuestIps", value)
    ...
    def migrate_wait_timeout(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "migrateWaitTimeout", value)
    ...
    def pci_device_id(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pciDeviceId", value)
    ...
    def poweron_timeout(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "poweronTimeout", value)
    ...
    def resource_pool_id(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "resourcePoolId", value)
    ...
    def sata_controller_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "sataControllerCount", value)
    ...
    def scsi_bus_sharing(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scsiBusSharing", value)
    ...
    def scsi_controller_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scsiControllerCount", value)
    ...
    def shutdown_wait_timeout(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "shutdownWaitTimeout", value)
    ...
    def wait_for_guest_ip_timeout(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "waitForGuestIpTimeout", value)
    ...
    def wait_for_guest_net_routable(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "waitForGuestNetRoutable"))
    ...
    def wait_for_guest_net_routable(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "waitForGuestNetRoutable", value)
    ...
    def wait_for_guest_net_timeout(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "waitForGuestNetTimeout", value)
...
class VirtualMachineCdrom:
    ...
    def client_device(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#client_device VirtualMachine#client_device}
        '''
    ...
    def datastore_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_id VirtualMachine#datastore_id}
        '''
    ...
    def path(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#path VirtualMachine#path}
        '''
...
class VirtualMachineCdromOutputReference(
    ...
    def client_device_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "clientDeviceInput"))
    ...
    def client_device(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "clientDevice"))
    ...
    def client_device(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "clientDevice", value)
    ...
    def internal_value(self) -> typing.Optional[VirtualMachineCdrom]:
        return typing.cast(typing.Optional[VirtualMachineCdrom], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(self, value: typing.Optional[VirtualMachineCdrom]) -> None:
        if __debug__:
            def stub(value: typing.Optional[VirtualMachineCdrom]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class VirtualMachineClone:
    ...
    def template_uuid(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#template_uuid VirtualMachine#template_uuid}
        '''
    ...
    def customize(self) -> typing.Optional["VirtualMachineCloneCustomize"]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#customize VirtualMachine#customize}
        '''
    ...
    def linked_clone(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#linked_clone VirtualMachine#linked_clone}
        '''
    ...
    def ovf_network_map(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_network_map VirtualMachine#ovf_network_map}
        '''
    ...
    def ovf_storage_map(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_storage_map VirtualMachine#ovf_storage_map}
        '''
    ...
    def timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#timeout VirtualMachine#timeout}
        '''
...
class VirtualMachineCloneCustomize:
    def __init__(
        ...
        *,
        ...
        linux_options: typing.Optional[typing.Union["VirtualMachineCloneCustomizeLinuxOptions", typing.Dict[str, typing.Any]]] = None,
        network_interface: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["VirtualMachineCloneCustomizeNetworkInterface", typing.Dict[str, typing.Any]]]]] = None,
        timeout: typing.Optional[jsii.Number] = None,
        windows_options: typing.Optional[typing.Union["VirtualMachineCloneCustomizeWindowsOptions", typing.Dict[str, typing.Any]]] = None,
        windows_sysprep_text: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        :param dns_server_list: The list of DNS servers for a virtual network adapter with a static IP address. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_server_list VirtualMachine#dns_server_list}
        :param dns_suffix_list: A list of DNS search domains to add to the DNS configuration on the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_suffix_list VirtualMachine#dns_suffix_list}
        :param ipv4_gateway: The IPv4 default gateway when using network_interface customization on the virtual machine. This address must be local to a static IPv4 address configured in an interface sub-resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_gateway VirtualMachine#ipv4_gateway}
        :param ipv6_gateway: The IPv6 default gateway when using network_interface customization on the virtual machine. This address must be local to a static IPv4 address configured in an interface sub-resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_gateway VirtualMachine#ipv6_gateway}
        :param linux_options: linux_options block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#linux_options VirtualMachine#linux_options}
        :param network_interface: network_interface block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#network_interface VirtualMachine#network_interface}
        :param timeout: The amount of time, in minutes, to wait for guest OS customization to complete before returning with an error. Setting this value to 0 or a negative value skips the waiter. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#timeout VirtualMachine#timeout}
        :param windows_options: windows_options block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#windows_options VirtualMachine#windows_options}
        :param windows_sysprep_text: Use this option to specify a windows sysprep file directly. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#windows_sysprep_text VirtualMachine#windows_sysprep_text}
        '''
    ...
    def dns_server_list(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_server_list VirtualMachine#dns_server_list}
        '''
    ...
    def dns_suffix_list(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_suffix_list VirtualMachine#dns_suffix_list}
        '''
    ...
    def ipv4_gateway(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_gateway VirtualMachine#ipv4_gateway}
        '''
    ...
    def ipv6_gateway(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_gateway VirtualMachine#ipv6_gateway}
        '''
    ...
    def linux_options(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#linux_options VirtualMachine#linux_options}
        '''
    ...
    def network_interface(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineCloneCustomizeNetworkInterface"]]]:
        '''network_interface block.

        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#network_interface VirtualMachine#network_interface}
        '''
        result = self._values.get("network_interface")
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineCloneCustomizeNetworkInterface"]]], result)
    ...
    def windows_options(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#windows_options VirtualMachine#windows_options}
        '''
    ...
    def windows_sysprep_text(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#windows_sysprep_text VirtualMachine#windows_sysprep_text}
        '''
...
class VirtualMachineCloneCustomizeLinuxOptions:
    def __init__(
        ...
        *,
        ...
        hw_clock_utc: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        script_text: typing.Optional[builtins.str] = None,
        time_zone: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        :param domain: The domain name for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain VirtualMachine#domain}
        :param host_name: The hostname for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#host_name VirtualMachine#host_name}
        :param hw_clock_utc: Specifies whether or not the hardware clock should be in UTC or not. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hw_clock_utc VirtualMachine#hw_clock_utc}
        :param script_text: The customization script to run before and or after guest customization. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#script_text VirtualMachine#script_text}
        :param time_zone: Customize the time zone on the VM. This should be a time zone-style entry, like America/Los_Angeles. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#time_zone VirtualMachine#time_zone}
        '''
        if __debug__:
            def stub(
                *,
    ...
    def domain(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain VirtualMachine#domain}
        '''
    ...
    def host_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#host_name VirtualMachine#host_name}
        '''
    ...
    def hw_clock_utc(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hw_clock_utc VirtualMachine#hw_clock_utc}
        '''
    ...
    def script_text(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#script_text VirtualMachine#script_text}
        '''
    ...
    def time_zone(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#time_zone VirtualMachine#time_zone}
        '''
...
class VirtualMachineCloneCustomizeLinuxOptionsOutputReference(
    ...
    def hw_clock_utc_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "hwClockUtcInput"))
    ...
    def hw_clock_utc(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "hwClockUtc"))
    ...
    def hw_clock_utc(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "hwClockUtc", value)
    ...
    def script_text(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scriptText", value)
...
class VirtualMachineCloneCustomizeNetworkInterface:
    def __init__(
        ...
        *,
        ...
        '''
        :param dns_domain: A DNS search domain to add to the DNS configuration on the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_domain VirtualMachine#dns_domain}
        :param dns_server_list: Network-interface specific DNS settings for Windows operating systems. Ignored on Linux. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_server_list VirtualMachine#dns_server_list}
        :param ipv4_address: The IPv4 address assigned to this network adapter. If left blank, DHCP is used. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_address VirtualMachine#ipv4_address}
        :param ipv4_netmask: The IPv4 CIDR netmask for the supplied IP address. Ignored if DHCP is selected. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_netmask VirtualMachine#ipv4_netmask}
        :param ipv6_address: The IPv6 address assigned to this network adapter. If left blank, default auto-configuration is used. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_address VirtualMachine#ipv6_address}
        :param ipv6_netmask: The IPv6 CIDR netmask for the supplied IP address. Ignored if auto-configuration is selected. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_netmask VirtualMachine#ipv6_netmask}
        '''
        if __debug__:
            def stub(
                *,
    ...
    def dns_domain(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#dns_domain VirtualMachine#dns_domain}
        '''
    ...
    def ipv4_address(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_address VirtualMachine#ipv4_address}
        '''
    ...
    def ipv4_netmask(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv4_netmask VirtualMachine#ipv4_netmask}
        '''
    ...
    def ipv6_address(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_address VirtualMachine#ipv6_address}
        '''
    ...
    def ipv6_netmask(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ipv6_netmask VirtualMachine#ipv6_netmask}
        '''
...
class VirtualMachineCloneCustomizeNetworkInterfaceList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineCloneCustomizeNetworkInterface]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineCloneCustomizeNetworkInterface]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineCloneCustomizeNetworkInterface]]],
...
class VirtualMachineCloneCustomizeNetworkInterfaceOutputReference(
    ...
    def ipv4_netmask(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ipv4Netmask", value)
    ...
    def ipv6_netmask(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ipv6Netmask", value)

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[VirtualMachineCloneCustomizeNetworkInterface, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[VirtualMachineCloneCustomizeNetworkInterface, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[VirtualMachineCloneCustomizeNetworkInterface, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[VirtualMachineCloneCustomizeNetworkInterface, cdktf.IResolvable]],
...
class VirtualMachineCloneCustomizeOutputReference(
    ...
    def put_network_interface(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union[VirtualMachineCloneCustomizeNetworkInterface, typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_windows_options(
        ...
        *,
        ...
        auto_logon: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        '''
        :param computer_name: The host name for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#computer_name VirtualMachine#computer_name}
        :param admin_password: The new administrator password for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#admin_password VirtualMachine#admin_password}
        :param auto_logon: Specifies whether or not the VM automatically logs on as Administrator. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#auto_logon VirtualMachine#auto_logon}
        :param auto_logon_count: Specifies how many times the VM should auto-logon the Administrator account when auto_logon is true. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#auto_logon_count VirtualMachine#auto_logon_count}
        :param domain_admin_password: The password of the domain administrator used to join this virtual machine to the domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain_admin_password VirtualMachine#domain_admin_password}
        :param domain_admin_user: The user account of the domain administrator used to join this virtual machine to the domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain_admin_user VirtualMachine#domain_admin_user}
        :param full_name: The full name of the user of this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#full_name VirtualMachine#full_name}
        :param join_domain: The domain that the virtual machine should join. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#join_domain VirtualMachine#join_domain}
        :param organization_name: The organization name this virtual machine is being installed for. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#organization_name VirtualMachine#organization_name}
        :param product_key: The product key for this virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#product_key VirtualMachine#product_key}
        :param run_once_command_list: A list of commands to run at first user logon, after guest customization. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_once_command_list VirtualMachine#run_once_command_list}
        :param time_zone: The new time zone for the virtual machine. This is a sysprep-dictated timezone code. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#time_zone VirtualMachine#time_zone}
        :param workgroup: The workgroup for this virtual machine if not joining a domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#workgroup VirtualMachine#workgroup}
        '''
    ...
    def network_interface_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineCloneCustomizeNetworkInterface]]], jsii.get(self, "networkInterfaceInput"))
    ...
    def dns_suffix_list(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "dnsSuffixList", value)
    ...
    def windows_sysprep_text(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "windowsSysprepText", value)
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[VirtualMachineCloneCustomize]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class VirtualMachineCloneCustomizeWindowsOptions:
    ...
    def computer_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#computer_name VirtualMachine#computer_name}
        '''
    ...
    def admin_password(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#admin_password VirtualMachine#admin_password}
        '''
    ...
    def auto_logon(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#auto_logon VirtualMachine#auto_logon}
        '''
    ...
    def auto_logon_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#auto_logon_count VirtualMachine#auto_logon_count}
        '''
    ...
    def domain_admin_password(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain_admin_password VirtualMachine#domain_admin_password}
        '''
    ...
    def domain_admin_user(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#domain_admin_user VirtualMachine#domain_admin_user}
        '''
    ...
    def full_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#full_name VirtualMachine#full_name}
        '''
    ...
    def join_domain(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#join_domain VirtualMachine#join_domain}
        '''
    ...
    def organization_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#organization_name VirtualMachine#organization_name}
        '''
    ...
    def product_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#product_key VirtualMachine#product_key}
        '''
    ...
    def run_once_command_list(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_once_command_list VirtualMachine#run_once_command_list}
        '''
    ...
    def workgroup(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#workgroup VirtualMachine#workgroup}
        '''
...
class VirtualMachineCloneCustomizeWindowsOptionsOutputReference(
    ...
    def auto_logon_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "autoLogonInput"))
    ...
    def auto_logon(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "autoLogon"))

    @auto_logon.setter
    def auto_logon(self, value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
        if __debug__:
            def stub(value: typing.Union[builtins.bool, cdktf.IResolvable]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "autoLogon", value)
    ...
    def auto_logon_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "autoLogonCount", value)
    ...
    def domain_admin_password(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "domainAdminPassword", value)
    ...
    def domain_admin_user(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "domainAdminUser", value)
    ...
    def run_once_command_list(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "runOnceCommandList", value)
...
class VirtualMachineCloneOutputReference(
    ...
    def linked_clone_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "linkedCloneInput"))
    ...
    def linked_clone(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "linkedClone"))
    ...
    def linked_clone(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "linkedClone", value)
    ...
    def ovf_network_map(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ovfNetworkMap", value)
    ...
    def ovf_storage_map(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ovfStorageMap", value)
    ...
    def internal_value(self, value: typing.Optional[VirtualMachineClone]) -> None:
        if __debug__:
            def stub(value: typing.Optional[VirtualMachineClone]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class VirtualMachineConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if isinstance(cdrom, dict):
            cdrom = VirtualMachineCdrom(**cdrom)
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#name VirtualMachine#name}
        '''
    ...
    def resource_pool_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#resource_pool_id VirtualMachine#resource_pool_id}
        '''
    ...
    def alternate_guest_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#alternate_guest_name VirtualMachine#alternate_guest_name}
        '''
    ...
    def annotation(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#annotation VirtualMachine#annotation}
        '''
    ...
    def boot_delay(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_delay VirtualMachine#boot_delay}
        '''
    ...
    def boot_retry_delay(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_retry_delay VirtualMachine#boot_retry_delay}
        '''
    ...
    def boot_retry_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#boot_retry_enabled VirtualMachine#boot_retry_enabled}
        '''
        result = self._values.get("boot_retry_enabled")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], result)

    @builtins.property
    def cdrom(self) -> typing.Optional[VirtualMachineCdrom]:
        '''cdrom block.
        ...
        return typing.cast(typing.Optional[VirtualMachineCdrom], result)
    ...
    def cpu_hot_add_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_hot_add_enabled VirtualMachine#cpu_hot_add_enabled}
        '''
    ...
    def cpu_hot_remove_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_hot_remove_enabled VirtualMachine#cpu_hot_remove_enabled}
        '''
    ...
    def cpu_limit(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_limit VirtualMachine#cpu_limit}
        '''
    ...
    def cpu_performance_counters_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_performance_counters_enabled VirtualMachine#cpu_performance_counters_enabled}
        '''
    ...
    def cpu_reservation(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_reservation VirtualMachine#cpu_reservation}
        '''
    ...
    def cpu_share_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_share_count VirtualMachine#cpu_share_count}
        '''
    ...
    def cpu_share_level(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#cpu_share_level VirtualMachine#cpu_share_level}
        '''
    ...
    def custom_attributes(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#custom_attributes VirtualMachine#custom_attributes}
        '''
    ...
    def datacenter_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datacenter_id VirtualMachine#datacenter_id}
        '''
    ...
    def datastore_cluster_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_cluster_id VirtualMachine#datastore_cluster_id}
        '''
    ...
    def disk(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk VirtualMachine#disk}
        '''
        result = self._values.get("disk")
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineDisk"]]], result)
    ...
    def efi_secure_boot_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#efi_secure_boot_enabled VirtualMachine#efi_secure_boot_enabled}
        '''
    ...
    def enable_disk_uuid(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_disk_uuid VirtualMachine#enable_disk_uuid}
        '''
    ...
    def enable_logging(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_logging VirtualMachine#enable_logging}
        '''
    ...
    def ept_rvi_mode(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ept_rvi_mode VirtualMachine#ept_rvi_mode}
        '''
    ...
    def folder(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#folder VirtualMachine#folder}
        '''
    ...
    def force_power_off(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#force_power_off VirtualMachine#force_power_off}
        '''
    ...
    def guest_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#guest_id VirtualMachine#guest_id}
        '''
    ...
    def hardware_version(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hardware_version VirtualMachine#hardware_version}
        '''
    ...
    def host_system_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#host_system_id VirtualMachine#host_system_id}
        '''
    ...
    def hv_mode(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#hv_mode VirtualMachine#hv_mode}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#id VirtualMachine#id}.
    ...
    def ide_controller_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ide_controller_count VirtualMachine#ide_controller_count}
        '''
    ...
    def ignored_guest_ips(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ignored_guest_ips VirtualMachine#ignored_guest_ips}
        '''
    ...
    def latency_sensitivity(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#latency_sensitivity VirtualMachine#latency_sensitivity}
        '''
    ...
    def memory(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory VirtualMachine#memory}
        '''
    ...
    def memory_hot_add_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_hot_add_enabled VirtualMachine#memory_hot_add_enabled}
        '''
    ...
    def memory_limit(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_limit VirtualMachine#memory_limit}
        '''
    ...
    def memory_reservation(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_reservation VirtualMachine#memory_reservation}
        '''
    ...
    def memory_share_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_share_count VirtualMachine#memory_share_count}
        '''
    ...
    def memory_share_level(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#memory_share_level VirtualMachine#memory_share_level}
        '''
    ...
    def migrate_wait_timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#migrate_wait_timeout VirtualMachine#migrate_wait_timeout}
        '''
    ...
    def nested_hv_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#nested_hv_enabled VirtualMachine#nested_hv_enabled}
        '''
    ...
    def network_interface(
        ...
        '''
        result = self._values.get("network_interface")
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["VirtualMachineNetworkInterface"]]], result)
    ...
    def num_cores_per_socket(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#num_cores_per_socket VirtualMachine#num_cores_per_socket}
        '''
    ...
    def num_cpus(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#num_cpus VirtualMachine#num_cpus}
        '''
    ...
    def ovf_deploy(self) -> typing.Optional["VirtualMachineOvfDeploy"]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_deploy VirtualMachine#ovf_deploy}
        '''
    ...
    def pci_device_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#pci_device_id VirtualMachine#pci_device_id}
        '''
    ...
    def poweron_timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#poweron_timeout VirtualMachine#poweron_timeout}
        '''
    ...
    def replace_trigger(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#replace_trigger VirtualMachine#replace_trigger}
        '''
    ...
    def run_tools_scripts_after_power_on(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_after_power_on VirtualMachine#run_tools_scripts_after_power_on}
        '''
    ...
    def run_tools_scripts_after_resume(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_after_resume VirtualMachine#run_tools_scripts_after_resume}
        '''
    ...
    def run_tools_scripts_before_guest_reboot(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_reboot VirtualMachine#run_tools_scripts_before_guest_reboot}
        '''
    ...
    def run_tools_scripts_before_guest_shutdown(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_shutdown VirtualMachine#run_tools_scripts_before_guest_shutdown}
        '''
    ...
    def run_tools_scripts_before_guest_standby(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#run_tools_scripts_before_guest_standby VirtualMachine#run_tools_scripts_before_guest_standby}
        '''
    ...
    def sata_controller_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sata_controller_count VirtualMachine#sata_controller_count}
        '''
    ...
    def scsi_bus_sharing(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_bus_sharing VirtualMachine#scsi_bus_sharing}
        '''
    ...
    def scsi_controller_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_controller_count VirtualMachine#scsi_controller_count}
        '''
    ...
    def scsi_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#scsi_type VirtualMachine#scsi_type}
        '''
    ...
    def shutdown_wait_timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#shutdown_wait_timeout VirtualMachine#shutdown_wait_timeout}
        '''
    ...
    def storage_policy_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#storage_policy_id VirtualMachine#storage_policy_id}
        '''
    ...
    def swap_placement_policy(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#swap_placement_policy VirtualMachine#swap_placement_policy}
        '''
    ...
    def sync_time_with_host(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sync_time_with_host VirtualMachine#sync_time_with_host}
        '''
    ...
    def sync_time_with_host_periodically(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#sync_time_with_host_periodically VirtualMachine#sync_time_with_host_periodically}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#tags VirtualMachine#tags}
        '''
    ...
    def tools_upgrade_policy(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#tools_upgrade_policy VirtualMachine#tools_upgrade_policy}
        '''
    ...
    def vapp(self) -> typing.Optional["VirtualMachineVapp"]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vapp VirtualMachine#vapp}
        '''
    ...
    def vbs_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vbs_enabled VirtualMachine#vbs_enabled}
        '''
    ...
    def vvtd_enabled(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#vvtd_enabled VirtualMachine#vvtd_enabled}
        '''
    ...
    def wait_for_guest_ip_timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_ip_timeout VirtualMachine#wait_for_guest_ip_timeout}
        '''
    ...
    def wait_for_guest_net_routable(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_net_routable VirtualMachine#wait_for_guest_net_routable}
        '''
    ...
    def wait_for_guest_net_timeout(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#wait_for_guest_net_timeout VirtualMachine#wait_for_guest_net_timeout}
        '''
...
class VirtualMachineDisk:
    def __init__(
        ...
        *,
        ...
        eagerly_scrub: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        ...
        keep_on_remove: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        path: typing.Optional[builtins.str] = None,
        size: typing.Optional[jsii.Number] = None,
        storage_policy_id: typing.Optional[builtins.str] = None,
        thin_provisioned: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        unit_number: typing.Optional[jsii.Number] = None,
        write_through: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
    ) -> None:
        '''
        :param label: A unique label for this disk. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#label VirtualMachine#label}
        :param attach: If this is true, the disk is attached instead of created. Implies keep_on_remove. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#attach VirtualMachine#attach}
        :param controller_type: The type of controller the disk should be connected to. Must be 'scsi', 'sata', or 'ide'. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#controller_type VirtualMachine#controller_type}
        :param datastore_id: The datastore ID for this virtual disk, if different than the virtual machine. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#datastore_id VirtualMachine#datastore_id}
        :param disk_mode: The mode of this this virtual disk for purposes of writes and snapshotting. Can be one of append, independent_nonpersistent, independent_persistent, nonpersistent, persistent, or undoable. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_mode VirtualMachine#disk_mode}
        :param disk_sharing: The sharing mode of this virtual disk. Can be one of sharingMultiWriter or sharingNone. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_sharing VirtualMachine#disk_sharing}
        :param eagerly_scrub: The virtual disk file zeroing policy when thin_provision is not true. The default is false, which lazily-zeros the disk, speeding up thick-provisioned disk creation time. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#eagerly_scrub VirtualMachine#eagerly_scrub}
        :param io_limit: The upper limit of IOPS that this disk can use. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_limit VirtualMachine#io_limit}
        :param io_reservation: The I/O guarantee that this disk has, in IOPS. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_reservation VirtualMachine#io_reservation}
        :param io_share_count: The share count for this disk when the share level is custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_share_count VirtualMachine#io_share_count}
        :param io_share_level: The share allocation level for this disk. Can be one of low, normal, high, or custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_share_level VirtualMachine#io_share_level}
        :param keep_on_remove: Set to true to keep the underlying VMDK file when removing this virtual disk from configuration. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#keep_on_remove VirtualMachine#keep_on_remove}
        :param path: The full path of the virtual disk. This can only be provided if attach is set to true, otherwise it is a read-only value. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#path VirtualMachine#path}
        :param size: The size of the disk, in GB. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#size VirtualMachine#size}
        :param storage_policy_id: The ID of the storage policy to assign to the virtual disk in VM. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#storage_policy_id VirtualMachine#storage_policy_id}
        :param thin_provisioned: If true, this disk is thin provisioned, with space for the file being allocated on an as-needed basis. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#thin_provisioned VirtualMachine#thin_provisioned}
        :param unit_number: The unique device number for this disk. This number determines where on the SCSI bus this device will be attached. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#unit_number VirtualMachine#unit_number}
        :param write_through: If true, writes for this disk are sent directly to the filesystem immediately instead of being buffered. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#write_through VirtualMachine#write_through}
        '''
        if __debug__:
            def stub(
                *,
    ...
    def label(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#label VirtualMachine#label}
        '''
    ...
    def attach(self) -> typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#attach VirtualMachine#attach}
        '''
    ...
    def controller_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#controller_type VirtualMachine#controller_type}
        '''
    ...
    def disk_mode(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_mode VirtualMachine#disk_mode}
        '''
    ...
    def disk_sharing(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_sharing VirtualMachine#disk_sharing}
        '''
    ...
    def eagerly_scrub(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#eagerly_scrub VirtualMachine#eagerly_scrub}
        '''
    ...
    def io_limit(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_limit VirtualMachine#io_limit}
        '''
    ...
    def io_reservation(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_reservation VirtualMachine#io_reservation}
        '''
    ...
    def io_share_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_share_count VirtualMachine#io_share_count}
        '''
    ...
    def io_share_level(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#io_share_level VirtualMachine#io_share_level}
        '''
    ...
    def keep_on_remove(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#keep_on_remove VirtualMachine#keep_on_remove}
        '''
    ...
    def size(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#size VirtualMachine#size}
        '''
    ...
    def thin_provisioned(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#thin_provisioned VirtualMachine#thin_provisioned}
        '''
    ...
    def unit_number(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#unit_number VirtualMachine#unit_number}
        '''
    ...
    def write_through(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#write_through VirtualMachine#write_through}
        '''
...
class VirtualMachineDiskList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineDisk]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineDisk]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineDisk]]],
...
class VirtualMachineDiskOutputReference(
    ...
    def eagerly_scrub_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "eagerlyScrubInput"))
    ...
    def keep_on_remove_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "keepOnRemoveInput"))
    ...
    def thin_provisioned_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "thinProvisionedInput"))
    ...
    def write_through_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "writeThroughInput"))
    ...
    def controller_type(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "controllerType", value)
    ...
    def disk_sharing(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "diskSharing", value)

    @builtins.property
    @jsii.member(jsii_name="eagerlyScrub")
    def eagerly_scrub(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "eagerlyScrub"))
    ...
    def eagerly_scrub(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "eagerlyScrub", value)
    ...
    def io_reservation(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ioReservation", value)
    ...
    def io_share_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ioShareCount", value)
    ...
    def io_share_level(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ioShareLevel", value)

    @builtins.property
    @jsii.member(jsii_name="keepOnRemove")
    def keep_on_remove(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "keepOnRemove"))
    ...
    def keep_on_remove(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "keepOnRemove", value)
    ...
    def thin_provisioned(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "thinProvisioned"))
    ...
    def thin_provisioned(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "thinProvisioned", value)
    ...
    def write_through(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "writeThrough"))
    ...
    def write_through(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "writeThrough", value)

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[VirtualMachineDisk, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[VirtualMachineDisk, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[VirtualMachineDisk, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[VirtualMachineDisk, cdktf.IResolvable]],
...
class VirtualMachineNetworkInterface:
    def __init__(
        ...
        *,
        ...
        use_static_mac: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
    ) -> None:
        '''
        :param network_id: The ID of the network to connect this network interface to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#network_id VirtualMachine#network_id}
        :param adapter_type: The controller type. Can be one of e1000, e1000e, or vmxnet3. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#adapter_type VirtualMachine#adapter_type}
        :param bandwidth_limit: The upper bandwidth limit of this network interface, in Mbits/sec. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_limit VirtualMachine#bandwidth_limit}
        :param bandwidth_reservation: The bandwidth reservation of this network interface, in Mbits/sec. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_reservation VirtualMachine#bandwidth_reservation}
        :param bandwidth_share_count: The share count for this network interface when the share level is custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_share_count VirtualMachine#bandwidth_share_count}
        :param bandwidth_share_level: The bandwidth share allocation level for this interface. Can be one of low, normal, high, or custom. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_share_level VirtualMachine#bandwidth_share_level}
        :param mac_address: The MAC address of this network interface. Can only be manually set if use_static_mac is true. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#mac_address VirtualMachine#mac_address}
        :param ovf_mapping: Mapping of network interface to OVF network. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_mapping VirtualMachine#ovf_mapping}
        :param use_static_mac: If true, the mac_address field is treated as a static MAC address and set accordingly. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#use_static_mac VirtualMachine#use_static_mac}
        '''
        if __debug__:
            def stub(
                *,
    ...
    def bandwidth_limit(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_limit VirtualMachine#bandwidth_limit}
        '''
    ...
    def bandwidth_reservation(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_reservation VirtualMachine#bandwidth_reservation}
        '''
    ...
    def bandwidth_share_count(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_share_count VirtualMachine#bandwidth_share_count}
        '''
    ...
    def bandwidth_share_level(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#bandwidth_share_level VirtualMachine#bandwidth_share_level}
        '''
    ...
    def mac_address(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#mac_address VirtualMachine#mac_address}
        '''
    ...
    def ovf_mapping(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ovf_mapping VirtualMachine#ovf_mapping}
        '''
    ...
    def use_static_mac(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#use_static_mac VirtualMachine#use_static_mac}
        '''
...
class VirtualMachineNetworkInterfaceList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineNetworkInterface]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineNetworkInterface]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[VirtualMachineNetworkInterface]]],
...
class VirtualMachineNetworkInterfaceOutputReference(
    ...
    def use_static_mac_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "useStaticMacInput"))
    ...
    def bandwidth_reservation(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bandwidthReservation", value)
    ...
    def bandwidth_share_count(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bandwidthShareCount", value)
    ...
    def bandwidth_share_level(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bandwidthShareLevel", value)
    ...
    def ovf_mapping(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ovfMapping", value)

    @builtins.property
    @jsii.member(jsii_name="useStaticMac")
    def use_static_mac(self) -> typing.Union[builtins.bool, cdktf.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "useStaticMac"))
    ...
    def use_static_mac(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "useStaticMac", value)

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[VirtualMachineNetworkInterface, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[VirtualMachineNetworkInterface, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[VirtualMachineNetworkInterface, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[VirtualMachineNetworkInterface, cdktf.IResolvable]],
...
class VirtualMachineOvfDeploy:
    ...
    def allow_unverified_ssl_cert(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#allow_unverified_ssl_cert VirtualMachine#allow_unverified_ssl_cert}
        '''
    ...
    def deployment_option(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#deployment_option VirtualMachine#deployment_option}
        '''
    ...
    def disk_provisioning(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#disk_provisioning VirtualMachine#disk_provisioning}
        '''
    ...
    def enable_hidden_properties(
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#enable_hidden_properties VirtualMachine#enable_hidden_properties}
        '''
    ...
    def ip_allocation_policy(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ip_allocation_policy VirtualMachine#ip_allocation_policy}
        '''
    ...
    def ip_protocol(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#ip_protocol VirtualMachine#ip_protocol}
        '''
    ...
    def local_ovf_path(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#local_ovf_path VirtualMachine#local_ovf_path}
        '''
    ...
    def remote_ovf_url(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#remote_ovf_url VirtualMachine#remote_ovf_url}
        '''
...
class VirtualMachineOvfDeployOutputReference(
    ...
    def allow_unverified_ssl_cert_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "allowUnverifiedSslCertInput"))
    ...
    def enable_hidden_properties_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "enableHiddenPropertiesInput"))
    ...
    def allow_unverified_ssl_cert(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "allowUnverifiedSslCert"))
    ...
    def allow_unverified_ssl_cert(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "allowUnverifiedSslCert", value)
    ...
    def disk_provisioning(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "diskProvisioning", value)
    ...
    def enable_hidden_properties(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "enableHiddenProperties"))
    ...
    def enable_hidden_properties(
        ...
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableHiddenProperties", value)
    ...
    def ip_allocation_policy(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "ipAllocationPolicy", value)
    ...
    def local_ovf_path(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "localOvfPath", value)
    ...
    def remote_ovf_url(self, value: builtins.str) -> None:
        if __debug__:
            ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "remoteOvfUrl", value)
    ...
    def internal_value(self, value: typing.Optional[VirtualMachineOvfDeploy]) -> None:
        if __debug__:
            def stub(value: typing.Optional[VirtualMachineOvfDeploy]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class VirtualMachineVappOutputReference(
    ...
    def internal_value(self, value: typing.Optional[VirtualMachineVapp]) -> None:
        if __debug__:
            def stub(value: typing.Optional[VirtualMachineVapp]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
