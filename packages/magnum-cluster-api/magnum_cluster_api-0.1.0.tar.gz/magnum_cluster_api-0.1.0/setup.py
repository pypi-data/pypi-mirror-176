...
packages = \
['magnum_cluster_api', 'magnum_cluster_api.cmd', 'magnum_cluster_api.manifests']
...
install_requires = \
['click', 'pykube-ng>=22.9.0,<23.0.0', 'requests', 'shortuuid>=1.0.9,<2.0.0']
