...
##########
##########
# (general) function to initiate the homework_notebook Student_ID request
##########
##########
##########
 ...
 * Calculate Yxq [kJ/cmol] (p. 36-38  in the QM3-script ‘Quantitative Microbiologie week 4 – Folien’\n
