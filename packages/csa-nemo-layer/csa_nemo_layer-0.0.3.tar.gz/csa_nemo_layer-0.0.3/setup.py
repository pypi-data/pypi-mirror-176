...
setup(
    ...
    download_url='https://github.com/struk77/csa_nemo_layer/archive/v_0.0.3.tar.gz',
    keywords=['AWS', 'AIOBOTO3'],
    install_requires=['aioboto3', 'botocore', 'simplejson',
                      'datetime', 'aws_lambda_powertools'],
    classifiers=[
