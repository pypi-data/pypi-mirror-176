...
<p align="center"><font size=3><i>DELIA is a Python package that facilitates data extraction from DICOM files to support large-scale image analysis workflows.</i></p>
