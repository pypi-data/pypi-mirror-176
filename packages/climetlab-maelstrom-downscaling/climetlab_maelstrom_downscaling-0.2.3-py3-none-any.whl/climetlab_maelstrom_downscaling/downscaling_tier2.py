...
PATTERN = "{url}/MAELSTROM_AP5/maelstrom-downscaling-tier2_{date}.nc"
...
class Downscaling(Dataset):
    ...
    dataset_types = {"training": dates_all[dates_all.year.isin(list(np.arange(2006, 2016)))],
    ...
    def parse_date(self, dates: List_or_string):
        ...
        print("dates before normalised",dates)
        dates = DateListNormaliser(dates)
        print("dates after normalised",dates)
