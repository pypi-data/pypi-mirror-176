...
class Downloader(ConfigBase):
    """
    Downloads data from the https://tickerdax.com data api using a provided config.
    """
    def __init__(self, config, client_kwargs=None, till_now=False, log_connection=True):
        # allow the downloader to specific whether it logs the connection
        client_kwargs['log_connection'] = log_connection
